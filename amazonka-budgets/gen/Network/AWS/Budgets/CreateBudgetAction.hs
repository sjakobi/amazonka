...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cbarrsResponseStatus' - -- | The response status code.
--
-- * 'cbarrsAccountId' - Undocumented member.
--
-- * 'cbarrsBudgetName' - Undocumented member.
--
-- * 'cbarrsActionId' - A system-generated universally unique identifier (UUID) for the action.
createBudgetActionResponse ::
  -- | 'cbarrsResponseStatus'
  Int ->
  -- | 'cbarrsAccountId'
...
createBudgetActionResponse
  ...
  pActionId_ =
    CreateBudgetActionResponse'
      { _cbarrsResponseStatus =
          pResponseStatus_,
        _cbarrsAccountId = pAccountId_,
        _cbarrsBudgetName = pBudgetName_,
        _cbarrsActionId = pActionId_
      }

-- | -- | The response status code.
cbarrsResponseStatus :: Lens' CreateBudgetActionResponse Int
cbarrsResponseStatus = lens _cbarrsResponseStatus (\s a -> s {_cbarrsResponseStatus = a})

-- | Undocumented member.
cbarrsAccountId :: Lens' CreateBudgetActionResponse Text
cbarrsAccountId = lens _cbarrsAccountId (\s a -> s {_cbarrsAccountId = a})

-- | Undocumented member.
cbarrsBudgetName :: Lens' CreateBudgetActionResponse Text
cbarrsBudgetName = lens _cbarrsBudgetName (\s a -> s {_cbarrsBudgetName = a})

-- | A system-generated universally unique identifier (UUID) for the action.
cbarrsActionId :: Lens' CreateBudgetActionResponse Text
cbarrsActionId = lens _cbarrsActionId (\s a -> s {_cbarrsActionId = a})
