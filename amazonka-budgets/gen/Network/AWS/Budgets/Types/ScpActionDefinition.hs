...
data ScpActionDefinition = ScpActionDefinition'
  { -- | The policy ID attached.
    ...
    targetIds :: Prelude.List1 Prelude.Text
  }
...
newScpActionDefinition pPolicyId_ pTargetIds_ =
  ScpActionDefinition'
    { policyId = pPolicyId_,
      targetIds = Prelude._List1 Lens.# pTargetIds_
    }
...
scpActionDefinition_targetIds = Lens.lens (\ScpActionDefinition' {targetIds} -> targetIds) (\s@ScpActionDefinition' {} a -> s {targetIds = a} :: ScpActionDefinition) Prelude.. Prelude._List1
