  ...
  toQuery CreateListener' {..} =
    mconcat
      [ "Action" =: ("CreateListener" :: ByteString),
        ...
        "AlpnPolicy"
          =: toQuery (toQueryList "member" <$> _clAlpnPolicy),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'clrrsListeners' - Information about the listener.
--
...
createListenerResponse pResponseStatus_ =
  CreateListenerResponse'
    { _clrrsListeners = Nothing,
      _clrrsResponseStatus = pResponseStatus_
    }

-- | Information about the listener.
clrrsListeners :: Lens' CreateListenerResponse [Listener]
clrrsListeners = lens _clrrsListeners (\s a -> s {_clrrsListeners = a}) . _Default . _Coerce

-- | -- | The response status code.
clrrsResponseStatus :: Lens' CreateListenerResponse Int
