...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'clbrrsLoadBalancers' - Information about the load balancer.
--
...
clbrrsLoadBalancers :: Lens' CreateLoadBalancerResponse [LoadBalancer]
clbrrsLoadBalancers = lens _clbrrsLoadBalancers (\s a -> s {_clbrrsLoadBalancers = a}) . _Default . _Coerce
