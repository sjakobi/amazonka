...
detectFacesResponse pResponseStatus_ =
  DetectFacesResponse'
    { _dfrrsFaceDetails = Nothing,
      _dfrrsOrientationCorrection = Nothing,
      _dfrrsResponseStatus = pResponseStatus_
    }

-- | Details of each face found in the image.
dfrrsFaceDetails :: Lens' DetectFacesResponse [FaceDetail]
dfrrsFaceDetails = lens _dfrrsFaceDetails (\s a -> s {_dfrrsFaceDetails = a}) . _Default . _Coerce
...
dfrrsOrientationCorrection :: Lens' DetectFacesResponse (Maybe OrientationCorrection)
dfrrsOrientationCorrection = lens _dfrrsOrientationCorrection (\s a -> s {_dfrrsOrientationCorrection = a})

-- | -- | The response status code.
dfrrsResponseStatus :: Lens' DetectFacesResponse Int
