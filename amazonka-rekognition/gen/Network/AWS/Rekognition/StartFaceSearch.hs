...
instance Hashable StartFaceSearch

instance NFData StartFaceSearch
    ...
    object
      ( catMaybes
          [ ("NotificationChannel" .=)
            ...
            ("JobTag" .=) <$> _sfsJobTag,
            ("FaceMatchThreshold" .=) <$> _sfsFaceMatchThreshold,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'sfsrrsJobId' - The identifier for the search job. Use @JobId@ to identify the job in a subsequent call to @GetFaceSearch@ .
--
-- * 'sfsrrsResponseStatus' - -- | The response status code.
startFaceSearchResponse ::
  -- | 'sfsrrsResponseStatus'
  Int ->
  StartFaceSearchResponse
startFaceSearchResponse pResponseStatus_ =
  StartFaceSearchResponse'
    { _sfsrrsJobId = Nothing,
      _sfsrrsResponseStatus = pResponseStatus_
    }

-- | The identifier for the search job. Use @JobId@ to identify the job in a subsequent call to @GetFaceSearch@ .
sfsrrsJobId :: Lens' StartFaceSearchResponse (Maybe Text)
sfsrrsJobId = lens _sfsrrsJobId (\s a -> s {_sfsrrsJobId = a})

-- | -- | The response status code.
sfsrrsResponseStatus :: Lens' StartFaceSearchResponse Int
sfsrrsResponseStatus = lens _sfsrrsResponseStatus (\s a -> s {_sfsrrsResponseStatus = a})

instance NFData StartFaceSearchResponse
