...
createPlatformVersion_tags = Lens.lens (\CreatePlatformVersion' {tags} -> tags) (\s@CreatePlatformVersion' {} a -> s {tags = a} :: CreatePlatformVersion) Prelude.. Lens.mapping Prelude._Coerce

-- | The configuration option settings to apply to the builder environment.
createPlatformVersion_optionSettings :: Lens.Lens' CreatePlatformVersion (Prelude.Maybe [ConfigurationOptionSetting])
createPlatformVersion_optionSettings = Lens.lens (\CreatePlatformVersion' {optionSettings} -> optionSettings) (\s@CreatePlatformVersion' {} a -> s {optionSettings = a} :: CreatePlatformVersion) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.AWSRequest CreatePlatformVersion where
  type
...
instance Prelude.ToHeaders CreatePlatformVersion where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath CreatePlatformVersion where
  toPath = Prelude.const "/"

instance Prelude.ToQuery CreatePlatformVersion where
  toQuery CreatePlatformVersion' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("CreatePlatformVersion" :: Prelude.ByteString),
        "Version"
        ...
        "PlatformName" Prelude.=: platformName,
        "PlatformVersion" Prelude.=: platformVersion,
        "PlatformDefinitionBundle"
          Prelude.=: platformDefinitionBundle
      ]
