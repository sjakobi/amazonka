...
instance Hashable DeletePlatformVersion

instance NFData DeletePlatformVersion
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dpvrrsPlatformSummary' - Detailed information about the version of the custom platform.
--
...
dpvrrsPlatformSummary :: Lens' DeletePlatformVersionResponse (Maybe PlatformSummary)
dpvrrsPlatformSummary = lens _dpvrrsPlatformSummary (\s a -> s {_dpvrrsPlatformSummary = a})

-- | -- | The response status code.
dpvrrsResponseStatus :: Lens' DeletePlatformVersionResponse Int
dpvrrsResponseStatus = lens _dpvrrsResponseStatus (\s a -> s {_dpvrrsResponseStatus = a})

instance NFData DeletePlatformVersionResponse
