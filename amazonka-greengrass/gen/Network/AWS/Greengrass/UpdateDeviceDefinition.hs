...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uddrrsResponseStatus' - -- | The response status code.
updateDeviceDefinitionResponse ::
  -- | 'uddrrsResponseStatus'
  Int ->
  UpdateDeviceDefinitionResponse
...
uddrrsResponseStatus :: Lens' UpdateDeviceDefinitionResponse Int
uddrrsResponseStatus = lens _uddrrsResponseStatus (\s a -> s {_uddrrsResponseStatus = a})
