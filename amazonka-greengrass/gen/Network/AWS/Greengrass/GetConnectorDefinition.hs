...
instance Prelude.AWSRequest GetConnectorDefinition where
  type
...
instance Prelude.ToHeaders GetConnectorDefinition where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Prelude.ToPath GetConnectorDefinition where
...
instance Prelude.ToQuery GetConnectorDefinition where
...
getConnectorDefinitionResponse_tags = Lens.lens (\GetConnectorDefinitionResponse' {tags} -> tags) (\s@GetConnectorDefinitionResponse' {} a -> s {tags = a} :: GetConnectorDefinitionResponse) Prelude.. Lens.mapping Prelude._Map
