...
coBucketKeyEnabled = lens _coBucketKeyEnabled (\s a -> s {_coBucketKeyEnabled = a})
...
data CopyObjectResponse = CopyObjectResponse'
  { _corrsRequestCharged ::
      !(Maybe RequestCharged),
    _corrsCopySourceVersionId ::
      !(Maybe Text),
    _corrsExpiration :: !(Maybe Text),
    _corrsSSEKMSEncryptionContext ::
      !(Maybe (Sensitive Text)),
    _corrsSSEKMSKeyId ::
      !(Maybe (Sensitive Text)),
    _corrsSSECustomerKeyMD5 ::
      !(Maybe Text),
    _corrsVersionId ::
      !(Maybe ObjectVersionId),
    _corrsBucketKeyEnabled ::
      !(Maybe Bool),
    _corrsCopyObjectResult ::
      !(Maybe CopyObjectResult),
    _corrsServerSideEncryption ::
      !(Maybe ServerSideEncryption),
    _corrsSSECustomerAlgorithm ::
      !(Maybe Text),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'corrsRequestCharged' - Undocumented member.
--
-- * 'corrsCopySourceVersionId' - Version of the copied object in the destination bucket.
--
-- * 'corrsExpiration' - If the object expiration is configured, the response includes this header.
--
-- * 'corrsSSEKMSEncryptionContext' - If present, specifies the AWS KMS Encryption Context to use for object encryption. The value of this header is a base64-encoded UTF-8 string holding JSON with the encryption context key-value pairs.
--
-- * 'corrsSSEKMSKeyId' - If present, specifies the ID of the AWS Key Management Service (AWS KMS) symmetric customer managed customer master key (CMK) that was used for the object.
--
-- * 'corrsSSECustomerKeyMD5' - If server-side encryption with a customer-provided encryption key was requested, the response will include this header to provide round-trip message integrity verification of the customer-provided encryption key.
--
-- * 'corrsVersionId' - Version ID of the newly created copy.
--
-- * 'corrsBucketKeyEnabled' - Indicates whether the copied object uses an S3 Bucket Key for server-side encryption with AWS KMS (SSE-KMS).
--
-- * 'corrsCopyObjectResult' - Container for all response elements.
--
-- * 'corrsServerSideEncryption' - The server-side encryption algorithm used when storing this object in Amazon S3 (for example, AES256, aws:kms).
--
-- * 'corrsSSECustomerAlgorithm' - If server-side encryption with a customer-provided encryption key was requested, the response will include this header confirming the encryption algorithm used.
--
...
copyObjectResponse pResponseStatus_ =
  CopyObjectResponse'
    { _corrsRequestCharged = Nothing,
      _corrsCopySourceVersionId = Nothing,
      _corrsExpiration = Nothing,
      _corrsSSEKMSEncryptionContext = Nothing,
      _corrsSSEKMSKeyId = Nothing,
      _corrsSSECustomerKeyMD5 = Nothing,
      _corrsVersionId = Nothing,
      _corrsBucketKeyEnabled = Nothing,
      _corrsCopyObjectResult = Nothing,
      _corrsServerSideEncryption = Nothing,
      _corrsSSECustomerAlgorithm = Nothing,
      _corrsResponseStatus = pResponseStatus_
    }

-- | Undocumented member.
corrsRequestCharged :: Lens' CopyObjectResponse (Maybe RequestCharged)
corrsRequestCharged = lens _corrsRequestCharged (\s a -> s {_corrsRequestCharged = a})

-- | Version of the copied object in the destination bucket.
corrsCopySourceVersionId :: Lens' CopyObjectResponse (Maybe Text)
corrsCopySourceVersionId = lens _corrsCopySourceVersionId (\s a -> s {_corrsCopySourceVersionId = a})

-- | If the object expiration is configured, the response includes this header.
corrsExpiration :: Lens' CopyObjectResponse (Maybe Text)
corrsExpiration = lens _corrsExpiration (\s a -> s {_corrsExpiration = a})

-- | If present, specifies the AWS KMS Encryption Context to use for object encryption. The value of this header is a base64-encoded UTF-8 string holding JSON with the encryption context key-value pairs.
corrsSSEKMSEncryptionContext :: Lens' CopyObjectResponse (Maybe Text)
corrsSSEKMSEncryptionContext = lens _corrsSSEKMSEncryptionContext (\s a -> s {_corrsSSEKMSEncryptionContext = a}) . mapping _Sensitive

-- | If present, specifies the ID of the AWS Key Management Service (AWS KMS) symmetric customer managed customer master key (CMK) that was used for the object.
corrsSSEKMSKeyId :: Lens' CopyObjectResponse (Maybe Text)
corrsSSEKMSKeyId = lens _corrsSSEKMSKeyId (\s a -> s {_corrsSSEKMSKeyId = a}) . mapping _Sensitive

-- | If server-side encryption with a customer-provided encryption key was requested, the response will include this header to provide round-trip message integrity verification of the customer-provided encryption key.
corrsSSECustomerKeyMD5 :: Lens' CopyObjectResponse (Maybe Text)
corrsSSECustomerKeyMD5 = lens _corrsSSECustomerKeyMD5 (\s a -> s {_corrsSSECustomerKeyMD5 = a})

-- | Version ID of the newly created copy.
corrsVersionId :: Lens' CopyObjectResponse (Maybe ObjectVersionId)
corrsVersionId = lens _corrsVersionId (\s a -> s {_corrsVersionId = a})

-- | Indicates whether the copied object uses an S3 Bucket Key for server-side encryption with AWS KMS (SSE-KMS).
corrsBucketKeyEnabled :: Lens' CopyObjectResponse (Maybe Bool)
corrsBucketKeyEnabled = lens _corrsBucketKeyEnabled (\s a -> s {_corrsBucketKeyEnabled = a})

-- | Container for all response elements.
corrsCopyObjectResult :: Lens' CopyObjectResponse (Maybe CopyObjectResult)
corrsCopyObjectResult = lens _corrsCopyObjectResult (\s a -> s {_corrsCopyObjectResult = a})

-- | The server-side encryption algorithm used when storing this object in Amazon S3 (for example, AES256, aws:kms).
corrsServerSideEncryption :: Lens' CopyObjectResponse (Maybe ServerSideEncryption)
corrsServerSideEncryption = lens _corrsServerSideEncryption (\s a -> s {_corrsServerSideEncryption = a})

-- | If server-side encryption with a customer-provided encryption key was requested, the response will include this header confirming the encryption algorithm used.
corrsSSECustomerAlgorithm :: Lens' CopyObjectResponse (Maybe Text)
corrsSSECustomerAlgorithm = lens _corrsSSECustomerAlgorithm (\s a -> s {_corrsSSECustomerAlgorithm = a})

-- | -- | The response status code.
corrsResponseStatus :: Lens' CopyObjectResponse Int
