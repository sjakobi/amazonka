...
--
-- * 'gbprrsPolicy' - The bucket policy as a JSON document.
getBucketPolicyResponse ::
  -- | 'gbprrsResponseStatus'
  Int ->
  -- | 'gbprrsPolicy'
...
getBucketPolicyResponse pResponseStatus_ pPolicy_ =
  GetBucketPolicyResponse'
    { _gbprrsResponseStatus =
        pResponseStatus_,
      _gbprrsPolicy = pPolicy_
    }

-- | -- | The response status code.
gbprrsResponseStatus :: Lens' GetBucketPolicyResponse Int
gbprrsResponseStatus = lens _gbprrsResponseStatus (\s a -> s {_gbprrsResponseStatus = a})

-- | The bucket policy as a JSON document.
gbprrsPolicy :: Lens' GetBucketPolicyResponse ByteString
gbprrsPolicy = lens _gbprrsPolicy (\s a -> s {_gbprrsPolicy = a})
