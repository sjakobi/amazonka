...
--
-- * 'dotKey' - The key that identifies the object in the bucket from which to remove all tags.
deleteObjectTagging ::
  -- | 'dotBucket'
  BucketName ->
  -- | 'dotKey'
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dotrrsVersionId' - The versionId of the object the tag-set was removed from.
--
-- * 'dotrrsResponseStatus' - -- | The response status code.
deleteObjectTaggingResponse ::
  -- | 'dotrrsResponseStatus'
  Int ->
  DeleteObjectTaggingResponse
deleteObjectTaggingResponse pResponseStatus_ =
  DeleteObjectTaggingResponse'
    { _dotrrsVersionId =
        Nothing,
      _dotrrsResponseStatus = pResponseStatus_
    }

-- | The versionId of the object the tag-set was removed from.
dotrrsVersionId :: Lens' DeleteObjectTaggingResponse (Maybe ObjectVersionId)
dotrrsVersionId = lens _dotrrsVersionId (\s a -> s {_dotrrsVersionId = a})

-- | -- | The response status code.
dotrrsResponseStatus :: Lens' DeleteObjectTaggingResponse Int
dotrrsResponseStatus = lens _dotrrsResponseStatus (\s a -> s {_dotrrsResponseStatus = a})
