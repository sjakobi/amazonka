...
data AbortMultipartUploadResponse = AbortMultipartUploadResponse'
  { _amurrsRequestCharged ::
      !( Maybe
           RequestCharged
       ),
    _amurrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'amurrsRequestCharged' - Undocumented member.
--
-- * 'amurrsResponseStatus' - -- | The response status code.
abortMultipartUploadResponse ::
  -- | 'amurrsResponseStatus'
  Int ->
  AbortMultipartUploadResponse
abortMultipartUploadResponse pResponseStatus_ =
  AbortMultipartUploadResponse'
    { _amurrsRequestCharged =
        Nothing,
      _amurrsResponseStatus = pResponseStatus_
    }

-- | Undocumented member.
amurrsRequestCharged :: Lens' AbortMultipartUploadResponse (Maybe RequestCharged)
amurrsRequestCharged = lens _amurrsRequestCharged (\s a -> s {_amurrsRequestCharged = a})

-- | -- | The response status code.
amurrsResponseStatus :: Lens' AbortMultipartUploadResponse Int
amurrsResponseStatus = lens _amurrsResponseStatus (\s a -> s {_amurrsResponseStatus = a})
