...
data GetBucketAnalyticsConfigurationResponse = GetBucketAnalyticsConfigurationResponse'
  { _gbacrrsAnalyticsConfiguration ::
      !( Maybe
           AnalyticsConfiguration
       ),
    _gbacrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gbacrrsAnalyticsConfiguration' - The configuration and any analyses for the analytics filter.
--
-- * 'gbacrrsResponseStatus' - -- | The response status code.
getBucketAnalyticsConfigurationResponse ::
  -- | 'gbacrrsResponseStatus'
  Int ->
  GetBucketAnalyticsConfigurationResponse
...
gbacrrsAnalyticsConfiguration :: Lens' GetBucketAnalyticsConfigurationResponse (Maybe AnalyticsConfiguration)
gbacrrsAnalyticsConfiguration = lens _gbacrrsAnalyticsConfiguration (\s a -> s {_gbacrrsAnalyticsConfiguration = a})

-- | -- | The response status code.
gbacrrsResponseStatus :: Lens' GetBucketAnalyticsConfigurationResponse Int
gbacrrsResponseStatus = lens _gbacrrsResponseStatus (\s a -> s {_gbacrrsResponseStatus = a})
