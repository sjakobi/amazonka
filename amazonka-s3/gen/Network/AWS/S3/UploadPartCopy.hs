...
data UploadPartCopyResponse = UploadPartCopyResponse'
  { _upcrrsRequestCharged ::
      !(Maybe RequestCharged),
    _upcrrsCopySourceVersionId ::
      !(Maybe Text),
    _upcrrsCopyPartResult ::
      !(Maybe CopyPartResult),
    _upcrrsSSEKMSKeyId ::
      !(Maybe (Sensitive Text)),
    _upcrrsSSECustomerKeyMD5 ::
      !(Maybe Text),
    _upcrrsBucketKeyEnabled ::
      !(Maybe Bool),
    _upcrrsServerSideEncryption ::
      !( Maybe
           ServerSideEncryption
       ),
    _upcrrsSSECustomerAlgorithm ::
      !(Maybe Text),
    _upcrrsResponseStatus ::
      !Int
  }
  deriving (Eq, Show, Data, Typeable, Generic)
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'upcrrsRequestCharged' - Undocumented member.
--
-- * 'upcrrsCopySourceVersionId' - The version of the source object that was copied, if you have enabled versioning on the source bucket.
--
-- * 'upcrrsCopyPartResult' - Container for all response elements.
--
-- * 'upcrrsSSEKMSKeyId' - If present, specifies the ID of the AWS Key Management Service (AWS KMS) symmetric customer managed customer master key (CMK) that was used for the object.
--
-- * 'upcrrsSSECustomerKeyMD5' - If server-side encryption with a customer-provided encryption key was requested, the response will include this header to provide round-trip message integrity verification of the customer-provided encryption key.
--
-- * 'upcrrsBucketKeyEnabled' - Indicates whether the multipart upload uses an S3 Bucket Key for server-side encryption with AWS KMS (SSE-KMS).
--
-- * 'upcrrsServerSideEncryption' - The server-side encryption algorithm used when storing this object in Amazon S3 (for example, AES256, aws:kms).
--
-- * 'upcrrsSSECustomerAlgorithm' - If server-side encryption with a customer-provided encryption key was requested, the response will include this header confirming the encryption algorithm used.
--
-- * 'upcrrsResponseStatus' - -- | The response status code.
uploadPartCopyResponse ::
  -- | 'upcrrsResponseStatus'
  Int ->
  UploadPartCopyResponse
uploadPartCopyResponse pResponseStatus_ =
  UploadPartCopyResponse'
    { _upcrrsRequestCharged =
        Nothing,
      _upcrrsCopySourceVersionId = Nothing,
      _upcrrsCopyPartResult = Nothing,
      _upcrrsSSEKMSKeyId = Nothing,
      _upcrrsSSECustomerKeyMD5 = Nothing,
      _upcrrsBucketKeyEnabled = Nothing,
      _upcrrsServerSideEncryption = Nothing,
      _upcrrsSSECustomerAlgorithm = Nothing,
      _upcrrsResponseStatus = pResponseStatus_
    }

-- | Undocumented member.
upcrrsRequestCharged :: Lens' UploadPartCopyResponse (Maybe RequestCharged)
upcrrsRequestCharged = lens _upcrrsRequestCharged (\s a -> s {_upcrrsRequestCharged = a})

-- | The version of the source object that was copied, if you have enabled versioning on the source bucket.
upcrrsCopySourceVersionId :: Lens' UploadPartCopyResponse (Maybe Text)
upcrrsCopySourceVersionId = lens _upcrrsCopySourceVersionId (\s a -> s {_upcrrsCopySourceVersionId = a})

-- | Container for all response elements.
upcrrsCopyPartResult :: Lens' UploadPartCopyResponse (Maybe CopyPartResult)
upcrrsCopyPartResult = lens _upcrrsCopyPartResult (\s a -> s {_upcrrsCopyPartResult = a})

-- | If present, specifies the ID of the AWS Key Management Service (AWS KMS) symmetric customer managed customer master key (CMK) that was used for the object.
upcrrsSSEKMSKeyId :: Lens' UploadPartCopyResponse (Maybe Text)
upcrrsSSEKMSKeyId = lens _upcrrsSSEKMSKeyId (\s a -> s {_upcrrsSSEKMSKeyId = a}) . mapping _Sensitive

-- | If server-side encryption with a customer-provided encryption key was requested, the response will include this header to provide round-trip message integrity verification of the customer-provided encryption key.
upcrrsSSECustomerKeyMD5 :: Lens' UploadPartCopyResponse (Maybe Text)
upcrrsSSECustomerKeyMD5 = lens _upcrrsSSECustomerKeyMD5 (\s a -> s {_upcrrsSSECustomerKeyMD5 = a})

-- | Indicates whether the multipart upload uses an S3 Bucket Key for server-side encryption with AWS KMS (SSE-KMS).
upcrrsBucketKeyEnabled :: Lens' UploadPartCopyResponse (Maybe Bool)
upcrrsBucketKeyEnabled = lens _upcrrsBucketKeyEnabled (\s a -> s {_upcrrsBucketKeyEnabled = a})

-- | The server-side encryption algorithm used when storing this object in Amazon S3 (for example, AES256, aws:kms).
upcrrsServerSideEncryption :: Lens' UploadPartCopyResponse (Maybe ServerSideEncryption)
upcrrsServerSideEncryption = lens _upcrrsServerSideEncryption (\s a -> s {_upcrrsServerSideEncryption = a})

-- | If server-side encryption with a customer-provided encryption key was requested, the response will include this header confirming the encryption algorithm used.
upcrrsSSECustomerAlgorithm :: Lens' UploadPartCopyResponse (Maybe Text)
upcrrsSSECustomerAlgorithm = lens _upcrrsSSECustomerAlgorithm (\s a -> s {_upcrrsSSECustomerAlgorithm = a})

-- | -- | The response status code.
upcrrsResponseStatus :: Lens' UploadPartCopyResponse Int
upcrrsResponseStatus = lens _upcrrsResponseStatus (\s a -> s {_upcrrsResponseStatus = a})
