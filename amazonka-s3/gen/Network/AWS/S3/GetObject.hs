...
data GetObject = GetObject'
  { -- | Return the object only if it has not been modified since the specified
    ...
    ifUnmodifiedSince :: Prelude.Maybe Prelude.ISO8601,
    ...
    ifModifiedSince :: Prelude.Maybe Prelude.ISO8601,
    -- | The account id of the expected bucket owner. If the bucket is owned by a
    -- different account, the request will fail with an HTTP
    -- @403 (Access Denied)@ error.
    expectedBucketOwner :: Prelude.Maybe Prelude.Text,
    -- | Sets the @Expires@ header of the response.
    responseExpires :: Prelude.Maybe Prelude.ISO8601,
...
getObject_ifUnmodifiedSince = Lens.lens (\GetObject' {ifUnmodifiedSince} -> ifUnmodifiedSince) (\s@GetObject' {} a -> s {ifUnmodifiedSince = a} :: GetObject) Prelude.. Lens.mapping Prelude._Time
...
getObject_ifModifiedSince = Lens.lens (\GetObject' {ifModifiedSince} -> ifModifiedSince) (\s@GetObject' {} a -> s {ifModifiedSince = a} :: GetObject) Prelude.. Lens.mapping Prelude._Time
...
getObject_responseExpires = Lens.lens (\GetObject' {responseExpires} -> responseExpires) (\s@GetObject' {} a -> s {responseExpires = a} :: GetObject) Prelude.. Lens.mapping Prelude._Time
...
getObject_sSECustomerKey = Lens.lens (\GetObject' {sSECustomerKey} -> sSECustomerKey) (\s@GetObject' {} a -> s {sSECustomerKey = a} :: GetObject) Prelude.. Lens.mapping Prelude._Sensitive
    ...
    Response.receiveBody
      ( \s h x ->
          GetObjectResponse'
            ...
            Prelude.<*> (h Prelude..#? "x-amz-mp-parts-count")
            Prelude.<*> (h Prelude..#? "x-amz-website-redirect-location")
            Prelude.<*> (h Prelude..#? "Content-Type")
            Prelude.<*> (h Prelude..#? "x-amz-tagging-count")
            ...
            Prelude.<*> (h Prelude..#? "Content-Language")
            Prelude.<*> (h Prelude..#? "x-amz-replication-status")
            Prelude.<*> (Prelude.parseHeadersMap "x-amz-meta-" h)
            Prelude.<*> (h Prelude..#? "Content-Length")
            Prelude.<*> (h Prelude..#? "Content-Encoding")
            Prelude.<*> ( h
            ...
            Prelude.<*> (h Prelude..#? "x-amz-storage-class")
            ...
            Prelude.<*> (h Prelude..#? "x-amz-missing-meta")
            Prelude.<*> (h Prelude..#? "x-amz-object-lock-legal-hold")
            Prelude.<*> ( h
                            Prelude..#? "x-amz-server-side-encryption-customer-algorithm"
                        )
            Prelude.<*> (h Prelude..#? "Last-Modified")
            Prelude.<*> (h Prelude..#? "Cache-Control")
            Prelude.<*> (h Prelude..#? "Expires")
            Prelude.<*> (h Prelude..#? "x-amz-restore")
            Prelude.<*> (h Prelude..#? "x-amz-object-lock-mode")
            Prelude.<*> (h Prelude..#? "x-amz-object-lock-retain-until-date")
...
instance Prelude.ToHeaders GetObject where
  toHeaders GetObject' {..} =
    Prelude.mconcat
      [ "If-Unmodified-Since" Prelude.=# ifUnmodifiedSince,
        "Range" Prelude.=# range,
        "If-Modified-Since" Prelude.=# ifModifiedSince,
        "x-amz-expected-bucket-owner"
          Prelude.=# expectedBucketOwner,
        "x-amz-server-side-encryption-customer-key-MD5"
          Prelude.=# sSECustomerKeyMD5,
        "If-Match" Prelude.=# ifMatch,
        "If-None-Match" Prelude.=# ifNoneMatch,
        "x-amz-server-side-encryption-customer-algorithm"
...
instance Prelude.ToQuery GetObject where
  toQuery GetObject' {..} =
    Prelude.mconcat
      [ "response-expires" Prelude.=: responseExpires,
        "versionId" Prelude.=: versionId,
        "partNumber" Prelude.=: partNumber,
        "response-content-encoding"
          Prelude.=: responseContentEncoding,
        "response-content-language"
          Prelude.=: responseContentLanguage,
        "response-cache-control"
          Prelude.=: responseCacheControl,
        "response-content-disposition"
          Prelude.=: responseContentDisposition,
        "response-content-type"
          Prelude.=: responseContentType
      ]
...
data GetObjectResponse = GetObjectResponse'
  { -- | An ETag is an opaque identifier assigned by a web server to a specific
    ...
    metadata :: Prelude.Map Prelude.Text Prelude.Text,
...
getObjectResponse_metadata = Lens.lens (\GetObjectResponse' {metadata} -> metadata) (\s@GetObjectResponse' {} a -> s {metadata = a} :: GetObjectResponse) Prelude.. Prelude._Map
...
getObjectResponse_sSEKMSKeyId = Lens.lens (\GetObjectResponse' {sSEKMSKeyId} -> sSEKMSKeyId) (\s@GetObjectResponse' {} a -> s {sSEKMSKeyId = a} :: GetObjectResponse) Prelude.. Lens.mapping Prelude._Sensitive
...
getObjectResponse_expires = Lens.lens (\GetObjectResponse' {expires} -> expires) (\s@GetObjectResponse' {} a -> s {expires = a} :: GetObjectResponse) Prelude.. Lens.mapping Prelude._Time
...
getObjectResponse_objectLockRetainUntilDate = Lens.lens (\GetObjectResponse' {objectLockRetainUntilDate} -> objectLockRetainUntilDate) (\s@GetObjectResponse' {} a -> s {objectLockRetainUntilDate = a} :: GetObjectResponse) Prelude.. Lens.mapping Prelude._Time
