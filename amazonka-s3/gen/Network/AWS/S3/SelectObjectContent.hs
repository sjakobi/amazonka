...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'socrrsPayload' - The array of results.
--
-- * 'socrrsResponseStatus' - -- | The response status code.
selectObjectContentResponse ::
  -- | 'socrrsResponseStatus'
  Int ->
  SelectObjectContentResponse
selectObjectContentResponse pResponseStatus_ =
  SelectObjectContentResponse'
    { _socrrsPayload =
        Nothing,
      _socrrsResponseStatus = pResponseStatus_
    }

-- | The array of results.
socrrsPayload :: Lens' SelectObjectContentResponse (Maybe SelectObjectContentEventStream)
socrrsPayload = lens _socrrsPayload (\s a -> s {_socrrsPayload = a})

-- | -- | The response status code.
socrrsResponseStatus :: Lens' SelectObjectContentResponse Int
socrrsResponseStatus = lens _socrrsResponseStatus (\s a -> s {_socrrsResponseStatus = a})
