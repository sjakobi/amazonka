...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dqfwrrsResponseStatus' - -- | The response status code.
disassociateQualificationFromWorkerResponse ::
  -- | 'dqfwrrsResponseStatus'
  Int ->
  DisassociateQualificationFromWorkerResponse
...
dqfwrrsResponseStatus :: Lens' DisassociateQualificationFromWorkerResponse Int
dqfwrrsResponseStatus = lens _dqfwrrsResponseStatus (\s a -> s {_dqfwrrsResponseStatus = a})
