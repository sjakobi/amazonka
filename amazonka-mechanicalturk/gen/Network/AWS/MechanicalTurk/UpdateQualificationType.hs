...
data UpdateQualificationTypeResponse = UpdateQualificationTypeResponse'
  { _uqtrrsQualificationType ::
      !( Maybe
           QualificationType
       ),
    _uqtrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uqtrrsQualificationType' - Contains a QualificationType data structure.
--
-- * 'uqtrrsResponseStatus' - -- | The response status code.
updateQualificationTypeResponse ::
  -- | 'uqtrrsResponseStatus'
  Int ->
  UpdateQualificationTypeResponse
updateQualificationTypeResponse pResponseStatus_ =
  UpdateQualificationTypeResponse'
    { _uqtrrsQualificationType =
        Nothing,
      _uqtrrsResponseStatus = pResponseStatus_
    }

-- | Contains a QualificationType data structure.
uqtrrsQualificationType :: Lens' UpdateQualificationTypeResponse (Maybe QualificationType)
uqtrrsQualificationType = lens _uqtrrsQualificationType (\s a -> s {_uqtrrsQualificationType = a})

-- | -- | The response status code.
uqtrrsResponseStatus :: Lens' UpdateQualificationTypeResponse Int
uqtrrsResponseStatus = lens _uqtrrsResponseStatus (\s a -> s {_uqtrrsResponseStatus = a})
