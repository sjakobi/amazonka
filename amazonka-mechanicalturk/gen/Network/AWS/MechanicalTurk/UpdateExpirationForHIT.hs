...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uefhitrrsResponseStatus' - -- | The response status code.
updateExpirationForHITResponse ::
  -- | 'uefhitrrsResponseStatus'
  Int ->
  UpdateExpirationForHITResponse
...
uefhitrrsResponseStatus :: Lens' UpdateExpirationForHITResponse Int
uefhitrrsResponseStatus = lens _uefhitrrsResponseStatus (\s a -> s {_uefhitrrsResponseStatus = a})
