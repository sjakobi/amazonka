...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'chitrrsHIT' - Contains the newly created HIT data. For a description of the HIT data structure as it appears in responses, see the HIT Data Structure documentation.
--
-- * 'chitrrsResponseStatus' - -- | The response status code.
createHITResponse ::
  -- | 'chitrrsResponseStatus'
  Int ->
  CreateHITResponse
createHITResponse pResponseStatus_ =
  CreateHITResponse'
    { _chitrrsHIT = Nothing,
      _chitrrsResponseStatus = pResponseStatus_
    }

-- | Contains the newly created HIT data. For a description of the HIT data structure as it appears in responses, see the HIT Data Structure documentation.
chitrrsHIT :: Lens' CreateHITResponse (Maybe HIT)
chitrrsHIT = lens _chitrrsHIT (\s a -> s {_chitrrsHIT = a})

-- | -- | The response status code.
chitrrsResponseStatus :: Lens' CreateHITResponse Int
chitrrsResponseStatus = lens _chitrrsResponseStatus (\s a -> s {_chitrrsResponseStatus = a})
