...
instance AWSRequest CreateAdditionalAssignmentsForHIT where
  type
...
instance ToHeaders CreateAdditionalAssignmentsForHIT where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
...
instance ToJSON CreateAdditionalAssignmentsForHIT where
...
instance ToPath CreateAdditionalAssignmentsForHIT where
  toPath = const "/"

instance ToQuery CreateAdditionalAssignmentsForHIT where
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'caafhitrrsResponseStatus' - -- | The response status code.
createAdditionalAssignmentsForHITResponse ::
  -- | 'caafhitrrsResponseStatus'
  Int ->
  CreateAdditionalAssignmentsForHITResponse
...
caafhitrrsResponseStatus :: Lens' CreateAdditionalAssignmentsForHITResponse Int
caafhitrrsResponseStatus = lens _caafhitrrsResponseStatus (\s a -> s {_caafhitrrsResponseStatus = a})
