...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uhitrsrrsResponseStatus' - -- | The response status code.
updateHITReviewStatusResponse ::
  -- | 'uhitrsrrsResponseStatus'
  Int ->
  UpdateHITReviewStatusResponse
...
uhitrsrrsResponseStatus :: Lens' UpdateHITReviewStatusResponse Int
uhitrsrrsResponseStatus = lens _uhitrsrrsResponseStatus (\s a -> s {_uhitrsrrsResponseStatus = a})
