...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ccrrsComment' - The comment that has been created.
--
...
createCommentResponse pResponseStatus_ =
  CreateCommentResponse'
    { _ccrrsComment = Nothing,
      _ccrrsResponseStatus = pResponseStatus_
    }

-- | The comment that has been created.
ccrrsComment :: Lens' CreateCommentResponse (Maybe Comment)
ccrrsComment = lens _ccrrsComment (\s a -> s {_ccrrsComment = a})

-- | -- | The response status code.
ccrrsResponseStatus :: Lens' CreateCommentResponse Int
