...
data StorageRuleType = StorageRuleType'
  { -- | The type of storage.
    ...
    storageAllocatedInBytes :: Prelude.Maybe Prelude.Nat
  }
...
storageRuleType_storageAllocatedInBytes = Lens.lens (\StorageRuleType' {storageAllocatedInBytes} -> storageAllocatedInBytes) (\s@StorageRuleType' {} a -> s {storageAllocatedInBytes = a} :: StorageRuleType) Prelude.. Lens.mapping Prelude._Nat
