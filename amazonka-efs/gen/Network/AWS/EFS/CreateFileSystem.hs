...
createFileSystem_tags = Lens.lens (\CreateFileSystem' {tags} -> tags) (\s@CreateFileSystem' {} a -> s {tags = a} :: CreateFileSystem) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.AWSRequest CreateFileSystem where
...
instance Prelude.ToHeaders CreateFileSystem where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToJSON CreateFileSystem where
...
instance Prelude.ToPath CreateFileSystem where
  toPath = Prelude.const "/2015-02-01/file-systems"

instance Prelude.ToQuery CreateFileSystem where
