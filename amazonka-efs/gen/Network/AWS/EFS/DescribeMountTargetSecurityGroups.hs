...
data DescribeMountTargetSecurityGroupsResponse = DescribeMountTargetSecurityGroupsResponse'
  { _dmtsgrrsResponseStatus ::
      !Int,
    _dmtsgrrsSecurityGroups ::
      ![Text]
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dmtsgrrsResponseStatus' - -- | The response status code.
--
-- * 'dmtsgrrsSecurityGroups' - An array of security groups.
describeMountTargetSecurityGroupsResponse ::
  -- | 'dmtsgrrsResponseStatus'
  Int ->
  DescribeMountTargetSecurityGroupsResponse
describeMountTargetSecurityGroupsResponse
  pResponseStatus_ =
    DescribeMountTargetSecurityGroupsResponse'
      { _dmtsgrrsResponseStatus =
          pResponseStatus_,
        _dmtsgrrsSecurityGroups = mempty
      }

-- | -- | The response status code.
dmtsgrrsResponseStatus :: Lens' DescribeMountTargetSecurityGroupsResponse Int
dmtsgrrsResponseStatus = lens _dmtsgrrsResponseStatus (\s a -> s {_dmtsgrrsResponseStatus = a})

-- | An array of security groups.
dmtsgrrsSecurityGroups :: Lens' DescribeMountTargetSecurityGroupsResponse [Text]
dmtsgrrsSecurityGroups = lens _dmtsgrrsSecurityGroups (\s a -> s {_dmtsgrrsSecurityGroups = a}) . _Coerce
