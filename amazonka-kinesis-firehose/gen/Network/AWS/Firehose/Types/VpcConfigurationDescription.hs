...
data VpcConfigurationDescription = VpcConfigurationDescription'
  { -- | The IDs of the subnets that Kinesis Data Firehose uses to create ENIs in
    ...
    securityGroupIds :: Prelude.List1 Prelude.Text,
...
newVpcConfigurationDescription
  ...
  pVpcId_ =
    VpcConfigurationDescription'
      { subnetIds =
          Prelude._List1 Lens.# pSubnetIds_,
        roleARN = pRoleARN_,
        securityGroupIds =
          Prelude._List1 Lens.# pSecurityGroupIds_,
        vpcId = pVpcId_
      }
...
vpcConfigurationDescription_subnetIds = Lens.lens (\VpcConfigurationDescription' {subnetIds} -> subnetIds) (\s@VpcConfigurationDescription' {} a -> s {subnetIds = a} :: VpcConfigurationDescription) Prelude.. Prelude._List1
...
vpcConfigurationDescription_securityGroupIds = Lens.lens (\VpcConfigurationDescription' {securityGroupIds} -> securityGroupIds) (\s@VpcConfigurationDescription' {} a -> s {securityGroupIds = a} :: VpcConfigurationDescription) Prelude.. Prelude._List1
...
instance Prelude.FromJSON VpcConfigurationDescription where
  parseJSON =
    Prelude.withObject
      "VpcConfigurationDescription"
      ( \x ->
