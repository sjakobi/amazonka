...
data ParquetSerDe = ParquetSerDe'
  { -- | The Parquet page size. Column chunks are divided into pages. A page is
    ...
    pageSizeBytes :: Prelude.Maybe Prelude.Nat,
    ...
    maxPaddingBytes :: Prelude.Maybe Prelude.Nat,
    ...
    blockSizeBytes :: Prelude.Maybe Prelude.Nat
  }
...
parquetSerDe_pageSizeBytes = Lens.lens (\ParquetSerDe' {pageSizeBytes} -> pageSizeBytes) (\s@ParquetSerDe' {} a -> s {pageSizeBytes = a} :: ParquetSerDe) Prelude.. Lens.mapping Prelude._Nat
...
parquetSerDe_maxPaddingBytes = Lens.lens (\ParquetSerDe' {maxPaddingBytes} -> maxPaddingBytes) (\s@ParquetSerDe' {} a -> s {maxPaddingBytes = a} :: ParquetSerDe) Prelude.. Lens.mapping Prelude._Nat
...
parquetSerDe_blockSizeBytes = Lens.lens (\ParquetSerDe' {blockSizeBytes} -> blockSizeBytes) (\s@ParquetSerDe' {} a -> s {blockSizeBytes = a} :: ParquetSerDe) Prelude.. Lens.mapping Prelude._Nat
