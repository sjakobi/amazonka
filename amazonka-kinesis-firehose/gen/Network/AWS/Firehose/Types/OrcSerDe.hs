...
data OrcSerDe = OrcSerDe'
  { -- | The number of rows between index entries. The default is 10,000 and the
    -- minimum is 1,000.
    rowIndexStride :: Prelude.Maybe Prelude.Nat,
    ...
    -- minimum is 8 MiB.
    stripeSizeBytes :: Prelude.Maybe Prelude.Nat
  }
...
orcSerDe_rowIndexStride = Lens.lens (\OrcSerDe' {rowIndexStride} -> rowIndexStride) (\s@OrcSerDe' {} a -> s {rowIndexStride = a} :: OrcSerDe) Prelude.. Lens.mapping Prelude._Nat
...
orcSerDe_blockSizeBytes = Lens.lens (\OrcSerDe' {blockSizeBytes} -> blockSizeBytes) (\s@OrcSerDe' {} a -> s {blockSizeBytes = a} :: OrcSerDe) Prelude.. Lens.mapping Prelude._Nat
...
orcSerDe_stripeSizeBytes = Lens.lens (\OrcSerDe' {stripeSizeBytes} -> stripeSizeBytes) (\s@OrcSerDe' {} a -> s {stripeSizeBytes = a} :: OrcSerDe) Prelude.. Lens.mapping Prelude._Nat
