...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cdsrrsDeliveryStreamARN' - The ARN of the delivery stream.
--
...
cdsrrsDeliveryStreamARN :: Lens' CreateDeliveryStreamResponse (Maybe Text)
cdsrrsDeliveryStreamARN = lens _cdsrrsDeliveryStreamARN (\s a -> s {_cdsrrsDeliveryStreamARN = a})

-- | -- | The response status code.
cdsrrsResponseStatus :: Lens' CreateDeliveryStreamResponse Int
