...
data DescribeDeliveryStreamResponse = DescribeDeliveryStreamResponse'
  { _ddsrrsResponseStatus ::
      !Int,
    _ddsrrsDeliveryStreamDescription ::
...
--
-- * 'ddsrrsDeliveryStreamDescription' - Information about the delivery stream.
describeDeliveryStreamResponse ::
  -- | 'ddsrrsResponseStatus'
  Int ->
  -- | 'ddsrrsDeliveryStreamDescription'
...
ddsrrsResponseStatus :: Lens' DescribeDeliveryStreamResponse Int
ddsrrsResponseStatus = lens _ddsrrsResponseStatus (\s a -> s {_ddsrrsResponseStatus = a})

-- | Information about the delivery stream.
ddsrrsDeliveryStreamDescription :: Lens' DescribeDeliveryStreamResponse DeliveryStreamDescription
ddsrrsDeliveryStreamDescription = lens _ddsrrsDeliveryStreamDescription (\s a -> s {_ddsrrsDeliveryStreamDescription = a})
