...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'tdsrrsResponseStatus' - -- | The response status code.
tagDeliveryStreamResponse ::
  -- | 'tdsrrsResponseStatus'
  Int ->
  TagDeliveryStreamResponse
...
tdsrrsResponseStatus :: Lens' TagDeliveryStreamResponse Int
tdsrrsResponseStatus = lens _tdsrrsResponseStatus (\s a -> s {_tdsrrsResponseStatus = a})
