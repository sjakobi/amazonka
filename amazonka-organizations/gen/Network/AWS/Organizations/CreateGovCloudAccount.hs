...
createGovCloudAccount pEmail_ pAccountName_ =
  CreateGovCloudAccount'
    { _cgcaRoleName = Nothing,
      _cgcaIAMUserAccessToBilling = Nothing,
      _cgcaTags = Nothing,
...
instance Hashable CreateGovCloudAccount

instance NFData CreateGovCloudAccount
...
data CreateGovCloudAccountResponse = CreateGovCloudAccountResponse'
  { _cgcarrsCreateAccountStatus ::
      !( Maybe
           CreateAccountStatus
       ),
    _cgcarrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cgcarrsCreateAccountStatus' - Undocumented member.
--
-- * 'cgcarrsResponseStatus' - -- | The response status code.
createGovCloudAccountResponse ::
  -- | 'cgcarrsResponseStatus'
  Int ->
  CreateGovCloudAccountResponse
createGovCloudAccountResponse pResponseStatus_ =
  CreateGovCloudAccountResponse'
    { _cgcarrsCreateAccountStatus =
        Nothing,
      _cgcarrsResponseStatus = pResponseStatus_
    }

-- | Undocumented member.
cgcarrsCreateAccountStatus :: Lens' CreateGovCloudAccountResponse (Maybe CreateAccountStatus)
cgcarrsCreateAccountStatus = lens _cgcarrsCreateAccountStatus (\s a -> s {_cgcarrsCreateAccountStatus = a})

-- | -- | The response status code.
cgcarrsResponseStatus :: Lens' CreateGovCloudAccountResponse Int
cgcarrsResponseStatus = lens _cgcarrsResponseStatus (\s a -> s {_cgcarrsResponseStatus = a})

instance NFData CreateGovCloudAccountResponse
