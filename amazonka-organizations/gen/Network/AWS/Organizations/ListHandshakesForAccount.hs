...
listHandshakesForAccount_maxResults = Lens.lens (\ListHandshakesForAccount' {maxResults} -> maxResults) (\s@ListHandshakesForAccount' {} a -> s {maxResults = a} :: ListHandshakesForAccount) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.AWSRequest ListHandshakesForAccount where
  type
...
instance Prelude.ToHeaders ListHandshakesForAccount where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AWSOrganizationsV20161128.ListHandshakesForAccount" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON ListHandshakesForAccount where
...
instance Prelude.ToPath ListHandshakesForAccount where
  toPath = Prelude.const "/"

instance Prelude.ToQuery ListHandshakesForAccount where
...
listHandshakesForAccountResponse_handshakes = Lens.lens (\ListHandshakesForAccountResponse' {handshakes} -> handshakes) (\s@ListHandshakesForAccountResponse' {} a -> s {handshakes = a} :: ListHandshakesForAccountResponse) Prelude.. Lens.mapping Prelude._Coerce
