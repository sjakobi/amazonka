...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'larrsNextToken' - If present, indicates that more output is available than is included in the current response. Use this value in the @NextToken@ request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the @NextToken@ response element comes back as @null@ .
--
-- * 'larrsAccounts' - A list of objects in the organization.
--
...
listAccountsResponse pResponseStatus_ =
  ListAccountsResponse'
    { _larrsNextToken = Nothing,
      _larrsAccounts = Nothing,
      _larrsResponseStatus = pResponseStatus_
    }

-- | If present, indicates that more output is available than is included in the current response. Use this value in the @NextToken@ request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the @NextToken@ response element comes back as @null@ .
larrsNextToken :: Lens' ListAccountsResponse (Maybe Text)
larrsNextToken = lens _larrsNextToken (\s a -> s {_larrsNextToken = a})

-- | A list of objects in the organization.
larrsAccounts :: Lens' ListAccountsResponse [Account]
larrsAccounts = lens _larrsAccounts (\s a -> s {_larrsAccounts = a}) . _Default . _Coerce

-- | -- | The response status code.
larrsResponseStatus :: Lens' ListAccountsResponse Int
