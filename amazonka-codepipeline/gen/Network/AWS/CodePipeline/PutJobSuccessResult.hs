...
putJobSuccessResult_outputVariables = Lens.lens (\PutJobSuccessResult' {outputVariables} -> outputVariables) (\s@PutJobSuccessResult' {} a -> s {outputVariables = a} :: PutJobSuccessResult) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.AWSRequest PutJobSuccessResult where
  type
...
instance Prelude.ToHeaders PutJobSuccessResult where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "CodePipeline_20150709.PutJobSuccessResult" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON PutJobSuccessResult where
...
instance Prelude.ToPath PutJobSuccessResult where
  toPath = Prelude.const "/"

instance Prelude.ToQuery PutJobSuccessResult where
