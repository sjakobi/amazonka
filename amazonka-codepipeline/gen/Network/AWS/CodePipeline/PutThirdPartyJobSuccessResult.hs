...
data PutThirdPartyJobSuccessResult = PutThirdPartyJobSuccessResult'
  { _ptpjsrExecutionDetails ::
      !( Maybe
           ExecutionDetails
       ),
    _ptpjsrCurrentRevision ::
      !( Maybe
           CurrentRevision
       ),
...
instance AWSRequest PutThirdPartyJobSuccessResult where
  type
...
instance ToHeaders PutThirdPartyJobSuccessResult where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
