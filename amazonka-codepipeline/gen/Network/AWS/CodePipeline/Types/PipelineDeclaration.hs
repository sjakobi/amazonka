...
data PipelineDeclaration = PipelineDeclaration'
  { -- | The version number of the pipeline. A new pipeline always has a version
    ...
    artifactStores :: Prelude.Maybe (Prelude.Map Prelude.Text ArtifactStore),
...
pipelineDeclaration_version = Lens.lens (\PipelineDeclaration' {version} -> version) (\s@PipelineDeclaration' {} a -> s {version = a} :: PipelineDeclaration) Prelude.. Lens.mapping Prelude._Nat
...
pipelineDeclaration_artifactStores = Lens.lens (\PipelineDeclaration' {artifactStores} -> artifactStores) (\s@PipelineDeclaration' {} a -> s {artifactStores = a} :: PipelineDeclaration) Prelude.. Lens.mapping Prelude._Map
