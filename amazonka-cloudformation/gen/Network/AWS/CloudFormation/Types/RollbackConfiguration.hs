...
data RollbackConfiguration = RollbackConfiguration'
  { -- | The amount of time, in minutes, during which CloudFormation should
    ...
    monitoringTimeInMinutes :: Prelude.Maybe Prelude.Nat,
...
rollbackConfiguration_monitoringTimeInMinutes = Lens.lens (\RollbackConfiguration' {monitoringTimeInMinutes} -> monitoringTimeInMinutes) (\s@RollbackConfiguration' {} a -> s {monitoringTimeInMinutes = a} :: RollbackConfiguration) Prelude.. Lens.mapping Prelude._Nat
