...
instance Prelude.AWSRequest DescribeTypeRegistration where
  type
  ...
  response =
    Response.receiveXMLWrapper
      ...
      ( \s h x ->
          DescribeTypeRegistrationResponse'
            Prelude.<$> (x Prelude..@? "TypeVersionArn")
            Prelude.<*> (x Prelude..@? "ProgressStatus")
...
instance Prelude.ToHeaders DescribeTypeRegistration where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath DescribeTypeRegistration where
  toPath = Prelude.const "/"

instance Prelude.ToQuery DescribeTypeRegistration where
  toQuery DescribeTypeRegistration' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("DescribeTypeRegistration" :: Prelude.ByteString),
        "Version"
