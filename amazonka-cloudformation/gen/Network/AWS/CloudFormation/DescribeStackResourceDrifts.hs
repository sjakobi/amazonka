...
data DescribeStackResourceDrifts = DescribeStackResourceDrifts'
  { -- | A string that identifies the next page of stack resource drift results.
    ...
    --     value.
    stackResourceDriftStatusFilters :: Prelude.Maybe (Prelude.List1 StackResourceDriftStatus),
...
describeStackResourceDrifts_maxResults = Lens.lens (\DescribeStackResourceDrifts' {maxResults} -> maxResults) (\s@DescribeStackResourceDrifts' {} a -> s {maxResults = a} :: DescribeStackResourceDrifts) Prelude.. Lens.mapping Prelude._Nat
...
describeStackResourceDrifts_stackResourceDriftStatusFilters = Lens.lens (\DescribeStackResourceDrifts' {stackResourceDriftStatusFilters} -> stackResourceDriftStatusFilters) (\s@DescribeStackResourceDrifts' {} a -> s {stackResourceDriftStatusFilters = a} :: DescribeStackResourceDrifts) Prelude.. Lens.mapping Prelude._List1
