...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'currrsResponseStatus' - -- | The response status code.
continueUpdateRollbackResponse ::
  -- | 'currrsResponseStatus'
  Int ->
  ContinueUpdateRollbackResponse
...
currrsResponseStatus :: Lens' ContinueUpdateRollbackResponse Int
currrsResponseStatus = lens _currrsResponseStatus (\s a -> s {_currrsResponseStatus = a})
