...
instance Prelude.AWSRequest PollForActivityTask where
  type
...
instance Prelude.ToHeaders PollForActivityTask where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "SimpleWorkflowService.PollForActivityTask" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON PollForActivityTask where
...
instance Prelude.ToPath PollForActivityTask where
  toPath = Prelude.const "/"

instance Prelude.ToQuery PollForActivityTask where
