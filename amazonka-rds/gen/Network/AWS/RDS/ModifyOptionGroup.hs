...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mogrrsOptionGroup' - Undocumented member.
--
-- * 'mogrrsResponseStatus' - -- | The response status code.
modifyOptionGroupResponse ::
  -- | 'mogrrsResponseStatus'
  Int ->
  ModifyOptionGroupResponse
modifyOptionGroupResponse pResponseStatus_ =
  ModifyOptionGroupResponse'
    { _mogrrsOptionGroup =
        Nothing,
      _mogrrsResponseStatus = pResponseStatus_
    }

-- | Undocumented member.
mogrrsOptionGroup :: Lens' ModifyOptionGroupResponse (Maybe OptionGroup)
mogrrsOptionGroup = lens _mogrrsOptionGroup (\s a -> s {_mogrrsOptionGroup = a})

-- | -- | The response status code.
mogrrsResponseStatus :: Lens' ModifyOptionGroupResponse Int
mogrrsResponseStatus = lens _mogrrsResponseStatus (\s a -> s {_mogrrsResponseStatus = a})
