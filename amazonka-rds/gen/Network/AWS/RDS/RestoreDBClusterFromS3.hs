...
data RestoreDBClusterFromS3 = RestoreDBClusterFromS3'
  { _rdcfsBackupRetentionPeriod ::
    ...
    _rdcfsDBClusterIdentifier ::
      !Text,
    _rdcfsEngine :: !Text,
    _rdcfsMasterUsername ::
      !Text,
    _rdcfsMasterUserPassword ::
      !Text,
    _rdcfsSourceEngine ::
      !Text,
    _rdcfsSourceEngineVersion ::
      !Text,
    _rdcfsS3BucketName ::
      !Text,
    _rdcfsS3IngestionRoleARN ::
      !Text
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rdcfsrrsDBCluster' - Undocumented member.
--
-- * 'rdcfsrrsResponseStatus' - -- | The response status code.
restoreDBClusterFromS3Response ::
  -- | 'rdcfsrrsResponseStatus'
  Int ->
  RestoreDBClusterFromS3Response
restoreDBClusterFromS3Response pResponseStatus_ =
  RestoreDBClusterFromS3Response'
    { _rdcfsrrsDBCluster =
        Nothing,
      _rdcfsrrsResponseStatus = pResponseStatus_
    }

-- | Undocumented member.
rdcfsrrsDBCluster :: Lens' RestoreDBClusterFromS3Response (Maybe DBCluster)
rdcfsrrsDBCluster = lens _rdcfsrrsDBCluster (\s a -> s {_rdcfsrrsDBCluster = a})

-- | -- | The response status code.
rdcfsrrsResponseStatus :: Lens' RestoreDBClusterFromS3Response Int
rdcfsrrsResponseStatus = lens _rdcfsrrsResponseStatus (\s a -> s {_rdcfsrrsResponseStatus = a})
