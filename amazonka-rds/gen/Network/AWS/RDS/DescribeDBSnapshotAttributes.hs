...
module Network.AWS.RDS.DescribeDBSnapshotAttributes
  ( -- * Creating a Request
    ...
    -- * Response Lenses
    ddsarrsDBSnapshotAttributesResult,
    ddsarrsResponseStatus,
  )
where
...
instance AWSRequest DescribeDBSnapshotAttributes where
  type
...
data DescribeDBSnapshotAttributesResponse = DescribeDBSnapshotAttributesResponse'
  { _ddsarrsDBSnapshotAttributesResult ::
      !( Maybe
           DBSnapshotAttributesResult
       ),
    _ddsarrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ddsarrsDBSnapshotAttributesResult' - Undocumented member.
--
-- * 'ddsarrsResponseStatus' - -- | The response status code.
describeDBSnapshotAttributesResponse ::
  -- | 'ddsarrsResponseStatus'
  Int ->
  DescribeDBSnapshotAttributesResponse
...
-- | Undocumented member.
ddsarrsDBSnapshotAttributesResult :: Lens' DescribeDBSnapshotAttributesResponse (Maybe DBSnapshotAttributesResult)
ddsarrsDBSnapshotAttributesResult = lens _ddsarrsDBSnapshotAttributesResult (\s a -> s {_ddsarrsDBSnapshotAttributesResult = a})

-- | -- | The response status code.
ddsarrsResponseStatus :: Lens' DescribeDBSnapshotAttributesResponse Int
ddsarrsResponseStatus = lens _ddsarrsResponseStatus (\s a -> s {_ddsarrsResponseStatus = a})
