...
module Network.AWS.RDS.ModifyDBSnapshotAttribute
  ( -- * Creating a Request
    ...
    -- * Response Lenses
    mdsarrsDBSnapshotAttributesResult,
    mdsarrsResponseStatus,
  )
where
...
data ModifyDBSnapshotAttributeResponse = ModifyDBSnapshotAttributeResponse'
  { _mdsarrsDBSnapshotAttributesResult ::
      !( Maybe
           DBSnapshotAttributesResult
       ),
    _mdsarrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mdsarrsDBSnapshotAttributesResult' - Undocumented member.
--
-- * 'mdsarrsResponseStatus' - -- | The response status code.
modifyDBSnapshotAttributeResponse ::
  -- | 'mdsarrsResponseStatus'
  Int ->
  ModifyDBSnapshotAttributeResponse
...
-- | Undocumented member.
mdsarrsDBSnapshotAttributesResult :: Lens' ModifyDBSnapshotAttributeResponse (Maybe DBSnapshotAttributesResult)
mdsarrsDBSnapshotAttributesResult = lens _mdsarrsDBSnapshotAttributesResult (\s a -> s {_mdsarrsDBSnapshotAttributesResult = a})

-- | -- | The response status code.
mdsarrsResponseStatus :: Lens' ModifyDBSnapshotAttributeResponse Int
mdsarrsResponseStatus = lens _mdsarrsResponseStatus (\s a -> s {_mdsarrsResponseStatus = a})
