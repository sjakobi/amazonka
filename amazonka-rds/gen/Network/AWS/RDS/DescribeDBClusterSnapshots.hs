...
describeDBClusterSnapshots_filters = Lens.lens (\DescribeDBClusterSnapshots' {filters} -> filters) (\s@DescribeDBClusterSnapshots' {} a -> s {filters = a} :: DescribeDBClusterSnapshots) Prelude.. Lens.mapping Prelude._Coerce
...
instance
  ...
  response =
    Response.receiveXMLWrapper
      ...
      ( \s h x ->
          DescribeDBClusterSnapshotsResponse'
            Prelude.<$> ( x Prelude..@? "DBClusterSnapshots"
                            Prelude..!@ Prelude.mempty
                            Prelude.>>= Prelude.may
                              (Prelude.parseXMLList "DBClusterSnapshot")
                        )
...
instance Prelude.ToHeaders DescribeDBClusterSnapshots where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath DescribeDBClusterSnapshots where
  toPath = Prelude.const "/"

instance Prelude.ToQuery DescribeDBClusterSnapshots where
  toQuery DescribeDBClusterSnapshots' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("DescribeDBClusterSnapshots" :: Prelude.ByteString),
        "Version"
...
describeDBClusterSnapshotsResponse_dBClusterSnapshots = Lens.lens (\DescribeDBClusterSnapshotsResponse' {dBClusterSnapshots} -> dBClusterSnapshots) (\s@DescribeDBClusterSnapshotsResponse' {} a -> s {dBClusterSnapshots = a} :: DescribeDBClusterSnapshotsResponse) Prelude.. Lens.mapping Prelude._Coerce
