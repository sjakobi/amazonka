...
instance Prelude.AWSRequest CreateGlobalCluster where
  type
...
instance Prelude.ToHeaders CreateGlobalCluster where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath CreateGlobalCluster where
  toPath = Prelude.const "/"

instance Prelude.ToQuery CreateGlobalCluster where
  toQuery CreateGlobalCluster' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("CreateGlobalCluster" :: Prelude.ByteString),
        "Version"
