...
data CopyDBClusterSnapshotResponse = CopyDBClusterSnapshotResponse'
  { _cdbcsrrsDBClusterSnapshot ::
      !( Maybe
           DBClusterSnapshot
       ),
    _cdbcsrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cdbcsrrsDBClusterSnapshot' - Undocumented member.
--
-- * 'cdbcsrrsResponseStatus' - -- | The response status code.
copyDBClusterSnapshotResponse ::
  -- | 'cdbcsrrsResponseStatus'
  Int ->
  CopyDBClusterSnapshotResponse
copyDBClusterSnapshotResponse pResponseStatus_ =
  CopyDBClusterSnapshotResponse'
    { _cdbcsrrsDBClusterSnapshot =
        Nothing,
      _cdbcsrrsResponseStatus = pResponseStatus_
    }

-- | Undocumented member.
cdbcsrrsDBClusterSnapshot :: Lens' CopyDBClusterSnapshotResponse (Maybe DBClusterSnapshot)
cdbcsrrsDBClusterSnapshot = lens _cdbcsrrsDBClusterSnapshot (\s a -> s {_cdbcsrrsDBClusterSnapshot = a})

-- | -- | The response status code.
cdbcsrrsResponseStatus :: Lens' CopyDBClusterSnapshotResponse Int
cdbcsrrsResponseStatus = lens _cdbcsrrsResponseStatus (\s a -> s {_cdbcsrrsResponseStatus = a})
