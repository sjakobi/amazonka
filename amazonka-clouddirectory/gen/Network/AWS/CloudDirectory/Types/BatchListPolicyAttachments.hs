...
batchListPolicyAttachments_maxResults = Lens.lens (\BatchListPolicyAttachments' {maxResults} -> maxResults) (\s@BatchListPolicyAttachments' {} a -> s {maxResults = a} :: BatchListPolicyAttachments) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.ToJSON BatchListPolicyAttachments where
