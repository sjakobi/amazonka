...
data AttachTypedLinkResponse = AttachTypedLinkResponse'
  { _atlrrsTypedLinkSpecifier ::
      !( Maybe
           TypedLinkSpecifier
       ),
    _atlrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'atlrrsTypedLinkSpecifier' - Returns a typed link specifier as output.
--
-- * 'atlrrsResponseStatus' - -- | The response status code.
attachTypedLinkResponse ::
  -- | 'atlrrsResponseStatus'
  Int ->
  AttachTypedLinkResponse
attachTypedLinkResponse pResponseStatus_ =
  AttachTypedLinkResponse'
    { _atlrrsTypedLinkSpecifier =
        Nothing,
      _atlrrsResponseStatus = pResponseStatus_
    }

-- | Returns a typed link specifier as output.
atlrrsTypedLinkSpecifier :: Lens' AttachTypedLinkResponse (Maybe TypedLinkSpecifier)
atlrrsTypedLinkSpecifier = lens _atlrrsTypedLinkSpecifier (\s a -> s {_atlrrsTypedLinkSpecifier = a})

-- | -- | The response status code.
atlrrsResponseStatus :: Lens' AttachTypedLinkResponse Int
atlrrsResponseStatus = lens _atlrrsResponseStatus (\s a -> s {_atlrrsResponseStatus = a})
