...
instance ToPath UpdatePublicKey where
  toPath UpdatePublicKey' {..} =
    mconcat
      ["/2020-05-31/public-key/", toBS _upkId, "/config"]
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'upkrrsETag' - The identifier of the current version of the public key.
--
-- * 'upkrrsPublicKey' - The public key.
--
-- * 'upkrrsResponseStatus' - -- | The response status code.
updatePublicKeyResponse ::
  -- | 'upkrrsResponseStatus'
  Int ->
  UpdatePublicKeyResponse
updatePublicKeyResponse pResponseStatus_ =
  UpdatePublicKeyResponse'
    { _upkrrsETag = Nothing,
      _upkrrsPublicKey = Nothing,
      _upkrrsResponseStatus = pResponseStatus_
    }

-- | The identifier of the current version of the public key.
upkrrsETag :: Lens' UpdatePublicKeyResponse (Maybe Text)
upkrrsETag = lens _upkrrsETag (\s a -> s {_upkrrsETag = a})

-- | The public key.
upkrrsPublicKey :: Lens' UpdatePublicKeyResponse (Maybe PublicKey)
upkrrsPublicKey = lens _upkrrsPublicKey (\s a -> s {_upkrrsPublicKey = a})

-- | -- | The response status code.
upkrrsResponseStatus :: Lens' UpdatePublicKeyResponse Int
upkrrsResponseStatus = lens _upkrrsResponseStatus (\s a -> s {_upkrrsResponseStatus = a})
