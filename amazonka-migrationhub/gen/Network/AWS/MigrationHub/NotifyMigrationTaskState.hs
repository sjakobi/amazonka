...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'nmtsrrsResponseStatus' - -- | The response status code.
notifyMigrationTaskStateResponse ::
  -- | 'nmtsrrsResponseStatus'
  Int ->
  NotifyMigrationTaskStateResponse
...
nmtsrrsResponseStatus :: Lens' NotifyMigrationTaskStateResponse Int
nmtsrrsResponseStatus = lens _nmtsrrsResponseStatus (\s a -> s {_nmtsrrsResponseStatus = a})
