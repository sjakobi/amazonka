  ...
  pNextUpdateSeconds_ =
    NotifyMigrationTaskState'
      { dryRun = Prelude.Nothing,
        ...
        nextUpdateSeconds =
          Prelude._Nat Lens.# pNextUpdateSeconds_
      }
...
notifyMigrationTaskState_nextUpdateSeconds = Lens.lens (\NotifyMigrationTaskState' {nextUpdateSeconds} -> nextUpdateSeconds) (\s@NotifyMigrationTaskState' {} a -> s {nextUpdateSeconds = a} :: NotifyMigrationTaskState) Prelude.. Prelude._Nat
