...
data UpdateServiceAccessPoliciesResponse = UpdateServiceAccessPoliciesResponse'
  { _usaprrsResponseStatus ::
      !Int,
    _usaprrsAccessPolicies ::
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'usaprrsResponseStatus' - -- | The response status code.
--
-- * 'usaprrsAccessPolicies' - The access rules configured for the domain.
updateServiceAccessPoliciesResponse ::
  -- | 'usaprrsResponseStatus'
  Int ->
  -- | 'usaprrsAccessPolicies'
...
usaprrsResponseStatus :: Lens' UpdateServiceAccessPoliciesResponse Int
usaprrsResponseStatus = lens _usaprrsResponseStatus (\s a -> s {_usaprrsResponseStatus = a})

-- | The access rules configured for the domain.
usaprrsAccessPolicies :: Lens' UpdateServiceAccessPoliciesResponse AccessPoliciesStatus
usaprrsAccessPolicies = lens _usaprrsAccessPolicies (\s a -> s {_usaprrsAccessPolicies = a})
