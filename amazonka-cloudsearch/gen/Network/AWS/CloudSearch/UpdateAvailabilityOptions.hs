...
data UpdateAvailabilityOptionsResponse = UpdateAvailabilityOptionsResponse'
  { _uaorrsAvailabilityOptions ::
      !( Maybe
           AvailabilityOptionsStatus
       ),
    _uaorrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uaorrsAvailabilityOptions' - The newly-configured availability options. Indicates whether Multi-AZ is enabled for the domain.
--
-- * 'uaorrsResponseStatus' - -- | The response status code.
updateAvailabilityOptionsResponse ::
  -- | 'uaorrsResponseStatus'
  Int ->
  UpdateAvailabilityOptionsResponse
updateAvailabilityOptionsResponse pResponseStatus_ =
  UpdateAvailabilityOptionsResponse'
    { _uaorrsAvailabilityOptions =
        Nothing,
      _uaorrsResponseStatus = pResponseStatus_
    }

-- | The newly-configured availability options. Indicates whether Multi-AZ is enabled for the domain.
uaorrsAvailabilityOptions :: Lens' UpdateAvailabilityOptionsResponse (Maybe AvailabilityOptionsStatus)
uaorrsAvailabilityOptions = lens _uaorrsAvailabilityOptions (\s a -> s {_uaorrsAvailabilityOptions = a})

-- | -- | The response status code.
uaorrsResponseStatus :: Lens' UpdateAvailabilityOptionsResponse Int
uaorrsResponseStatus = lens _uaorrsResponseStatus (\s a -> s {_uaorrsResponseStatus = a})
