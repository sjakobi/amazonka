...
data VpcConfig = VpcConfig'
  { -- | The ID number for a security group on an instance of your private VPC.
    ...
    subnets :: Prelude.List1 Prelude.Text
  }
...
newVpcConfig pSecurityGroupIds_ pSubnets_ =
  VpcConfig'
    { securityGroupIds =
      ...
      subnets = Prelude._List1 Lens.# pSubnets_
    }
...
vpcConfig_securityGroupIds = Lens.lens (\VpcConfig' {securityGroupIds} -> securityGroupIds) (\s@VpcConfig' {} a -> s {securityGroupIds = a} :: VpcConfig) Prelude.. Prelude._List1
...
vpcConfig_subnets = Lens.lens (\VpcConfig' {subnets} -> subnets) (\s@VpcConfig' {} a -> s {subnets = a} :: VpcConfig) Prelude.. Prelude._List1
