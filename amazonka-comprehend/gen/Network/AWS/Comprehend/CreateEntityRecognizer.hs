...
data CreateEntityRecognizerResponse = CreateEntityRecognizerResponse'
  { _cerrrsEntityRecognizerARN ::
      !( Maybe
           Text
       ),
    _cerrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cerrrsEntityRecognizerARN' - The Amazon Resource Name (ARN) that identifies the entity recognizer.
--
-- * 'cerrrsResponseStatus' - -- | The response status code.
createEntityRecognizerResponse ::
  -- | 'cerrrsResponseStatus'
  Int ->
  CreateEntityRecognizerResponse
createEntityRecognizerResponse pResponseStatus_ =
  CreateEntityRecognizerResponse'
    { _cerrrsEntityRecognizerARN =
        Nothing,
      _cerrrsResponseStatus = pResponseStatus_
    }

-- | The Amazon Resource Name (ARN) that identifies the entity recognizer.
cerrrsEntityRecognizerARN :: Lens' CreateEntityRecognizerResponse (Maybe Text)
cerrrsEntityRecognizerARN = lens _cerrrsEntityRecognizerARN (\s a -> s {_cerrrsEntityRecognizerARN = a})

-- | -- | The response status code.
cerrrsResponseStatus :: Lens' CreateEntityRecognizerResponse Int
cerrrsResponseStatus = lens _cerrrsResponseStatus (\s a -> s {_cerrrsResponseStatus = a})
