...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'sterrrsResponseStatus' - -- | The response status code.
stopTrainingEntityRecognizerResponse ::
  -- | 'sterrrsResponseStatus'
  Int ->
  StopTrainingEntityRecognizerResponse
...
sterrrsResponseStatus :: Lens' StopTrainingEntityRecognizerResponse Int
sterrrsResponseStatus = lens _sterrrsResponseStatus (\s a -> s {_sterrrsResponseStatus = a})
