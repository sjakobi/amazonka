...
-- | An object representing an AWS Batch compute resource. For more information, see <https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html Compute Environments> in the /AWS Batch User Guide/ .
--
--
--
...
--
-- * 'crEc2KeyPair' - The Amazon EC2 key pair that's used for instances launched in the compute environment. You can use this key pair to log in to your instances with SSH.
--
...
--
-- * 'crEc2Configuration' - Provides information used to select Amazon Machine Images (AMIs) for EC2 instances in the compute environment. If @Ec2Configuration@ isn't specified, the default is @ECS_AL1@ .
--
...
computeResource ::
  ...
  Int ->
  ComputeResource
computeResource pType_ pMaxvCPUs_ =
  ComputeResource'
...
crInstanceTypes = lens _crInstanceTypes (\s a -> s {_crInstanceTypes = a}) . _Default . _Coerce
