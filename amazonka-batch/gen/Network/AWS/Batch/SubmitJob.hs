...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'sjrrsJobARN' - The Amazon Resource Name (ARN) for the job.
--
-- * 'sjrrsResponseStatus' - -- | The response status code.
--
-- * 'sjrrsJobName' - The name of the job.
--
-- * 'sjrrsJobId' - The unique identifier for the job.
submitJobResponse ::
  -- | 'sjrrsResponseStatus'
  Int ->
  -- | 'sjrrsJobName'
...
submitJobResponse pResponseStatus_ pJobName_ pJobId_ =
  SubmitJobResponse'
    { _sjrrsJobARN = Nothing,
      _sjrrsResponseStatus = pResponseStatus_,
      _sjrrsJobName = pJobName_,
      _sjrrsJobId = pJobId_
    }

-- | The Amazon Resource Name (ARN) for the job.
sjrrsJobARN :: Lens' SubmitJobResponse (Maybe Text)
sjrrsJobARN = lens _sjrrsJobARN (\s a -> s {_sjrrsJobARN = a})

-- | -- | The response status code.
sjrrsResponseStatus :: Lens' SubmitJobResponse Int
sjrrsResponseStatus = lens _sjrrsResponseStatus (\s a -> s {_sjrrsResponseStatus = a})

-- | The name of the job.
sjrrsJobName :: Lens' SubmitJobResponse Text
sjrrsJobName = lens _sjrrsJobName (\s a -> s {_sjrrsJobName = a})

-- | The unique identifier for the job.
sjrrsJobId :: Lens' SubmitJobResponse Text
sjrrsJobId = lens _sjrrsJobId (\s a -> s {_sjrrsJobId = a})
