...
data RefreshPreferences = RefreshPreferences'
  { -- | The amount of capacity in the Auto Scaling group that must remain
    ...
    minHealthyPercentage :: Prelude.Maybe Prelude.Nat,
    ...
    instanceWarmup :: Prelude.Maybe Prelude.Nat
  }
...
refreshPreferences_minHealthyPercentage = Lens.lens (\RefreshPreferences' {minHealthyPercentage} -> minHealthyPercentage) (\s@RefreshPreferences' {} a -> s {minHealthyPercentage = a} :: RefreshPreferences) Prelude.. Lens.mapping Prelude._Nat
...
refreshPreferences_instanceWarmup = Lens.lens (\RefreshPreferences' {instanceWarmup} -> instanceWarmup) (\s@RefreshPreferences' {} a -> s {instanceWarmup = a} :: RefreshPreferences) Prelude.. Lens.mapping Prelude._Nat
