...
data InstanceRefresh = InstanceRefresh'
  { -- | The current status for the instance refresh operation:
    ...
    percentageComplete :: Prelude.Maybe Prelude.Nat,
    ...
    -- is complete.
    instancesToUpdate :: Prelude.Maybe Prelude.Nat,
...
instanceRefresh_percentageComplete = Lens.lens (\InstanceRefresh' {percentageComplete} -> percentageComplete) (\s@InstanceRefresh' {} a -> s {percentageComplete = a} :: InstanceRefresh) Prelude.. Lens.mapping Prelude._Nat
...
instanceRefresh_instancesToUpdate = Lens.lens (\InstanceRefresh' {instancesToUpdate} -> instancesToUpdate) (\s@InstanceRefresh' {} a -> s {instancesToUpdate = a} :: InstanceRefresh) Prelude.. Lens.mapping Prelude._Nat
