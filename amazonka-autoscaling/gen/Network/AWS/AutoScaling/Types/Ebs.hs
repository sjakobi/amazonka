...
data Ebs = Ebs'
  { -- | Specifies whether the volume should be encrypted. Encrypted EBS volumes
    ...
    volumeSize :: Prelude.Maybe Prelude.Nat,
    ...
    iops :: Prelude.Maybe Prelude.Nat
  }
...
ebs_volumeSize = Lens.lens (\Ebs' {volumeSize} -> volumeSize) (\s@Ebs' {} a -> s {volumeSize = a} :: Ebs) Prelude.. Lens.mapping Prelude._Nat
...
ebs_iops = Lens.lens (\Ebs' {iops} -> iops) (\s@Ebs' {} a -> s {iops = a} :: Ebs) Prelude.. Lens.mapping Prelude._Nat
