...
data BatchPutScheduledUpdateGroupActionResponse = BatchPutScheduledUpdateGroupActionResponse'
  { _bpsugarrsFailedScheduledUpdateGroupActions ::
      !( Maybe
           [FailedScheduledUpdateGroupActionRequest]
       ),
    _bpsugarrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'bpsugarrsFailedScheduledUpdateGroupActions' - The names of the scheduled actions that could not be created or updated, including an error message.
--
-- * 'bpsugarrsResponseStatus' - -- | The response status code.
batchPutScheduledUpdateGroupActionResponse ::
  -- | 'bpsugarrsResponseStatus'
  Int ->
  BatchPutScheduledUpdateGroupActionResponse
...
bpsugarrsFailedScheduledUpdateGroupActions :: Lens' BatchPutScheduledUpdateGroupActionResponse [FailedScheduledUpdateGroupActionRequest]
bpsugarrsFailedScheduledUpdateGroupActions = lens _bpsugarrsFailedScheduledUpdateGroupActions (\s a -> s {_bpsugarrsFailedScheduledUpdateGroupActions = a}) . _Default . _Coerce

-- | -- | The response status code.
bpsugarrsResponseStatus :: Lens' BatchPutScheduledUpdateGroupActionResponse Int
bpsugarrsResponseStatus = lens _bpsugarrsResponseStatus (\s a -> s {_bpsugarrsResponseStatus = a})
