...
--
-- * 'casgLaunchTemplate' - Parameters used to specify the launch template and version to use to launch instances.  Conditional: You must specify either a launch template (@LaunchTemplate@ or @MixedInstancesPolicy@ ) or a launch configuration (@LaunchConfigurationName@ or @InstanceId@ ).
--
...
casgAvailabilityZones :: Lens' CreateAutoScalingGroup [Text]
casgAvailabilityZones = lens _casgAvailabilityZones (\s a -> s {_casgAvailabilityZones = a}) . _Default . _Coerce
...
-- | Parameters used to specify the launch template and version to use to launch instances.  Conditional: You must specify either a launch template (@LaunchTemplate@ or @MixedInstancesPolicy@ ) or a launch configuration (@LaunchConfigurationName@ or @InstanceId@ ).
