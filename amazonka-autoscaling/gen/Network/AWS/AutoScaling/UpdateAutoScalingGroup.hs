...
uasgAvailabilityZones :: Lens' UpdateAutoScalingGroup [Text]
uasgAvailabilityZones = lens _uasgAvailabilityZones (\s a -> s {_uasgAvailabilityZones = a}) . _Default . _Coerce
