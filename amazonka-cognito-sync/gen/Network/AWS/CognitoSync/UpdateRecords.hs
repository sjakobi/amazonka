...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'urrrsRecords' - A list of records that have been updated.
--
...
updateRecordsResponse pResponseStatus_ =
  UpdateRecordsResponse'
    { _urrrsRecords = Nothing,
      _urrrsResponseStatus = pResponseStatus_
    }

-- | A list of records that have been updated.
urrrsRecords :: Lens' UpdateRecordsResponse [Record]
urrrsRecords = lens _urrrsRecords (\s a -> s {_urrrsRecords = a}) . _Default . _Coerce

-- | -- | The response status code.
urrrsResponseStatus :: Lens' UpdateRecordsResponse Int
