...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cslrrrsRole' - A 'Role' object that contains details about the newly created role.
--
-- * 'cslrrrsResponseStatus' - -- | The response status code.
createServiceLinkedRoleResponse ::
  -- | 'cslrrrsResponseStatus'
  Int ->
  CreateServiceLinkedRoleResponse
createServiceLinkedRoleResponse pResponseStatus_ =
  CreateServiceLinkedRoleResponse'
    { _cslrrrsRole =
        Nothing,
      _cslrrrsResponseStatus = pResponseStatus_
    }

-- | A 'Role' object that contains details about the newly created role.
cslrrrsRole :: Lens' CreateServiceLinkedRoleResponse (Maybe Role)
cslrrrsRole = lens _cslrrrsRole (\s a -> s {_cslrrrsRole = a})

-- | -- | The response status code.
cslrrrsResponseStatus :: Lens' CreateServiceLinkedRoleResponse Int
cslrrrsResponseStatus = lens _cslrrrsResponseStatus (\s a -> s {_cslrrrsResponseStatus = a})
