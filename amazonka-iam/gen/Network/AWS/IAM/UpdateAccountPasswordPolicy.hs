...
data UpdateAccountPasswordPolicy = UpdateAccountPasswordPolicy'
  { -- | The number of days that an IAM user password is valid.
    ...
    -- never expire.
    maxPasswordAge :: Prelude.Maybe Prelude.Nat,
    ...
    minimumPasswordLength :: Prelude.Maybe Prelude.Nat,
    ...
    passwordReusePrevention :: Prelude.Maybe Prelude.Nat,
...
-- require at least one uppercase character.
--
-- 'allowUsersToChangePassword', 'updateAccountPasswordPolicy_allowUsersToChangePassword' - Allows all IAM users in your account to use the AWS Management Console
-- to change their own passwords. For more information, see
-- <https://docs.aws.amazon.com/IAM/latest/UserGuide/HowToPwdIAMUser.html Letting IAM users change their own passwords>
-- in the /IAM User Guide/.
--
...
updateAccountPasswordPolicy_maxPasswordAge = Lens.lens (\UpdateAccountPasswordPolicy' {maxPasswordAge} -> maxPasswordAge) (\s@UpdateAccountPasswordPolicy' {} a -> s {maxPasswordAge = a} :: UpdateAccountPasswordPolicy) Prelude.. Lens.mapping Prelude._Nat
...
updateAccountPasswordPolicy_minimumPasswordLength = Lens.lens (\UpdateAccountPasswordPolicy' {minimumPasswordLength} -> minimumPasswordLength) (\s@UpdateAccountPasswordPolicy' {} a -> s {minimumPasswordLength = a} :: UpdateAccountPasswordPolicy) Prelude.. Lens.mapping Prelude._Nat
...
updateAccountPasswordPolicy_passwordReusePrevention = Lens.lens (\UpdateAccountPasswordPolicy' {passwordReusePrevention} -> passwordReusePrevention) (\s@UpdateAccountPasswordPolicy' {} a -> s {passwordReusePrevention = a} :: UpdateAccountPasswordPolicy) Prelude.. Lens.mapping Prelude._Nat
