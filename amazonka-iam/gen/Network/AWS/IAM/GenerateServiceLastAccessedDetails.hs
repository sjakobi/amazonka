...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gsladrrsJobId' - The @JobId@ that you can use in the 'GetServiceLastAccessedDetails' or 'GetServiceLastAccessedDetailsWithEntities' operations. The @JobId@ returned by @GenerateServiceLastAccessedDetail@ must be used by the same role within a session, or by the same user when used to call @GetServiceLastAccessedDetail@ .
--
-- * 'gsladrrsResponseStatus' - -- | The response status code.
generateServiceLastAccessedDetailsResponse ::
  -- | 'gsladrrsResponseStatus'
  Int ->
  GenerateServiceLastAccessedDetailsResponse
...
gsladrrsJobId :: Lens' GenerateServiceLastAccessedDetailsResponse (Maybe Text)
gsladrrsJobId = lens _gsladrrsJobId (\s a -> s {_gsladrrsJobId = a})

-- | -- | The response status code.
gsladrrsResponseStatus :: Lens' GenerateServiceLastAccessedDetailsResponse Int
gsladrrsResponseStatus = lens _gsladrrsResponseStatus (\s a -> s {_gsladrrsResponseStatus = a})
