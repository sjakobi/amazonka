...
instance ToQuery SetSecurityTokenServicePreferences where
  toQuery SetSecurityTokenServicePreferences' {..} =
    mconcat
      [ "Action"
          =: ("SetSecurityTokenServicePreferences" :: ByteString),
