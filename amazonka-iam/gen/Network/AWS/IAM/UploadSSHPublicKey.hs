...
data UploadSSHPublicKeyResponse = UploadSSHPublicKeyResponse'
  { _uspkrrsSSHPublicKey ::
      !( Maybe
           SSHPublicKey
       ),
    _uspkrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uspkrrsSSHPublicKey' - Contains information about the SSH public key.
--
-- * 'uspkrrsResponseStatus' - -- | The response status code.
uploadSSHPublicKeyResponse ::
  -- | 'uspkrrsResponseStatus'
  Int ->
  UploadSSHPublicKeyResponse
uploadSSHPublicKeyResponse pResponseStatus_ =
  UploadSSHPublicKeyResponse'
    { _uspkrrsSSHPublicKey =
        Nothing,
      _uspkrrsResponseStatus = pResponseStatus_
    }

-- | Contains information about the SSH public key.
uspkrrsSSHPublicKey :: Lens' UploadSSHPublicKeyResponse (Maybe SSHPublicKey)
uspkrrsSSHPublicKey = lens _uspkrrsSSHPublicKey (\s a -> s {_uspkrrsSSHPublicKey = a})

-- | -- | The response status code.
uspkrrsResponseStatus :: Lens' UploadSSHPublicKeyResponse Int
uspkrrsResponseStatus = lens _uspkrrsResponseStatus (\s a -> s {_uspkrrsResponseStatus = a})
