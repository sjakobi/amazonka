...
listGroupPolicies_maxItems = Lens.lens (\ListGroupPolicies' {maxItems} -> maxItems) (\s@ListGroupPolicies' {} a -> s {maxItems = a} :: ListGroupPolicies) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.AWSRequest ListGroupPolicies where
...
instance Prelude.ToHeaders ListGroupPolicies where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath ListGroupPolicies where
  toPath = Prelude.const "/"

instance Prelude.ToQuery ListGroupPolicies where
  toQuery ListGroupPolicies' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("ListGroupPolicies" :: Prelude.ByteString),
        "Version"
...
listGroupPoliciesResponse_policyNames = Lens.lens (\ListGroupPoliciesResponse' {policyNames} -> policyNames) (\s@ListGroupPoliciesResponse' {} a -> s {policyNames = a} :: ListGroupPoliciesResponse) Prelude.. Prelude._Coerce
