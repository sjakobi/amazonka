...
--
-- For information about the maximum number of inline policies that you can embed in a user, see <https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-quotas.html IAM and STS quotas> in the /IAM User Guide/ .
module Network.AWS.IAM.PutUserPolicy
  ( -- * Creating a Request
    putUserPolicy,
    PutUserPolicy,
