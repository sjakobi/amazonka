...
newSampledHTTPRequest pRequest_ pWeight_ =
  SampledHTTPRequest'
    { timestamp = Prelude.Nothing,
      ...
      request = pRequest_,
      weight = Prelude._Nat Lens.# pWeight_
    }
...
sampledHTTPRequest_weight = Lens.lens (\SampledHTTPRequest' {weight} -> weight) (\s@SampledHTTPRequest' {} a -> s {weight = a} :: SampledHTTPRequest) Prelude.. Prelude._Nat
