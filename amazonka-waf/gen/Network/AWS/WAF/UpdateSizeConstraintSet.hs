...
data UpdateSizeConstraintSet = UpdateSizeConstraintSet'
  { -- | The @SizeConstraintSetId@ of the SizeConstraintSet that you want to
    ...
    updates :: Prelude.List1 SizeConstraintSetUpdate
  }
...
updateSizeConstraintSet_updates = Lens.lens (\UpdateSizeConstraintSet' {updates} -> updates) (\s@UpdateSizeConstraintSet' {} a -> s {updates = a} :: UpdateSizeConstraintSet) Prelude.. Prelude._List1
...
instance Prelude.ToHeaders UpdateSizeConstraintSet where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AWSWAF_20150824.UpdateSizeConstraintSet" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
