...
data UpdateXssMatchSet = UpdateXssMatchSet'
  { -- | The @XssMatchSetId@ of the @XssMatchSet@ that you want to update.
    ...
    updates :: Prelude.List1 XssMatchSetUpdate
  }
...
updateXssMatchSet_updates = Lens.lens (\UpdateXssMatchSet' {updates} -> updates) (\s@UpdateXssMatchSet' {} a -> s {updates = a} :: UpdateXssMatchSet) Prelude.. Prelude._List1
