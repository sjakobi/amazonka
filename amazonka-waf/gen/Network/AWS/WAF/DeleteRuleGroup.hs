...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'drgrrsChangeToken' - The @ChangeToken@ that you used to submit the @DeleteRuleGroup@ request. You can also use this value to query the status of the request. For more information, see 'GetChangeTokenStatus' .
--
...
drgrrsChangeToken :: Lens' DeleteRuleGroupResponse (Maybe Text)
drgrrsChangeToken = lens _drgrrsChangeToken (\s a -> s {_drgrrsChangeToken = a})

-- | -- | The response status code.
drgrrsResponseStatus :: Lens' DeleteRuleGroupResponse Int
