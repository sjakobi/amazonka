...
getQueryResults_maxResults = Lens.lens (\GetQueryResults' {maxResults} -> maxResults) (\s@GetQueryResults' {} a -> s {maxResults = a} :: GetQueryResults) Prelude.. Lens.mapping Prelude._Nat
    ...
    Response.receiveJSON
      ( \s h x ->
          GetQueryResultsResponse'
            ...
            Prelude.<*> (x Prelude..?> "ResultSet")
            Prelude.<*> (x Prelude..?> "UpdateCount")
...
instance Prelude.ToHeaders GetQueryResults where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AmazonAthena.GetQueryResults" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
