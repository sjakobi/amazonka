...
listQueryExecutions_maxResults = Lens.lens (\ListQueryExecutions' {maxResults} -> maxResults) (\s@ListQueryExecutions' {} a -> s {maxResults = a} :: ListQueryExecutions) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.AWSRequest ListQueryExecutions where
  type
    ...
    Response.receiveJSON
      ( \s h x ->
          ListQueryExecutionsResponse'
            ...
            Prelude.<*> (x Prelude..?> "QueryExecutionIds")
...
instance Prelude.ToHeaders ListQueryExecutions where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AmazonAthena.ListQueryExecutions" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON ListQueryExecutions where
...
instance Prelude.ToPath ListQueryExecutions where
  toPath = Prelude.const "/"

instance Prelude.ToQuery ListQueryExecutions where
...
data ListQueryExecutionsResponse = ListQueryExecutionsResponse'
  { -- | A token to be used by the next request if this request is truncated.
    ...
    queryExecutionIds :: Prelude.Maybe (Prelude.List1 Prelude.Text),
...
listQueryExecutionsResponse_queryExecutionIds = Lens.lens (\ListQueryExecutionsResponse' {queryExecutionIds} -> queryExecutionIds) (\s@ListQueryExecutionsResponse' {} a -> s {queryExecutionIds = a} :: ListQueryExecutionsResponse) Prelude.. Lens.mapping Prelude._List1
