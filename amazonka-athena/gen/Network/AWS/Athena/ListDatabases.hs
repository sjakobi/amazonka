...
instance AWSPager ListDatabases where
  page rq rs
    ...
    | stop (rs ^. ldrrsDatabaseList) = Nothing
    | otherwise =
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ldrrsDatabaseList' - A list of databases from a data catalog.
--
-- * 'ldrrsNextToken' - A token generated by the Athena service that specifies where to continue pagination if a previous request was truncated. To obtain the next set of pages, pass in the NextToken from the response object of the previous page call.
--
...
ldrrsDatabaseList :: Lens' ListDatabasesResponse [Database]
ldrrsDatabaseList = lens _ldrrsDatabaseList (\s a -> s {_ldrrsDatabaseList = a}) . _Default . _Coerce

-- | A token generated by the Athena service that specifies where to continue pagination if a previous request was truncated. To obtain the next set of pages, pass in the NextToken from the response object of the previous page call.
ldrrsNextToken :: Lens' ListDatabasesResponse (Maybe Text)
ldrrsNextToken = lens _ldrrsNextToken (\s a -> s {_ldrrsNextToken = a})

-- | -- | The response status code.
ldrrsResponseStatus :: Lens' ListDatabasesResponse Int
