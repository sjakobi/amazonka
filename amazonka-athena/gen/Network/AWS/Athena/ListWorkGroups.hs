...
listWorkGroups_maxResults = Lens.lens (\ListWorkGroups' {maxResults} -> maxResults) (\s@ListWorkGroups' {} a -> s {maxResults = a} :: ListWorkGroups) Prelude.. Lens.mapping Prelude._Nat

instance Prelude.AWSRequest ListWorkGroups where
...
instance Prelude.ToHeaders ListWorkGroups where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AmazonAthena.ListWorkGroups" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON ListWorkGroups where
...
instance Prelude.ToPath ListWorkGroups where
  toPath = Prelude.const "/"

instance Prelude.ToQuery ListWorkGroups where
...
listWorkGroupsResponse_workGroups = Lens.lens (\ListWorkGroupsResponse' {workGroups} -> workGroups) (\s@ListWorkGroupsResponse' {} a -> s {workGroups = a} :: ListWorkGroupsResponse) Prelude.. Lens.mapping Prelude._Coerce
