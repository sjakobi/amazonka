...
data CreateOpsItem = CreateOpsItem'
  { _coiPlannedEndTime ::
    ...
    _coiActualStartTime :: !(Maybe POSIX),
    _coiCategory :: !(Maybe Text),
    _coiOperationalData ::
      !(Maybe (Map Text OpsItemDataValue)),
    _coiPriority :: !(Maybe Nat),
    _coiActualEndTime :: !(Maybe POSIX),
    _coiTags :: !(Maybe [Tag]),
    _coiOpsItemType :: !(Maybe Text),
    _coiPlannedStartTime :: !(Maybe POSIX),
    _coiNotifications ::
...
--
-- * 'coiPlannedEndTime' - The time specified in a change request for a runbook workflow to end. Currently supported only for the OpsItem type @/aws/changerequest@ .
--
-- * 'coiSeverity' - Specify a severity to assign to an OpsItem.
--
-- * 'coiActualStartTime' - The time a runbook workflow started. Currently reported only for the OpsItem type @/aws/changerequest@ .
--
...
--
-- * 'coiActualEndTime' - The time a runbook workflow ended. Currently reported only for the OpsItem type @/aws/changerequest@ .
--
...
--
-- * 'coiOpsItemType' - The type of OpsItem to create. Currently, the only valid values are @/aws/changerequest@ and @/aws/issue@ .
--
-- * 'coiPlannedStartTime' - The time specified in a change request for a runbook workflow to start. Currently supported only for the OpsItem type @/aws/changerequest@ .
--
...
createOpsItem pDescription_ pSource_ pTitle_ =
  CreateOpsItem'
    { _coiPlannedEndTime = Nothing,
      _coiSeverity = Nothing,
      _coiActualStartTime = Nothing,
      _coiCategory = Nothing,
      _coiOperationalData = Nothing,
      _coiPriority = Nothing,
      _coiActualEndTime = Nothing,
      _coiTags = Nothing,
      _coiOpsItemType = Nothing,
      _coiPlannedStartTime = Nothing,
...
coiPlannedEndTime :: Lens' CreateOpsItem (Maybe UTCTime)
coiPlannedEndTime = lens _coiPlannedEndTime (\s a -> s {_coiPlannedEndTime = a}) . mapping _Time
...
coiActualStartTime :: Lens' CreateOpsItem (Maybe UTCTime)
coiActualStartTime = lens _coiActualStartTime (\s a -> s {_coiActualStartTime = a}) . mapping _Time
...
coiActualEndTime :: Lens' CreateOpsItem (Maybe UTCTime)
coiActualEndTime = lens _coiActualEndTime (\s a -> s {_coiActualEndTime = a}) . mapping _Time
...
coiOpsItemType :: Lens' CreateOpsItem (Maybe Text)
coiOpsItemType = lens _coiOpsItemType (\s a -> s {_coiOpsItemType = a})

-- | The time specified in a change request for a runbook workflow to start. Currently supported only for the OpsItem type @/aws/changerequest@ .
coiPlannedStartTime :: Lens' CreateOpsItem (Maybe UTCTime)
coiPlannedStartTime = lens _coiPlannedStartTime (\s a -> s {_coiPlannedStartTime = a}) . mapping _Time
...
instance ToHeaders CreateOpsItem where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
              =# ("AmazonSSM.CreateOpsItem" :: ByteString),
            "Content-Type"
...
instance ToJSON CreateOpsItem where
  toJSON CreateOpsItem' {..} =
    object
      ( catMaybes
          [ ("PlannedEndTime" .=) <$> _coiPlannedEndTime,
            ("Severity" .=) <$> _coiSeverity,
            ("ActualStartTime" .=) <$> _coiActualStartTime,
            ("Category" .=) <$> _coiCategory,
            ("OperationalData" .=) <$> _coiOperationalData,
            ("Priority" .=) <$> _coiPriority,
            ("ActualEndTime" .=) <$> _coiActualEndTime,
            ("Tags" .=) <$> _coiTags,
            ("OpsItemType" .=) <$> _coiOpsItemType,
            ("PlannedStartTime" .=) <$> _coiPlannedStartTime,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'coirrsOpsItemId' - The ID of the OpsItem.
--
-- * 'coirrsResponseStatus' - -- | The response status code.
createOpsItemResponse ::
  -- | 'coirrsResponseStatus'
  Int ->
  CreateOpsItemResponse
createOpsItemResponse pResponseStatus_ =
  CreateOpsItemResponse'
    { _coirrsOpsItemId = Nothing,
      _coirrsResponseStatus = pResponseStatus_
    }

-- | The ID of the OpsItem.
coirrsOpsItemId :: Lens' CreateOpsItemResponse (Maybe Text)
coirrsOpsItemId = lens _coirrsOpsItemId (\s a -> s {_coirrsOpsItemId = a})

-- | -- | The response status code.
coirrsResponseStatus :: Lens' CreateOpsItemResponse Int
coirrsResponseStatus = lens _coirrsResponseStatus (\s a -> s {_coirrsResponseStatus = a})
