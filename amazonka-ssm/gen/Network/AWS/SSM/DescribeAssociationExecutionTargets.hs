...
data DescribeAssociationExecutionTargets = DescribeAssociationExecutionTargets'
  { -- | A token to start the list. Use this token to get the next set of
    ...
    --
    -- ResourceType (EQUAL)
    filters :: Prelude.Maybe (Prelude.List1 AssociationExecutionTargetsFilter),
...
describeAssociationExecutionTargets_maxResults = Lens.lens (\DescribeAssociationExecutionTargets' {maxResults} -> maxResults) (\s@DescribeAssociationExecutionTargets' {} a -> s {maxResults = a} :: DescribeAssociationExecutionTargets) Prelude.. Lens.mapping Prelude._Nat
...
describeAssociationExecutionTargets_filters = Lens.lens (\DescribeAssociationExecutionTargets' {filters} -> filters) (\s@DescribeAssociationExecutionTargets' {} a -> s {filters = a} :: DescribeAssociationExecutionTargets) Prelude.. Lens.mapping Prelude._List1
      ...
      ( \s h x ->
          DescribeAssociationExecutionTargetsResponse'
            Prelude.<$> (x Prelude..?> "NextToken")
              Prelude.<*> ( x Prelude..?> "AssociationExecutionTargets"
...
instance
  ...
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AmazonSSM.DescribeAssociationExecutionTargets" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
    ...
    Prelude.object
      ( Prelude.catMaybes
          [ ("NextToken" Prelude..=) Prelude.<$> nextToken,
            ...
            Prelude.Just ("ExecutionId" Prelude..= executionId)
          ]
      )
