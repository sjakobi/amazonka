...
createAssociation_targets = Lens.lens (\CreateAssociation' {targets} -> targets) (\s@CreateAssociation' {} a -> s {targets = a} :: CreateAssociation) Prelude.. Lens.mapping Prelude._Coerce

-- | A location is a combination of AWS Regions and AWS accounts where you
-- want to run the association. Use this action to create an association in
-- multiple Regions and multiple accounts.
createAssociation_targetLocations :: Lens.Lens' CreateAssociation (Prelude.Maybe (Prelude.NonEmpty TargetLocation))
createAssociation_targetLocations = Lens.lens (\CreateAssociation' {targetLocations} -> targetLocations) (\s@CreateAssociation' {} a -> s {targetLocations = a} :: CreateAssociation) Prelude.. Lens.mapping Prelude._List1
...
createAssociation_parameters = Lens.lens (\CreateAssociation' {parameters} -> parameters) (\s@CreateAssociation' {} a -> s {parameters = a} :: CreateAssociation) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.AWSRequest CreateAssociation where
...
instance Prelude.ToHeaders CreateAssociation where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AmazonSSM.CreateAssociation" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON CreateAssociation where
...
instance Prelude.ToPath CreateAssociation where
  toPath = Prelude.const "/"

instance Prelude.ToQuery CreateAssociation where
