...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'pprrsVersion' - The new version number of a parameter. If you edit a parameter value, Parameter Store automatically creates a new version and assigns this new version a unique ID. You can reference a parameter version ID in API actions or in Systems Manager documents (SSM documents). By default, if you don't specify a specific version, the system returns the latest parameter value when a parameter is called.
--
-- * 'pprrsTier' - The tier assigned to the parameter.
--
...
putParameterResponse pResponseStatus_ =
  PutParameterResponse'
    { _pprrsVersion = Nothing,
      _pprrsTier = Nothing,
      _pprrsResponseStatus = pResponseStatus_
    }

-- | The new version number of a parameter. If you edit a parameter value, Parameter Store automatically creates a new version and assigns this new version a unique ID. You can reference a parameter version ID in API actions or in Systems Manager documents (SSM documents). By default, if you don't specify a specific version, the system returns the latest parameter value when a parameter is called.
pprrsVersion :: Lens' PutParameterResponse (Maybe Integer)
pprrsVersion = lens _pprrsVersion (\s a -> s {_pprrsVersion = a})

-- | The tier assigned to the parameter.
pprrsTier :: Lens' PutParameterResponse (Maybe ParameterTier)
pprrsTier = lens _pprrsTier (\s a -> s {_pprrsTier = a})

-- | -- | The response status code.
pprrsResponseStatus :: Lens' PutParameterResponse Int
