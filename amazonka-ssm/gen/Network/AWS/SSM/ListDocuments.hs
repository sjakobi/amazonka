...
data ListDocuments = ListDocuments'
  { -- | The token for the next set of items to return. (You received this token
    ...
    documentFilterList :: Prelude.Maybe (Prelude.List1 DocumentFilter)
  }
...
listDocuments_maxResults = Lens.lens (\ListDocuments' {maxResults} -> maxResults) (\s@ListDocuments' {} a -> s {maxResults = a} :: ListDocuments) Prelude.. Lens.mapping Prelude._Nat
...
listDocuments_documentFilterList = Lens.lens (\ListDocuments' {documentFilterList} -> documentFilterList) (\s@ListDocuments' {} a -> s {documentFilterList = a} :: ListDocuments) Prelude.. Lens.mapping Prelude._List1
