...
data ResourceDataSyncAwsOrganizationsSource = ResourceDataSyncAwsOrganizationsSource'
  { -- | The AWS Organizations organization units included in the sync.
    organizationalUnits :: Prelude.Maybe (Prelude.List1 ResourceDataSyncOrganizationalUnit),
...
resourceDataSyncAwsOrganizationsSource_organizationalUnits = Lens.lens (\ResourceDataSyncAwsOrganizationsSource' {organizationalUnits} -> organizationalUnits) (\s@ResourceDataSyncAwsOrganizationsSource' {} a -> s {organizationalUnits = a} :: ResourceDataSyncAwsOrganizationsSource) Prelude.. Lens.mapping Prelude._List1
    ...
    Prelude.withObject
      ...
      ( \x ->
          ResourceDataSyncAwsOrganizationsSource'
            ...
            Prelude.<*> (x Prelude..: "OrganizationSourceType")
      )
...
instance
  ...
  toJSON ResourceDataSyncAwsOrganizationsSource' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("OrganizationalUnits" Prelude..=)
              Prelude.<$> organizationalUnits,
            Prelude.Just
              ( "OrganizationSourceType"
                  Prelude..= organizationSourceType
              )
          ]
      )
