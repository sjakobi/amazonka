...
data InventoryItemSchema = InventoryItemSchema'
  { -- | The schema version for the inventory item.
    ...
    -- attribute name.
    attributes :: Prelude.List1 InventoryItemAttribute
  }
...
inventoryItemSchema_attributes = Lens.lens (\InventoryItemSchema' {attributes} -> attributes) (\s@InventoryItemSchema' {} a -> s {attributes = a} :: InventoryItemSchema) Prelude.. Prelude._List1
