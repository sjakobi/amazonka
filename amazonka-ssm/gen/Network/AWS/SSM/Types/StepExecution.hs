...
data StepExecution = StepExecution'
  { -- | Returned values from the execution of the step.
    ...
    overriddenParameters :: Prelude.Maybe (Prelude.Map Prelude.Text [Prelude.Text]),
    ...
    inputs :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
...
stepExecution_outputs = Lens.lens (\StepExecution' {outputs} -> outputs) (\s@StepExecution' {} a -> s {outputs = a} :: StepExecution) Prelude.. Lens.mapping Prelude._Map
...
stepExecution_overriddenParameters = Lens.lens (\StepExecution' {overriddenParameters} -> overriddenParameters) (\s@StepExecution' {} a -> s {overriddenParameters = a} :: StepExecution) Prelude.. Lens.mapping Prelude._Map
...
stepExecution_inputs = Lens.lens (\StepExecution' {inputs} -> inputs) (\s@StepExecution' {} a -> s {inputs = a} :: StepExecution) Prelude.. Lens.mapping Prelude._Map
