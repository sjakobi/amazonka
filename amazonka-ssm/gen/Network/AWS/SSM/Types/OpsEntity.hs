...
data OpsEntity = OpsEntity'
  { -- | The data returned by the query.
    data' :: Prelude.Maybe (Prelude.Map Prelude.Text OpsEntityItem),
    -- | The query ID.
...
opsEntity_data = Lens.lens (\OpsEntity' {data'} -> data') (\s@OpsEntity' {} a -> s {data' = a} :: OpsEntity) Prelude.. Lens.mapping Prelude._Map
