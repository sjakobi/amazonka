...
data InstanceInformationFilter = InstanceInformationFilter'
  { -- | The name of the filter.
    ...
    -- | The filter values.
    valueSet :: Prelude.List1 Prelude.Text
  }
...
newInstanceInformationFilter pKey_ pValueSet_ =
  InstanceInformationFilter'
    { key = pKey_,
      valueSet = Prelude._List1 Lens.# pValueSet_
    }
...
instanceInformationFilter_valueSet = Lens.lens (\InstanceInformationFilter' {valueSet} -> valueSet) (\s@InstanceInformationFilter' {} a -> s {valueSet = a} :: InstanceInformationFilter) Prelude.. Prelude._List1
