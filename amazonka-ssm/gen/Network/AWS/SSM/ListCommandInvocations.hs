...
data ListCommandInvocations = ListCommandInvocations'
  { -- | (Optional) The token for the next set of items to return. (You received
    ...
    -- list of results.
    filters :: Prelude.Maybe (Prelude.List1 CommandFilter)
  }
...
listCommandInvocations_maxResults = Lens.lens (\ListCommandInvocations' {maxResults} -> maxResults) (\s@ListCommandInvocations' {} a -> s {maxResults = a} :: ListCommandInvocations) Prelude.. Lens.mapping Prelude._Nat
...
listCommandInvocations_filters = Lens.lens (\ListCommandInvocations' {filters} -> filters) (\s@ListCommandInvocations' {} a -> s {filters = a} :: ListCommandInvocations) Prelude.. Lens.mapping Prelude._List1
