...
data ConfigurationItem = ConfigurationItem'
  { -- | A list of related AWS resources.
    ...
    -- parameter.
    supplementaryConfiguration :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
...
configurationItem_supplementaryConfiguration = Lens.lens (\ConfigurationItem' {supplementaryConfiguration} -> supplementaryConfiguration) (\s@ConfigurationItem' {} a -> s {supplementaryConfiguration = a} :: ConfigurationItem) Prelude.. Lens.mapping Prelude._Map
...
configurationItem_tags = Lens.lens (\ConfigurationItem' {tags} -> tags) (\s@ConfigurationItem' {} a -> s {tags = a} :: ConfigurationItem) Prelude.. Lens.mapping Prelude._Map
