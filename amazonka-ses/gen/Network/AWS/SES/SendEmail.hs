...
--
-- * 'serrsMessageId' - The unique message identifier returned from the @SendEmail@ action.
sendEmailResponse ::
  -- | 'serrsResponseStatus'
  Int ->
  -- | 'serrsMessageId'
...
sendEmailResponse pResponseStatus_ pMessageId_ =
  SendEmailResponse'
    { _serrsResponseStatus =
        pResponseStatus_,
      _serrsMessageId = pMessageId_
    }

-- | -- | The response status code.
serrsResponseStatus :: Lens' SendEmailResponse Int
serrsResponseStatus = lens _serrsResponseStatus (\s a -> s {_serrsResponseStatus = a})

-- | The unique message identifier returned from the @SendEmail@ action.
serrsMessageId :: Lens' SendEmailResponse Text
serrsMessageId = lens _serrsMessageId (\s a -> s {_serrsMessageId = a})
