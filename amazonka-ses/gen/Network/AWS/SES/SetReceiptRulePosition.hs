...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'srrprrsResponseStatus' - -- | The response status code.
setReceiptRulePositionResponse ::
  -- | 'srrprrsResponseStatus'
  Int ->
  SetReceiptRulePositionResponse
...
srrprrsResponseStatus :: Lens' SetReceiptRulePositionResponse Int
srrprrsResponseStatus = lens _srrprrsResponseStatus (\s a -> s {_srrprrsResponseStatus = a})
