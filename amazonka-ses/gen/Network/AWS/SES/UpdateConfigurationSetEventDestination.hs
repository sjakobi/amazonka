...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ucsedrrsResponseStatus' - -- | The response status code.
updateConfigurationSetEventDestinationResponse ::
  -- | 'ucsedrrsResponseStatus'
  Int ->
  UpdateConfigurationSetEventDestinationResponse
...
ucsedrrsResponseStatus :: Lens' UpdateConfigurationSetEventDestinationResponse Int
ucsedrrsResponseStatus = lens _ucsedrrsResponseStatus (\s a -> s {_ucsedrrsResponseStatus = a})
