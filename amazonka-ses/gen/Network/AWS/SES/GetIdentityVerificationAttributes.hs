...
instance ToHeaders GetIdentityVerificationAttributes where
...
data GetIdentityVerificationAttributesResponse = GetIdentityVerificationAttributesResponse'
  { _givarrsResponseStatus ::
      !Int,
    _givarrsVerificationAttributes ::
      !( Map
           Text
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'givarrsResponseStatus' - -- | The response status code.
--
-- * 'givarrsVerificationAttributes' - A map of Identities to IdentityVerificationAttributes objects.
getIdentityVerificationAttributesResponse ::
  -- | 'givarrsResponseStatus'
  Int ->
  GetIdentityVerificationAttributesResponse
...
givarrsResponseStatus :: Lens' GetIdentityVerificationAttributesResponse Int
givarrsResponseStatus = lens _givarrsResponseStatus (\s a -> s {_givarrsResponseStatus = a})

-- | A map of Identities to IdentityVerificationAttributes objects.
givarrsVerificationAttributes :: Lens' GetIdentityVerificationAttributesResponse (HashMap Text IdentityVerificationAttributes)
givarrsVerificationAttributes = lens _givarrsVerificationAttributes (\s a -> s {_givarrsVerificationAttributes = a}) . _Map
