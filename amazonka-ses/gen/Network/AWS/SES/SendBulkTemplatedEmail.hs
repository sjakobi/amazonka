...
sendBulkTemplatedEmail_defaultTags = Lens.lens (\SendBulkTemplatedEmail' {defaultTags} -> defaultTags) (\s@SendBulkTemplatedEmail' {} a -> s {defaultTags = a} :: SendBulkTemplatedEmail) Prelude.. Lens.mapping Prelude._Coerce

-- | The reply-to email address(es) for the message. If the recipient replies
-- to the message, each reply-to address will receive the reply.
sendBulkTemplatedEmail_replyToAddresses :: Lens.Lens' SendBulkTemplatedEmail (Prelude.Maybe [Prelude.Text])
sendBulkTemplatedEmail_replyToAddresses = Lens.lens (\SendBulkTemplatedEmail' {replyToAddresses} -> replyToAddresses) (\s@SendBulkTemplatedEmail' {} a -> s {replyToAddresses = a} :: SendBulkTemplatedEmail) Prelude.. Lens.mapping Prelude._Coerce
...
sendBulkTemplatedEmail_destinations = Lens.lens (\SendBulkTemplatedEmail' {destinations} -> destinations) (\s@SendBulkTemplatedEmail' {} a -> s {destinations = a} :: SendBulkTemplatedEmail) Prelude.. Prelude._Coerce

instance Prelude.AWSRequest SendBulkTemplatedEmail where
  type
    Rs SendBulkTemplatedEmail =
      SendBulkTemplatedEmailResponse
...
instance Prelude.ToHeaders SendBulkTemplatedEmail where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath SendBulkTemplatedEmail where
  toPath = Prelude.const "/"

instance Prelude.ToQuery SendBulkTemplatedEmail where
  toQuery SendBulkTemplatedEmail' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("SendBulkTemplatedEmail" :: Prelude.ByteString),
        "Version"
          Prelude.=: ("2010-12-01" :: Prelude.ByteString),
        "ReturnPath" Prelude.=: returnPath,
        "DefaultTemplateData" Prelude.=: defaultTemplateData,
        ...
        "Destinations"
          Prelude.=: Prelude.toQueryList "member" destinations
      ]
...
sendBulkTemplatedEmailResponse_status = Lens.lens (\SendBulkTemplatedEmailResponse' {status} -> status) (\s@SendBulkTemplatedEmailResponse' {} a -> s {status = a} :: SendBulkTemplatedEmailResponse) Prelude.. Prelude._Coerce
