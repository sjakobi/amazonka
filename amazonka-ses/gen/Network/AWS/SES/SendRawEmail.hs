...
--
-- * 'srerrsMessageId' - The unique message identifier returned from the @SendRawEmail@ action.
sendRawEmailResponse ::
  -- | 'srerrsResponseStatus'
  Int ->
  -- | 'srerrsMessageId'
...
sendRawEmailResponse pResponseStatus_ pMessageId_ =
  SendRawEmailResponse'
    { _srerrsResponseStatus =
        pResponseStatus_,
      _srerrsMessageId = pMessageId_
    }

-- | -- | The response status code.
srerrsResponseStatus :: Lens' SendRawEmailResponse Int
srerrsResponseStatus = lens _srerrsResponseStatus (\s a -> s {_srerrsResponseStatus = a})

-- | The unique message identifier returned from the @SendRawEmail@ action.
srerrsMessageId :: Lens' SendRawEmailResponse Text
srerrsMessageId = lens _srerrsMessageId (\s a -> s {_srerrsMessageId = a})
