...
data GetIdentityNotificationAttributesResponse = GetIdentityNotificationAttributesResponse'
  { _ginarrsResponseStatus ::
      !Int,
    _ginarrsNotificationAttributes ::
      !( Map
           Text
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ginarrsResponseStatus' - -- | The response status code.
--
-- * 'ginarrsNotificationAttributes' - A map of Identity to IdentityNotificationAttributes.
getIdentityNotificationAttributesResponse ::
  -- | 'ginarrsResponseStatus'
  Int ->
  GetIdentityNotificationAttributesResponse
...
ginarrsResponseStatus :: Lens' GetIdentityNotificationAttributesResponse Int
ginarrsResponseStatus = lens _ginarrsResponseStatus (\s a -> s {_ginarrsResponseStatus = a})

-- | A map of Identity to IdentityNotificationAttributes.
ginarrsNotificationAttributes :: Lens' GetIdentityNotificationAttributesResponse (HashMap Text IdentityNotificationAttributes)
ginarrsNotificationAttributes = lens _ginarrsNotificationAttributes (\s a -> s {_ginarrsNotificationAttributes = a}) . _Map
