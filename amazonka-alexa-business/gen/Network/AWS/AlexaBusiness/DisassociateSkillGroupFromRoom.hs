...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dsgfrrrsResponseStatus' - -- | The response status code.
disassociateSkillGroupFromRoomResponse ::
  -- | 'dsgfrrrsResponseStatus'
  Int ->
  DisassociateSkillGroupFromRoomResponse
...
dsgfrrrsResponseStatus :: Lens' DisassociateSkillGroupFromRoomResponse Int
dsgfrrrsResponseStatus = lens _dsgfrrrsResponseStatus (\s a -> s {_dsgfrrrsResponseStatus = a})
