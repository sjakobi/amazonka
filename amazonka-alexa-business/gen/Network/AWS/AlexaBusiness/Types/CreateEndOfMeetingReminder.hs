...
data CreateEndOfMeetingReminder = CreateEndOfMeetingReminder'
  { -- | A range of 3 to 15 minutes that determines when the reminder begins.
    reminderAtMinutes :: Prelude.List1 Prelude.Int,
...
newCreateEndOfMeetingReminder
  ...
  pEnabled_ =
    CreateEndOfMeetingReminder'
      { reminderAtMinutes =
          Prelude._List1 Lens.# pReminderAtMinutes_,
...
createEndOfMeetingReminder_reminderAtMinutes = Lens.lens (\CreateEndOfMeetingReminder' {reminderAtMinutes} -> reminderAtMinutes) (\s@CreateEndOfMeetingReminder' {} a -> s {reminderAtMinutes = a} :: CreateEndOfMeetingReminder) Prelude.. Prelude._List1
