...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'lrrrsNextToken' - The continuation token to use when requesting the next set of results, if there are more results to be returned.
--
-- * 'lrrrsResources' - An array of resources associated with the project.
--
