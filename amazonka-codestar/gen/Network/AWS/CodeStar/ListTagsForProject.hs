...
listTagsForProject_maxResults = Lens.lens (\ListTagsForProject' {maxResults} -> maxResults) (\s@ListTagsForProject' {} a -> s {maxResults = a} :: ListTagsForProject) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.AWSRequest ListTagsForProject where
  type
...
instance Prelude.ToHeaders ListTagsForProject where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "CodeStar_20170419.ListTagsForProject" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON ListTagsForProject where
...
instance Prelude.ToPath ListTagsForProject where
  toPath = Prelude.const "/"

instance Prelude.ToQuery ListTagsForProject where
...
listTagsForProjectResponse_tags = Lens.lens (\ListTagsForProjectResponse' {tags} -> tags) (\s@ListTagsForProjectResponse' {} a -> s {tags = a} :: ListTagsForProjectResponse) Prelude.. Lens.mapping Prelude._Map
