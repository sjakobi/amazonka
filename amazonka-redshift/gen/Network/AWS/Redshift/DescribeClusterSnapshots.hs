...
describeClusterSnapshots_sortingEntities = Lens.lens (\DescribeClusterSnapshots' {sortingEntities} -> sortingEntities) (\s@DescribeClusterSnapshots' {} a -> s {sortingEntities = a} :: DescribeClusterSnapshots) Prelude.. Lens.mapping Prelude._Coerce
...
describeClusterSnapshots_tagKeys = Lens.lens (\DescribeClusterSnapshots' {tagKeys} -> tagKeys) (\s@DescribeClusterSnapshots' {} a -> s {tagKeys = a} :: DescribeClusterSnapshots) Prelude.. Lens.mapping Prelude._Coerce
...
describeClusterSnapshots_startTime = Lens.lens (\DescribeClusterSnapshots' {startTime} -> startTime) (\s@DescribeClusterSnapshots' {} a -> s {startTime = a} :: DescribeClusterSnapshots) Prelude.. Lens.mapping Prelude._Time
...
describeClusterSnapshots_endTime = Lens.lens (\DescribeClusterSnapshots' {endTime} -> endTime) (\s@DescribeClusterSnapshots' {} a -> s {endTime = a} :: DescribeClusterSnapshots) Prelude.. Lens.mapping Prelude._Time
...
describeClusterSnapshots_tagValues = Lens.lens (\DescribeClusterSnapshots' {tagValues} -> tagValues) (\s@DescribeClusterSnapshots' {} a -> s {tagValues = a} :: DescribeClusterSnapshots) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.AWSRequest DescribeClusterSnapshots where
  type
...
instance Prelude.ToHeaders DescribeClusterSnapshots where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath DescribeClusterSnapshots where
  toPath = Prelude.const "/"

instance Prelude.ToQuery DescribeClusterSnapshots where
  toQuery DescribeClusterSnapshots' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("DescribeClusterSnapshots" :: Prelude.ByteString),
        "Version"
          Prelude.=: ("2012-12-01" :: Prelude.ByteString),
        "SnapshotIdentifier" Prelude.=: snapshotIdentifier,
        "SortingEntities"
          Prelude.=: Prelude.toQuery
            ( Prelude.toQueryList "SnapshotSortingEntity"
        ...
        "ClusterExists" Prelude.=: clusterExists,
        "TagValues"
          Prelude.=: Prelude.toQuery
...
describeClusterSnapshotsResponse_snapshots = Lens.lens (\DescribeClusterSnapshotsResponse' {snapshots} -> snapshots) (\s@DescribeClusterSnapshotsResponse' {} a -> s {snapshots = a} :: DescribeClusterSnapshotsResponse) Prelude.. Lens.mapping Prelude._Coerce
