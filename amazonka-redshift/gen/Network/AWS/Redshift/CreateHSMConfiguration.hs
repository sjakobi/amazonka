...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'chcrrsHSMConfiguration' - Undocumented member.
--
...
-- | Undocumented member.
chcrrsHSMConfiguration :: Lens' CreateHSMConfigurationResponse (Maybe HSMConfiguration)
chcrrsHSMConfiguration = lens _chcrrsHSMConfiguration (\s a -> s {_chcrrsHSMConfiguration = a})

-- | -- | The response status code.
chcrrsResponseStatus :: Lens' CreateHSMConfigurationResponse Int
