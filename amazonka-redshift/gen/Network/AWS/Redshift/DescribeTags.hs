...
instance AWSPager DescribeTags where
  page rq rs
    ...
    | stop (rs ^. dtrrsTaggedResources) = Nothing
    | otherwise =
...
data DescribeTagsResponse = DescribeTagsResponse'
  { _dtrrsTaggedResources ::
      !(Maybe [TaggedResource]),
    _dtrrsMarker :: !(Maybe Text),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dtrrsTaggedResources' - A list of tags with their associated resources.
--
-- * 'dtrrsMarker' - A value that indicates the starting point for the next set of response records in a subsequent request. If a value is returned in a response, you can retrieve the next set of records by providing this returned marker value in the @Marker@ parameter and retrying the command. If the @Marker@ field is empty, all response records have been retrieved for the request.
--
...
dtrrsTaggedResources :: Lens' DescribeTagsResponse [TaggedResource]
dtrrsTaggedResources = lens _dtrrsTaggedResources (\s a -> s {_dtrrsTaggedResources = a}) . _Default . _Coerce

-- | A value that indicates the starting point for the next set of response records in a subsequent request. If a value is returned in a response, you can retrieve the next set of records by providing this returned marker value in the @Marker@ parameter and retrying the command. If the @Marker@ field is empty, all response records have been retrieved for the request.
dtrrsMarker :: Lens' DescribeTagsResponse (Maybe Text)
