...
data CreateHSMClientCertificateResponse = CreateHSMClientCertificateResponse'
  { _chccrrsHSMClientCertificate ::
      !( Maybe
           HSMClientCertificate
       ),
    _chccrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'chccrrsHSMClientCertificate' - Undocumented member.
--
-- * 'chccrrsResponseStatus' - -- | The response status code.
createHSMClientCertificateResponse ::
  -- | 'chccrrsResponseStatus'
  Int ->
  CreateHSMClientCertificateResponse
...
-- | Undocumented member.
chccrrsHSMClientCertificate :: Lens' CreateHSMClientCertificateResponse (Maybe HSMClientCertificate)
chccrrsHSMClientCertificate = lens _chccrrsHSMClientCertificate (\s a -> s {_chccrrsHSMClientCertificate = a})

-- | -- | The response status code.
chccrrsResponseStatus :: Lens' CreateHSMClientCertificateResponse Int
chccrrsResponseStatus = lens _chccrrsResponseStatus (\s a -> s {_chccrrsResponseStatus = a})
