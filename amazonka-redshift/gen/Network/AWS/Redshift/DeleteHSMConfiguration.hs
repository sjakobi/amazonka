...
--
-- * 'dhsmcHSMConfigurationIdentifier' - The identifier of the Amazon Redshift HSM configuration to be deleted.
deleteHSMConfiguration ::
  -- | 'dhsmcHSMConfigurationIdentifier'
  Text ->
  DeleteHSMConfiguration
...
dhsmcHSMConfigurationIdentifier :: Lens' DeleteHSMConfiguration Text
