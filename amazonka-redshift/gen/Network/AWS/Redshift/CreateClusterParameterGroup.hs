...
data CreateClusterParameterGroup = CreateClusterParameterGroup'
  { _ccpgTags ::
      !(Maybe [Tag]),
    _ccpgParameterGroupName ::
      !Text,
    _ccpgParameterGroupFamily ::
      !Text,
    _ccpgDescription ::
      !Text
  }
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ccpgrrsClusterParameterGroup' - Undocumented member.
--
...
-- | Undocumented member.
ccpgrrsClusterParameterGroup :: Lens' CreateClusterParameterGroupResponse (Maybe ClusterParameterGroup)
ccpgrrsClusterParameterGroup = lens _ccpgrrsClusterParameterGroup (\s a -> s {_ccpgrrsClusterParameterGroup = a})

-- | -- | The response status code.
ccpgrrsResponseStatus :: Lens' CreateClusterParameterGroupResponse Int
