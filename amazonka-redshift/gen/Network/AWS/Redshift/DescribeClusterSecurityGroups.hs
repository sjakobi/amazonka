...
instance AWSPager DescribeClusterSecurityGroups where
  page rq rs
    ...
    | stop (rs ^. dcsgrrsClusterSecurityGroups) = Nothing
    | otherwise =
      Just $ rq & dcsgMarker .~ rs ^. dcsgrrsMarker
...
instance ToHeaders DescribeClusterSecurityGroups where
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dcsgrrsClusterSecurityGroups' - A list of 'ClusterSecurityGroup' instances.
--
-- * 'dcsgrrsMarker' - A value that indicates the starting point for the next set of response records in a subsequent request. If a value is returned in a response, you can retrieve the next set of records by providing this returned marker value in the @Marker@ parameter and retrying the command. If the @Marker@ field is empty, all response records have been retrieved for the request.
--
...
dcsgrrsClusterSecurityGroups :: Lens' DescribeClusterSecurityGroupsResponse [ClusterSecurityGroup]
dcsgrrsClusterSecurityGroups = lens _dcsgrrsClusterSecurityGroups (\s a -> s {_dcsgrrsClusterSecurityGroups = a}) . _Default . _Coerce

-- | A value that indicates the starting point for the next set of response records in a subsequent request. If a value is returned in a response, you can retrieve the next set of records by providing this returned marker value in the @Marker@ parameter and retrying the command. If the @Marker@ field is empty, all response records have been retrieved for the request.
dcsgrrsMarker :: Lens' DescribeClusterSecurityGroupsResponse (Maybe Text)
dcsgrrsMarker = lens _dcsgrrsMarker (\s a -> s {_dcsgrrsMarker = a})

-- | -- | The response status code.
dcsgrrsResponseStatus :: Lens' DescribeClusterSecurityGroupsResponse Int
