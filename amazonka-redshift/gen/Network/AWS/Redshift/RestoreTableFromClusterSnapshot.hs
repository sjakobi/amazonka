...
data RestoreTableFromClusterSnapshot = RestoreTableFromClusterSnapshot'
  { _rtfcsTargetSchemaName ::
      !( Maybe
           Text
       ),
    _rtfcsTargetDatabaseName ::
      !( Maybe
           Text
       ),
    _rtfcsSourceSchemaName ::
      !( Maybe
           Text
       ),
    _rtfcsClusterIdentifier ::
      !Text,
    _rtfcsSnapshotIdentifier ::
      !Text,
    _rtfcsSourceDatabaseName ::
      !Text,
    _rtfcsSourceTableName ::
      !Text,
    _rtfcsNewTableName ::
      !Text
  }
...
instance AWSRequest RestoreTableFromClusterSnapshot where
  type
...
instance ToHeaders RestoreTableFromClusterSnapshot where
  toHeaders = const mempty

instance ToPath RestoreTableFromClusterSnapshot where
  toPath = const "/"

instance ToQuery RestoreTableFromClusterSnapshot where
...
data RestoreTableFromClusterSnapshotResponse = RestoreTableFromClusterSnapshotResponse'
  { _rtfcsrrsTableRestoreStatus ::
      !( Maybe
           TableRestoreStatus
       ),
    _rtfcsrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rtfcsrrsTableRestoreStatus' - Undocumented member.
--
-- * 'rtfcsrrsResponseStatus' - -- | The response status code.
restoreTableFromClusterSnapshotResponse ::
  -- | 'rtfcsrrsResponseStatus'
  Int ->
  RestoreTableFromClusterSnapshotResponse
...
-- | Undocumented member.
rtfcsrrsTableRestoreStatus :: Lens' RestoreTableFromClusterSnapshotResponse (Maybe TableRestoreStatus)
rtfcsrrsTableRestoreStatus = lens _rtfcsrrsTableRestoreStatus (\s a -> s {_rtfcsrrsTableRestoreStatus = a})

-- | -- | The response status code.
rtfcsrrsResponseStatus :: Lens' RestoreTableFromClusterSnapshotResponse Int
rtfcsrrsResponseStatus = lens _rtfcsrrsResponseStatus (\s a -> s {_rtfcsrrsResponseStatus = a})
