...
data Cluster = Cluster'
  { _cEnhancedVPCRouting ::
    ...
    _cExpectedNextSnapshotScheduleTimeStatus ::
      !(Maybe Text),
    ...
    _cAvailabilityZoneRelocationStatus :: !(Maybe Text),
    _cDBName :: !(Maybe Text),
    _cDataTransferProgress ::
    ...
    _cExpectedNextSnapshotScheduleTime ::
      !(Maybe ISO8601),
...
--
-- * 'cAvailabilityZoneRelocationStatus' - Describes the status of the Availability Zone relocation operation.
--
...
cluster =
  Cluster'
    { _cEnhancedVPCRouting = Nothing,
      ...
      _cAvailabilityZoneRelocationStatus = Nothing,
      _cDBName = Nothing,
...
cAvailabilityZoneRelocationStatus :: Lens' Cluster (Maybe Text)
cAvailabilityZoneRelocationStatus = lens _cAvailabilityZoneRelocationStatus (\s a -> s {_cAvailabilityZoneRelocationStatus = a})
...
instance FromXML Cluster where
  parseXML x =
    Cluster'
      ...
      <*> (x .@? "NumberOfNodes")
      <*> (x .@? "AvailabilityZoneRelocationStatus")
      <*> (x .@? "DBName")
