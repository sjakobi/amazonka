...
data Cluster = Cluster'
  { -- | An option that specifies whether to create the cluster with enhanced VPC
    ...
    nextMaintenanceWindowStartTime :: Prelude.Maybe Prelude.ISO8601,
    ...
    expectedNextSnapshotScheduleTime :: Prelude.Maybe Prelude.ISO8601,
...
cluster_vpcSecurityGroups = Lens.lens (\Cluster' {vpcSecurityGroups} -> vpcSecurityGroups) (\s@Cluster' {} a -> s {vpcSecurityGroups = a} :: Cluster) Prelude.. Lens.mapping Prelude._Coerce
...
cluster_deferredMaintenanceWindows = Lens.lens (\Cluster' {deferredMaintenanceWindows} -> deferredMaintenanceWindows) (\s@Cluster' {} a -> s {deferredMaintenanceWindows = a} :: Cluster) Prelude.. Lens.mapping Prelude._Coerce
...
cluster_clusterCreateTime = Lens.lens (\Cluster' {clusterCreateTime} -> clusterCreateTime) (\s@Cluster' {} a -> s {clusterCreateTime = a} :: Cluster) Prelude.. Lens.mapping Prelude._Time
...
cluster_clusterParameterGroups = Lens.lens (\Cluster' {clusterParameterGroups} -> clusterParameterGroups) (\s@Cluster' {} a -> s {clusterParameterGroups = a} :: Cluster) Prelude.. Lens.mapping Prelude._Coerce
...
cluster_clusterNodes = Lens.lens (\Cluster' {clusterNodes} -> clusterNodes) (\s@Cluster' {} a -> s {clusterNodes = a} :: Cluster) Prelude.. Lens.mapping Prelude._Coerce
...
cluster_nextMaintenanceWindowStartTime = Lens.lens (\Cluster' {nextMaintenanceWindowStartTime} -> nextMaintenanceWindowStartTime) (\s@Cluster' {} a -> s {nextMaintenanceWindowStartTime = a} :: Cluster) Prelude.. Lens.mapping Prelude._Time
...
cluster_clusterSecurityGroups = Lens.lens (\Cluster' {clusterSecurityGroups} -> clusterSecurityGroups) (\s@Cluster' {} a -> s {clusterSecurityGroups = a} :: Cluster) Prelude.. Lens.mapping Prelude._Coerce
...
cluster_expectedNextSnapshotScheduleTime = Lens.lens (\Cluster' {expectedNextSnapshotScheduleTime} -> expectedNextSnapshotScheduleTime) (\s@Cluster' {} a -> s {expectedNextSnapshotScheduleTime = a} :: Cluster) Prelude.. Lens.mapping Prelude._Time
...
cluster_iamRoles = Lens.lens (\Cluster' {iamRoles} -> iamRoles) (\s@Cluster' {} a -> s {iamRoles = a} :: Cluster) Prelude.. Lens.mapping Prelude._Coerce

-- | Cluster operations that are waiting to be started.
cluster_pendingActions :: Lens.Lens' Cluster (Prelude.Maybe [Prelude.Text])
cluster_pendingActions = Lens.lens (\Cluster' {pendingActions} -> pendingActions) (\s@Cluster' {} a -> s {pendingActions = a} :: Cluster) Prelude.. Lens.mapping Prelude._Coerce

instance Prelude.FromXML Cluster where
  parseXML x =
    Cluster'
      ...
      Prelude.<*> ( x Prelude..@? "VpcSecurityGroups"
                      ...
                      Prelude.>>= Prelude.may
                        (Prelude.parseXMLList "VpcSecurityGroup")
                  )
      Prelude.<*> (x Prelude..@? "ResizeInfo")
      Prelude.<*> (x Prelude..@? "ClusterNamespaceArn")
      Prelude.<*> (x Prelude..@? "ClusterSubnetGroupName")
      Prelude.<*> ( x Prelude..@? "DeferredMaintenanceWindows"
                      Prelude..!@ Prelude.mempty
                      Prelude.>>= Prelude.may
                        (Prelude.parseXMLList "DeferredMaintenanceWindow")
                  )
      Prelude.<*> ( x
                      Prelude..@? "ExpectedNextSnapshotScheduleTimeStatus"
                  )
      Prelude.<*> (x Prelude..@? "SnapshotScheduleState")
      Prelude.<*> (x Prelude..@? "Encrypted")
      Prelude.<*> (x Prelude..@? "AllowVersionUpgrade")
      Prelude.<*> (x Prelude..@? "ClusterCreateTime")
      Prelude.<*> (x Prelude..@? "AutomatedSnapshotRetentionPeriod")
      Prelude.<*> (x Prelude..@? "ElasticIpStatus")
      Prelude.<*> (x Prelude..@? "HsmStatus")
      Prelude.<*> (x Prelude..@? "SnapshotScheduleIdentifier")
      Prelude.<*> (x Prelude..@? "MasterUsername")
      Prelude.<*> (x Prelude..@? "PubliclyAccessible")
      Prelude.<*> (x Prelude..@? "ClusterAvailabilityStatus")
      Prelude.<*> (x Prelude..@? "ManualSnapshotRetentionPeriod")
      Prelude.<*> (x Prelude..@? "KmsKeyId")
      Prelude.<*> (x Prelude..@? "ClusterSnapshotCopyStatus")
      Prelude.<*> (x Prelude..@? "AvailabilityZone")
      Prelude.<*> ( x Prelude..@? "ClusterParameterGroups"
                      Prelude..!@ Prelude.mempty
                      Prelude.>>= Prelude.may
                        (Prelude.parseXMLList "ClusterParameterGroup")
                  )
      Prelude.<*> (x Prelude..@? "PreferredMaintenanceWindow")
      Prelude.<*> (x Prelude..@? "ClusterPublicKey")
      Prelude.<*> (x Prelude..@? "RestoreStatus")
      Prelude.<*> (x Prelude..@? "ModifyStatus")
      Prelude.<*> (x Prelude..@? "ClusterIdentifier")
      Prelude.<*> ( x Prelude..@? "Tags" Prelude..!@ Prelude.mempty
                      Prelude.>>= Prelude.may (Prelude.parseXMLList "Tag")
                  )
      Prelude.<*> ( x Prelude..@? "ClusterNodes"
                      Prelude..!@ Prelude.mempty
                      Prelude.>>= Prelude.may (Prelude.parseXMLList "member")
                  )
      Prelude.<*> (x Prelude..@? "NumberOfNodes")
      Prelude.<*> (x Prelude..@? "AvailabilityZoneRelocationStatus")
      Prelude.<*> (x Prelude..@? "DBName")
      Prelude.<*> (x Prelude..@? "DataTransferProgress")
      Prelude.<*> (x Prelude..@? "ClusterStatus")
      Prelude.<*> (x Prelude..@? "PendingModifiedValues")
      Prelude.<*> (x Prelude..@? "Endpoint")
      Prelude.<*> (x Prelude..@? "NextMaintenanceWindowStartTime")
      ...
      Prelude.<*> (x Prelude..@? "ElasticResizeNumberOfNodeOptions")
      Prelude.<*> (x Prelude..@? "ExpectedNextSnapshotScheduleTime")
      Prelude.<*> (x Prelude..@? "MaintenanceTrackName")
      Prelude.<*> (x Prelude..@? "ClusterRevisionNumber")
      Prelude.<*> ( x Prelude..@? "IamRoles" Prelude..!@ Prelude.mempty
                      Prelude.>>= Prelude.may (Prelude.parseXMLList "ClusterIamRole")
                  )
      Prelude.<*> ( x Prelude..@? "PendingActions"
                      Prelude..!@ Prelude.mempty
                      Prelude.>>= Prelude.may (Prelude.parseXMLList "member")
                  )
