...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mcirrrsCluster' - Undocumented member.
--
-- * 'mcirrrsResponseStatus' - -- | The response status code.
modifyClusterIAMRolesResponse ::
  -- | 'mcirrrsResponseStatus'
  Int ->
  ModifyClusterIAMRolesResponse
modifyClusterIAMRolesResponse pResponseStatus_ =
  ModifyClusterIAMRolesResponse'
    { _mcirrrsCluster =
        Nothing,
      _mcirrrsResponseStatus = pResponseStatus_
    }

-- | Undocumented member.
mcirrrsCluster :: Lens' ModifyClusterIAMRolesResponse (Maybe Cluster)
mcirrrsCluster = lens _mcirrrsCluster (\s a -> s {_mcirrrsCluster = a})

-- | -- | The response status code.
mcirrrsResponseStatus :: Lens' ModifyClusterIAMRolesResponse Int
mcirrrsResponseStatus = lens _mcirrrsResponseStatus (\s a -> s {_mcirrrsResponseStatus = a})
