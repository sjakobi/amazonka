...
createHsmClientCertificate_tags = Lens.lens (\CreateHsmClientCertificate' {tags} -> tags) (\s@CreateHsmClientCertificate' {} a -> s {tags = a} :: CreateHsmClientCertificate) Prelude.. Lens.mapping Prelude._Coerce
...
instance
  ...
  response =
    Response.receiveXMLWrapper
      ...
      ( \s h x ->
          CreateHsmClientCertificateResponse'
            Prelude.<$> (x Prelude..@? "HsmClientCertificate")
...
instance Prelude.ToHeaders CreateHsmClientCertificate where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath CreateHsmClientCertificate where
  toPath = Prelude.const "/"

instance Prelude.ToQuery CreateHsmClientCertificate where
  toQuery CreateHsmClientCertificate' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("CreateHsmClientCertificate" :: Prelude.ByteString),
        "Version"
