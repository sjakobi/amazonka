...
data ListAllowedNodeTypeModificationsResponse = ListAllowedNodeTypeModificationsResponse'
  { _lantmrrsScaleUpModifications ::
      !( Maybe
           [Text]
       ),
    _lantmrrsScaleDownModifications ::
      !( Maybe
           [Text]
       ),
    _lantmrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'lantmrrsScaleUpModifications' - A string list, each element of which specifies a cache node type which you can use to scale your cluster or replication group. When scaling up a Redis cluster or replication group using @ModifyCacheCluster@ or @ModifyReplicationGroup@ , use a value from this list for the @CacheNodeType@ parameter.
--
-- * 'lantmrrsScaleDownModifications' - A string list, each element of which specifies a cache node type which you can use to scale your cluster or replication group. When scaling down a Redis cluster or replication group using ModifyCacheCluster or ModifyReplicationGroup, use a value from this list for the CacheNodeType parameter.
--
-- * 'lantmrrsResponseStatus' - -- | The response status code.
listAllowedNodeTypeModificationsResponse ::
  -- | 'lantmrrsResponseStatus'
  Int ->
  ListAllowedNodeTypeModificationsResponse
...
lantmrrsScaleUpModifications :: Lens' ListAllowedNodeTypeModificationsResponse [Text]
lantmrrsScaleUpModifications = lens _lantmrrsScaleUpModifications (\s a -> s {_lantmrrsScaleUpModifications = a}) . _Default . _Coerce
...
lantmrrsScaleDownModifications :: Lens' ListAllowedNodeTypeModificationsResponse [Text]
lantmrrsScaleDownModifications = lens _lantmrrsScaleDownModifications (\s a -> s {_lantmrrsScaleDownModifications = a}) . _Default . _Coerce

-- | -- | The response status code.
lantmrrsResponseStatus :: Lens' ListAllowedNodeTypeModificationsResponse Int
lantmrrsResponseStatus = lens _lantmrrsResponseStatus (\s a -> s {_lantmrrsResponseStatus = a})
