...
modifyCacheCluster_securityGroupIds = Lens.lens (\ModifyCacheCluster' {securityGroupIds} -> securityGroupIds) (\s@ModifyCacheCluster' {} a -> s {securityGroupIds = a} :: ModifyCacheCluster) Prelude.. Lens.mapping Prelude._Coerce
...
modifyCacheCluster_cacheSecurityGroupNames = Lens.lens (\ModifyCacheCluster' {cacheSecurityGroupNames} -> cacheSecurityGroupNames) (\s@ModifyCacheCluster' {} a -> s {cacheSecurityGroupNames = a} :: ModifyCacheCluster) Prelude.. Lens.mapping Prelude._Coerce
...
modifyCacheCluster_newAvailabilityZones = Lens.lens (\ModifyCacheCluster' {newAvailabilityZones'} -> newAvailabilityZones') (\s@ModifyCacheCluster' {} a -> s {newAvailabilityZones' = a} :: ModifyCacheCluster) Prelude.. Lens.mapping Prelude._Coerce
...
modifyCacheCluster_cacheNodeIdsToRemove = Lens.lens (\ModifyCacheCluster' {cacheNodeIdsToRemove} -> cacheNodeIdsToRemove) (\s@ModifyCacheCluster' {} a -> s {cacheNodeIdsToRemove = a} :: ModifyCacheCluster) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.AWSRequest ModifyCacheCluster where
  type
...
instance Prelude.ToHeaders ModifyCacheCluster where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath ModifyCacheCluster where
  toPath = Prelude.const "/"

instance Prelude.ToQuery ModifyCacheCluster where
  toQuery ModifyCacheCluster' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("ModifyCacheCluster" :: Prelude.ByteString),
        "Version"
        ...
        "CacheNodeIdsToRemove"
          Prelude.=: Prelude.toQuery
            ( Prelude.toQueryList "CacheNodeId"
