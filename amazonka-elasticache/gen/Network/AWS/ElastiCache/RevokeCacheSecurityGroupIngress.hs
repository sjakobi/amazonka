...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rcsgirrsCacheSecurityGroup' - Undocumented member.
--
...
-- | Undocumented member.
rcsgirrsCacheSecurityGroup :: Lens' RevokeCacheSecurityGroupIngressResponse (Maybe CacheSecurityGroup)
rcsgirrsCacheSecurityGroup = lens _rcsgirrsCacheSecurityGroup (\s a -> s {_rcsgirrsCacheSecurityGroup = a})

-- | -- | The response status code.
rcsgirrsResponseStatus :: Lens' RevokeCacheSecurityGroupIngressResponse Int
