...
data ModifyReplicationGroupShardConfigurationResponse = ModifyReplicationGroupShardConfigurationResponse'
  { _mrgscrrsReplicationGroup ::
      !( Maybe
           ReplicationGroup
       ),
    _mrgscrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mrgscrrsReplicationGroup' - Undocumented member.
--
-- * 'mrgscrrsResponseStatus' - -- | The response status code.
modifyReplicationGroupShardConfigurationResponse ::
  -- | 'mrgscrrsResponseStatus'
  Int ->
  ModifyReplicationGroupShardConfigurationResponse
...
-- | Undocumented member.
mrgscrrsReplicationGroup :: Lens' ModifyReplicationGroupShardConfigurationResponse (Maybe ReplicationGroup)
mrgscrrsReplicationGroup = lens _mrgscrrsReplicationGroup (\s a -> s {_mrgscrrsReplicationGroup = a})

-- | -- | The response status code.
mrgscrrsResponseStatus :: Lens' ModifyReplicationGroupShardConfigurationResponse Int
mrgscrrsResponseStatus = lens _mrgscrrsResponseStatus (\s a -> s {_mrgscrrsResponseStatus = a})
