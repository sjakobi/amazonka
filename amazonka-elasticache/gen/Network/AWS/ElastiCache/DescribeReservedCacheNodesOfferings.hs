...
instance AWSPager DescribeReservedCacheNodesOfferings where
  page rq rs
    | stop (rs ^. drcnorrsMarker) = Nothing
    | stop (rs ^. drcnorrsReservedCacheNodesOfferings) =
      Nothing
    | otherwise =
      Just $ rq & drcnoMarker .~ rs ^. drcnorrsMarker
...
data DescribeReservedCacheNodesOfferingsResponse = DescribeReservedCacheNodesOfferingsResponse'
  { _drcnorrsReservedCacheNodesOfferings ::
      !( Maybe
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'drcnorrsReservedCacheNodesOfferings' - A list of reserved cache node offerings. Each element in the list contains detailed information about one offering.
--
-- * 'drcnorrsMarker' - Provides an identifier to allow retrieval of paginated results.
--
-- * 'drcnorrsResponseStatus' - -- | The response status code.
describeReservedCacheNodesOfferingsResponse ::
  -- | 'drcnorrsResponseStatus'
  Int ->
  DescribeReservedCacheNodesOfferingsResponse
describeReservedCacheNodesOfferingsResponse
  pResponseStatus_ =
    DescribeReservedCacheNodesOfferingsResponse'
      { _drcnorrsReservedCacheNodesOfferings =
          Nothing,
        _drcnorrsMarker = Nothing,
        _drcnorrsResponseStatus =
          pResponseStatus_
      }

-- | A list of reserved cache node offerings. Each element in the list contains detailed information about one offering.
drcnorrsReservedCacheNodesOfferings :: Lens' DescribeReservedCacheNodesOfferingsResponse [ReservedCacheNodesOffering]
drcnorrsReservedCacheNodesOfferings = lens _drcnorrsReservedCacheNodesOfferings (\s a -> s {_drcnorrsReservedCacheNodesOfferings = a}) . _Default . _Coerce

-- | Provides an identifier to allow retrieval of paginated results.
drcnorrsMarker :: Lens' DescribeReservedCacheNodesOfferingsResponse (Maybe Text)
drcnorrsMarker = lens _drcnorrsMarker (\s a -> s {_drcnorrsMarker = a})

-- | -- | The response status code.
drcnorrsResponseStatus :: Lens' DescribeReservedCacheNodesOfferingsResponse Int
drcnorrsResponseStatus = lens _drcnorrsResponseStatus (\s a -> s {_drcnorrsResponseStatus = a})
