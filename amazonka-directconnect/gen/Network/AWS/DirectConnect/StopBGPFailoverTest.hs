...
module Network.AWS.DirectConnect.StopBGPFailoverTest
  ( -- * Creating a Request
    ...
    -- * Response Lenses
    sbgpftrrsVirtualInterfaceTest,
    sbgpftrrsResponseStatus,
  )
where
...
instance ToJSON StopBGPFailoverTest where
  toJSON StopBGPFailoverTest' {..} =
    object
      ( catMaybes
          [ Just
              ("virtualInterfaceId" .= _sbgpftVirtualInterfaceId)
          ]
      )
...
data StopBGPFailoverTestResponse = StopBGPFailoverTestResponse'
  { _sbgpftrrsVirtualInterfaceTest ::
      !( Maybe
           VirtualInterfaceTestHistory
       ),
    _sbgpftrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'sbgpftrrsVirtualInterfaceTest' - Information about the virtual interface failover test.
--
-- * 'sbgpftrrsResponseStatus' - -- | The response status code.
stopBGPFailoverTestResponse ::
  -- | 'sbgpftrrsResponseStatus'
  Int ->
  StopBGPFailoverTestResponse
stopBGPFailoverTestResponse pResponseStatus_ =
  StopBGPFailoverTestResponse'
    { _sbgpftrrsVirtualInterfaceTest =
        Nothing,
      _sbgpftrrsResponseStatus = pResponseStatus_
    }

-- | Information about the virtual interface failover test.
sbgpftrrsVirtualInterfaceTest :: Lens' StopBGPFailoverTestResponse (Maybe VirtualInterfaceTestHistory)
sbgpftrrsVirtualInterfaceTest = lens _sbgpftrrsVirtualInterfaceTest (\s a -> s {_sbgpftrrsVirtualInterfaceTest = a})

-- | -- | The response status code.
sbgpftrrsResponseStatus :: Lens' StopBGPFailoverTestResponse Int
sbgpftrrsResponseStatus = lens _sbgpftrrsResponseStatus (\s a -> s {_sbgpftrrsResponseStatus = a})
