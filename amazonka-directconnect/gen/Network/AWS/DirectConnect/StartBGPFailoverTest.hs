...
data StartBGPFailoverTest = StartBGPFailoverTest'
  { _sbftBgpPeers ::
      !(Maybe [Text]),
    _sbftTestDurationInMinutes ::
      !(Maybe Int),
    _sbftVirtualInterfaceId ::
      !Text
  }
      ...
      ( catMaybes
          [ ("bgpPeers" .=) <$> _sbftBgpPeers,
            ("testDurationInMinutes" .=)
              <$> _sbftTestDurationInMinutes,
            Just
              ("virtualInterfaceId" .= _sbftVirtualInterfaceId)
          ]
      )
...
data StartBGPFailoverTestResponse = StartBGPFailoverTestResponse'
  { _sbftrrsVirtualInterfaceTest ::
      !( Maybe
           VirtualInterfaceTestHistory
       ),
    _sbftrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'sbftrrsVirtualInterfaceTest' - Information about the virtual interface failover test.
--
-- * 'sbftrrsResponseStatus' - -- | The response status code.
startBGPFailoverTestResponse ::
  -- | 'sbftrrsResponseStatus'
  Int ->
  StartBGPFailoverTestResponse
startBGPFailoverTestResponse pResponseStatus_ =
  StartBGPFailoverTestResponse'
    { _sbftrrsVirtualInterfaceTest =
        Nothing,
      _sbftrrsResponseStatus = pResponseStatus_
    }

-- | Information about the virtual interface failover test.
sbftrrsVirtualInterfaceTest :: Lens' StartBGPFailoverTestResponse (Maybe VirtualInterfaceTestHistory)
sbftrrsVirtualInterfaceTest = lens _sbftrrsVirtualInterfaceTest (\s a -> s {_sbftrrsVirtualInterfaceTest = a})

-- | -- | The response status code.
sbftrrsResponseStatus :: Lens' StartBGPFailoverTestResponse Int
sbftrrsResponseStatus = lens _sbftrrsResponseStatus (\s a -> s {_sbftrrsResponseStatus = a})
