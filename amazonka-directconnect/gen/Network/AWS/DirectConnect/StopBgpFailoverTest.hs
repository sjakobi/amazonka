...
instance Prelude.AWSRequest StopBgpFailoverTest where
  type
...
instance Prelude.ToHeaders StopBgpFailoverTest where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "OvertureService.StopBgpFailoverTest" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON StopBgpFailoverTest where
...
instance Prelude.ToPath StopBgpFailoverTest where
  toPath = Prelude.const "/"

instance Prelude.ToQuery StopBgpFailoverTest where
