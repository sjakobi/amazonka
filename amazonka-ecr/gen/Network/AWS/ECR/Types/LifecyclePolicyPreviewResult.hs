...
data LifecyclePolicyPreviewResult = LifecyclePolicyPreviewResult'
  { -- | The @sha256@ digest of the image manifest.
    ...
    appliedRulePriority :: Prelude.Maybe Prelude.Nat,
...
lifecyclePolicyPreviewResult_appliedRulePriority = Lens.lens (\LifecyclePolicyPreviewResult' {appliedRulePriority} -> appliedRulePriority) (\s@LifecyclePolicyPreviewResult' {} a -> s {appliedRulePriority = a} :: LifecyclePolicyPreviewResult) Prelude.. Lens.mapping Prelude._Nat
