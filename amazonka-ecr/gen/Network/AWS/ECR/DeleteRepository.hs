...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'drrrrsRepository' - The repository that was deleted.
--
...
drrrrsRepository :: Lens' DeleteRepositoryResponse (Maybe Repository)
drrrrsRepository = lens _drrrrsRepository (\s a -> s {_drrrrsRepository = a})

-- | -- | The response status code.
drrrrsResponseStatus :: Lens' DeleteRepositoryResponse Int
