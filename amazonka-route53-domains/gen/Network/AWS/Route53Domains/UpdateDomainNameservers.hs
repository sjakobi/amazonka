...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'udnrrsResponseStatus' - -- | The response status code.
--
-- * 'udnrrsOperationId' - Identifier for tracking the progress of the request. To query the operation status, use <https://docs.aws.amazon.com/Route53/latest/APIReference/API_domains_GetOperationDetail.html GetOperationDetail> .
updateDomainNameserversResponse ::
  -- | 'udnrrsResponseStatus'
  Int ->
  -- | 'udnrrsOperationId'
...
updateDomainNameserversResponse
  ...
  pOperationId_ =
    UpdateDomainNameserversResponse'
      { _udnrrsResponseStatus =
          pResponseStatus_,
        _udnrrsOperationId = pOperationId_
      }

-- | -- | The response status code.
udnrrsResponseStatus :: Lens' UpdateDomainNameserversResponse Int
udnrrsResponseStatus = lens _udnrrsResponseStatus (\s a -> s {_udnrrsResponseStatus = a})
...
udnrrsOperationId :: Lens' UpdateDomainNameserversResponse Text
udnrrsOperationId = lens _udnrrsOperationId (\s a -> s {_udnrrsOperationId = a})
