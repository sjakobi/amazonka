...
data CheckDomainTransferabilityResponse = CheckDomainTransferabilityResponse'
  { _cdtrrsResponseStatus ::
      !Int,
    _cdtrrsTransferability ::
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cdtrrsResponseStatus' - -- | The response status code.
--
-- * 'cdtrrsTransferability' - A complex type that contains information about whether the specified domain can be transferred to Route 53.
checkDomainTransferabilityResponse ::
  -- | 'cdtrrsResponseStatus'
  Int ->
  -- | 'cdtrrsTransferability'
...
cdtrrsResponseStatus :: Lens' CheckDomainTransferabilityResponse Int
cdtrrsResponseStatus = lens _cdtrrsResponseStatus (\s a -> s {_cdtrrsResponseStatus = a})

-- | A complex type that contains information about whether the specified domain can be transferred to Route 53.
cdtrrsTransferability :: Lens' CheckDomainTransferabilityResponse DomainTransferability
cdtrrsTransferability = lens _cdtrrsTransferability (\s a -> s {_cdtrrsTransferability = a})
