...
instance Prelude.FromText CountryCode where
  parser = CountryCode' Prelude.<$> Prelude.takeText

instance Prelude.ToText CountryCode where
  toText (CountryCode' x) = x

instance Prelude.Hashable CountryCode

instance Prelude.NFData CountryCode

instance Prelude.ToByteString CountryCode

instance Prelude.ToQuery CountryCode

instance Prelude.ToHeader CountryCode

instance Prelude.ToJSON CountryCode where
  toJSON = Prelude.toJSONText

instance Prelude.FromJSON CountryCode where
  parseJSON = Prelude.parseJSONText "CountryCode"
