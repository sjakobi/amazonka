...
data AssociateNodeResponse = AssociateNodeResponse'
  { _anrrsNodeAssociationStatusToken ::
      !(Maybe Text),
    _anrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'anrrsNodeAssociationStatusToken' - Contains a token which can be passed to the @DescribeNodeAssociationStatus@ API call to get the status of the association request.
--
-- * 'anrrsResponseStatus' - -- | The response status code.
associateNodeResponse ::
  -- | 'anrrsResponseStatus'
  Int ->
  AssociateNodeResponse
associateNodeResponse pResponseStatus_ =
  AssociateNodeResponse'
    { _anrrsNodeAssociationStatusToken =
        Nothing,
      _anrrsResponseStatus = pResponseStatus_
    }

-- | Contains a token which can be passed to the @DescribeNodeAssociationStatus@ API call to get the status of the association request.
anrrsNodeAssociationStatusToken :: Lens' AssociateNodeResponse (Maybe Text)
anrrsNodeAssociationStatusToken = lens _anrrsNodeAssociationStatusToken (\s a -> s {_anrrsNodeAssociationStatusToken = a})

-- | -- | The response status code.
anrrsResponseStatus :: Lens' AssociateNodeResponse Int
anrrsResponseStatus = lens _anrrsResponseStatus (\s a -> s {_anrrsResponseStatus = a})
