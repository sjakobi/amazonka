...
data CreateServer = CreateServer'
  { -- | A list of security group IDs to attach to the Amazon EC2 instance. If
    ...
    customPrivateKey :: Prelude.Maybe (Prelude.Sensitive Prelude.Text),
    ...
    backupRetentionCount :: Prelude.Maybe Prelude.Nat,
...
createServer_securityGroupIds = Lens.lens (\CreateServer' {securityGroupIds} -> securityGroupIds) (\s@CreateServer' {} a -> s {securityGroupIds = a} :: CreateServer) Prelude.. Lens.mapping Prelude._Coerce
...
createServer_customPrivateKey = Lens.lens (\CreateServer' {customPrivateKey} -> customPrivateKey) (\s@CreateServer' {} a -> s {customPrivateKey = a} :: CreateServer) Prelude.. Lens.mapping Prelude._Sensitive
...
createServer_engineAttributes = Lens.lens (\CreateServer' {engineAttributes} -> engineAttributes) (\s@CreateServer' {} a -> s {engineAttributes = a} :: CreateServer) Prelude.. Lens.mapping Prelude._Coerce
...
createServer_subnetIds = Lens.lens (\CreateServer' {subnetIds} -> subnetIds) (\s@CreateServer' {} a -> s {subnetIds = a} :: CreateServer) Prelude.. Lens.mapping Prelude._Coerce
...
createServer_tags = Lens.lens (\CreateServer' {tags} -> tags) (\s@CreateServer' {} a -> s {tags = a} :: CreateServer) Prelude.. Lens.mapping Prelude._Coerce

-- | The number of automated backups that you want to keep. Whenever a new
-- backup is created, AWS OpsWorks CM deletes the oldest backups if this
-- number is exceeded. The default value is @1@.
createServer_backupRetentionCount :: Lens.Lens' CreateServer (Prelude.Maybe Prelude.Natural)
createServer_backupRetentionCount = Lens.lens (\CreateServer' {backupRetentionCount} -> backupRetentionCount) (\s@CreateServer' {} a -> s {backupRetentionCount = a} :: CreateServer) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.AWSRequest CreateServer where
...
instance Prelude.ToHeaders CreateServer where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "OpsWorksCM_V2016_11_01.CreateServer" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON CreateServer where
  toJSON CreateServer' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("SecurityGroupIds" Prelude..=)
            ...
            ("CustomPrivateKey" Prelude..=)
              Prelude.<$> customPrivateKey,
            ("EngineAttributes" Prelude..=)
              Prelude.<$> engineAttributes,
            ("CustomDomain" Prelude..=) Prelude.<$> customDomain,
            ("BackupId" Prelude..=) Prelude.<$> backupId,
            ...
            ("EngineModel" Prelude..=) Prelude.<$> engineModel,
            ("CustomCertificate" Prelude..=)
              Prelude.<$> customCertificate,
            Prelude.Just ("Engine" Prelude..= engine),
            Prelude.Just ("ServerName" Prelude..= serverName),
            Prelude.Just
              ("InstanceProfileArn" Prelude..= instanceProfileArn),
            Prelude.Just
...
instance Prelude.ToPath CreateServer where
  toPath = Prelude.const "/"

instance Prelude.ToQuery CreateServer where
