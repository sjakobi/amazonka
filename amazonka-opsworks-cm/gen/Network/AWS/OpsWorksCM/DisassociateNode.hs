...
data DisassociateNodeResponse = DisassociateNodeResponse'
  { _dnrrsNodeAssociationStatusToken ::
      !(Maybe Text),
    _dnrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dnrrsNodeAssociationStatusToken' - Contains a token which can be passed to the @DescribeNodeAssociationStatus@ API call to get the status of the disassociation request.
--
-- * 'dnrrsResponseStatus' - -- | The response status code.
disassociateNodeResponse ::
  -- | 'dnrrsResponseStatus'
  Int ->
  DisassociateNodeResponse
disassociateNodeResponse pResponseStatus_ =
  DisassociateNodeResponse'
    { _dnrrsNodeAssociationStatusToken =
        Nothing,
      _dnrrsResponseStatus = pResponseStatus_
    }

-- | Contains a token which can be passed to the @DescribeNodeAssociationStatus@ API call to get the status of the disassociation request.
dnrrsNodeAssociationStatusToken :: Lens' DisassociateNodeResponse (Maybe Text)
dnrrsNodeAssociationStatusToken = lens _dnrrsNodeAssociationStatusToken (\s a -> s {_dnrrsNodeAssociationStatusToken = a})

-- | -- | The response status code.
dnrrsResponseStatus :: Lens' DisassociateNodeResponse Int
dnrrsResponseStatus = lens _dnrrsResponseStatus (\s a -> s {_dnrrsResponseStatus = a})
