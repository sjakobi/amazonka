...
newRegisterUsage pProductCode_ pPublicKeyVersion_ =
  RegisterUsage'
    { nonce = Prelude.Nothing,
      ...
      publicKeyVersion =
        Prelude._Nat Lens.# pPublicKeyVersion_
    }
...
registerUsage_publicKeyVersion = Lens.lens (\RegisterUsage' {publicKeyVersion} -> publicKeyVersion) (\s@RegisterUsage' {} a -> s {publicKeyVersion = a} :: RegisterUsage) Prelude.. Prelude._Nat
