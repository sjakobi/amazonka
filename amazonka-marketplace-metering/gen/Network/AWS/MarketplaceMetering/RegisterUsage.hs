...
data RegisterUsageResponse = RegisterUsageResponse'
  { _rurrsSignature ::
      !(Maybe Text),
    _rurrsPublicKeyRotationTimestamp ::
      !(Maybe POSIX),
    _rurrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rurrsSignature' - JWT Token
--
-- * 'rurrsPublicKeyRotationTimestamp' - (Optional) Only included when public key version has expired
--
-- * 'rurrsResponseStatus' - -- | The response status code.
registerUsageResponse ::
  -- | 'rurrsResponseStatus'
  Int ->
  RegisterUsageResponse
registerUsageResponse pResponseStatus_ =
  RegisterUsageResponse'
    { _rurrsSignature = Nothing,
      _rurrsPublicKeyRotationTimestamp = Nothing,
      _rurrsResponseStatus = pResponseStatus_
    }

-- | JWT Token
rurrsSignature :: Lens' RegisterUsageResponse (Maybe Text)
rurrsSignature = lens _rurrsSignature (\s a -> s {_rurrsSignature = a})

-- | (Optional) Only included when public key version has expired
rurrsPublicKeyRotationTimestamp :: Lens' RegisterUsageResponse (Maybe UTCTime)
rurrsPublicKeyRotationTimestamp = lens _rurrsPublicKeyRotationTimestamp (\s a -> s {_rurrsPublicKeyRotationTimestamp = a}) . mapping _Time

-- | -- | The response status code.
rurrsResponseStatus :: Lens' RegisterUsageResponse Int
rurrsResponseStatus = lens _rurrsResponseStatus (\s a -> s {_rurrsResponseStatus = a})
