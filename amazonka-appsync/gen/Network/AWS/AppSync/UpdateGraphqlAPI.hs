...
instance Hashable UpdateGraphqlAPI

instance NFData UpdateGraphqlAPI
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ugarrsGraphqlAPI' - The updated @GraphqlApi@ object.
--
-- * 'ugarrsResponseStatus' - -- | The response status code.
updateGraphqlAPIResponse ::
  -- | 'ugarrsResponseStatus'
  Int ->
  UpdateGraphqlAPIResponse
updateGraphqlAPIResponse pResponseStatus_ =
  UpdateGraphqlAPIResponse'
    { _ugarrsGraphqlAPI =
        Nothing,
      _ugarrsResponseStatus = pResponseStatus_
    }

-- | The updated @GraphqlApi@ object.
ugarrsGraphqlAPI :: Lens' UpdateGraphqlAPIResponse (Maybe GraphqlAPI)
ugarrsGraphqlAPI = lens _ugarrsGraphqlAPI (\s a -> s {_ugarrsGraphqlAPI = a})

-- | -- | The response status code.
ugarrsResponseStatus :: Lens' UpdateGraphqlAPIResponse Int
ugarrsResponseStatus = lens _ugarrsResponseStatus (\s a -> s {_ugarrsResponseStatus = a})

instance NFData UpdateGraphqlAPIResponse
