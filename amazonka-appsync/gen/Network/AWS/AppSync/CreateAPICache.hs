    ...
    object
      ( catMaybes
          [ ("atRestEncryptionEnabled" .=)
            ...
            Just ("ttl" .= _cacTtl),
            Just
              ("apiCachingBehavior" .= _cacApiCachingBehavior),
            Just ("type" .= _cacType)
          ]
      )
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cacrrsApiCache' - The @ApiCache@ object.
--
-- * 'cacrrsResponseStatus' - -- | The response status code.
createAPICacheResponse ::
  -- | 'cacrrsResponseStatus'
  Int ->
  CreateAPICacheResponse
createAPICacheResponse pResponseStatus_ =
  CreateAPICacheResponse'
    { _cacrrsApiCache = Nothing,
      _cacrrsResponseStatus = pResponseStatus_
    }

-- | The @ApiCache@ object.
cacrrsApiCache :: Lens' CreateAPICacheResponse (Maybe APICache)
cacrrsApiCache = lens _cacrrsApiCache (\s a -> s {_cacrrsApiCache = a})

-- | -- | The response status code.
cacrrsResponseStatus :: Lens' CreateAPICacheResponse Int
cacrrsResponseStatus = lens _cacrrsResponseStatus (\s a -> s {_cacrrsResponseStatus = a})
