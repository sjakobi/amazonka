...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uacrrsApiCache' - The @ApiCache@ object.
--
...
updateAPICacheResponse pResponseStatus_ =
  UpdateAPICacheResponse'
    { _uacrrsApiCache = Nothing,
      _uacrrsResponseStatus = pResponseStatus_
    }

-- | The @ApiCache@ object.
uacrrsApiCache :: Lens' UpdateAPICacheResponse (Maybe APICache)
uacrrsApiCache = lens _uacrrsApiCache (\s a -> s {_uacrrsApiCache = a})

-- | -- | The response status code.
uacrrsResponseStatus :: Lens' UpdateAPICacheResponse Int
