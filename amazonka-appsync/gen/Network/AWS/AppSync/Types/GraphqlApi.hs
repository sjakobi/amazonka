...
data GraphqlApi = GraphqlApi'
  { -- | The ARN of the AWS Web Application Firewall (WAF) ACL associated with
    ...
    -- | The URIs.
    uris :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text)
  }
...
graphqlApi_tags = Lens.lens (\GraphqlApi' {tags} -> tags) (\s@GraphqlApi' {} a -> s {tags = a} :: GraphqlApi) Prelude.. Lens.mapping Prelude._Map
...
graphqlApi_uris = Lens.lens (\GraphqlApi' {uris} -> uris) (\s@GraphqlApi' {} a -> s {uris = a} :: GraphqlApi) Prelude.. Lens.mapping Prelude._Map
