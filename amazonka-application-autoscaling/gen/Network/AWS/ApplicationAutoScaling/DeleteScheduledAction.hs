...
--
--
-- For more information, see <https://docs.aws.amazon.com/autoscaling/application/userguide/scheduled-scaling-additional-cli-commands.html#delete-scheduled-action Delete a scheduled action> in the /Application Auto Scaling User Guide/ .
module Network.AWS.ApplicationAutoScaling.DeleteScheduledAction
  ( -- * Creating a Request
  ...
  pScalableDimension_ =
    DeleteScheduledAction'
      { _dServiceNamespace =
        ...
        _dScalableDimension = pScalableDimension_
      }

-- | The namespace of the AWS service that provides the resource. For a resource provided by your own application or service, use @custom-resource@ instead.
dServiceNamespace :: Lens' DeleteScheduledAction ServiceNamespace
    ...
    object
      ( catMaybes
          [ Just ("ServiceNamespace" .= _dServiceNamespace),
            ...
            Just ("ScalableDimension" .= _dScalableDimension)
          ]
      )
