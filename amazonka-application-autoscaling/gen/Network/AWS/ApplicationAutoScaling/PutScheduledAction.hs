...
psaTimezone :: Lens' PutScheduledAction (Maybe Text)
psaTimezone = lens _psaTimezone (\s a -> s {_psaTimezone = a})
...
psarrsResponseStatus :: Lens' PutScheduledActionResponse Int
