...
--
-- * 'psprrsPolicyARN' - The Amazon Resource Name (ARN) of the resulting scaling policy.
putScalingPolicyResponse ::
  -- | 'psprrsResponseStatus'
  Int ->
  -- | 'psprrsPolicyARN'
...
psprrsPolicyARN :: Lens' PutScalingPolicyResponse Text
