...
data CorsRule = CorsRule'
  { -- | Identifies an HTTP method that the origin that is specified in the rule
    ...
    allowedMethods :: Prelude.Maybe (Prelude.List1 MethodName),
    -- | The time in seconds that your browser caches the preflight response for
    -- the specified resource.
    --
    -- A CORS rule can have only one @MaxAgeSeconds@ element.
    maxAgeSeconds :: Prelude.Maybe Prelude.Nat,
    ...
    allowedOrigins :: Prelude.List1 Prelude.Text,
...
newCorsRule pAllowedOrigins_ =
  CorsRule'
    { allowedMethods = Prelude.Nothing,
      ...
      allowedOrigins =
        Prelude._List1 Lens.# pAllowedOrigins_,
...
corsRule_allowedMethods = Lens.lens (\CorsRule' {allowedMethods} -> allowedMethods) (\s@CorsRule' {} a -> s {allowedMethods = a} :: CorsRule) Prelude.. Lens.mapping Prelude._List1
...
corsRule_maxAgeSeconds = Lens.lens (\CorsRule' {maxAgeSeconds} -> maxAgeSeconds) (\s@CorsRule' {} a -> s {maxAgeSeconds = a} :: CorsRule) Prelude.. Lens.mapping Prelude._Nat
...
corsRule_allowedOrigins = Lens.lens (\CorsRule' {allowedOrigins} -> allowedOrigins) (\s@CorsRule' {} a -> s {allowedOrigins = a} :: CorsRule) Prelude.. Prelude._List1
...
corsRule_allowedHeaders = Lens.lens (\CorsRule' {allowedHeaders} -> allowedHeaders) (\s@CorsRule' {} a -> s {allowedHeaders = a} :: CorsRule) Prelude.. Prelude._Coerce

instance Prelude.FromJSON CorsRule where
  parseJSON =
    Prelude.withObject
      "CorsRule"
      ( \x ->
          CorsRule'
            ...
            Prelude.<*> ( x Prelude..:? "ExposeHeaders"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..: "AllowedOrigins")
            Prelude.<*> ( x Prelude..:? "AllowedHeaders"
                            Prelude..!= Prelude.mempty
                        )
      )
...
instance Prelude.ToJSON CorsRule where
  toJSON CorsRule' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("AllowedMethods" Prelude..=)
              Prelude.<$> allowedMethods,
            ("MaxAgeSeconds" Prelude..=)
              Prelude.<$> maxAgeSeconds,
            ("ExposeHeaders" Prelude..=)
              Prelude.<$> exposeHeaders,
            Prelude.Just
              ("AllowedOrigins" Prelude..= allowedOrigins),
            Prelude.Just
              ("AllowedHeaders" Prelude..= allowedHeaders)
          ]
      )
