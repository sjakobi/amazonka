...
data MetricPolicy = MetricPolicy'
  { -- | A parameter that holds an array of rules that enable metrics at the
    ...
    metricPolicyRules :: Prelude.Maybe (Prelude.List1 MetricPolicyRule),
...
metricPolicy_metricPolicyRules = Lens.lens (\MetricPolicy' {metricPolicyRules} -> metricPolicyRules) (\s@MetricPolicy' {} a -> s {metricPolicyRules = a} :: MetricPolicy) Prelude.. Lens.mapping Prelude._List1
