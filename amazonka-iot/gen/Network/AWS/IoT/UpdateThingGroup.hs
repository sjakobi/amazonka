...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'utgrrsVersion' - The version of the updated thing group.
--
-- * 'utgrrsResponseStatus' - -- | The response status code.
updateThingGroupResponse ::
  -- | 'utgrrsResponseStatus'
  Int ->
  UpdateThingGroupResponse
updateThingGroupResponse pResponseStatus_ =
  UpdateThingGroupResponse'
    { _utgrrsVersion = Nothing,
      _utgrrsResponseStatus = pResponseStatus_
    }

-- | The version of the updated thing group.
utgrrsVersion :: Lens' UpdateThingGroupResponse (Maybe Integer)
utgrrsVersion = lens _utgrrsVersion (\s a -> s {_utgrrsVersion = a})

-- | -- | The response status code.
utgrrsResponseStatus :: Lens' UpdateThingGroupResponse Int
utgrrsResponseStatus = lens _utgrrsResponseStatus (\s a -> s {_utgrrsResponseStatus = a})
