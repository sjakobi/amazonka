...
instance ToPath UpdateBillingGroup where
  toPath UpdateBillingGroup' {..} =
    mconcat
      ["/billing-groups/", toBS _ubgBillingGroupName]
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ubgrrsVersion' - The latest version of the billing group.
--
-- * 'ubgrrsResponseStatus' - -- | The response status code.
updateBillingGroupResponse ::
  -- | 'ubgrrsResponseStatus'
  Int ->
  UpdateBillingGroupResponse
updateBillingGroupResponse pResponseStatus_ =
  UpdateBillingGroupResponse'
    { _ubgrrsVersion =
        Nothing,
      _ubgrrsResponseStatus = pResponseStatus_
    }

-- | The latest version of the billing group.
ubgrrsVersion :: Lens' UpdateBillingGroupResponse (Maybe Integer)
ubgrrsVersion = lens _ubgrrsVersion (\s a -> s {_ubgrrsVersion = a})

-- | -- | The response status code.
ubgrrsResponseStatus :: Lens' UpdateBillingGroupResponse Int
ubgrrsResponseStatus = lens _ubgrrsResponseStatus (\s a -> s {_ubgrrsResponseStatus = a})
