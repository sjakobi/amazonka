...
instance Prelude.AWSRequest CreateKeysAndCertificate where
  type
...
instance Prelude.ToHeaders CreateKeysAndCertificate where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToJSON CreateKeysAndCertificate where
  toJSON =
    Prelude.const (Prelude.Object Prelude.mempty)

instance Prelude.ToPath CreateKeysAndCertificate where
  toPath = Prelude.const "/keys-and-certificate"

instance Prelude.ToQuery CreateKeysAndCertificate where
