...
instance Prelude.AWSRequest GetV2LoggingOptions where
  type
    ...
    Response.receiveJSON
      ( \s h x ->
          GetV2LoggingOptionsResponse'
            ...
            Prelude.<*> (x Prelude..?> "disableAllLogs")
            Prelude.<*> (x Prelude..?> "defaultLogLevel")
...
instance Prelude.ToHeaders GetV2LoggingOptions where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath GetV2LoggingOptions where
  toPath = Prelude.const "/v2LoggingOptions"

instance Prelude.ToQuery GetV2LoggingOptions where
