...
data GetTopicRuleDestinationResponse = GetTopicRuleDestinationResponse'
  { _gtrdrrsTopicRuleDestination ::
      !( Maybe
           TopicRuleDestination
       ),
    _gtrdrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gtrdrrsTopicRuleDestination' - The topic rule destination.
--
-- * 'gtrdrrsResponseStatus' - -- | The response status code.
getTopicRuleDestinationResponse ::
  -- | 'gtrdrrsResponseStatus'
  Int ->
  GetTopicRuleDestinationResponse
getTopicRuleDestinationResponse pResponseStatus_ =
  GetTopicRuleDestinationResponse'
    { _gtrdrrsTopicRuleDestination =
        Nothing,
      _gtrdrrsResponseStatus = pResponseStatus_
    }

-- | The topic rule destination.
gtrdrrsTopicRuleDestination :: Lens' GetTopicRuleDestinationResponse (Maybe TopicRuleDestination)
gtrdrrsTopicRuleDestination = lens _gtrdrrsTopicRuleDestination (\s a -> s {_gtrdrrsTopicRuleDestination = a})

-- | -- | The response status code.
gtrdrrsResponseStatus :: Lens' GetTopicRuleDestinationResponse Int
gtrdrrsResponseStatus = lens _gtrdrrsResponseStatus (\s a -> s {_gtrdrrsResponseStatus = a})
