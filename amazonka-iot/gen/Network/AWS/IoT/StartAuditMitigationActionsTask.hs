...
data StartAuditMitigationActionsTask = StartAuditMitigationActionsTask'
  { -- | A unique identifier for the task. You can use this identifier to check
    ...
    auditCheckToActionsMapping :: Prelude.Map Prelude.Text (Prelude.List1 Prelude.Text),
...
startAuditMitigationActionsTask_auditCheckToActionsMapping = Lens.lens (\StartAuditMitigationActionsTask' {auditCheckToActionsMapping} -> auditCheckToActionsMapping) (\s@StartAuditMitigationActionsTask' {} a -> s {auditCheckToActionsMapping = a} :: StartAuditMitigationActionsTask) Prelude.. Prelude._Map
    ...
    Prelude.object
      ( Prelude.catMaybes
          [ Prelude.Just ("target" Prelude..= target),
            Prelude.Just
              ( "auditCheckToActionsMapping"
                  Prelude..= auditCheckToActionsMapping
              ),
            Prelude.Just
              ( "clientRequestToken"
