...
--
-- * 'trdcVpcConfiguration' - Configuration of the virtual private cloud (VPC) connection.
--
...
topicRuleDestinationConfiguration =
  TopicRuleDestinationConfiguration'
    { _trdcVpcConfiguration =
        Nothing,
      _trdcHttpURLConfiguration = Nothing
    }

-- | Configuration of the virtual private cloud (VPC) connection.
trdcVpcConfiguration :: Lens' TopicRuleDestinationConfiguration (Maybe VPCDestinationConfiguration)
trdcVpcConfiguration = lens _trdcVpcConfiguration (\s a -> s {_trdcVpcConfiguration = a})
...
instance ToJSON TopicRuleDestinationConfiguration where
  toJSON TopicRuleDestinationConfiguration' {..} =
    object
      ( catMaybes
          [ ("vpcConfiguration" .=) <$> _trdcVpcConfiguration,
