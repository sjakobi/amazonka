...
data AddThingsToThingGroupParams = AddThingsToThingGroupParams'
  { -- | Specifies if this mitigation action can move the things that triggered
    ...
    thingGroupNames :: Prelude.List1 Prelude.Text
  }
...
newAddThingsToThingGroupParams pThingGroupNames_ =
  AddThingsToThingGroupParams'
    { overrideDynamicGroups =
        Prelude.Nothing,
      thingGroupNames =
        Prelude._List1 Lens.# pThingGroupNames_
    }
...
addThingsToThingGroupParams_thingGroupNames = Lens.lens (\AddThingsToThingGroupParams' {thingGroupNames} -> thingGroupNames) (\s@AddThingsToThingGroupParams' {} a -> s {thingGroupNames = a} :: AddThingsToThingGroupParams) Prelude.. Prelude._List1
