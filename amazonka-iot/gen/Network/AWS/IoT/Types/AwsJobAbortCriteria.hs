...
data AwsJobAbortCriteria = AwsJobAbortCriteria'
  { -- | The type of job execution failures that can initiate a job abort.
    ...
    minNumberOfExecutedThings :: Prelude.Nat
  }
  ...
  pMinNumberOfExecutedThings_ =
    AwsJobAbortCriteria'
      { failureType = pFailureType_,
        ...
        minNumberOfExecutedThings =
          Prelude._Nat Lens.# pMinNumberOfExecutedThings_
      }
...
awsJobAbortCriteria_minNumberOfExecutedThings = Lens.lens (\AwsJobAbortCriteria' {minNumberOfExecutedThings} -> minNumberOfExecutedThings) (\s@AwsJobAbortCriteria' {} a -> s {minNumberOfExecutedThings = a} :: AwsJobAbortCriteria) Prelude.. Prelude._Nat

instance Prelude.Hashable AwsJobAbortCriteria

instance Prelude.NFData AwsJobAbortCriteria

instance Prelude.ToJSON AwsJobAbortCriteria where
