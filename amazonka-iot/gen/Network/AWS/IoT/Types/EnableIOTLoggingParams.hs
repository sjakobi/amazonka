...
--
-- * 'eiotlpRoleARNForLogging' - The Amazon Resource Name (ARN) of the IAM role used for logging.
--
-- * 'eiotlpLogLevel' - Specifies the type of information to be logged.
...
instance ToJSON EnableIOTLoggingParams where
  toJSON EnableIOTLoggingParams' {..} =
    object
      ( catMaybes
          [ Just
              ("roleArnForLogging" .= _eiotlpRoleARNForLogging),
