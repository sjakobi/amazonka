...
data IotSiteWiseAction = IotSiteWiseAction'
  { -- | A list of asset property value entries.
    putAssetPropertyValueEntries :: Prelude.List1 PutAssetPropertyValueEntry,
...
newIotSiteWiseAction
  ...
  pRoleArn_ =
    IotSiteWiseAction'
      { putAssetPropertyValueEntries =
          Prelude._List1 Lens.# pPutAssetPropertyValueEntries_,
        roleArn = pRoleArn_
      }

-- | A list of asset property value entries.
iotSiteWiseAction_putAssetPropertyValueEntries :: Lens.Lens' IotSiteWiseAction (Prelude.NonEmpty PutAssetPropertyValueEntry)
iotSiteWiseAction_putAssetPropertyValueEntries = Lens.lens (\IotSiteWiseAction' {putAssetPropertyValueEntries} -> putAssetPropertyValueEntries) (\s@IotSiteWiseAction' {} a -> s {putAssetPropertyValueEntries = a} :: IotSiteWiseAction) Prelude.. Prelude._List1
