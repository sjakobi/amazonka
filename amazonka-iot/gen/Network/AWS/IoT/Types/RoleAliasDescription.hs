...
data RoleAliasDescription = RoleAliasDescription'
  { -- | The ARN of the role alias.
    ...
    credentialDurationSeconds :: Prelude.Maybe Prelude.Nat,
    -- | The role alias.
...
roleAliasDescription_credentialDurationSeconds = Lens.lens (\RoleAliasDescription' {credentialDurationSeconds} -> credentialDurationSeconds) (\s@RoleAliasDescription' {} a -> s {credentialDurationSeconds = a} :: RoleAliasDescription) Prelude.. Lens.mapping Prelude._Nat
