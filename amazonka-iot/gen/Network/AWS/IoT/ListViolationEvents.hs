...
listViolationEvents_maxResults = Lens.lens (\ListViolationEvents' {maxResults} -> maxResults) (\s@ListViolationEvents' {} a -> s {maxResults = a} :: ListViolationEvents) Prelude.. Lens.mapping Prelude._Nat
...
listViolationEvents_startTime = Lens.lens (\ListViolationEvents' {startTime} -> startTime) (\s@ListViolationEvents' {} a -> s {startTime = a} :: ListViolationEvents) Prelude.. Prelude._Time

-- | The end time for the alerts to be listed.
listViolationEvents_endTime :: Lens.Lens' ListViolationEvents Prelude.UTCTime
listViolationEvents_endTime = Lens.lens (\ListViolationEvents' {endTime} -> endTime) (\s@ListViolationEvents' {} a -> s {endTime = a} :: ListViolationEvents) Prelude.. Prelude._Time
...
instance Prelude.AWSRequest ListViolationEvents where
  type
    ...
    Response.receiveJSON
      ( \s h x ->
          ListViolationEventsResponse'
            ...
            Prelude.<*> ( x Prelude..?> "violationEvents"
...
instance Prelude.ToHeaders ListViolationEvents where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath ListViolationEvents where
  toPath = Prelude.const "/violation-events"

instance Prelude.ToQuery ListViolationEvents where
...
listViolationEventsResponse_violationEvents = Lens.lens (\ListViolationEventsResponse' {violationEvents} -> violationEvents) (\s@ListViolationEventsResponse' {} a -> s {violationEvents = a} :: ListViolationEventsResponse) Prelude.. Lens.mapping Prelude._Coerce
