...
data DockerVolumeConfiguration = DockerVolumeConfiguration'
  { -- | Custom metadata to add to your Docker volume. This parameter maps to
    ...
    labels :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
    ...
    -- @xxopt@ option to
    -- <https://docs.docker.com/engine/reference/commandline/volume_create/ docker volume create>.
    driverOpts :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
...
dockerVolumeConfiguration_labels = Lens.lens (\DockerVolumeConfiguration' {labels} -> labels) (\s@DockerVolumeConfiguration' {} a -> s {labels = a} :: DockerVolumeConfiguration) Prelude.. Lens.mapping Prelude._Map
...
dockerVolumeConfiguration_driverOpts = Lens.lens (\DockerVolumeConfiguration' {driverOpts} -> driverOpts) (\s@DockerVolumeConfiguration' {} a -> s {driverOpts = a} :: DockerVolumeConfiguration) Prelude.. Lens.mapping Prelude._Map
