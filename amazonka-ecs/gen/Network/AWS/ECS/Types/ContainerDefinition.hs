...
data ContainerDefinition = ContainerDefinition'
  { -- | The hostname to use for your container. This parameter maps to
    ...
    dockerLabels :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
...
containerDefinition_dockerLabels = Lens.lens (\ContainerDefinition' {dockerLabels} -> dockerLabels) (\s@ContainerDefinition' {} a -> s {dockerLabels = a} :: ContainerDefinition) Prelude.. Lens.mapping Prelude._Map
