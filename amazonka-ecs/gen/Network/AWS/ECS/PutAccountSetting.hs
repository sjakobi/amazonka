...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'pasrrsSetting' - The current account setting for a resource.
--
-- * 'pasrrsResponseStatus' - -- | The response status code.
putAccountSettingResponse ::
  -- | 'pasrrsResponseStatus'
  Int ->
  PutAccountSettingResponse
putAccountSettingResponse pResponseStatus_ =
  PutAccountSettingResponse'
    { _pasrrsSetting =
        Nothing,
      _pasrrsResponseStatus = pResponseStatus_
    }

-- | The current account setting for a resource.
pasrrsSetting :: Lens' PutAccountSettingResponse (Maybe Setting)
pasrrsSetting = lens _pasrrsSetting (\s a -> s {_pasrrsSetting = a})

-- | -- | The response status code.
pasrrsResponseStatus :: Lens' PutAccountSettingResponse Int
pasrrsResponseStatus = lens _pasrrsResponseStatus (\s a -> s {_pasrrsResponseStatus = a})
