...
registerTaskDefinition pFamily_ =
  RegisterTaskDefinition'
    { _rtdTaskRoleARN = Nothing,
      ...
      _rtdVolumes = Nothing,
      _rtdInferenceAccelerators = Nothing,
...
data RegisterTaskDefinitionResponse = RegisterTaskDefinitionResponse'
  { _rtdrrsTags ::
    ...
    _rtdrrsTaskDefinition ::
      !( Maybe
           TaskDefinition
       ),
    _rtdrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rtdrrsTags' - The list of tags associated with the task definition.
--
-- * 'rtdrrsTaskDefinition' - The full description of the registered task definition.
--
-- * 'rtdrrsResponseStatus' - -- | The response status code.
registerTaskDefinitionResponse ::
  -- | 'rtdrrsResponseStatus'
  Int ->
  RegisterTaskDefinitionResponse
registerTaskDefinitionResponse pResponseStatus_ =
  RegisterTaskDefinitionResponse'
    { _rtdrrsTags =
        Nothing,
      _rtdrrsTaskDefinition = Nothing,
      _rtdrrsResponseStatus = pResponseStatus_
    }

-- | The list of tags associated with the task definition.
rtdrrsTags :: Lens' RegisterTaskDefinitionResponse [Tag]
rtdrrsTags = lens _rtdrrsTags (\s a -> s {_rtdrrsTags = a}) . _Default . _Coerce

-- | The full description of the registered task definition.
rtdrrsTaskDefinition :: Lens' RegisterTaskDefinitionResponse (Maybe TaskDefinition)
rtdrrsTaskDefinition = lens _rtdrrsTaskDefinition (\s a -> s {_rtdrrsTaskDefinition = a})

-- | -- | The response status code.
rtdrrsResponseStatus :: Lens' RegisterTaskDefinitionResponse Int
rtdrrsResponseStatus = lens _rtdrrsResponseStatus (\s a -> s {_rtdrrsResponseStatus = a})
