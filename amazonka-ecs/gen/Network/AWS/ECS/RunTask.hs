...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rtrrsTasks' - A full description of the tasks that were run. The tasks that were successfully placed on your cluster are described here.
--
-- * 'rtrrsFailures' - Any failures associated with the call.
--
...
runTaskResponse pResponseStatus_ =
  RunTaskResponse'
    { _rtrrsTasks = Nothing,
      _rtrrsFailures = Nothing,
      _rtrrsResponseStatus = pResponseStatus_
    }

-- | A full description of the tasks that were run. The tasks that were successfully placed on your cluster are described here.
rtrrsTasks :: Lens' RunTaskResponse [Task]
rtrrsTasks = lens _rtrrsTasks (\s a -> s {_rtrrsTasks = a}) . _Default . _Coerce

-- | Any failures associated with the call.
rtrrsFailures :: Lens' RunTaskResponse [Failure]
rtrrsFailures = lens _rtrrsFailures (\s a -> s {_rtrrsFailures = a}) . _Default . _Coerce

-- | -- | The response status code.
rtrrsResponseStatus :: Lens' RunTaskResponse Int
