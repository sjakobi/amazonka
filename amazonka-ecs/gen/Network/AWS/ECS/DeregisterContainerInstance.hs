...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'drsContainerInstance' - The container instance that was deregistered.
--
...
drsContainerInstance :: Lens' DeregisterContainerInstanceResponse (Maybe ContainerInstance)
drsContainerInstance = lens _drsContainerInstance (\s a -> s {_drsContainerInstance = a})

-- | -- | The response status code.
drsResponseStatus :: Lens' DeregisterContainerInstanceResponse Int
