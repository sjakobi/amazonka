...
startTask_tags = Lens.lens (\StartTask' {tags} -> tags) (\s@StartTask' {} a -> s {tags = a} :: StartTask) Prelude.. Lens.mapping Prelude._Coerce
...
startTask_containerInstances = Lens.lens (\StartTask' {containerInstances} -> containerInstances) (\s@StartTask' {} a -> s {containerInstances = a} :: StartTask) Prelude.. Prelude._Coerce
...
instance Prelude.AWSRequest StartTask where
...
instance Prelude.ToHeaders StartTask where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AmazonEC2ContainerServiceV20141113.StartTask" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON StartTask where
  toJSON StartTask' {..} =
    Prelude.object
      ( Prelude.catMaybes
...
instance Prelude.ToPath StartTask where
  toPath = Prelude.const "/"

instance Prelude.ToQuery StartTask where
...
startTaskResponse_tasks = Lens.lens (\StartTaskResponse' {tasks} -> tasks) (\s@StartTaskResponse' {} a -> s {tasks = a} :: StartTaskResponse) Prelude.. Lens.mapping Prelude._Coerce

-- | Any failures associated with the call.
startTaskResponse_failures :: Lens.Lens' StartTaskResponse (Prelude.Maybe [Failure])
startTaskResponse_failures = Lens.lens (\StartTaskResponse' {failures} -> failures) (\s@StartTaskResponse' {} a -> s {failures = a} :: StartTaskResponse) Prelude.. Lens.mapping Prelude._Coerce
