...
instance Prelude.AWSRequest ListAccountSettings where
  type
...
instance Prelude.ToHeaders ListAccountSettings where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AmazonEC2ContainerServiceV20141113.ListAccountSettings" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON ListAccountSettings where
  toJSON ListAccountSettings' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("nextToken" Prelude..=) Prelude.<$> nextToken,
            ("maxResults" Prelude..=) Prelude.<$> maxResults,
            ("effectiveSettings" Prelude..=)
              Prelude.<$> effectiveSettings,
            ("name" Prelude..=) Prelude.<$> name,
            ("principalArn" Prelude..=) Prelude.<$> principalArn,
            ("value" Prelude..=) Prelude.<$> value
          ]
      )

instance Prelude.ToPath ListAccountSettings where
  toPath = Prelude.const "/"

instance Prelude.ToQuery ListAccountSettings where
...
listAccountSettingsResponse_settings = Lens.lens (\ListAccountSettingsResponse' {settings} -> settings) (\s@ListAccountSettingsResponse' {} a -> s {settings = a} :: ListAccountSettingsResponse) Prelude.. Lens.mapping Prelude._Coerce
