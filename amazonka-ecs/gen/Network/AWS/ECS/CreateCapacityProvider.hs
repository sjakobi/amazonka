...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ccprrsCapacityProvider' - The full description of the new capacity provider.
--
...
ccprrsCapacityProvider :: Lens' CreateCapacityProviderResponse (Maybe CapacityProvider)
ccprrsCapacityProvider = lens _ccprrsCapacityProvider (\s a -> s {_ccprrsCapacityProvider = a})

-- | -- | The response status code.
ccprrsResponseStatus :: Lens' CreateCapacityProviderResponse Int
