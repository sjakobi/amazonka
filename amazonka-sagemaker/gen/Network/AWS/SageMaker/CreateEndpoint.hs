...
--
-- * 'ceTags' - An array of key-value pairs. You can use tags to categorize your AWS resources in different ways, for example, by purpose, owner, or environment. For more information, see <https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html Tagging AWS Resources> .
--
...
--
-- * 'cerrsEndpointARN' - The Amazon Resource Name (ARN) of the endpoint.
createEndpointResponse ::
  -- | 'cerrsResponseStatus'
  Int ->
  -- | 'cerrsEndpointARN'
...
createEndpointResponse pResponseStatus_ pEndpointARN_ =
  CreateEndpointResponse'
    { _cerrsResponseStatus =
        pResponseStatus_,
      _cerrsEndpointARN = pEndpointARN_
    }
...
cerrsEndpointARN :: Lens' CreateEndpointResponse Text
