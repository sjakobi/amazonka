...
data CreatePresignedNotebookInstanceURLResponse = CreatePresignedNotebookInstanceURLResponse'
  { _cpniurrsAuthorizedURL ::
      !( Maybe
           Text
       ),
    _cpniurrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cpniurrsAuthorizedURL' - A JSON object that contains the URL string.
--
-- * 'cpniurrsResponseStatus' - -- | The response status code.
createPresignedNotebookInstanceURLResponse ::
  -- | 'cpniurrsResponseStatus'
  Int ->
  CreatePresignedNotebookInstanceURLResponse
...
cpniurrsAuthorizedURL :: Lens' CreatePresignedNotebookInstanceURLResponse (Maybe Text)
cpniurrsAuthorizedURL = lens _cpniurrsAuthorizedURL (\s a -> s {_cpniurrsAuthorizedURL = a})

-- | -- | The response status code.
cpniurrsResponseStatus :: Lens' CreatePresignedNotebookInstanceURLResponse Int
cpniurrsResponseStatus = lens _cpniurrsResponseStatus (\s a -> s {_cpniurrsResponseStatus = a})
