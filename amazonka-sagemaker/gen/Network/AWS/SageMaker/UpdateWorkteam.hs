...
data UpdateWorkteam = UpdateWorkteam'
  { -- | A list of @MemberDefinition@ objects that contains objects that identify
    ...
    memberDefinitions :: Prelude.Maybe (Prelude.List1 MemberDefinition),
...
updateWorkteam_memberDefinitions = Lens.lens (\UpdateWorkteam' {memberDefinitions} -> memberDefinitions) (\s@UpdateWorkteam' {} a -> s {memberDefinitions = a} :: UpdateWorkteam) Prelude.. Lens.mapping Prelude._List1
