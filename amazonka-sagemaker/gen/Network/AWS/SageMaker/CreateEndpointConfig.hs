...
--
-- * 'cecTags' - An array of key-value pairs. You can use tags to categorize your AWS resources in different ways, for example, by purpose, owner, or environment. For more information, see <https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html Tagging AWS Resources> .
--
...
data CreateEndpointConfigResponse = CreateEndpointConfigResponse'
  { _cecrrsResponseStatus ::
      !Int,
    _cecrrsEndpointConfigARN ::
      !Text
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cecrrsResponseStatus' - -- | The response status code.
--
-- * 'cecrrsEndpointConfigARN' - The Amazon Resource Name (ARN) of the endpoint configuration.
createEndpointConfigResponse ::
  -- | 'cecrrsResponseStatus'
  Int ->
  -- | 'cecrrsEndpointConfigARN'
...
cecrrsResponseStatus :: Lens' CreateEndpointConfigResponse Int
cecrrsResponseStatus = lens _cecrrsResponseStatus (\s a -> s {_cecrrsResponseStatus = a})

-- | The Amazon Resource Name (ARN) of the endpoint configuration.
cecrrsEndpointConfigARN :: Lens' CreateEndpointConfigResponse Text
cecrrsEndpointConfigARN = lens _cecrrsEndpointConfigARN (\s a -> s {_cecrrsEndpointConfigARN = a})
