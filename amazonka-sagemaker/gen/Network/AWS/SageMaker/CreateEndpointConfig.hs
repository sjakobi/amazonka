  ...
  pProductionVariants_ =
    CreateEndpointConfig'
      { kmsKeyId = Prelude.Nothing,
        ...
        productionVariants =
          Prelude._List1 Lens.# pProductionVariants_
      }
...
createEndpointConfig_productionVariants = Lens.lens (\CreateEndpointConfig' {productionVariants} -> productionVariants) (\s@CreateEndpointConfig' {} a -> s {productionVariants = a} :: CreateEndpointConfig) Prelude.. Prelude._List1
