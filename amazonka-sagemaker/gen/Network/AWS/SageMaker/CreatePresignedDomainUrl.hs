...
data CreatePresignedDomainUrl = CreatePresignedDomainUrl'
  { -- | The session expiration duration in seconds. This value defaults to
    -- 43200.
    sessionExpirationDurationInSeconds :: Prelude.Maybe Prelude.Nat,
    -- | The number of seconds until the pre-signed URL expires. This value
    -- defaults to 300.
    expiresInSeconds :: Prelude.Maybe Prelude.Nat,
    -- | The domain ID.
...
createPresignedDomainUrl_sessionExpirationDurationInSeconds = Lens.lens (\CreatePresignedDomainUrl' {sessionExpirationDurationInSeconds} -> sessionExpirationDurationInSeconds) (\s@CreatePresignedDomainUrl' {} a -> s {sessionExpirationDurationInSeconds = a} :: CreatePresignedDomainUrl) Prelude.. Lens.mapping Prelude._Nat

-- | The number of seconds until the pre-signed URL expires. This value
-- defaults to 300.
createPresignedDomainUrl_expiresInSeconds :: Lens.Lens' CreatePresignedDomainUrl (Prelude.Maybe Prelude.Natural)
createPresignedDomainUrl_expiresInSeconds = Lens.lens (\CreatePresignedDomainUrl' {expiresInSeconds} -> expiresInSeconds) (\s@CreatePresignedDomainUrl' {} a -> s {expiresInSeconds = a} :: CreatePresignedDomainUrl) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.AWSRequest CreatePresignedDomainUrl where
  type
...
instance Prelude.ToHeaders CreatePresignedDomainUrl where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "SageMaker.CreatePresignedDomainUrl" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToPath CreatePresignedDomainUrl where
  toPath = Prelude.const "/"

instance Prelude.ToQuery CreatePresignedDomainUrl where
