...
data HumanTaskConfig = HumanTaskConfig'
  { -- | Keywords used to describe the task so that workers on Amazon Mechanical
    ...
    -- objects.
    maxConcurrentTaskCount :: Prelude.Maybe Prelude.Nat,
    ...
    numberOfHumanWorkersPerDataObject :: Prelude.Nat,
    ...
    taskTimeLimitInSeconds :: Prelude.Nat,
  ...
  pAnnotationConsolidationConfig_ =
    HumanTaskConfig'
      { taskKeywords = Prelude.Nothing,
        ...
        numberOfHumanWorkersPerDataObject =
          Prelude._Nat
            Lens.# pNumberOfHumanWorkersPerDataObject_,
        taskTimeLimitInSeconds =
          Prelude._Nat Lens.# pTaskTimeLimitInSeconds_,
        annotationConsolidationConfig =
          pAnnotationConsolidationConfig_
      }
...
humanTaskConfig_taskKeywords = Lens.lens (\HumanTaskConfig' {taskKeywords} -> taskKeywords) (\s@HumanTaskConfig' {} a -> s {taskKeywords = a} :: HumanTaskConfig) Prelude.. Lens.mapping Prelude._List1
...
humanTaskConfig_taskAvailabilityLifetimeInSeconds = Lens.lens (\HumanTaskConfig' {taskAvailabilityLifetimeInSeconds} -> taskAvailabilityLifetimeInSeconds) (\s@HumanTaskConfig' {} a -> s {taskAvailabilityLifetimeInSeconds = a} :: HumanTaskConfig) Prelude.. Lens.mapping Prelude._Nat
...
humanTaskConfig_maxConcurrentTaskCount = Lens.lens (\HumanTaskConfig' {maxConcurrentTaskCount} -> maxConcurrentTaskCount) (\s@HumanTaskConfig' {} a -> s {maxConcurrentTaskCount = a} :: HumanTaskConfig) Prelude.. Lens.mapping Prelude._Nat
...
humanTaskConfig_numberOfHumanWorkersPerDataObject = Lens.lens (\HumanTaskConfig' {numberOfHumanWorkersPerDataObject} -> numberOfHumanWorkersPerDataObject) (\s@HumanTaskConfig' {} a -> s {numberOfHumanWorkersPerDataObject = a} :: HumanTaskConfig) Prelude.. Prelude._Nat
...
humanTaskConfig_taskTimeLimitInSeconds = Lens.lens (\HumanTaskConfig' {taskTimeLimitInSeconds} -> taskTimeLimitInSeconds) (\s@HumanTaskConfig' {} a -> s {taskTimeLimitInSeconds = a} :: HumanTaskConfig) Prelude.. Prelude._Nat
...
instance Prelude.FromJSON HumanTaskConfig where
  parseJSON =
    Prelude.withObject
      "HumanTaskConfig"
      ( \x ->
          HumanTaskConfig'
            ...
            Prelude.<*> (x Prelude..: "AnnotationConsolidationConfig")
      )
...
instance Prelude.ToJSON HumanTaskConfig where
    ...
    Prelude.object
      ( Prelude.catMaybes
          [ ("TaskKeywords" Prelude..=)
            ...
            ("MaxConcurrentTaskCount" Prelude..=)
            ...
            Prelude.Just ("UiConfig" Prelude..= uiConfig),
            Prelude.Just
              ( "PreHumanTaskLambdaArn"
                  Prelude..= preHumanTaskLambdaArn
              ),
            ...
            Prelude.Just
              ( "NumberOfHumanWorkersPerDataObject"
                  Prelude..= numberOfHumanWorkersPerDataObject
              ),
            Prelude.Just
              ( "TaskTimeLimitInSeconds"
            ...
            Prelude.Just
              ( "AnnotationConsolidationConfig"
                  Prelude..= annotationConsolidationConfig
              )
          ]
      )
