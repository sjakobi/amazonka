...
instance Prelude.FromText ProductionVariantInstanceType where
  parser = ProductionVariantInstanceType' Prelude.<$> Prelude.takeText

instance Prelude.ToText ProductionVariantInstanceType where
  toText (ProductionVariantInstanceType' x) = x

instance Prelude.Hashable ProductionVariantInstanceType

instance Prelude.NFData ProductionVariantInstanceType

instance Prelude.ToByteString ProductionVariantInstanceType

instance Prelude.ToQuery ProductionVariantInstanceType

instance Prelude.ToHeader ProductionVariantInstanceType

instance Prelude.ToJSON ProductionVariantInstanceType where
  toJSON = Prelude.toJSONText

instance Prelude.FromJSON ProductionVariantInstanceType where
  parseJSON = Prelude.parseJSONText "ProductionVariantInstanceType"
