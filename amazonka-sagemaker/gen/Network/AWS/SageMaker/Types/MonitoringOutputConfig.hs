...
data MonitoringOutputConfig = MonitoringOutputConfig'
  { -- | The AWS Key Management Service (AWS KMS) key that Amazon SageMaker uses
    ...
    monitoringOutputs :: Prelude.List1 MonitoringOutput
  }
...
newMonitoringOutputConfig pMonitoringOutputs_ =
  MonitoringOutputConfig'
    { kmsKeyId = Prelude.Nothing,
      monitoringOutputs =
        Prelude._List1 Lens.# pMonitoringOutputs_
    }
...
monitoringOutputConfig_monitoringOutputs = Lens.lens (\MonitoringOutputConfig' {monitoringOutputs} -> monitoringOutputs) (\s@MonitoringOutputConfig' {} a -> s {monitoringOutputs = a} :: MonitoringOutputConfig) Prelude.. Prelude._List1
