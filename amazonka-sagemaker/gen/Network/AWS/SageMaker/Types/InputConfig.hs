...
--
-- * 'icFrameworkVersion' - Specifies the framework version to use. This API field is only supported for PyTorch framework versions @1.4@ , @1.5@ , and @1.6@ for cloud instance target devices: @ml_c4@ , @ml_c5@ , @ml_m4@ , @ml_m5@ , @ml_p2@ , @ml_p3@ , and @ml_g4dn@ .
--
...
icFrameworkVersion :: Lens' InputConfig (Maybe Text)
icFrameworkVersion = lens _icFrameworkVersion (\s a -> s {_icFrameworkVersion = a})
...
instance ToJSON InputConfig where
  toJSON InputConfig' {..} =
    object
      ( catMaybes
          [ ("FrameworkVersion" .=) <$> _icFrameworkVersion,
            Just ("S3Uri" .= _icS3URI),
