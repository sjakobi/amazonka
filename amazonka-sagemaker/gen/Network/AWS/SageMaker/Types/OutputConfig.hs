...
data OutputConfig = OutputConfig'
  { _ocCompilerOptions ::
      !(Maybe Text),
    _ocKMSKeyId :: !(Maybe Text),
    _ocTargetDevice :: !(Maybe TargetDevice),
    _ocTargetPlatform :: !(Maybe TargetPlatform),
...
ocKMSKeyId :: Lens' OutputConfig (Maybe Text)
ocKMSKeyId = lens _ocKMSKeyId (\s a -> s {_ocKMSKeyId = a})
