...
data AutoRollbackConfig = AutoRollbackConfig'
  { alarms :: Prelude.Maybe (Prelude.List1 Alarm)
  }
...
autoRollbackConfig_alarms = Lens.lens (\AutoRollbackConfig' {alarms} -> alarms) (\s@AutoRollbackConfig' {} a -> s {alarms = a} :: AutoRollbackConfig) Prelude.. Lens.mapping Prelude._List1
