...
instance Prelude.FromText TrainingInstanceType where
  parser = TrainingInstanceType' Prelude.<$> Prelude.takeText

instance Prelude.ToText TrainingInstanceType where
  toText (TrainingInstanceType' x) = x

instance Prelude.Hashable TrainingInstanceType

instance Prelude.NFData TrainingInstanceType

instance Prelude.ToByteString TrainingInstanceType

instance Prelude.ToQuery TrainingInstanceType

instance Prelude.ToHeader TrainingInstanceType

instance Prelude.ToJSON TrainingInstanceType where
  toJSON = Prelude.toJSONText

instance Prelude.FromJSON TrainingInstanceType where
  parseJSON = Prelude.parseJSONText "TrainingInstanceType"
