...
data SearchExpression = SearchExpression'
  { -- | A list of nested filter objects.
    nestedFilters :: Prelude.Maybe (Prelude.List1 NestedFilters),
    ...
    filters :: Prelude.Maybe (Prelude.List1 Filter),
    -- | A list of search expression objects.
    subExpressions :: Prelude.Maybe (Prelude.List1 SearchExpression)
  }
...
searchExpression_nestedFilters = Lens.lens (\SearchExpression' {nestedFilters} -> nestedFilters) (\s@SearchExpression' {} a -> s {nestedFilters = a} :: SearchExpression) Prelude.. Lens.mapping Prelude._List1
...
searchExpression_filters = Lens.lens (\SearchExpression' {filters} -> filters) (\s@SearchExpression' {} a -> s {filters = a} :: SearchExpression) Prelude.. Lens.mapping Prelude._List1

-- | A list of search expression objects.
searchExpression_subExpressions :: Lens.Lens' SearchExpression (Prelude.Maybe (Prelude.NonEmpty SearchExpression))
searchExpression_subExpressions = Lens.lens (\SearchExpression' {subExpressions} -> subExpressions) (\s@SearchExpression' {} a -> s {subExpressions = a} :: SearchExpression) Prelude.. Lens.mapping Prelude._List1
