...
data StoppingCondition = StoppingCondition'
  { -- | The maximum length of time, in seconds, that the training or compilation
    ...
    maxRuntimeInSeconds :: Prelude.Maybe Prelude.Nat,
    ...
    maxWaitTimeInSeconds :: Prelude.Maybe Prelude.Nat
  }
...
stoppingCondition_maxRuntimeInSeconds = Lens.lens (\StoppingCondition' {maxRuntimeInSeconds} -> maxRuntimeInSeconds) (\s@StoppingCondition' {} a -> s {maxRuntimeInSeconds = a} :: StoppingCondition) Prelude.. Lens.mapping Prelude._Nat
...
stoppingCondition_maxWaitTimeInSeconds = Lens.lens (\StoppingCondition' {maxWaitTimeInSeconds} -> maxWaitTimeInSeconds) (\s@StoppingCondition' {} a -> s {maxWaitTimeInSeconds = a} :: StoppingCondition) Prelude.. Lens.mapping Prelude._Nat
