...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'prprrsResourcePolicy' - The new policy.
--
...
-- | The new policy.
prprrsResourcePolicy :: Lens' PutResourcePolicyResponse (Maybe ResourcePolicy)
prprrsResourcePolicy = lens _prprrsResourcePolicy (\s a -> s {_prprrsResourcePolicy = a})
