...
data PutMetricFilter = PutMetricFilter'
  { -- | The name of the log group.
    ...
    metricTransformations :: Prelude.List1 MetricTransformation
  }
  ...
  pMetricTransformations_ =
    PutMetricFilter'
      { logGroupName = pLogGroupName_,
        ...
        metricTransformations =
          Prelude._List1 Lens.# pMetricTransformations_
      }
...
putMetricFilter_metricTransformations = Lens.lens (\PutMetricFilter' {metricTransformations} -> metricTransformations) (\s@PutMetricFilter' {} a -> s {metricTransformations = a} :: PutMetricFilter) Prelude.. Prelude._List1
