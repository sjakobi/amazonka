...
data ExportTaskExecutionInfo = ExportTaskExecutionInfo'
  { -- | The creation time of the export task, expressed as the number of
    ...
    -- milliseconds after Jan 1, 1970 00:00:00 UTC.
    completionTime :: Prelude.Maybe Prelude.Nat
  }
...
exportTaskExecutionInfo_creationTime = Lens.lens (\ExportTaskExecutionInfo' {creationTime} -> creationTime) (\s@ExportTaskExecutionInfo' {} a -> s {creationTime = a} :: ExportTaskExecutionInfo) Prelude.. Lens.mapping Prelude._Nat

-- | The completion time of the export task, expressed as the number of
-- milliseconds after Jan 1, 1970 00:00:00 UTC.
exportTaskExecutionInfo_completionTime :: Lens.Lens' ExportTaskExecutionInfo (Prelude.Maybe Prelude.Natural)
exportTaskExecutionInfo_completionTime = Lens.lens (\ExportTaskExecutionInfo' {completionTime} -> completionTime) (\s@ExportTaskExecutionInfo' {} a -> s {completionTime = a} :: ExportTaskExecutionInfo) Prelude.. Lens.mapping Prelude._Nat
