...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ajfsrrsStepIds' - The identifiers of the list of steps added to the job flow.
--
-- * 'ajfsrrsResponseStatus' - -- | The response status code.
addJobFlowStepsResponse ::
  -- | 'ajfsrrsResponseStatus'
  Int ->
  AddJobFlowStepsResponse
addJobFlowStepsResponse pResponseStatus_ =
  AddJobFlowStepsResponse'
    { _ajfsrrsStepIds = Nothing,
      _ajfsrrsResponseStatus = pResponseStatus_
    }

-- | The identifiers of the list of steps added to the job flow.
ajfsrrsStepIds :: Lens' AddJobFlowStepsResponse [Text]
ajfsrrsStepIds = lens _ajfsrrsStepIds (\s a -> s {_ajfsrrsStepIds = a}) . _Default . _Coerce

-- | -- | The response status code.
ajfsrrsResponseStatus :: Lens' AddJobFlowStepsResponse Int
ajfsrrsResponseStatus = lens _ajfsrrsResponseStatus (\s a -> s {_ajfsrrsResponseStatus = a})
