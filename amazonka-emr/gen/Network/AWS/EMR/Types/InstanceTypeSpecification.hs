...
data InstanceTypeSpecification = InstanceTypeSpecification'
  { -- | The EC2 instance type, for example @m3.xlarge@.
    ...
    weightedCapacity :: Prelude.Maybe Prelude.Nat
  }
...
instanceTypeSpecification_weightedCapacity = Lens.lens (\InstanceTypeSpecification' {weightedCapacity} -> weightedCapacity) (\s@InstanceTypeSpecification' {} a -> s {weightedCapacity = a} :: InstanceTypeSpecification) Prelude.. Lens.mapping Prelude._Nat
