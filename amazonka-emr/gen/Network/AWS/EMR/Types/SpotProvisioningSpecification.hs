...
data SpotProvisioningSpecification = SpotProvisioningSpecification'
  { -- | The defined duration for Spot Instances (also known as Spot blocks) in
    ...
    blockDurationMinutes :: Prelude.Maybe Prelude.Nat,
    ...
    timeoutDurationMinutes :: Prelude.Nat,
...
spotProvisioningSpecification_blockDurationMinutes = Lens.lens (\SpotProvisioningSpecification' {blockDurationMinutes} -> blockDurationMinutes) (\s@SpotProvisioningSpecification' {} a -> s {blockDurationMinutes = a} :: SpotProvisioningSpecification) Prelude.. Lens.mapping Prelude._Nat
...
spotProvisioningSpecification_timeoutDurationMinutes = Lens.lens (\SpotProvisioningSpecification' {timeoutDurationMinutes} -> timeoutDurationMinutes) (\s@SpotProvisioningSpecification' {} a -> s {timeoutDurationMinutes = a} :: SpotProvisioningSpecification) Prelude.. Prelude._Nat
