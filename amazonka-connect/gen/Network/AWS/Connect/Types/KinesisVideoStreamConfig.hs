...
data KinesisVideoStreamConfig = KinesisVideoStreamConfig'
  { -- | The prefix of the video stream.
    ...
    -- data.
    retentionPeriodHours :: Prelude.Nat,
...
newKinesisVideoStreamConfig
  ...
  pEncryptionConfig_ =
    KinesisVideoStreamConfig'
      { prefix = pPrefix_,
        retentionPeriodHours =
          Prelude._Nat Lens.# pRetentionPeriodHours_,
...
kinesisVideoStreamConfig_retentionPeriodHours = Lens.lens (\KinesisVideoStreamConfig' {retentionPeriodHours} -> retentionPeriodHours) (\s@KinesisVideoStreamConfig' {} a -> s {retentionPeriodHours = a} :: KinesisVideoStreamConfig) Prelude.. Prelude._Nat
