...
--
-- * 'lbLexRegion' - The Region that the Amazon Lex bot was created in.
lexBot ::
  LexBot
lexBot =
  LexBot' {_lbName = Nothing, _lbLexRegion = Nothing}
