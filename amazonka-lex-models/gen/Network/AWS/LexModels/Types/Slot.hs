...
slot_priority = Lens.lens (\Slot' {priority} -> priority) (\s@Slot' {} a -> s {priority = a} :: Slot) Prelude.. Lens.mapping Prelude._Nat
...
slot_sampleUtterances = Lens.lens (\Slot' {sampleUtterances} -> sampleUtterances) (\s@Slot' {} a -> s {sampleUtterances = a} :: Slot) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.FromJSON Slot where
  parseJSON =
    Prelude.withObject
      "Slot"
      ( \x ->
          Slot'
            ...
            Prelude.<*> (x Prelude..:? "valueElicitationPrompt")
            Prelude.<*> (x Prelude..:? "slotType")
            Prelude.<*> (x Prelude..:? "slotTypeVersion")
            Prelude.<*> (x Prelude..:? "priority")
            Prelude.<*> ( x Prelude..:? "sampleUtterances"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "description")
            Prelude.<*> (x Prelude..:? "defaultValueSpec")
            Prelude.<*> (x Prelude..:? "obfuscationSetting")
            Prelude.<*> (x Prelude..: "name")
            Prelude.<*> (x Prelude..: "slotConstraint")
      )
