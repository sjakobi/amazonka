...
data ListResourceRecordSets = ListResourceRecordSets'
  { -- | /Resource record sets that have a routing policy other than simple:/ If
    ...
    -- @InvalidInput@ error.
    startRecordType :: Prelude.Maybe RecordType,
...
-- Constraint: Specifying @type@ without specifying @name@ returns an
-- @InvalidInput@ error.
listResourceRecordSets_startRecordType :: Lens.Lens' ListResourceRecordSets (Prelude.Maybe RecordType)
...
data ListResourceRecordSetsResponse = ListResourceRecordSetsResponse'
  { -- | If the results were truncated, the type of the next record in the list.
    ...
    nextRecordType :: Prelude.Maybe RecordType,
    -- | /Resource record sets that have a routing policy other than simple:/ If
...
--
-- This element is present only if @IsTruncated@ is true.
listResourceRecordSetsResponse_nextRecordType :: Lens.Lens' ListResourceRecordSetsResponse (Prelude.Maybe RecordType)
