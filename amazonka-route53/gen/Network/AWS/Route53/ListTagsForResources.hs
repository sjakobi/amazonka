...
newListTagsForResources pResourceType_ pResourceIds_ =
  ListTagsForResources'
    { resourceType =
        pResourceType_,
      resourceIds = Prelude._List1 Lens.# pResourceIds_
    }
...
listTagsForResources_resourceIds = Lens.lens (\ListTagsForResources' {resourceIds} -> resourceIds) (\s@ListTagsForResources' {} a -> s {resourceIds = a} :: ListTagsForResources) Prelude.. Prelude._List1
