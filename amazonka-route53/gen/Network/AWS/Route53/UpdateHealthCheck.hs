...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uhcrrsResponseStatus' - -- | The response status code.
--
-- * 'uhcrrsHealthCheck' - A complex type that contains the response to an @UpdateHealthCheck@ request.
updateHealthCheckResponse ::
  -- | 'uhcrrsResponseStatus'
  Int ->
  -- | 'uhcrrsHealthCheck'
...
updateHealthCheckResponse
  ...
  pHealthCheck_ =
    UpdateHealthCheckResponse'
      { _uhcrrsResponseStatus =
          pResponseStatus_,
        _uhcrrsHealthCheck = pHealthCheck_
      }

-- | -- | The response status code.
uhcrrsResponseStatus :: Lens' UpdateHealthCheckResponse Int
uhcrrsResponseStatus = lens _uhcrrsResponseStatus (\s a -> s {_uhcrrsResponseStatus = a})

-- | A complex type that contains the response to an @UpdateHealthCheck@ request.
uhcrrsHealthCheck :: Lens' UpdateHealthCheckResponse HealthCheck
uhcrrsHealthCheck = lens _uhcrrsHealthCheck (\s a -> s {_uhcrrsHealthCheck = a})
