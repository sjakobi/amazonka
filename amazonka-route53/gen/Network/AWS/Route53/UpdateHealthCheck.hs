...
data UpdateHealthCheck = UpdateHealthCheck'
  { -- | The number of consecutive health checks that an endpoint must pass or
    ...
    healthCheckVersion :: Prelude.Maybe Prelude.Nat,
...
updateHealthCheck_failureThreshold = Lens.lens (\UpdateHealthCheck' {failureThreshold} -> failureThreshold) (\s@UpdateHealthCheck' {} a -> s {failureThreshold = a} :: UpdateHealthCheck) Prelude.. Lens.mapping Prelude._Nat
...
updateHealthCheck_port = Lens.lens (\UpdateHealthCheck' {port} -> port) (\s@UpdateHealthCheck' {} a -> s {port = a} :: UpdateHealthCheck) Prelude.. Lens.mapping Prelude._Nat
...
updateHealthCheck_healthThreshold = Lens.lens (\UpdateHealthCheck' {healthThreshold} -> healthThreshold) (\s@UpdateHealthCheck' {} a -> s {healthThreshold = a} :: UpdateHealthCheck) Prelude.. Lens.mapping Prelude._Nat

-- | A complex type that contains one @Region@ element for each region that
-- you want Amazon Route 53 health checkers to check the specified endpoint
-- from.
updateHealthCheck_regions :: Lens.Lens' UpdateHealthCheck (Prelude.Maybe (Prelude.NonEmpty HealthCheckRegion))
updateHealthCheck_regions = Lens.lens (\UpdateHealthCheck' {regions} -> regions) (\s@UpdateHealthCheck' {} a -> s {regions = a} :: UpdateHealthCheck) Prelude.. Lens.mapping Prelude._List1
...
updateHealthCheck_healthCheckVersion = Lens.lens (\UpdateHealthCheck' {healthCheckVersion} -> healthCheckVersion) (\s@UpdateHealthCheck' {} a -> s {healthCheckVersion = a} :: UpdateHealthCheck) Prelude.. Lens.mapping Prelude._Nat
