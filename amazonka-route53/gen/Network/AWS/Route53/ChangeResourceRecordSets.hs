...
--
-- * 'crrsrrsChangeInfo' - A complex type that contains information about changes made to your hosted zone. This element contains an ID that you use when performing a <https://docs.aws.amazon.com/Route53/latest/APIReference/API_GetChange.html GetChange> action to get detailed information about the change.
changeResourceRecordSetsResponse ::
  -- | 'crrsrrsResponseStatus'
  Int ->
  -- | 'crrsrrsChangeInfo'
...
changeResourceRecordSetsResponse
  ...
  pChangeInfo_ =
    ChangeResourceRecordSetsResponse'
      { _crrsrrsResponseStatus =
          pResponseStatus_,
        _crrsrrsChangeInfo = pChangeInfo_
      }

-- | -- | The response status code.
crrsrrsResponseStatus :: Lens' ChangeResourceRecordSetsResponse Int
...
crrsrrsChangeInfo :: Lens' ChangeResourceRecordSetsResponse ChangeInfo
crrsrrsChangeInfo = lens _crrsrrsChangeInfo (\s a -> s {_crrsrrsChangeInfo = a})
