...
data HealthCheckConfig = HealthCheckConfig'
  { -- | The number of consecutive health checks that an endpoint must pass or
    ...
    -- is @30@ seconds.
    requestInterval :: Prelude.Maybe Prelude.Nat,
    ...
    --     be healthy.
    healthThreshold :: Prelude.Maybe Prelude.Nat,
    ...
    -- regions).
    regions :: Prelude.Maybe (Prelude.List1 HealthCheckRegion),
    ...
    -- display CloudWatch latency graphs on the __Health Checks__ page in the
    -- Route 53 console.
    --
...
healthCheckConfig_failureThreshold = Lens.lens (\HealthCheckConfig' {failureThreshold} -> failureThreshold) (\s@HealthCheckConfig' {} a -> s {failureThreshold = a} :: HealthCheckConfig) Prelude.. Lens.mapping Prelude._Nat
...
healthCheckConfig_childHealthChecks = Lens.lens (\HealthCheckConfig' {childHealthChecks} -> childHealthChecks) (\s@HealthCheckConfig' {} a -> s {childHealthChecks = a} :: HealthCheckConfig) Prelude.. Lens.mapping Prelude._Coerce
...
healthCheckConfig_port = Lens.lens (\HealthCheckConfig' {port} -> port) (\s@HealthCheckConfig' {} a -> s {port = a} :: HealthCheckConfig) Prelude.. Lens.mapping Prelude._Nat
...
healthCheckConfig_requestInterval = Lens.lens (\HealthCheckConfig' {requestInterval} -> requestInterval) (\s@HealthCheckConfig' {} a -> s {requestInterval = a} :: HealthCheckConfig) Prelude.. Lens.mapping Prelude._Nat
...
healthCheckConfig_healthThreshold = Lens.lens (\HealthCheckConfig' {healthThreshold} -> healthThreshold) (\s@HealthCheckConfig' {} a -> s {healthThreshold = a} :: HealthCheckConfig) Prelude.. Lens.mapping Prelude._Nat
...
healthCheckConfig_regions = Lens.lens (\HealthCheckConfig' {regions} -> regions) (\s@HealthCheckConfig' {} a -> s {regions = a} :: HealthCheckConfig) Prelude.. Lens.mapping Prelude._List1
...
instance Prelude.FromXML HealthCheckConfig where
  parseXML x =
    HealthCheckConfig'
      Prelude.<$> (x Prelude..@? "FailureThreshold")
      Prelude.<*> (x Prelude..@? "SearchString")
      Prelude.<*> ( x Prelude..@? "ChildHealthChecks"
                      Prelude..!@ Prelude.mempty
                      Prelude.>>= Prelude.may
                        (Prelude.parseXMLList "ChildHealthCheck")
                  )
      Prelude.<*> (x Prelude..@? "Disabled")
      Prelude.<*> (x Prelude..@? "AlarmIdentifier")
      Prelude.<*> (x Prelude..@? "EnableSNI")
      Prelude.<*> (x Prelude..@? "InsufficientDataHealthStatus")
      Prelude.<*> (x Prelude..@? "IPAddress")
      Prelude.<*> (x Prelude..@? "ResourcePath")
      Prelude.<*> (x Prelude..@? "Port")
      Prelude.<*> (x Prelude..@? "RequestInterval")
      Prelude.<*> (x Prelude..@? "HealthThreshold")
      Prelude.<*> ( x Prelude..@? "Regions" Prelude..!@ Prelude.mempty
                      Prelude.>>= Prelude.may (Prelude.parseXMLList1 "Region")
                  )
      Prelude.<*> (x Prelude..@? "FullyQualifiedDomainName")
      Prelude.<*> (x Prelude..@? "Inverted")
      Prelude.<*> (x Prelude..@? "MeasureLatency")
...
instance Prelude.ToXML HealthCheckConfig where
  toXML HealthCheckConfig' {..} =
    Prelude.mconcat
      [ "FailureThreshold" Prelude.@= failureThreshold,
        ...
        "Port" Prelude.@= port,
        "RequestInterval" Prelude.@= requestInterval,
        ...
        "MeasureLatency" Prelude.@= measureLatency,
        "Type" Prelude.@= type'
      ]
