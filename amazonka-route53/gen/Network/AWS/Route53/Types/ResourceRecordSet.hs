...
data ResourceRecordSet = ResourceRecordSet'
  { -- | If you want Amazon Route 53 to return this resource record set in
    ...
    -- @ResourceRecords@.
    resourceRecords :: Prelude.Maybe (Prelude.List1 ResourceRecord),
    ...
    --
    -- -   <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-private-hosted-zones.html Configuring Failover in a Private Hosted Zone>
    failover :: Prelude.Maybe Failover,
...
resourceRecordSet_weight = Lens.lens (\ResourceRecordSet' {weight} -> weight) (\s@ResourceRecordSet' {} a -> s {weight = a} :: ResourceRecordSet) Prelude.. Lens.mapping Prelude._Nat
...
resourceRecordSet_resourceRecords = Lens.lens (\ResourceRecordSet' {resourceRecords} -> resourceRecords) (\s@ResourceRecordSet' {} a -> s {resourceRecords = a} :: ResourceRecordSet) Prelude.. Lens.mapping Prelude._List1
...
--
-- -   <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-private-hosted-zones.html Configuring Failover in a Private Hosted Zone>
resourceRecordSet_failover :: Lens.Lens' ResourceRecordSet (Prelude.Maybe Failover)
...
resourceRecordSet_tTL = Lens.lens (\ResourceRecordSet' {tTL} -> tTL) (\s@ResourceRecordSet' {} a -> s {tTL = a} :: ResourceRecordSet) Prelude.. Lens.mapping Prelude._Nat
...
--     same values for the @Name@ and @Type@ elements as latency resource
--     record sets.
resourceRecordSet_region :: Lens.Lens' ResourceRecordSet (Prelude.Maybe Region)
...
--     traffic to, and creating a CNAME record for the zone apex isn\'t
--     supported even for an alias record.
resourceRecordSet_type :: Lens.Lens' ResourceRecordSet RecordType
