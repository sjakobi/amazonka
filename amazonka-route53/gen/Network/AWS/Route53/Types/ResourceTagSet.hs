...
resourceTagSet_tags = Lens.lens (\ResourceTagSet' {tags} -> tags) (\s@ResourceTagSet' {} a -> s {tags = a} :: ResourceTagSet) Prelude.. Lens.mapping Prelude._List1

instance Prelude.FromXML ResourceTagSet where
  parseXML x =
    ResourceTagSet'
      Prelude.<$> (x Prelude..@? "ResourceId")
      Prelude.<*> (x Prelude..@? "ResourceType")
      Prelude.<*> ( x Prelude..@? "Tags" Prelude..!@ Prelude.mempty
                      Prelude.>>= Prelude.may (Prelude.parseXMLList1 "Tag")
                  )
