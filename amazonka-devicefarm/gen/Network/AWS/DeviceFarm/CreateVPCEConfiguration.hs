...
module Network.AWS.DeviceFarm.CreateVPCEConfiguration
  ( -- * Creating a Request
    ...
    -- * Response Lenses
    cvecrrsVpceConfiguration,
    cvecrrsResponseStatus,
  )
where
...
data CreateVPCEConfigurationResponse = CreateVPCEConfigurationResponse'
  { _cvecrrsVpceConfiguration ::
      !( Maybe
           VPCEConfiguration
       ),
    _cvecrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cvecrrsVpceConfiguration' - An object that contains information about your VPC endpoint configuration.
--
-- * 'cvecrrsResponseStatus' - -- | The response status code.
createVPCEConfigurationResponse ::
  -- | 'cvecrrsResponseStatus'
  Int ->
  CreateVPCEConfigurationResponse
createVPCEConfigurationResponse pResponseStatus_ =
  CreateVPCEConfigurationResponse'
    { _cvecrrsVpceConfiguration =
        Nothing,
      _cvecrrsResponseStatus = pResponseStatus_
    }

-- | An object that contains information about your VPC endpoint configuration.
cvecrrsVpceConfiguration :: Lens' CreateVPCEConfigurationResponse (Maybe VPCEConfiguration)
cvecrrsVpceConfiguration = lens _cvecrrsVpceConfiguration (\s a -> s {_cvecrrsVpceConfiguration = a})

-- | -- | The response status code.
cvecrrsResponseStatus :: Lens' CreateVPCEConfigurationResponse Int
cvecrrsResponseStatus = lens _cvecrrsResponseStatus (\s a -> s {_cvecrrsResponseStatus = a})
