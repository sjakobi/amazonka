...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uiprrsInstanceProfile' - An object that contains information about your instance profile.
--
...
updateInstanceProfileResponse pResponseStatus_ =
  UpdateInstanceProfileResponse'
    { _uiprrsInstanceProfile =
        Nothing,
      _uiprrsResponseStatus = pResponseStatus_
    }

-- | An object that contains information about your instance profile.
uiprrsInstanceProfile :: Lens' UpdateInstanceProfileResponse (Maybe InstanceProfile)
uiprrsInstanceProfile = lens _uiprrsInstanceProfile (\s a -> s {_uiprrsInstanceProfile = a})

-- | -- | The response status code.
uiprrsResponseStatus :: Lens' UpdateInstanceProfileResponse Int
