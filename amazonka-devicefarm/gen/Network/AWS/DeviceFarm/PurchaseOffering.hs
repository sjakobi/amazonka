...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'porrsOfferingTransaction' - Represents the offering transaction for the purchase result.
--
...
porrsOfferingTransaction :: Lens' PurchaseOfferingResponse (Maybe OfferingTransaction)
porrsOfferingTransaction = lens _porrsOfferingTransaction (\s a -> s {_porrsOfferingTransaction = a})
