...
scheduleRunTest_parameters = Lens.lens (\ScheduleRunTest' {parameters} -> parameters) (\s@ScheduleRunTest' {} a -> s {parameters = a} :: ScheduleRunTest) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.ToJSON ScheduleRunTest where
  toJSON ScheduleRunTest' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("testPackageArn" Prelude..=)
              Prelude.<$> testPackageArn,
            ("testSpecArn" Prelude..=) Prelude.<$> testSpecArn,
