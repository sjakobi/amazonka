...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rorrsOfferingTransaction' - Represents the status of the offering transaction for the renewal.
--
...
rorrsOfferingTransaction :: Lens' RenewOfferingResponse (Maybe OfferingTransaction)
rorrsOfferingTransaction = lens _rorrsOfferingTransaction (\s a -> s {_rorrsOfferingTransaction = a})

-- | -- | The response status code.
rorrsResponseStatus :: Lens' RenewOfferingResponse Int
