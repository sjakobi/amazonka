...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'airrrsResponseStatus' - -- | The response status code.
authorizeIPRulesResponse ::
  -- | 'airrrsResponseStatus'
  Int ->
  AuthorizeIPRulesResponse
...
airrrsResponseStatus :: Lens' AuthorizeIPRulesResponse Int
airrrsResponseStatus = lens _airrrsResponseStatus (\s a -> s {_airrrsResponseStatus = a})
