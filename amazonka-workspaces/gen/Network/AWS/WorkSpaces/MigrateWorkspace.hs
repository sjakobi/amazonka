...
data MigrateWorkspaceResponse = MigrateWorkspaceResponse'
  { _mwrrsTargetWorkspaceId ::
      !(Maybe Text),
    _mwrrsSourceWorkspaceId ::
      !(Maybe Text),
    _mwrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mwrrsTargetWorkspaceId' - The new identifier of the WorkSpace that is being migrated. If the migration does not succeed, the target WorkSpace ID will not be used, and the WorkSpace will still have the original WorkSpace ID.
--
-- * 'mwrrsSourceWorkspaceId' - The original identifier of the WorkSpace that is being migrated.
--
-- * 'mwrrsResponseStatus' - -- | The response status code.
migrateWorkspaceResponse ::
  -- | 'mwrrsResponseStatus'
  Int ->
  MigrateWorkspaceResponse
migrateWorkspaceResponse pResponseStatus_ =
  MigrateWorkspaceResponse'
    { _mwrrsTargetWorkspaceId =
        Nothing,
      _mwrrsSourceWorkspaceId = Nothing,
      _mwrrsResponseStatus = pResponseStatus_
    }

-- | The new identifier of the WorkSpace that is being migrated. If the migration does not succeed, the target WorkSpace ID will not be used, and the WorkSpace will still have the original WorkSpace ID.
mwrrsTargetWorkspaceId :: Lens' MigrateWorkspaceResponse (Maybe Text)
mwrrsTargetWorkspaceId = lens _mwrrsTargetWorkspaceId (\s a -> s {_mwrrsTargetWorkspaceId = a})

-- | The original identifier of the WorkSpace that is being migrated.
mwrrsSourceWorkspaceId :: Lens' MigrateWorkspaceResponse (Maybe Text)
mwrrsSourceWorkspaceId = lens _mwrrsSourceWorkspaceId (\s a -> s {_mwrrsSourceWorkspaceId = a})

-- | -- | The response status code.
mwrrsResponseStatus :: Lens' MigrateWorkspaceResponse Int
mwrrsResponseStatus = lens _mwrrsResponseStatus (\s a -> s {_mwrrsResponseStatus = a})
