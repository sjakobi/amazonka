...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dipgrrsResponseStatus' - -- | The response status code.
deleteIPGroupResponse ::
  -- | 'dipgrrsResponseStatus'
  Int ->
  DeleteIPGroupResponse
...
dipgrrsResponseStatus :: Lens' DeleteIPGroupResponse Int
dipgrrsResponseStatus = lens _dipgrrsResponseStatus (\s a -> s {_dipgrrsResponseStatus = a})
