...
modifyClientProperties
  ...
  pClientProperties_ =
    ModifyClientProperties'
      { _mcpResourceId =
          pResourceId_,
        _mcpClientProperties = pClientProperties_
      }
...
instance Hashable ModifyClientProperties

instance NFData ModifyClientProperties
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mcprrsResponseStatus' - -- | The response status code.
modifyClientPropertiesResponse ::
  -- | 'mcprrsResponseStatus'
  Int ->
  ModifyClientPropertiesResponse
...
mcprrsResponseStatus :: Lens' ModifyClientPropertiesResponse Int
mcprrsResponseStatus = lens _mcprrsResponseStatus (\s a -> s {_mcprrsResponseStatus = a})

instance NFData ModifyClientPropertiesResponse
