...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rirrrsResponseStatus' - -- | The response status code.
revokeIPRulesResponse ::
  -- | 'rirrrsResponseStatus'
  Int ->
  RevokeIPRulesResponse
...
rirrrsResponseStatus :: Lens' RevokeIPRulesResponse Int
rirrrsResponseStatus = lens _rirrrsResponseStatus (\s a -> s {_rirrrsResponseStatus = a})
