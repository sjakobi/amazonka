...
instance Prelude.ToHeaders GetJourneyExecutionMetrics where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Prelude.ToPath GetJourneyExecutionMetrics where
...
instance Prelude.ToQuery GetJourneyExecutionMetrics where
