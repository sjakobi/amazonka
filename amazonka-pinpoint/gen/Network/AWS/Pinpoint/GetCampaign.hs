...
--
-- * 'gcrrsCampaignResponse' - Undocumented member.
getCampaignResponse ::
  -- | 'gcrrsResponseStatus'
  Int ->
  -- | 'gcrrsCampaignResponse'
...
getCampaignResponse
  ...
  pCampaignResponse_ =
    GetCampaignResponse'
      { _gcrrsResponseStatus =
          pResponseStatus_,
        _gcrrsCampaignResponse = pCampaignResponse_
      }

-- | -- | The response status code.
gcrrsResponseStatus :: Lens' GetCampaignResponse Int
gcrrsResponseStatus = lens _gcrrsResponseStatus (\s a -> s {_gcrrsResponseStatus = a})

-- | Undocumented member.
gcrrsCampaignResponse :: Lens' GetCampaignResponse CampaignResponse
gcrrsCampaignResponse = lens _gcrrsCampaignResponse (\s a -> s {_gcrrsCampaignResponse = a})
