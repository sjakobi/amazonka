...
--
-- * 'ccrrsCampaignResponse' - Undocumented member.
createCampaignResponse ::
  -- | 'ccrrsResponseStatus'
  Int ->
  -- | 'ccrrsCampaignResponse'
...
createCampaignResponse
  ...
  pCampaignResponse_ =
    CreateCampaignResponse'
      { _ccrrsResponseStatus =
          pResponseStatus_,
        _ccrrsCampaignResponse = pCampaignResponse_
      }

-- | -- | The response status code.
ccrrsResponseStatus :: Lens' CreateCampaignResponse Int
ccrrsResponseStatus = lens _ccrrsResponseStatus (\s a -> s {_ccrrsResponseStatus = a})

-- | Undocumented member.
ccrrsCampaignResponse :: Lens' CreateCampaignResponse CampaignResponse
ccrrsCampaignResponse = lens _ccrrsCampaignResponse (\s a -> s {_ccrrsCampaignResponse = a})
