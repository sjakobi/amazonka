...
--
-- * 'rarrsAttributesResource' - Undocumented member.
removeAttributesResponse ::
  -- | 'rarrsResponseStatus'
  Int ->
  -- | 'rarrsAttributesResource'
...
removeAttributesResponse
  ...
  pAttributesResource_ =
    RemoveAttributesResponse'
      { _rarrsResponseStatus =
          pResponseStatus_,
        _rarrsAttributesResource = pAttributesResource_
      }

-- | -- | The response status code.
rarrsResponseStatus :: Lens' RemoveAttributesResponse Int
rarrsResponseStatus = lens _rarrsResponseStatus (\s a -> s {_rarrsResponseStatus = a})

-- | Undocumented member.
rarrsAttributesResource :: Lens' RemoveAttributesResponse AttributesResource
rarrsAttributesResource = lens _rarrsAttributesResource (\s a -> s {_rarrsAttributesResource = a})
