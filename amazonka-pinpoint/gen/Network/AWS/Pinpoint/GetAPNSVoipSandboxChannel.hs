...
data GetAPNSVoipSandboxChannelResponse = GetAPNSVoipSandboxChannelResponse'
  { _gavscrrsResponseStatus ::
      !Int,
    _gavscrrsAPNSVoipSandboxChannelResponse ::
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gavscrrsResponseStatus' - -- | The response status code.
--
-- * 'gavscrrsAPNSVoipSandboxChannelResponse' - Undocumented member.
getAPNSVoipSandboxChannelResponse ::
  -- | 'gavscrrsResponseStatus'
  Int ->
  -- | 'gavscrrsAPNSVoipSandboxChannelResponse'
...
gavscrrsResponseStatus :: Lens' GetAPNSVoipSandboxChannelResponse Int
gavscrrsResponseStatus = lens _gavscrrsResponseStatus (\s a -> s {_gavscrrsResponseStatus = a})

-- | Undocumented member.
gavscrrsAPNSVoipSandboxChannelResponse :: Lens' GetAPNSVoipSandboxChannelResponse APNSVoipSandboxChannelResponse
gavscrrsAPNSVoipSandboxChannelResponse = lens _gavscrrsAPNSVoipSandboxChannelResponse (\s a -> s {_gavscrrsAPNSVoipSandboxChannelResponse = a})
