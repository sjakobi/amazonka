...
data DeleteAPNSVoipSandboxChannelResponse = DeleteAPNSVoipSandboxChannelResponse'
  { _davscrrsResponseStatus ::
      !Int,
    _davscrrsAPNSVoipSandboxChannelResponse ::
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'davscrrsResponseStatus' - -- | The response status code.
--
-- * 'davscrrsAPNSVoipSandboxChannelResponse' - Undocumented member.
deleteAPNSVoipSandboxChannelResponse ::
  -- | 'davscrrsResponseStatus'
  Int ->
  -- | 'davscrrsAPNSVoipSandboxChannelResponse'
...
davscrrsResponseStatus :: Lens' DeleteAPNSVoipSandboxChannelResponse Int
davscrrsResponseStatus = lens _davscrrsResponseStatus (\s a -> s {_davscrrsResponseStatus = a})

-- | Undocumented member.
davscrrsAPNSVoipSandboxChannelResponse :: Lens' DeleteAPNSVoipSandboxChannelResponse APNSVoipSandboxChannelResponse
davscrrsAPNSVoipSandboxChannelResponse = lens _davscrrsAPNSVoipSandboxChannelResponse (\s a -> s {_davscrrsAPNSVoipSandboxChannelResponse = a})
