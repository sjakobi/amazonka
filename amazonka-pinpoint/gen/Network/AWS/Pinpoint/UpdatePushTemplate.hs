...
instance ToPath UpdatePushTemplate where
  toPath UpdatePushTemplate' {..} =
    mconcat
      ["/v1/templates/", toBS _uptTemplateName, "/push"]
...
--
-- * 'uptrrsMessageBody' - Undocumented member.
updatePushTemplateResponse ::
  -- | 'uptrrsResponseStatus'
  Int ->
  -- | 'uptrrsMessageBody'
...
updatePushTemplateResponse
  ...
  pMessageBody_ =
    UpdatePushTemplateResponse'
      { _uptrrsResponseStatus =
          pResponseStatus_,
        _uptrrsMessageBody = pMessageBody_
      }

-- | -- | The response status code.
uptrrsResponseStatus :: Lens' UpdatePushTemplateResponse Int
uptrrsResponseStatus = lens _uptrrsResponseStatus (\s a -> s {_uptrrsResponseStatus = a})

-- | Undocumented member.
uptrrsMessageBody :: Lens' UpdatePushTemplateResponse MessageBody
uptrrsMessageBody = lens _uptrrsMessageBody (\s a -> s {_uptrrsMessageBody = a})
