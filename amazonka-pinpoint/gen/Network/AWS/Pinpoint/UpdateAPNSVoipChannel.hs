...
data UpdateAPNSVoipChannelResponse = UpdateAPNSVoipChannelResponse'
  { _uavcrrsResponseStatus ::
      !Int,
    _uavcrrsAPNSVoipChannelResponse ::
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uavcrrsResponseStatus' - -- | The response status code.
--
-- * 'uavcrrsAPNSVoipChannelResponse' - Undocumented member.
updateAPNSVoipChannelResponse ::
  -- | 'uavcrrsResponseStatus'
  Int ->
  -- | 'uavcrrsAPNSVoipChannelResponse'
...
uavcrrsResponseStatus :: Lens' UpdateAPNSVoipChannelResponse Int
uavcrrsResponseStatus = lens _uavcrrsResponseStatus (\s a -> s {_uavcrrsResponseStatus = a})

-- | Undocumented member.
uavcrrsAPNSVoipChannelResponse :: Lens' UpdateAPNSVoipChannelResponse APNSVoipChannelResponse
uavcrrsAPNSVoipChannelResponse = lens _uavcrrsAPNSVoipChannelResponse (\s a -> s {_uavcrrsAPNSVoipChannelResponse = a})
