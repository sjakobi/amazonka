...
instance ToPath DeletePushTemplate where
  toPath DeletePushTemplate' {..} =
    mconcat
      ["/v1/templates/", toBS _dptTemplateName, "/push"]
...
--
-- * 'dptrrsMessageBody' - Undocumented member.
deletePushTemplateResponse ::
  -- | 'dptrrsResponseStatus'
  Int ->
  -- | 'dptrrsMessageBody'
...
deletePushTemplateResponse
  ...
  pMessageBody_ =
    DeletePushTemplateResponse'
      { _dptrrsResponseStatus =
          pResponseStatus_,
        _dptrrsMessageBody = pMessageBody_
      }

-- | -- | The response status code.
dptrrsResponseStatus :: Lens' DeletePushTemplateResponse Int
dptrrsResponseStatus = lens _dptrrsResponseStatus (\s a -> s {_dptrrsResponseStatus = a})

-- | Undocumented member.
dptrrsMessageBody :: Lens' DeletePushTemplateResponse MessageBody
dptrrsMessageBody = lens _dptrrsMessageBody (\s a -> s {_dptrrsMessageBody = a})
