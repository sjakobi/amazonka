...
instance ToJSON UpdateJourney where
  toJSON UpdateJourney' {..} =
    object
      ( catMaybes
          [ Just
              ("WriteJourneyRequest" .= _ujWriteJourneyRequest)
          ]
      )
...
--
-- * 'ujrrsJourneyResponse' - Undocumented member.
updateJourneyResponse ::
  -- | 'ujrrsResponseStatus'
  Int ->
  -- | 'ujrrsJourneyResponse'
...
updateJourneyResponse
  ...
  pJourneyResponse_ =
    UpdateJourneyResponse'
      { _ujrrsResponseStatus =
          pResponseStatus_,
        _ujrrsJourneyResponse = pJourneyResponse_
      }

-- | -- | The response status code.
ujrrsResponseStatus :: Lens' UpdateJourneyResponse Int
ujrrsResponseStatus = lens _ujrrsResponseStatus (\s a -> s {_ujrrsResponseStatus = a})

-- | Undocumented member.
ujrrsJourneyResponse :: Lens' UpdateJourneyResponse JourneyResponse
ujrrsJourneyResponse = lens _ujrrsJourneyResponse (\s a -> s {_ujrrsJourneyResponse = a})
