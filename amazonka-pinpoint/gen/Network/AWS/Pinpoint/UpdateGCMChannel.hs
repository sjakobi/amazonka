...
data UpdateGCMChannelResponse = UpdateGCMChannelResponse'
  { _ugcrrsResponseStatus ::
      !Int,
    _ugcrrsGCMChannelResponse ::
      !GCMChannelResponse
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ugcrrsResponseStatus' - -- | The response status code.
--
-- * 'ugcrrsGCMChannelResponse' - Undocumented member.
updateGCMChannelResponse ::
  -- | 'ugcrrsResponseStatus'
  Int ->
  -- | 'ugcrrsGCMChannelResponse'
...
updateGCMChannelResponse
  ...
  pGCMChannelResponse_ =
    UpdateGCMChannelResponse'
      { _ugcrrsResponseStatus =
          pResponseStatus_,
        _ugcrrsGCMChannelResponse = pGCMChannelResponse_
      }

-- | -- | The response status code.
ugcrrsResponseStatus :: Lens' UpdateGCMChannelResponse Int
ugcrrsResponseStatus = lens _ugcrrsResponseStatus (\s a -> s {_ugcrrsResponseStatus = a})

-- | Undocumented member.
ugcrrsGCMChannelResponse :: Lens' UpdateGCMChannelResponse GCMChannelResponse
ugcrrsGCMChannelResponse = lens _ugcrrsGCMChannelResponse (\s a -> s {_ugcrrsGCMChannelResponse = a})
