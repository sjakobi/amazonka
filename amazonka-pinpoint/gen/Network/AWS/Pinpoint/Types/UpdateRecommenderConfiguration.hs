...
updateRecommenderConfiguration_attributes = Lens.lens (\UpdateRecommenderConfiguration' {attributes} -> attributes) (\s@UpdateRecommenderConfiguration' {} a -> s {attributes = a} :: UpdateRecommenderConfiguration) Prelude.. Lens.mapping Prelude._Map
...
instance
  ...
  toJSON UpdateRecommenderConfiguration' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("RecommendationsDisplayName" Prelude..=)
              Prelude.<$> recommendationsDisplayName,
            ("RecommendationTransformerUri" Prelude..=)
              Prelude.<$> recommendationTransformerUri,
            ("Attributes" Prelude..=) Prelude.<$> attributes,
            ("Name" Prelude..=) Prelude.<$> name,
            ("RecommendationsPerMessage" Prelude..=)
              Prelude.<$> recommendationsPerMessage,
            ("Description" Prelude..=) Prelude.<$> description,
            ("RecommendationProviderIdType" Prelude..=)
              Prelude.<$> recommendationProviderIdType,
            Prelude.Just
              ( "RecommendationProviderUri"
                  Prelude..= recommendationProviderUri
              ),
            Prelude.Just
              ( "RecommendationProviderRoleArn"
                  Prelude..= recommendationProviderRoleArn
              )
          ]
      )
