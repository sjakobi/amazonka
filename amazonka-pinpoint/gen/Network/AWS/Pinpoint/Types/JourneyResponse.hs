...
data JourneyResponse = JourneyResponse'
  { -- | The date, in ISO 8601 format, when the journey was last modified.
    ...
    -- the activity.
    activities :: Prelude.Maybe (Prelude.Map Prelude.Text Activity),
...
journeyResponse_activities = Lens.lens (\JourneyResponse' {activities} -> activities) (\s@JourneyResponse' {} a -> s {activities = a} :: JourneyResponse) Prelude.. Lens.mapping Prelude._Map
...
journeyResponse_tags = Lens.lens (\JourneyResponse' {tags} -> tags) (\s@JourneyResponse' {} a -> s {tags = a} :: JourneyResponse) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.FromJSON JourneyResponse where
  parseJSON =
    Prelude.withObject
      "JourneyResponse"
      ( \x ->
          JourneyResponse'
            ...
            Prelude.<*> (x Prelude..:? "RefreshFrequency")
            Prelude.<*> (x Prelude..:? "Limits")
            Prelude.<*> (x Prelude..:? "StartCondition")
            Prelude.<*> (x Prelude..:? "LocalTime")
            Prelude.<*> (x Prelude..:? "StartActivity")
