...
sMSTemplateResponse_tags = Lens.lens (\SMSTemplateResponse' {tags} -> tags) (\s@SMSTemplateResponse' {} a -> s {tags = a} :: SMSTemplateResponse) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.FromJSON SMSTemplateResponse where
  parseJSON =
    Prelude.withObject
      "SMSTemplateResponse"
      ( \x ->
