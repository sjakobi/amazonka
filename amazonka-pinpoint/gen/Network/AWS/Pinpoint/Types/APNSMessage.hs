...
aPNSMessage_data = Lens.lens (\APNSMessage' {data'} -> data') (\s@APNSMessage' {} a -> s {data' = a} :: APNSMessage) Prelude.. Lens.mapping Prelude._Map
...
aPNSMessage_substitutions = Lens.lens (\APNSMessage' {substitutions} -> substitutions) (\s@APNSMessage' {} a -> s {substitutions = a} :: APNSMessage) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.ToJSON APNSMessage where
  toJSON APNSMessage' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("SilentPush" Prelude..=) Prelude.<$> silentPush,
            ("CollapseId" Prelude..=) Prelude.<$> collapseId,
            ...
            ("APNSPushType" Prelude..=) Prelude.<$> aPNSPushType,
            ("PreferredAuthenticationMethod" Prelude..=)
