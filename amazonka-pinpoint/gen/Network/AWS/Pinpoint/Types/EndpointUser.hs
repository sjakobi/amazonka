...
data EndpointUser = EndpointUser'
  { -- | The unique identifier for the user.
    ...
    userAttributes :: Prelude.Maybe (Prelude.Map Prelude.Text [Prelude.Text])
  }
...
endpointUser_userAttributes = Lens.lens (\EndpointUser' {userAttributes} -> userAttributes) (\s@EndpointUser' {} a -> s {userAttributes = a} :: EndpointUser) Prelude.. Lens.mapping Prelude._Map
