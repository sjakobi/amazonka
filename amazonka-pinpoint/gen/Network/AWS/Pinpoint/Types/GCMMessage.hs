...
gCMMessage_data = Lens.lens (\GCMMessage' {data'} -> data') (\s@GCMMessage' {} a -> s {data' = a} :: GCMMessage) Prelude.. Lens.mapping Prelude._Map
...
gCMMessage_substitutions = Lens.lens (\GCMMessage' {substitutions} -> substitutions) (\s@GCMMessage' {} a -> s {substitutions = a} :: GCMMessage) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.ToJSON GCMMessage where
  toJSON GCMMessage' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("SilentPush" Prelude..=) Prelude.<$> silentPush,
            ("ImageIconUrl" Prelude..=) Prelude.<$> imageIconUrl,
            ("CollapseKey" Prelude..=) Prelude.<$> collapseKey,
