...
data UpdateSmsTemplate = UpdateSmsTemplate'
  { _ustVersion ::
      !(Maybe Text),
    _ustCreateNewVersion ::
      !(Maybe Bool),
    _ustTemplateName :: !Text,
    _ustSMSTemplateRequest ::
      !SMSTemplateRequest
  }
...
instance ToJSON UpdateSmsTemplate where
  toJSON UpdateSmsTemplate' {..} =
    object
      ( catMaybes
          [ Just
              ("SMSTemplateRequest" .= _ustSMSTemplateRequest)
          ]
      )
...
instance ToPath UpdateSmsTemplate where
  toPath UpdateSmsTemplate' {..} =
    mconcat
      ["/v1/templates/", toBS _ustTemplateName, "/sms"]
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ustrrsResponseStatus' - -- | The response status code.
--
-- * 'ustrrsMessageBody' - Undocumented member.
updateSmsTemplateResponse ::
  -- | 'ustrrsResponseStatus'
  Int ->
  -- | 'ustrrsMessageBody'
...
updateSmsTemplateResponse
  ...
  pMessageBody_ =
    UpdateSmsTemplateResponse'
      { _ustrrsResponseStatus =
          pResponseStatus_,
        _ustrrsMessageBody = pMessageBody_
      }

-- | -- | The response status code.
ustrrsResponseStatus :: Lens' UpdateSmsTemplateResponse Int
ustrrsResponseStatus = lens _ustrrsResponseStatus (\s a -> s {_ustrrsResponseStatus = a})

-- | Undocumented member.
ustrrsMessageBody :: Lens' UpdateSmsTemplateResponse MessageBody
ustrrsMessageBody = lens _ustrrsMessageBody (\s a -> s {_ustrrsMessageBody = a})
