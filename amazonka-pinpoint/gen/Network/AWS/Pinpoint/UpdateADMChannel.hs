...
module Network.AWS.Pinpoint.UpdateADMChannel
  ( -- * Creating a Request
    ...
    -- * Response Lenses
    uadmcrrsResponseStatus,
    uadmcrrsADMChannelResponse,
  )
where
...
instance Hashable UpdateADMChannel

instance NFData UpdateADMChannel
...
data UpdateADMChannelResponse = UpdateADMChannelResponse'
  { _uadmcrrsResponseStatus ::
      !Int,
    _uadmcrrsADMChannelResponse ::
      !ADMChannelResponse
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uadmcrrsResponseStatus' - -- | The response status code.
--
-- * 'uadmcrrsADMChannelResponse' - Undocumented member.
updateADMChannelResponse ::
  -- | 'uadmcrrsResponseStatus'
  Int ->
  -- | 'uadmcrrsADMChannelResponse'
...
uadmcrrsResponseStatus :: Lens' UpdateADMChannelResponse Int
uadmcrrsResponseStatus = lens _uadmcrrsResponseStatus (\s a -> s {_uadmcrrsResponseStatus = a})

-- | Undocumented member.
uadmcrrsADMChannelResponse :: Lens' UpdateADMChannelResponse ADMChannelResponse
uadmcrrsADMChannelResponse = lens _uadmcrrsADMChannelResponse (\s a -> s {_uadmcrrsADMChannelResponse = a})

instance NFData UpdateADMChannelResponse
