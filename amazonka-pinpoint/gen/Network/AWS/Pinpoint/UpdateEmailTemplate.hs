...
data UpdateEmailTemplate = UpdateEmailTemplate'
  { _uetVersion ::
      !(Maybe Text),
    _uetCreateNewVersion ::
      !(Maybe Bool),
    _uetTemplateName :: !Text,
    _uetEmailTemplateRequest ::
...
instance ToPath UpdateEmailTemplate where
  toPath UpdateEmailTemplate' {..} =
    mconcat
      ["/v1/templates/", toBS _uetTemplateName, "/email"]
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uetrrsResponseStatus' - -- | The response status code.
--
-- * 'uetrrsMessageBody' - Undocumented member.
updateEmailTemplateResponse ::
  -- | 'uetrrsResponseStatus'
  Int ->
  -- | 'uetrrsMessageBody'
...
updateEmailTemplateResponse
  ...
  pMessageBody_ =
    UpdateEmailTemplateResponse'
      { _uetrrsResponseStatus =
          pResponseStatus_,
        _uetrrsMessageBody = pMessageBody_
      }

-- | -- | The response status code.
uetrrsResponseStatus :: Lens' UpdateEmailTemplateResponse Int
uetrrsResponseStatus = lens _uetrrsResponseStatus (\s a -> s {_uetrrsResponseStatus = a})

-- | Undocumented member.
uetrrsMessageBody :: Lens' UpdateEmailTemplateResponse MessageBody
uetrrsMessageBody = lens _uetrrsMessageBody (\s a -> s {_uetrrsMessageBody = a})
