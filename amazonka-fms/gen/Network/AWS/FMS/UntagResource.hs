...
--
-- * 'urResourceARN' - The Amazon Resource Name (ARN) of the resource to return tags for. The AWS Firewall Manager resources that support tagging are policies, applications lists, and protocols lists.
--
-- * 'urTagKeys' - The keys of the tags to remove from the resource.
untagResource ::
  -- | 'urResourceARN'
  Text ->
  UntagResource
...
instance ToHeaders UntagResource where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
              =# ("AWSFMS_20180101.UntagResource" :: ByteString),
            "Content-Type"
