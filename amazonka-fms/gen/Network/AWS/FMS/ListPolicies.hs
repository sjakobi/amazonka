...
instance AWSPager ListPolicies where
  page rq rs
    ...
    | stop (rs ^. lprrsPolicyList) = Nothing
    | otherwise =
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'lprrsNextToken' - If you have more @PolicySummary@ objects than the number that you specified for @MaxResults@ in the request, the response includes a @NextToken@ value. To list more @PolicySummary@ objects, submit another @ListPolicies@ request, and specify the @NextToken@ value from the response in the @NextToken@ value in the next request.
--
-- * 'lprrsPolicyList' - An array of @PolicySummary@ objects.
--
...
lprrsPolicyList :: Lens' ListPoliciesResponse [PolicySummary]
lprrsPolicyList = lens _lprrsPolicyList (\s a -> s {_lprrsPolicyList = a}) . _Default . _Coerce
