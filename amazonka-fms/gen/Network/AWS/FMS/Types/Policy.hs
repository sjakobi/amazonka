...
data Policy = Policy'
  { -- | An array of @ResourceTag@ objects.
    ...
    includeMap :: Prelude.Maybe (Prelude.Map CustomerPolicyScopeIdType [Prelude.Text]),
    ...
    --     comma. For example, the following is a valid map:
    --     @{“ACCOUNT” : [“accountID1”, “accountID2”], “ORG_UNIT” : [“ouid111”, “ouid112”]}@.
    excludeMap :: Prelude.Maybe (Prelude.Map CustomerPolicyScopeIdType [Prelude.Text]),
...
policy_resourceTags = Lens.lens (\Policy' {resourceTags} -> resourceTags) (\s@Policy' {} a -> s {resourceTags = a} :: Policy) Prelude.. Lens.mapping Prelude._Coerce

-- | An array of @ResourceType@.
policy_resourceTypeList :: Lens.Lens' Policy (Prelude.Maybe [Prelude.Text])
policy_resourceTypeList = Lens.lens (\Policy' {resourceTypeList} -> resourceTypeList) (\s@Policy' {} a -> s {resourceTypeList = a} :: Policy) Prelude.. Lens.mapping Prelude._Coerce
...
policy_includeMap = Lens.lens (\Policy' {includeMap} -> includeMap) (\s@Policy' {} a -> s {includeMap = a} :: Policy) Prelude.. Lens.mapping Prelude._Map
...
policy_excludeMap = Lens.lens (\Policy' {excludeMap} -> excludeMap) (\s@Policy' {} a -> s {excludeMap = a} :: Policy) Prelude.. Lens.mapping Prelude._Map
    ...
    Prelude.withObject
      ...
      ( \x ->
          Policy'
            ...
            Prelude.<*> ( x Prelude..:? "ResourceTypeList"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "PolicyUpdateToken")
            Prelude.<*> ( x Prelude..:? "IncludeMap"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "PolicyId")
            Prelude.<*> ( x Prelude..:? "ExcludeMap"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..: "PolicyName")
            Prelude.<*> (x Prelude..: "SecurityServicePolicyData")
            Prelude.<*> (x Prelude..: "ResourceType")
            Prelude.<*> (x Prelude..: "ExcludeResourceTags")
...
instance Prelude.ToJSON Policy where
  toJSON Policy' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("ResourceTags" Prelude..=)
              Prelude.<$> resourceTags,
            ("ResourceTypeList" Prelude..=)
              Prelude.<$> resourceTypeList,
            ("PolicyUpdateToken" Prelude..=)
              Prelude.<$> policyUpdateToken,
            ("IncludeMap" Prelude..=) Prelude.<$> includeMap,
            ("PolicyId" Prelude..=) Prelude.<$> policyId,
            ("ExcludeMap" Prelude..=) Prelude.<$> excludeMap,
            Prelude.Just ("PolicyName" Prelude..= policyName),
            Prelude.Just
              ( "SecurityServicePolicyData"
                  Prelude..= securityServicePolicyData
              ),
            Prelude.Just
              ("ResourceType" Prelude..= resourceType),
            Prelude.Just
              ( "ExcludeResourceTags"
                  Prelude..= excludeResourceTags
              ),
            Prelude.Just
              ( "RemediationEnabled"
                  Prelude..= remediationEnabled
              )
          ]
      )
