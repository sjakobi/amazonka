...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dnrrsOperationId' - A value that you can use to determine whether the request completed successfully. To get the status of the operation, see <https://docs.aws.amazon.com/cloud-map/latest/api/API_GetOperation.html GetOperation> .
--
...
dnrrsOperationId :: Lens' DeleteNamespaceResponse (Maybe Text)
dnrrsOperationId = lens _dnrrsOperationId (\s a -> s {_dnrrsOperationId = a})

-- | -- | The response status code.
dnrrsResponseStatus :: Lens' DeleteNamespaceResponse Int
