...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rirrsOperationId' - A value that you can use to determine whether the request completed successfully. To get the status of the operation, see <https://docs.aws.amazon.com/cloud-map/latest/api/API_GetOperation.html GetOperation> .
--
...
rirrsOperationId :: Lens' RegisterInstanceResponse (Maybe Text)
rirrsOperationId = lens _rirrsOperationId (\s a -> s {_rirrsOperationId = a})

-- | -- | The response status code.
rirrsResponseStatus :: Lens' RegisterInstanceResponse Int
