...
data Operation = Operation'
  { -- | The status of the operation. Values include the following:
    ...
    --     property.
    targets :: Prelude.Maybe (Prelude.Map OperationTargetType Prelude.Text),
...
operation_targets = Lens.lens (\Operation' {targets} -> targets) (\s@Operation' {} a -> s {targets = a} :: Operation) Prelude.. Lens.mapping Prelude._Map
