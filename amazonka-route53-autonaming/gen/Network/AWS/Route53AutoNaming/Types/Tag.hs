...
--
-- * 'tagValue' - The string value associated with the key of the tag. You can set the value of a tag to an empty string, but you can't set the value of a tag to null.
tag ::
  -- | 'tagKey'
  Text ->
  -- | 'tagValue'
