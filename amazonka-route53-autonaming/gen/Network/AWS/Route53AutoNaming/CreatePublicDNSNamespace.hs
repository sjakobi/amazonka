...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cpdnrrsOperationId' - A value that you can use to determine whether the request completed successfully. To get the status of the operation, see <https://docs.aws.amazon.com/cloud-map/latest/api/API_GetOperation.html GetOperation> .
--
-- * 'cpdnrrsResponseStatus' - -- | The response status code.
createPublicDNSNamespaceResponse ::
  -- | 'cpdnrrsResponseStatus'
  Int ->
  CreatePublicDNSNamespaceResponse
createPublicDNSNamespaceResponse pResponseStatus_ =
  CreatePublicDNSNamespaceResponse'
    { _cpdnrrsOperationId =
        Nothing,
      _cpdnrrsResponseStatus = pResponseStatus_
    }
...
cpdnrrsOperationId :: Lens' CreatePublicDNSNamespaceResponse (Maybe Text)
cpdnrrsOperationId = lens _cpdnrrsOperationId (\s a -> s {_cpdnrrsOperationId = a})

-- | -- | The response status code.
cpdnrrsResponseStatus :: Lens' CreatePublicDNSNamespaceResponse Int
cpdnrrsResponseStatus = lens _cpdnrrsResponseStatus (\s a -> s {_cpdnrrsResponseStatus = a})
