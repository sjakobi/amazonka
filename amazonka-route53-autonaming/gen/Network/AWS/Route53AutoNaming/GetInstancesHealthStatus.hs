...
data GetInstancesHealthStatus = GetInstancesHealthStatus'
  { -- | For the first @GetInstancesHealthStatus@ request, omit this value.
    ...
    -- request.
    instances :: Prelude.Maybe (Prelude.List1 Prelude.Text),
...
getInstancesHealthStatus_maxResults = Lens.lens (\GetInstancesHealthStatus' {maxResults} -> maxResults) (\s@GetInstancesHealthStatus' {} a -> s {maxResults = a} :: GetInstancesHealthStatus) Prelude.. Lens.mapping Prelude._Nat
...
getInstancesHealthStatus_instances = Lens.lens (\GetInstancesHealthStatus' {instances} -> instances) (\s@GetInstancesHealthStatus' {} a -> s {instances = a} :: GetInstancesHealthStatus) Prelude.. Lens.mapping Prelude._List1
...
data GetInstancesHealthStatusResponse = GetInstancesHealthStatusResponse'
  { -- | A complex type that contains the IDs and the health status of the
    ...
    status :: Prelude.Maybe (Prelude.Map Prelude.Text HealthStatus),
    -- | If more than @MaxResults@ instances match the specified criteria, you
    -- can submit another @GetInstancesHealthStatus@ request to get the next
    -- group of results. Specify the value of @NextToken@ from the previous
    -- response in the next request.
...
getInstancesHealthStatusResponse_status = Lens.lens (\GetInstancesHealthStatusResponse' {status} -> status) (\s@GetInstancesHealthStatusResponse' {} a -> s {status = a} :: GetInstancesHealthStatusResponse) Prelude.. Lens.mapping Prelude._Map
