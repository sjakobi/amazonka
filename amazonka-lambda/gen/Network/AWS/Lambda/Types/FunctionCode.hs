...
--
-- * 'fcImageURI' - URI of a container image in the Amazon ECR registry.
--
...
fcImageURI :: Lens' FunctionCode (Maybe Text)
fcImageURI = lens _fcImageURI (\s a -> s {_fcImageURI = a})
