...
data AccountLimit = AccountLimit'
  { -- | The maximum size of a function\'s deployment package and layers when
    ...
    unreservedConcurrentExecutions :: Prelude.Maybe Prelude.Nat,
...
accountLimit_unreservedConcurrentExecutions = Lens.lens (\AccountLimit' {unreservedConcurrentExecutions} -> unreservedConcurrentExecutions) (\s@AccountLimit' {} a -> s {unreservedConcurrentExecutions = a} :: AccountLimit) Prelude.. Lens.mapping Prelude._Nat
