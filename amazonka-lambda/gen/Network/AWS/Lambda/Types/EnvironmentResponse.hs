...
data EnvironmentResponse = EnvironmentResponse'
  { -- | Environment variable key-value pairs.
    variables :: Prelude.Maybe (Prelude.Sensitive (Prelude.Map Prelude.Text (Prelude.Sensitive Prelude.Text))),
...
environmentResponse_variables = Lens.lens (\EnvironmentResponse' {variables} -> variables) (\s@EnvironmentResponse' {} a -> s {variables = a} :: EnvironmentResponse) Prelude.. Lens.mapping (Prelude._Sensitive Prelude.. Prelude._Map)
