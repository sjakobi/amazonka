...
putFunctionEventInvokeConfig_maximumEventAgeInSeconds = Lens.lens (\PutFunctionEventInvokeConfig' {maximumEventAgeInSeconds} -> maximumEventAgeInSeconds) (\s@PutFunctionEventInvokeConfig' {} a -> s {maximumEventAgeInSeconds = a} :: PutFunctionEventInvokeConfig) Prelude.. Lens.mapping Prelude._Nat
...
putFunctionEventInvokeConfig_maximumRetryAttempts = Lens.lens (\PutFunctionEventInvokeConfig' {maximumRetryAttempts} -> maximumRetryAttempts) (\s@PutFunctionEventInvokeConfig' {} a -> s {maximumRetryAttempts = a} :: PutFunctionEventInvokeConfig) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.ToJSON PutFunctionEventInvokeConfig where
...
instance Prelude.ToPath PutFunctionEventInvokeConfig where
...
instance Prelude.ToQuery PutFunctionEventInvokeConfig where
