...
data PutFunctionConcurrency = PutFunctionConcurrency'
  { -- | The name of the Lambda function.
    ...
    reservedConcurrentExecutions :: Prelude.Nat
  }
  ...
  pReservedConcurrentExecutions_ =
    PutFunctionConcurrency'
      { functionName =
        ...
        reservedConcurrentExecutions =
          Prelude._Nat
            Lens.# pReservedConcurrentExecutions_
      }
...
putFunctionConcurrency_reservedConcurrentExecutions = Lens.lens (\PutFunctionConcurrency' {reservedConcurrentExecutions} -> reservedConcurrentExecutions) (\s@PutFunctionConcurrency' {} a -> s {reservedConcurrentExecutions = a} :: PutFunctionConcurrency) Prelude.. Prelude._Nat
