...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'csrrsSubscriptionARN' - The ARN of the created subscription.
--
...
csrrsSubscriptionARN :: Lens' ConfirmSubscriptionResponse (Maybe Text)
csrrsSubscriptionARN = lens _csrrsSubscriptionARN (\s a -> s {_csrrsSubscriptionARN = a})

-- | -- | The response status code.
csrrsResponseStatus :: Lens' ConfirmSubscriptionResponse Int
