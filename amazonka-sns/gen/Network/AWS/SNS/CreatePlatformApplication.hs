...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cparrsPlatformApplicationARN' - PlatformApplicationArn is returned.
--
...
createPlatformApplicationResponse pResponseStatus_ =
  CreatePlatformApplicationResponse'
    { _cparrsPlatformApplicationARN =
        Nothing,
      _cparrsResponseStatus = pResponseStatus_
    }

-- | PlatformApplicationArn is returned.
cparrsPlatformApplicationARN :: Lens' CreatePlatformApplicationResponse (Maybe Text)
cparrsPlatformApplicationARN = lens _cparrsPlatformApplicationARN (\s a -> s {_cparrsPlatformApplicationARN = a})

-- | -- | The response status code.
cparrsResponseStatus :: Lens' CreatePlatformApplicationResponse Int
