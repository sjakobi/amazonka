...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'oipnrrsResponseStatus' - -- | The response status code.
optInPhoneNumberResponse ::
  -- | 'oipnrrsResponseStatus'
  Int ->
  OptInPhoneNumberResponse
...
oipnrrsResponseStatus :: Lens' OptInPhoneNumberResponse Int
oipnrrsResponseStatus = lens _oipnrrsResponseStatus (\s a -> s {_oipnrrsResponseStatus = a})
