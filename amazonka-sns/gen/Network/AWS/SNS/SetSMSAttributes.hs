...
setSMSAttributes ::
  SetSMSAttributes
setSMSAttributes =
  SetSMSAttributes' {_ssmsaAttributes = mempty}
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ssmsarrsResponseStatus' - -- | The response status code.
setSMSAttributesResponse ::
  -- | 'ssmsarrsResponseStatus'
  Int ->
  SetSMSAttributesResponse
...
ssmsarrsResponseStatus :: Lens' SetSMSAttributesResponse Int
ssmsarrsResponseStatus = lens _ssmsarrsResponseStatus (\s a -> s {_ssmsarrsResponseStatus = a})
