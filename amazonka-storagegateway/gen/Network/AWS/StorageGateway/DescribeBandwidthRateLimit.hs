...
instance Prelude.ToHeaders DescribeBandwidthRateLimit where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "StorageGateway_20130630.DescribeBandwidthRateLimit" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON DescribeBandwidthRateLimit where
...
instance Prelude.ToPath DescribeBandwidthRateLimit where
  toPath = Prelude.const "/"

instance Prelude.ToQuery DescribeBandwidthRateLimit where
...
describeBandwidthRateLimitResponse_averageUploadRateLimitInBitsPerSec = Lens.lens (\DescribeBandwidthRateLimitResponse' {averageUploadRateLimitInBitsPerSec} -> averageUploadRateLimitInBitsPerSec) (\s@DescribeBandwidthRateLimitResponse' {} a -> s {averageUploadRateLimitInBitsPerSec = a} :: DescribeBandwidthRateLimitResponse) Prelude.. Lens.mapping Prelude._Nat
