...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dbrlrbrsGatewayARN' - Undocumented member.
--
-- * 'dbrlrbrsResponseStatus' - -- | The response status code.
deleteBandwidthRateLimitResponse ::
  -- | 'dbrlrbrsResponseStatus'
  Int ->
  DeleteBandwidthRateLimitResponse
...
-- | Undocumented member.
dbrlrbrsGatewayARN :: Lens' DeleteBandwidthRateLimitResponse (Maybe Text)
dbrlrbrsGatewayARN = lens _dbrlrbrsGatewayARN (\s a -> s {_dbrlrbrsGatewayARN = a})

-- | -- | The response status code.
dbrlrbrsResponseStatus :: Lens' DeleteBandwidthRateLimitResponse Int
dbrlrbrsResponseStatus = lens _dbrlrbrsResponseStatus (\s a -> s {_dbrlrbrsResponseStatus = a})
