...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'sgrrsGatewayARN' - Undocumented member.
--
-- * 'sgrrsResponseStatus' - -- | The response status code.
startGatewayResponse ::
  -- | 'sgrrsResponseStatus'
  Int ->
  StartGatewayResponse
startGatewayResponse pResponseStatus_ =
  StartGatewayResponse'
    { _sgrrsGatewayARN = Nothing,
      _sgrrsResponseStatus = pResponseStatus_
    }

-- | Undocumented member.
sgrrsGatewayARN :: Lens' StartGatewayResponse (Maybe Text)
sgrrsGatewayARN = lens _sgrrsGatewayARN (\s a -> s {_sgrrsGatewayARN = a})

-- | -- | The response status code.
sgrrsResponseStatus :: Lens' StartGatewayResponse Int
sgrrsResponseStatus = lens _sgrrsResponseStatus (\s a -> s {_sgrrsResponseStatus = a})
