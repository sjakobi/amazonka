...
data UpdateSMBSecurityStrategyResponse = UpdateSMBSecurityStrategyResponse'
  { _usmbssrrsGatewayARN ::
      !( Maybe
           Text
       ),
    _usmbssrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'usmbssrrsGatewayARN' - Undocumented member.
--
-- * 'usmbssrrsResponseStatus' - -- | The response status code.
updateSMBSecurityStrategyResponse ::
  -- | 'usmbssrrsResponseStatus'
  Int ->
  UpdateSMBSecurityStrategyResponse
...
-- | Undocumented member.
usmbssrrsGatewayARN :: Lens' UpdateSMBSecurityStrategyResponse (Maybe Text)
usmbssrrsGatewayARN = lens _usmbssrrsGatewayARN (\s a -> s {_usmbssrrsGatewayARN = a})

-- | -- | The response status code.
usmbssrrsResponseStatus :: Lens' UpdateSMBSecurityStrategyResponse Int
usmbssrrsResponseStatus = lens _usmbssrrsResponseStatus (\s a -> s {_usmbssrrsResponseStatus = a})
