...
data RefreshCache = RefreshCache'
  { -- | A value that specifies whether to recursively refresh folders in the
    ...
    folderList :: Prelude.Maybe (Prelude.List1 Prelude.Text),
...
refreshCache_folderList = Lens.lens (\RefreshCache' {folderList} -> folderList) (\s@RefreshCache' {} a -> s {folderList = a} :: RefreshCache) Prelude.. Lens.mapping Prelude._List1
