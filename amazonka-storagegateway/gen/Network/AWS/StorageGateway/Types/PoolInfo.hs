...
poolInfo_retentionLockTimeInDays = Lens.lens (\PoolInfo' {retentionLockTimeInDays} -> retentionLockTimeInDays) (\s@PoolInfo' {} a -> s {retentionLockTimeInDays = a} :: PoolInfo) Prelude.. Lens.mapping Prelude._Nat

instance Prelude.FromJSON PoolInfo where
  parseJSON =
    Prelude.withObject
      "PoolInfo"
      ( \x ->
          PoolInfo'
            ...
            Prelude.<*> (x Prelude..:? "PoolName")
            Prelude.<*> (x Prelude..:? "StorageClass")
            Prelude.<*> (x Prelude..:? "RetentionLockType")
            Prelude.<*> (x Prelude..:? "PoolStatus")
            Prelude.<*> (x Prelude..:? "RetentionLockTimeInDays")
      )
