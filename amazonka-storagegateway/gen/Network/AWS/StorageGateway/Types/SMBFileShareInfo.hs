...
sMBFileShareInfo_validUserList = Lens.lens (\SMBFileShareInfo' {validUserList} -> validUserList) (\s@SMBFileShareInfo' {} a -> s {validUserList = a} :: SMBFileShareInfo) Prelude.. Lens.mapping Prelude._Coerce
...
sMBFileShareInfo_adminUserList = Lens.lens (\SMBFileShareInfo' {adminUserList} -> adminUserList) (\s@SMBFileShareInfo' {} a -> s {adminUserList = a} :: SMBFileShareInfo) Prelude.. Lens.mapping Prelude._Coerce
...
sMBFileShareInfo_tags = Lens.lens (\SMBFileShareInfo' {tags} -> tags) (\s@SMBFileShareInfo' {} a -> s {tags = a} :: SMBFileShareInfo) Prelude.. Lens.mapping Prelude._Coerce
...
sMBFileShareInfo_invalidUserList = Lens.lens (\SMBFileShareInfo' {invalidUserList} -> invalidUserList) (\s@SMBFileShareInfo' {} a -> s {invalidUserList = a} :: SMBFileShareInfo) Prelude.. Lens.mapping Prelude._Coerce

instance Prelude.FromJSON SMBFileShareInfo where
  parseJSON =
    Prelude.withObject
      "SMBFileShareInfo"
      ( \x ->
          SMBFileShareInfo'
            Prelude.<$> (x Prelude..:? "SMBACLEnabled")
            Prelude.<*> (x Prelude..:? "AccessBasedEnumeration")
            Prelude.<*> (x Prelude..:? "DefaultStorageClass")
            Prelude.<*> (x Prelude..:? "FileShareName")
            Prelude.<*> (x Prelude..:? "CaseSensitivity")
            Prelude.<*> (x Prelude..:? "GuessMIMETypeEnabled")
            Prelude.<*> (x Prelude..:? "ReadOnly")
            Prelude.<*> (x Prelude..:? "FileShareId")
            Prelude.<*> (x Prelude..:? "KMSEncrypted")
            Prelude.<*> (x Prelude..:? "Authentication")
            Prelude.<*> (x Prelude..:? "LocationARN")
            Prelude.<*> (x Prelude..:? "NotificationPolicy")
            Prelude.<*> ( x Prelude..:? "ValidUserList"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "KMSKey")
            Prelude.<*> (x Prelude..:? "FileShareStatus")
            Prelude.<*> ( x Prelude..:? "AdminUserList"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "AuditDestinationARN")
            Prelude.<*> (x Prelude..:? "Role")
            Prelude.<*> (x Prelude..:? "Tags" Prelude..!= Prelude.mempty)
            Prelude.<*> (x Prelude..:? "FileShareARN")
            Prelude.<*> (x Prelude..:? "CacheAttributes")
            Prelude.<*> (x Prelude..:? "ObjectACL")
            Prelude.<*> (x Prelude..:? "Path")
            Prelude.<*> (x Prelude..:? "GatewayARN")
            Prelude.<*> (x Prelude..:? "RequesterPays")
            Prelude.<*> ( x Prelude..:? "InvalidUserList"
                            Prelude..!= Prelude.mempty
                        )
      )
