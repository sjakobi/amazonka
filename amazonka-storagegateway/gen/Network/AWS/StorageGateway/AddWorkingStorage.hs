...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'awsrrsGatewayARN' - Undocumented member.
--
-- * 'awsrrsResponseStatus' - -- | The response status code.
addWorkingStorageResponse ::
  -- | 'awsrrsResponseStatus'
  Int ->
  AddWorkingStorageResponse
addWorkingStorageResponse pResponseStatus_ =
  AddWorkingStorageResponse'
    { _awsrrsGatewayARN =
        Nothing,
      _awsrrsResponseStatus = pResponseStatus_
    }

-- | Undocumented member.
awsrrsGatewayARN :: Lens' AddWorkingStorageResponse (Maybe Text)
awsrrsGatewayARN = lens _awsrrsGatewayARN (\s a -> s {_awsrrsGatewayARN = a})

-- | -- | The response status code.
awsrrsResponseStatus :: Lens' AddWorkingStorageResponse Int
awsrrsResponseStatus = lens _awsrrsResponseStatus (\s a -> s {_awsrrsResponseStatus = a})
