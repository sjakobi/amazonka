...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ctwbrrsTapeARN' - A unique Amazon Resource Name (ARN) that represents the virtual tape that was created.
--
-- * 'ctwbrrsResponseStatus' - -- | The response status code.
createTapeWithBarcodeResponse ::
  -- | 'ctwbrrsResponseStatus'
  Int ->
  CreateTapeWithBarcodeResponse
createTapeWithBarcodeResponse pResponseStatus_ =
  CreateTapeWithBarcodeResponse'
    { _ctwbrrsTapeARN =
        Nothing,
      _ctwbrrsResponseStatus = pResponseStatus_
    }

-- | A unique Amazon Resource Name (ARN) that represents the virtual tape that was created.
ctwbrrsTapeARN :: Lens' CreateTapeWithBarcodeResponse (Maybe Text)
ctwbrrsTapeARN = lens _ctwbrrsTapeARN (\s a -> s {_ctwbrrsTapeARN = a})

-- | -- | The response status code.
ctwbrrsResponseStatus :: Lens' CreateTapeWithBarcodeResponse Int
ctwbrrsResponseStatus = lens _ctwbrrsResponseStatus (\s a -> s {_ctwbrrsResponseStatus = a})
