...
getSessionToken_durationSeconds = Lens.lens (\GetSessionToken' {durationSeconds} -> durationSeconds) (\s@GetSessionToken' {} a -> s {durationSeconds = a} :: GetSessionToken) Prelude.. Lens.mapping Prelude._Nat

instance Prelude.AWSRequest GetSessionToken where
...
instance Prelude.ToHeaders GetSessionToken where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath GetSessionToken where
  toPath = Prelude.const "/"

instance Prelude.ToQuery GetSessionToken where
  toQuery GetSessionToken' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("GetSessionToken" :: Prelude.ByteString),
        "Version"
