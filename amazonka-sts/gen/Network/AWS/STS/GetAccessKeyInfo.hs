...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gakirrsAccount' - The number used to identify the AWS account.
--
-- * 'gakirrsResponseStatus' - -- | The response status code.
getAccessKeyInfoResponse ::
  -- | 'gakirrsResponseStatus'
  Int ->
  GetAccessKeyInfoResponse
getAccessKeyInfoResponse pResponseStatus_ =
  GetAccessKeyInfoResponse'
    { _gakirrsAccount =
        Nothing,
      _gakirrsResponseStatus = pResponseStatus_
    }

-- | The number used to identify the AWS account.
gakirrsAccount :: Lens' GetAccessKeyInfoResponse (Maybe Text)
gakirrsAccount = lens _gakirrsAccount (\s a -> s {_gakirrsAccount = a})

-- | -- | The response status code.
gakirrsResponseStatus :: Lens' GetAccessKeyInfoResponse Int
gakirrsResponseStatus = lens _gakirrsResponseStatus (\s a -> s {_gakirrsResponseStatus = a})
