...
data AssumeRoleWithWebIdentity = AssumeRoleWithWebIdentity'
  { -- | The fully qualified host component of the domain name of the identity
    ...
    -- in the /IAM User Guide/.
    durationSeconds :: Prelude.Maybe Prelude.Nat,
...
assumeRoleWithWebIdentity_policyArns = Lens.lens (\AssumeRoleWithWebIdentity' {policyArns} -> policyArns) (\s@AssumeRoleWithWebIdentity' {} a -> s {policyArns = a} :: AssumeRoleWithWebIdentity) Prelude.. Lens.mapping Prelude._Coerce
...
assumeRoleWithWebIdentity_durationSeconds = Lens.lens (\AssumeRoleWithWebIdentity' {durationSeconds} -> durationSeconds) (\s@AssumeRoleWithWebIdentity' {} a -> s {durationSeconds = a} :: AssumeRoleWithWebIdentity) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.AWSRequest AssumeRoleWithWebIdentity where
  type
    ...
    Response.receiveXMLWrapper
      ...
      ( \s h x ->
          AssumeRoleWithWebIdentityResponse'
            ...
            Prelude.<*> (x Prelude..@? "SubjectFromWebIdentityToken")
...
instance Prelude.ToHeaders AssumeRoleWithWebIdentity where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath AssumeRoleWithWebIdentity where
  toPath = Prelude.const "/"

instance Prelude.ToQuery AssumeRoleWithWebIdentity where
  toQuery AssumeRoleWithWebIdentity' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("AssumeRoleWithWebIdentity" :: Prelude.ByteString),
        "Version"
        ...
        "WebIdentityToken" Prelude.=: webIdentityToken
      ]
...
data AssumeRoleWithWebIdentityResponse = AssumeRoleWithWebIdentityResponse'
  { -- | The intended audience (also known as client ID) of the web identity
    ...
    packedPolicySize :: Prelude.Maybe Prelude.Nat,
...
assumeRoleWithWebIdentityResponse_packedPolicySize = Lens.lens (\AssumeRoleWithWebIdentityResponse' {packedPolicySize} -> packedPolicySize) (\s@AssumeRoleWithWebIdentityResponse' {} a -> s {packedPolicySize = a} :: AssumeRoleWithWebIdentityResponse) Prelude.. Lens.mapping Prelude._Nat
