...
data AssumeRoleWithWebIdentity = AssumeRoleWithWebIdentity'
  { _arwwiProviderId ::
    ...
    _arwwiPolicy ::
      !(Maybe Text),
    _arwwiDurationSeconds ::
      !(Maybe Nat),
    _arwwiRoleARN ::
      !Text,
    _arwwiRoleSessionName ::
      !Text,
    _arwwiWebIdentityToken ::
      !Text
  }
  deriving
    ( Eq,
...
data AssumeRoleWithWebIdentityResponse = AssumeRoleWithWebIdentityResponse'
  { _arwwirrsAudience ::
    ...
    _arwwirrsSubjectFromWebIdentityToken ::
      !( Maybe
           Text
       ),
    _arwwirrsProvider ::
    ...
    _arwwirrsCredentials ::
      !( Maybe
           AuthEnv
       ),
    _arwwirrsAssumedRoleUser ::
      !( Maybe
           AssumedRoleUser
       ),
    _arwwirrsPackedPolicySize ::
      !( Maybe
           Nat
       ),
    _arwwirrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'arwwirrsAudience' - The intended audience (also known as client ID) of the web identity token. This is traditionally the client identifier issued to the application that requested the web identity token.
--
-- * 'arwwirrsSubjectFromWebIdentityToken' - The unique user identifier that is returned by the identity provider. This identifier is associated with the @WebIdentityToken@ that was submitted with the @AssumeRoleWithWebIdentity@ call. The identifier is typically unique to the user and the application that acquired the @WebIdentityToken@ (pairwise identifier). For OpenID Connect ID tokens, this field contains the value returned by the identity provider as the token's @sub@ (Subject) claim.
--
-- * 'arwwirrsProvider' - The issuing authority of the web identity token presented. For OpenID Connect ID tokens, this contains the value of the @iss@ field. For OAuth 2.0 access tokens, this contains the value of the @ProviderId@ parameter that was passed in the @AssumeRoleWithWebIdentity@ request.
--
-- * 'arwwirrsCredentials' - The temporary security credentials, which include an access key ID, a secret access key, and a security token.
--
-- * 'arwwirrsAssumedRoleUser' - The Amazon Resource Name (ARN) and the assumed role ID, which are identifiers that you can use to refer to the resulting temporary security credentials. For example, you can reference these credentials as a principal in a resource-based policy by using the ARN or assumed role ID. The ARN and ID include the @RoleSessionName@ that you specified when you called @AssumeRole@ .
--
-- * 'arwwirrsPackedPolicySize' - A percentage value that indicates the packed size of the session policies and session tags combined passed in the request. The request fails if the packed size is greater than 100 percent, which means the policies and tags exceeded the allowed space.
--
-- * 'arwwirrsResponseStatus' - -- | The response status code.
assumeRoleWithWebIdentityResponse ::
  -- | 'arwwirrsResponseStatus'
  Int ->
  AssumeRoleWithWebIdentityResponse
assumeRoleWithWebIdentityResponse pResponseStatus_ =
  AssumeRoleWithWebIdentityResponse'
    { _arwwirrsAudience =
      ...
      _arwwirrsSubjectFromWebIdentityToken =
        Nothing,
      _arwwirrsProvider = Nothing,
      _arwwirrsCredentials = Nothing,
      _arwwirrsAssumedRoleUser = Nothing,
      _arwwirrsPackedPolicySize = Nothing,
      _arwwirrsResponseStatus =
        pResponseStatus_
    }

-- | The intended audience (also known as client ID) of the web identity token. This is traditionally the client identifier issued to the application that requested the web identity token.
arwwirrsAudience :: Lens' AssumeRoleWithWebIdentityResponse (Maybe Text)
arwwirrsAudience = lens _arwwirrsAudience (\s a -> s {_arwwirrsAudience = a})

-- | The unique user identifier that is returned by the identity provider. This identifier is associated with the @WebIdentityToken@ that was submitted with the @AssumeRoleWithWebIdentity@ call. The identifier is typically unique to the user and the application that acquired the @WebIdentityToken@ (pairwise identifier). For OpenID Connect ID tokens, this field contains the value returned by the identity provider as the token's @sub@ (Subject) claim.
arwwirrsSubjectFromWebIdentityToken :: Lens' AssumeRoleWithWebIdentityResponse (Maybe Text)
arwwirrsSubjectFromWebIdentityToken = lens _arwwirrsSubjectFromWebIdentityToken (\s a -> s {_arwwirrsSubjectFromWebIdentityToken = a})

-- | The issuing authority of the web identity token presented. For OpenID Connect ID tokens, this contains the value of the @iss@ field. For OAuth 2.0 access tokens, this contains the value of the @ProviderId@ parameter that was passed in the @AssumeRoleWithWebIdentity@ request.
arwwirrsProvider :: Lens' AssumeRoleWithWebIdentityResponse (Maybe Text)
arwwirrsProvider = lens _arwwirrsProvider (\s a -> s {_arwwirrsProvider = a})

-- | The temporary security credentials, which include an access key ID, a secret access key, and a security token.
arwwirrsCredentials :: Lens' AssumeRoleWithWebIdentityResponse (Maybe AuthEnv)
arwwirrsCredentials = lens _arwwirrsCredentials (\s a -> s {_arwwirrsCredentials = a})

-- | The Amazon Resource Name (ARN) and the assumed role ID, which are identifiers that you can use to refer to the resulting temporary security credentials. For example, you can reference these credentials as a principal in a resource-based policy by using the ARN or assumed role ID. The ARN and ID include the @RoleSessionName@ that you specified when you called @AssumeRole@ .
arwwirrsAssumedRoleUser :: Lens' AssumeRoleWithWebIdentityResponse (Maybe AssumedRoleUser)
arwwirrsAssumedRoleUser = lens _arwwirrsAssumedRoleUser (\s a -> s {_arwwirrsAssumedRoleUser = a})

-- | A percentage value that indicates the packed size of the session policies and session tags combined passed in the request. The request fails if the packed size is greater than 100 percent, which means the policies and tags exceeded the allowed space.
arwwirrsPackedPolicySize :: Lens' AssumeRoleWithWebIdentityResponse (Maybe Natural)
arwwirrsPackedPolicySize = lens _arwwirrsPackedPolicySize (\s a -> s {_arwwirrsPackedPolicySize = a}) . mapping _Nat

-- | -- | The response status code.
arwwirrsResponseStatus :: Lens' AssumeRoleWithWebIdentityResponse Int
arwwirrsResponseStatus = lens _arwwirrsResponseStatus (\s a -> s {_arwwirrsResponseStatus = a})
