...
intentSummary_slots = Lens.lens (\IntentSummary' {slots} -> slots) (\s@IntentSummary' {} a -> s {slots = a} :: IntentSummary) Prelude.. Lens.mapping (Prelude._Sensitive Prelude.. Prelude._Map)
...
instance Prelude.FromJSON IntentSummary where
  parseJSON =
    Prelude.withObject
      "IntentSummary"
      ( \x ->
          IntentSummary'
            ...
            Prelude.<*> (x Prelude..:? "checkpointLabel")
            Prelude.<*> (x Prelude..:? "slotToElicit")
            Prelude.<*> (x Prelude..:? "confirmationStatus")
            Prelude.<*> (x Prelude..: "dialogActionType")
      )
...
instance Prelude.ToJSON IntentSummary where
    ...
    Prelude.object
      ( Prelude.catMaybes
          [ ("intentName" Prelude..=) Prelude.<$> intentName,
            ...
            ("checkpointLabel" Prelude..=)
              Prelude.<$> checkpointLabel,
            ("slotToElicit" Prelude..=) Prelude.<$> slotToElicit,
            ("confirmationStatus" Prelude..=)
              Prelude.<$> confirmationStatus,
            Prelude.Just
              ("dialogActionType" Prelude..= dialogActionType)
          ]
      )
