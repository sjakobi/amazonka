...
data GetResources = GetResources'
  { -- | Specifies a list of TagFilters (keys and values) to restrict the output
    ...
    resourceARNList :: Prelude.Maybe (Prelude.List1 Prelude.Text),
...
getResources_resourceARNList = Lens.lens (\GetResources' {resourceARNList} -> resourceARNList) (\s@GetResources' {} a -> s {resourceARNList = a} :: GetResources) Prelude.. Lens.mapping Prelude._List1
