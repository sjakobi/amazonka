...
data GetUICustomizationResponse = GetUICustomizationResponse'
  { _guicrrsResponseStatus ::
      !Int,
    _guicrrsUICustomization ::
      !UICustomizationType
  }
  deriving (Eq, Show, Data, Typeable, Generic)
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'guicrrsResponseStatus' - -- | The response status code.
--
-- * 'guicrrsUICustomization' - The UI customization information.
getUICustomizationResponse ::
  -- | 'guicrrsResponseStatus'
  Int ->
  -- | 'guicrrsUICustomization'
...
getUICustomizationResponse
  ...
  pUICustomization_ =
    GetUICustomizationResponse'
      { _guicrrsResponseStatus =
          pResponseStatus_,
        _guicrrsUICustomization = pUICustomization_
      }

-- | -- | The response status code.
guicrrsResponseStatus :: Lens' GetUICustomizationResponse Int
guicrrsResponseStatus = lens _guicrrsResponseStatus (\s a -> s {_guicrrsResponseStatus = a})

-- | The UI customization information.
guicrrsUICustomization :: Lens' GetUICustomizationResponse UICustomizationType
guicrrsUICustomization = lens _guicrrsUICustomization (\s a -> s {_guicrrsUICustomization = a})
