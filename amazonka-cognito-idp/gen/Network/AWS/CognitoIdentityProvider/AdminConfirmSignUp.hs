...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'acsurrsResponseStatus' - -- | The response status code.
adminConfirmSignUpResponse ::
  -- | 'acsurrsResponseStatus'
  Int ->
  AdminConfirmSignUpResponse
...
acsurrsResponseStatus :: Lens' AdminConfirmSignUpResponse Int
acsurrsResponseStatus = lens _acsurrsResponseStatus (\s a -> s {_acsurrsResponseStatus = a})
