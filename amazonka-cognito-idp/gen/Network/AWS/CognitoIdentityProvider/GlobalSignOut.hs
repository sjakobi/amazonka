...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gsorrsResponseStatus' - -- | The response status code.
globalSignOutResponse ::
  -- | 'gsorrsResponseStatus'
  Int ->
  GlobalSignOutResponse
...
gsorrsResponseStatus :: Lens' GlobalSignOutResponse Int
gsorrsResponseStatus = lens _gsorrsResponseStatus (\s a -> s {_gsorrsResponseStatus = a})
