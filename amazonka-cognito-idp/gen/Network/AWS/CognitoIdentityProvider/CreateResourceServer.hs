...
--
-- * 'crsrrsResourceServer' - The newly created resource server.
createResourceServerResponse ::
  -- | 'crsrrsResponseStatus'
  Int ->
  -- | 'crsrrsResourceServer'
...
createResourceServerResponse
  ...
  pResourceServer_ =
    CreateResourceServerResponse'
      { _crsrrsResponseStatus =
          pResponseStatus_,
        _crsrrsResourceServer = pResourceServer_
      }

-- | -- | The response status code.
crsrrsResponseStatus :: Lens' CreateResourceServerResponse Int
crsrrsResponseStatus = lens _crsrrsResponseStatus (\s a -> s {_crsrrsResponseStatus = a})

-- | The newly created resource server.
crsrrsResourceServer :: Lens' CreateResourceServerResponse ResourceServerType
crsrrsResourceServer = lens _crsrrsResourceServer (\s a -> s {_crsrrsResourceServer = a})
