...
data UpdateIdentityProvider = UpdateIdentityProvider'
  { -- | The identity provider details to be updated, such as @MetadataURL@ and
    -- @MetadataFile@.
    providerDetails :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
    -- | A list of identity provider identifiers.
    idpIdentifiers :: Prelude.Maybe [Prelude.Text],
    -- | The identity provider attribute mapping to be changed.
    attributeMapping :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
    -- | The user pool ID.
...
updateIdentityProvider_providerDetails = Lens.lens (\UpdateIdentityProvider' {providerDetails} -> providerDetails) (\s@UpdateIdentityProvider' {} a -> s {providerDetails = a} :: UpdateIdentityProvider) Prelude.. Lens.mapping Prelude._Map
...
updateIdentityProvider_attributeMapping = Lens.lens (\UpdateIdentityProvider' {attributeMapping} -> attributeMapping) (\s@UpdateIdentityProvider' {} a -> s {attributeMapping = a} :: UpdateIdentityProvider) Prelude.. Lens.mapping Prelude._Map
