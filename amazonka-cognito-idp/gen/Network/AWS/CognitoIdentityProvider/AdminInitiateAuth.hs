...
data AdminInitiateAuthResponse = AdminInitiateAuthResponse'
  { _aiarrsAuthenticationResult ::
      !( Maybe
           AuthenticationResultType
       ),
    _aiarrsChallengeName ::
      !( Maybe
           ChallengeNameType
       ),
    _aiarrsChallengeParameters ::
      !( Maybe
           ( Map
               Text
               Text
...
adminInitiateAuthResponse pResponseStatus_ =
  AdminInitiateAuthResponse'
    { _aiarrsAuthenticationResult =
        Nothing,
      _aiarrsChallengeName = Nothing,
      _aiarrsChallengeParameters = Nothing,
      _aiarrsSession = Nothing,
      _aiarrsResponseStatus = pResponseStatus_
    }

-- | The result of the authentication response. This is only returned if the caller does not need to pass another challenge. If the caller does need to pass another challenge before it gets tokens, @ChallengeName@ , @ChallengeParameters@ , and @Session@ are returned.
aiarrsAuthenticationResult :: Lens' AdminInitiateAuthResponse (Maybe AuthenticationResultType)
aiarrsAuthenticationResult = lens _aiarrsAuthenticationResult (\s a -> s {_aiarrsAuthenticationResult = a})
...
aiarrsChallengeName :: Lens' AdminInitiateAuthResponse (Maybe ChallengeNameType)
aiarrsChallengeName = lens _aiarrsChallengeName (\s a -> s {_aiarrsChallengeName = a})
...
aiarrsChallengeParameters :: Lens' AdminInitiateAuthResponse (HashMap Text Text)
aiarrsChallengeParameters = lens _aiarrsChallengeParameters (\s a -> s {_aiarrsChallengeParameters = a}) . _Default . _Map
...
aiarrsSession :: Lens' AdminInitiateAuthResponse (Maybe Text)
aiarrsSession = lens _aiarrsSession (\s a -> s {_aiarrsSession = a})

-- | -- | The response status code.
aiarrsResponseStatus :: Lens' AdminInitiateAuthResponse Int
