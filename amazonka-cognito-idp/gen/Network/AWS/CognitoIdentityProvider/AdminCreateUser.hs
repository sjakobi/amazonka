...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'acurrsUser' - The newly created user.
--
-- * 'acurrsResponseStatus' - -- | The response status code.
adminCreateUserResponse ::
  -- | 'acurrsResponseStatus'
  Int ->
  AdminCreateUserResponse
adminCreateUserResponse pResponseStatus_ =
  AdminCreateUserResponse'
    { _acurrsUser = Nothing,
      _acurrsResponseStatus = pResponseStatus_
    }

-- | The newly created user.
acurrsUser :: Lens' AdminCreateUserResponse (Maybe UserType)
acurrsUser = lens _acurrsUser (\s a -> s {_acurrsUser = a})

-- | -- | The response status code.
acurrsResponseStatus :: Lens' AdminCreateUserResponse Int
acurrsResponseStatus = lens _acurrsResponseStatus (\s a -> s {_acurrsResponseStatus = a})
