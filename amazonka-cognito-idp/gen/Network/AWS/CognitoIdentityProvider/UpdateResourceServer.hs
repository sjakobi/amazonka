...
data UpdateResourceServerResponse = UpdateResourceServerResponse'
  { _ursrrsResponseStatus ::
      !Int,
    _ursrrsResourceServer ::
      !ResourceServerType
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ursrrsResponseStatus' - -- | The response status code.
--
-- * 'ursrrsResourceServer' - The resource server.
updateResourceServerResponse ::
  -- | 'ursrrsResponseStatus'
  Int ->
  -- | 'ursrrsResourceServer'
...
updateResourceServerResponse
  ...
  pResourceServer_ =
    UpdateResourceServerResponse'
      { _ursrrsResponseStatus =
          pResponseStatus_,
        _ursrrsResourceServer = pResourceServer_
      }

-- | -- | The response status code.
ursrrsResponseStatus :: Lens' UpdateResourceServerResponse Int
ursrrsResponseStatus = lens _ursrrsResponseStatus (\s a -> s {_ursrrsResponseStatus = a})

-- | The resource server.
ursrrsResourceServer :: Lens' UpdateResourceServerResponse ResourceServerType
ursrrsResourceServer = lens _ursrrsResourceServer (\s a -> s {_ursrrsResourceServer = a})
