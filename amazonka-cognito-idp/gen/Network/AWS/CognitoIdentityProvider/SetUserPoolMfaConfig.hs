...
instance Prelude.AWSRequest SetUserPoolMfaConfig where
  type
...
instance Prelude.ToHeaders SetUserPoolMfaConfig where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AWSCognitoIdentityProviderService.SetUserPoolMfaConfig" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON SetUserPoolMfaConfig where
  toJSON SetUserPoolMfaConfig' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("SoftwareTokenMfaConfiguration" Prelude..=)
              Prelude.<$> softwareTokenMfaConfiguration,
            ("SmsMfaConfiguration" Prelude..=)
...
instance Prelude.ToPath SetUserPoolMfaConfig where
  toPath = Prelude.const "/"

instance Prelude.ToQuery SetUserPoolMfaConfig where
