...
data UserPoolType = UserPoolType'
  { -- | The date the user pool was last modified.
    ...
    userPoolTags :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
    ...
    schemaAttributes :: Prelude.Maybe (Prelude.List1 SchemaAttributeType),
...
userPoolType_lastModifiedDate = Lens.lens (\UserPoolType' {lastModifiedDate} -> lastModifiedDate) (\s@UserPoolType' {} a -> s {lastModifiedDate = a} :: UserPoolType) Prelude.. Lens.mapping Prelude._Time

-- | The tags that are assigned to the user pool. A tag is a label that you
-- can apply to user pools to categorize and manage them in different ways,
-- such as by purpose, owner, environment, or other criteria.
userPoolType_userPoolTags :: Lens.Lens' UserPoolType (Prelude.Maybe (Prelude.HashMap Prelude.Text Prelude.Text))
userPoolType_userPoolTags = Lens.lens (\UserPoolType' {userPoolTags} -> userPoolTags) (\s@UserPoolType' {} a -> s {userPoolTags = a} :: UserPoolType) Prelude.. Lens.mapping Prelude._Map
...
userPoolType_usernameAttributes = Lens.lens (\UserPoolType' {usernameAttributes} -> usernameAttributes) (\s@UserPoolType' {} a -> s {usernameAttributes = a} :: UserPoolType) Prelude.. Lens.mapping Prelude._Coerce
...
userPoolType_autoVerifiedAttributes = Lens.lens (\UserPoolType' {autoVerifiedAttributes} -> autoVerifiedAttributes) (\s@UserPoolType' {} a -> s {autoVerifiedAttributes = a} :: UserPoolType) Prelude.. Lens.mapping Prelude._Coerce
...
userPoolType_creationDate = Lens.lens (\UserPoolType' {creationDate} -> creationDate) (\s@UserPoolType' {} a -> s {creationDate = a} :: UserPoolType) Prelude.. Lens.mapping Prelude._Time
...
userPoolType_aliasAttributes = Lens.lens (\UserPoolType' {aliasAttributes} -> aliasAttributes) (\s@UserPoolType' {} a -> s {aliasAttributes = a} :: UserPoolType) Prelude.. Lens.mapping Prelude._Coerce
...
userPoolType_schemaAttributes = Lens.lens (\UserPoolType' {schemaAttributes} -> schemaAttributes) (\s@UserPoolType' {} a -> s {schemaAttributes = a} :: UserPoolType) Prelude.. Lens.mapping Prelude._List1
...
instance Prelude.FromJSON UserPoolType where
  parseJSON =
    Prelude.withObject
      "UserPoolType"
      ( \x ->
          UserPoolType'
            ...
            Prelude.<*> ( x Prelude..:? "UserPoolTags"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "Status")
            Prelude.<*> ( x Prelude..:? "UsernameAttributes"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "EmailVerificationSubject")
            Prelude.<*> ( x Prelude..:? "AutoVerifiedAttributes"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "Policies")
            Prelude.<*> (x Prelude..:? "CustomDomain")
            Prelude.<*> (x Prelude..:? "Domain")
            Prelude.<*> (x Prelude..:? "AdminCreateUserConfig")
            ...
            Prelude.<*> (x Prelude..:? "EstimatedNumberOfUsers")
            Prelude.<*> (x Prelude..:? "SmsVerificationMessage")
            Prelude.<*> (x Prelude..:? "Name")
            Prelude.<*> (x Prelude..:? "AccountRecoverySetting")
            Prelude.<*> (x Prelude..:? "EmailConfiguration")
            Prelude.<*> (x Prelude..:? "EmailConfigurationFailure")
            Prelude.<*> ( x Prelude..:? "AliasAttributes"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "EmailVerificationMessage")
            Prelude.<*> (x Prelude..:? "UserPoolAddOns")
            Prelude.<*> (x Prelude..:? "UsernameConfiguration")
            Prelude.<*> (x Prelude..:? "SmsAuthenticationMessage")
            Prelude.<*> (x Prelude..:? "SchemaAttributes")
            Prelude.<*> (x Prelude..:? "SmsConfigurationFailure")
            Prelude.<*> (x Prelude..:? "MfaConfiguration")
            Prelude.<*> (x Prelude..:? "VerificationMessageTemplate")
      )
