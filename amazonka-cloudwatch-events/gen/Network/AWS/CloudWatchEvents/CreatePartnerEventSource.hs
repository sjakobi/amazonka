...
instance Hashable CreatePartnerEventSource

instance NFData CreatePartnerEventSource
...
data CreatePartnerEventSourceResponse = CreatePartnerEventSourceResponse'
  { _cpesrrsEventSourceARN ::
      !( Maybe
           Text
       ),
    _cpesrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cpesrrsEventSourceARN' - The ARN of the partner event source.
--
-- * 'cpesrrsResponseStatus' - -- | The response status code.
createPartnerEventSourceResponse ::
  -- | 'cpesrrsResponseStatus'
  Int ->
  CreatePartnerEventSourceResponse
createPartnerEventSourceResponse pResponseStatus_ =
  CreatePartnerEventSourceResponse'
    { _cpesrrsEventSourceARN =
        Nothing,
      _cpesrrsResponseStatus = pResponseStatus_
    }

-- | The ARN of the partner event source.
cpesrrsEventSourceARN :: Lens' CreatePartnerEventSourceResponse (Maybe Text)
cpesrrsEventSourceARN = lens _cpesrrsEventSourceARN (\s a -> s {_cpesrrsEventSourceARN = a})

-- | -- | The response status code.
cpesrrsResponseStatus :: Lens' CreatePartnerEventSourceResponse Int
cpesrrsResponseStatus = lens _cpesrrsResponseStatus (\s a -> s {_cpesrrsResponseStatus = a})
