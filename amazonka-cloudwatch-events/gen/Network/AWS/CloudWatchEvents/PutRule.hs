...
--
-- * 'prEventBusName' - The name or ARN of the event bus to associate with this rule. If you omit this, the default event bus is used.
--
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'prrrsRuleARN' - The Amazon Resource Name (ARN) of the rule.
--
...
putRuleResponse pResponseStatus_ =
  PutRuleResponse'
    { _prrrsRuleARN = Nothing,
      _prrrsResponseStatus = pResponseStatus_
    }

-- | The Amazon Resource Name (ARN) of the rule.
prrrsRuleARN :: Lens' PutRuleResponse (Maybe Text)
prrrsRuleARN = lens _prrrsRuleARN (\s a -> s {_prrrsRuleARN = a})

-- | -- | The response status code.
prrrsResponseStatus :: Lens' PutRuleResponse Int
