...
data HttpParameters = HttpParameters'
  { -- | The query string keys\/values that need to be sent as part of request
    ...
    queryStringParameters :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
    ...
    headerParameters :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text)
  }
...
httpParameters_queryStringParameters = Lens.lens (\HttpParameters' {queryStringParameters} -> queryStringParameters) (\s@HttpParameters' {} a -> s {queryStringParameters = a} :: HttpParameters) Prelude.. Lens.mapping Prelude._Map
...
httpParameters_headerParameters = Lens.lens (\HttpParameters' {headerParameters} -> headerParameters) (\s@HttpParameters' {} a -> s {headerParameters = a} :: HttpParameters) Prelude.. Lens.mapping Prelude._Map
