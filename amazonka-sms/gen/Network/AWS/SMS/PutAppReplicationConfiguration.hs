...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'parcrrsResponseStatus' - -- | The response status code.
putAppReplicationConfigurationResponse ::
  -- | 'parcrrsResponseStatus'
  Int ->
  PutAppReplicationConfigurationResponse
...
parcrrsResponseStatus :: Lens' PutAppReplicationConfigurationResponse Int
parcrrsResponseStatus = lens _parcrrsResponseStatus (\s a -> s {_parcrrsResponseStatus = a})
