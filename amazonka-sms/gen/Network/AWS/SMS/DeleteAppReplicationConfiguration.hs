...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'darcrrsResponseStatus' - -- | The response status code.
deleteAppReplicationConfigurationResponse ::
  -- | 'darcrrsResponseStatus'
  Int ->
  DeleteAppReplicationConfigurationResponse
...
darcrrsResponseStatus :: Lens' DeleteAppReplicationConfigurationResponse Int
darcrrsResponseStatus = lens _darcrrsResponseStatus (\s a -> s {_darcrrsResponseStatus = a})
