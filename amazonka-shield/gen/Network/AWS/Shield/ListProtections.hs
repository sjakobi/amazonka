...
instance AWSPager ListProtections where
  page rq rs
    ...
    | stop (rs ^. lprrsProtections) = Nothing
    | otherwise =
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'lprrsNextToken' - If you specify a value for @MaxResults@ and you have more Protections than the value of MaxResults, AWS Shield Advanced returns a NextToken value in the response that allows you to list another group of Protections. For the second and subsequent ListProtections requests, specify the value of NextToken from the previous response to get information about another batch of Protections. Shield Advanced might return the list of 'Protection' objects in batches smaller than the number specified by MaxResults. If there are more 'Protection' objects to return, Shield Advanced will always also return a @NextToken@ .
--
-- * 'lprrsProtections' - The array of enabled 'Protection' objects.
--
...
listProtectionsResponse pResponseStatus_ =
  ListProtectionsResponse'
    { _lprrsNextToken = Nothing,
      _lprrsProtections = Nothing,
      _lprrsResponseStatus = pResponseStatus_
    }

-- | If you specify a value for @MaxResults@ and you have more Protections than the value of MaxResults, AWS Shield Advanced returns a NextToken value in the response that allows you to list another group of Protections. For the second and subsequent ListProtections requests, specify the value of NextToken from the previous response to get information about another batch of Protections. Shield Advanced might return the list of 'Protection' objects in batches smaller than the number specified by MaxResults. If there are more 'Protection' objects to return, Shield Advanced will always also return a @NextToken@ .
lprrsNextToken :: Lens' ListProtectionsResponse (Maybe Text)
lprrsNextToken = lens _lprrsNextToken (\s a -> s {_lprrsNextToken = a})

-- | The array of enabled 'Protection' objects.
lprrsProtections :: Lens' ListProtectionsResponse [Protection]
lprrsProtections = lens _lprrsProtections (\s a -> s {_lprrsProtections = a}) . _Default . _Coerce

-- | -- | The response status code.
lprrsResponseStatus :: Lens' ListProtectionsResponse Int
