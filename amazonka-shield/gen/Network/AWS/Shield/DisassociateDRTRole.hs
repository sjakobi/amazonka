...
instance Hashable DisassociateDRTRole

instance NFData DisassociateDRTRole
...
--
-- * 'ddrtrrrsResponseStatus' - -- | The response status code.
disassociateDRTRoleResponse ::
  -- | 'ddrtrrrsResponseStatus'
  Int ->
  DisassociateDRTRoleResponse
...
ddrtrrrsResponseStatus :: Lens' DisassociateDRTRoleResponse Int
ddrtrrrsResponseStatus = lens _ddrtrrrsResponseStatus (\s a -> s {_ddrtrrrsResponseStatus = a})

instance NFData DisassociateDRTRoleResponse
