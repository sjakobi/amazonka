...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ddrtlbrrsResponseStatus' - -- | The response status code.
disassociateDRTLogBucketResponse ::
  -- | 'ddrtlbrrsResponseStatus'
  Int ->
  DisassociateDRTLogBucketResponse
...
ddrtlbrrsResponseStatus :: Lens' DisassociateDRTLogBucketResponse Int
ddrtlbrrsResponseStatus = lens _ddrtlbrrsResponseStatus (\s a -> s {_ddrtlbrrsResponseStatus = a})
