...
data Extensions = Extensions'
  { -- | Contains a sequence of one or more policy information terms, each of
    ...
    certificatePolicies :: Prelude.Maybe (Prelude.List1 PolicyInformation),
    ...
    extendedKeyUsage :: Prelude.Maybe (Prelude.List1 ExtendedKeyUsage),
    ...
    -- certificate.
    subjectAlternativeNames :: Prelude.Maybe (Prelude.List1 GeneralName),
...
extensions_certificatePolicies = Lens.lens (\Extensions' {certificatePolicies} -> certificatePolicies) (\s@Extensions' {} a -> s {certificatePolicies = a} :: Extensions) Prelude.. Lens.mapping Prelude._List1

-- | Specifies additional purposes for which the certified public key may be
-- used other than basic purposes indicated in the @KeyUsage@ extension.
extensions_extendedKeyUsage :: Lens.Lens' Extensions (Prelude.Maybe (Prelude.NonEmpty ExtendedKeyUsage))
extensions_extendedKeyUsage = Lens.lens (\Extensions' {extendedKeyUsage} -> extendedKeyUsage) (\s@Extensions' {} a -> s {extendedKeyUsage = a} :: Extensions) Prelude.. Lens.mapping Prelude._List1
...
extensions_subjectAlternativeNames = Lens.lens (\Extensions' {subjectAlternativeNames} -> subjectAlternativeNames) (\s@Extensions' {} a -> s {subjectAlternativeNames = a} :: Extensions) Prelude.. Lens.mapping Prelude._List1
...
instance Prelude.ToJSON Extensions where
  toJSON Extensions' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("CertificatePolicies" Prelude..=)
