...
--
--
-- A policy can also be applied by sharing a private CA through AWS Resource Access Manager (RAM). For more information, see <https://docs.aws.amazon.com/acm-pca/latest/userguide/pca-ram.html Attach a Policy for Cross-Account Access> .
--
...
instance ToHeaders PutPolicy where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
              =# ("ACMPrivateCA.PutPolicy" :: ByteString),
            "Content-Type"
