...
--
-- * 'dPermanentDeletionTimeInDays' - The number of days to make a CA restorable after it has been deleted. This can be anywhere from 7 to 30 days, with 30 being the default.
--
...
dPermanentDeletionTimeInDays :: Lens' DeleteCertificateAuthority (Maybe Natural)
dPermanentDeletionTimeInDays = lens _dPermanentDeletionTimeInDays (\s a -> s {_dPermanentDeletionTimeInDays = a}) . mapping _Nat

-- | The Amazon Resource Name (ARN) that was returned when you called <https://docs.aws.amazon.com/acm-pca/latest/APIReference/API_CreateCertificateAuthority.html CreateCertificateAuthority> . This must have the following form:  @arn:aws:acm-pca:/region/ :/account/ :certificate-authority//12345678-1234-1234-1234-123456789012/ @ .
dCertificateAuthorityARN :: Lens' DeleteCertificateAuthority Text
