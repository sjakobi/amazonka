...
data PutIntegration = PutIntegration'
  { -- | Specifies a put integration HTTP method. When the integration type is
    ...
    requestTemplates :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
    ...
    requestParameters :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
...
putIntegration_requestTemplates = Lens.lens (\PutIntegration' {requestTemplates} -> requestTemplates) (\s@PutIntegration' {} a -> s {requestTemplates = a} :: PutIntegration) Prelude.. Lens.mapping Prelude._Map
...
putIntegration_cacheKeyParameters = Lens.lens (\PutIntegration' {cacheKeyParameters} -> cacheKeyParameters) (\s@PutIntegration' {} a -> s {cacheKeyParameters = a} :: PutIntegration) Prelude.. Lens.mapping Prelude._Coerce
...
putIntegration_requestParameters = Lens.lens (\PutIntegration' {requestParameters} -> requestParameters) (\s@PutIntegration' {} a -> s {requestParameters = a} :: PutIntegration) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.AWSRequest PutIntegration where
...
instance Prelude.ToHeaders PutIntegration where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Accept"
...
instance Prelude.ToJSON PutIntegration where
  toJSON PutIntegration' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("httpMethod" Prelude..=)
              Prelude.<$> integrationHttpMethod,
            ("passthroughBehavior" Prelude..=)
            ...
            ("requestTemplates" Prelude..=)
              Prelude.<$> requestTemplates,
            ("timeoutInMillis" Prelude..=)
              Prelude.<$> timeoutInMillis,
            ("cacheNamespace" Prelude..=)
              Prelude.<$> cacheNamespace,
            ("cacheKeyParameters" Prelude..=)
              Prelude.<$> cacheKeyParameters,
            ("tlsConfig" Prelude..=) Prelude.<$> tlsConfig,
            ("requestParameters" Prelude..=)
              Prelude.<$> requestParameters,
            ("credentials" Prelude..=) Prelude.<$> credentials,
            Prelude.Just ("type" Prelude..= type')
          ]
      )

instance Prelude.ToPath PutIntegration where
...
instance Prelude.ToQuery PutIntegration where
