...
data ApiStage = ApiStage'
  { -- | API Id of the associated API stage in a usage plan.
    ...
    -- usage plan.
    throttle :: Prelude.Maybe (Prelude.Map Prelude.Text ThrottleSettings)
  }
...
apiStage_throttle = Lens.lens (\ApiStage' {throttle} -> throttle) (\s@ApiStage' {} a -> s {throttle = a} :: ApiStage) Prelude.. Lens.mapping Prelude._Map
