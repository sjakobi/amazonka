...
data Method = Method'
  { -- | The method\'s HTTP verb.
    ...
    -- the mapping key).
    requestModels :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
    ...
    methodResponses :: Prelude.Maybe (Prelude.Map Prelude.Text MethodResponse),
    ...
    -- or templates.
    requestParameters :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Bool),
...
method_requestModels = Lens.lens (\Method' {requestModels} -> requestModels) (\s@Method' {} a -> s {requestModels = a} :: Method) Prelude.. Lens.mapping Prelude._Map
...
method_methodResponses = Lens.lens (\Method' {methodResponses} -> methodResponses) (\s@Method' {} a -> s {methodResponses = a} :: Method) Prelude.. Lens.mapping Prelude._Map
...
method_requestParameters = Lens.lens (\Method' {requestParameters} -> requestParameters) (\s@Method' {} a -> s {requestParameters = a} :: Method) Prelude.. Lens.mapping Prelude._Map
...
method_authorizationScopes = Lens.lens (\Method' {authorizationScopes} -> authorizationScopes) (\s@Method' {} a -> s {authorizationScopes = a} :: Method) Prelude.. Lens.mapping Prelude._Coerce

instance Prelude.FromJSON Method where
  parseJSON =
    Prelude.withObject
      "Method"
      ( \x ->
          Method'
            ...
            Prelude.<*> (x Prelude..:? "methodIntegration")
            Prelude.<*> (x Prelude..:? "apiKeyRequired")
            Prelude.<*> (x Prelude..:? "authorizationType")
            Prelude.<*> ( x Prelude..:? "requestModels"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "operationName")
            Prelude.<*> (x Prelude..:? "requestValidatorId")
            Prelude.<*> ( x Prelude..:? "methodResponses"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "authorizerId")
            Prelude.<*> ( x Prelude..:? "requestParameters"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> ( x Prelude..:? "authorizationScopes"
                            Prelude..!= Prelude.mempty
                        )
      )
