...
data Resource = Resource'
  { -- | The resource\'s identifier.
    ...
    resourceMethods :: Prelude.Maybe (Prelude.Map Prelude.Text Method),
...
resource_resourceMethods = Lens.lens (\Resource' {resourceMethods} -> resourceMethods) (\s@Resource' {} a -> s {resourceMethods = a} :: Resource) Prelude.. Lens.mapping Prelude._Map
