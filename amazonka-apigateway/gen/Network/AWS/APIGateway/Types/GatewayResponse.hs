...
data GatewayResponse = GatewayResponse'
  { -- | Response templates of the GatewayResponse as a string-to-string map of
    -- key-value pairs.
    responseTemplates :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
    ...
    responseParameters :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
...
gatewayResponse_responseTemplates = Lens.lens (\GatewayResponse' {responseTemplates} -> responseTemplates) (\s@GatewayResponse' {} a -> s {responseTemplates = a} :: GatewayResponse) Prelude.. Lens.mapping Prelude._Map
...
gatewayResponse_responseParameters = Lens.lens (\GatewayResponse' {responseParameters} -> responseParameters) (\s@GatewayResponse' {} a -> s {responseParameters = a} :: GatewayResponse) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.FromJSON GatewayResponse where
  parseJSON =
    Prelude.withObject
      "GatewayResponse"
      ( \x ->
          GatewayResponse'
            ...
            Prelude.<*> (x Prelude..:? "responseType")
            Prelude.<*> (x Prelude..:? "defaultResponse")
      )
