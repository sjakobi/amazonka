...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dtacrrrsResult' - The detailed results of the Trusted Advisor check.
--
-- * 'dtacrrrsResponseStatus' - -- | The response status code.
describeTrustedAdvisorCheckResultResponse ::
  -- | 'dtacrrrsResponseStatus'
  Int ->
  DescribeTrustedAdvisorCheckResultResponse
...
dtacrrrsResult :: Lens' DescribeTrustedAdvisorCheckResultResponse (Maybe TrustedAdvisorCheckResult)
dtacrrrsResult = lens _dtacrrrsResult (\s a -> s {_dtacrrrsResult = a})

-- | -- | The response status code.
dtacrrrsResponseStatus :: Lens' DescribeTrustedAdvisorCheckResultResponse Int
dtacrrrsResponseStatus = lens _dtacrrrsResponseStatus (\s a -> s {_dtacrrrsResponseStatus = a})
