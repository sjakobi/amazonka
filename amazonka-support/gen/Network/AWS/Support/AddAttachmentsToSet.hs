...
data AddAttachmentsToSetResponse = AddAttachmentsToSetResponse'
  { _aatsrrsExpiryTime ::
      !(Maybe Text),
    _aatsrrsAttachmentSetId ::
      !(Maybe Text),
    _aatsrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'aatsrrsExpiryTime' - The time and date when the attachment set expires.
--
-- * 'aatsrrsAttachmentSetId' - The ID of the attachment set. If an @attachmentSetId@ was not specified, a new attachment set is created, and the ID of the set is returned in the response. If an @attachmentSetId@ was specified, the attachments are added to the specified set, if it exists.
--
-- * 'aatsrrsResponseStatus' - -- | The response status code.
addAttachmentsToSetResponse ::
  -- | 'aatsrrsResponseStatus'
  Int ->
  AddAttachmentsToSetResponse
addAttachmentsToSetResponse pResponseStatus_ =
  AddAttachmentsToSetResponse'
    { _aatsrrsExpiryTime =
        Nothing,
      _aatsrrsAttachmentSetId = Nothing,
      _aatsrrsResponseStatus = pResponseStatus_
    }

-- | The time and date when the attachment set expires.
aatsrrsExpiryTime :: Lens' AddAttachmentsToSetResponse (Maybe Text)
aatsrrsExpiryTime = lens _aatsrrsExpiryTime (\s a -> s {_aatsrrsExpiryTime = a})

-- | The ID of the attachment set. If an @attachmentSetId@ was not specified, a new attachment set is created, and the ID of the set is returned in the response. If an @attachmentSetId@ was specified, the attachments are added to the specified set, if it exists.
aatsrrsAttachmentSetId :: Lens' AddAttachmentsToSetResponse (Maybe Text)
aatsrrsAttachmentSetId = lens _aatsrrsAttachmentSetId (\s a -> s {_aatsrrsAttachmentSetId = a})

-- | -- | The response status code.
aatsrrsResponseStatus :: Lens' AddAttachmentsToSetResponse Int
aatsrrsResponseStatus = lens _aatsrrsResponseStatus (\s a -> s {_aatsrrsResponseStatus = a})
