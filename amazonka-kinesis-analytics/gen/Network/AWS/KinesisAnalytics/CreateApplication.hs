...
--
-- * 'carrsApplicationSummary' - In response to your @CreateApplication@ request, Amazon Kinesis Analytics returns a response with a summary of the application it created, including the application Amazon Resource Name (ARN), name, and status.
createApplicationResponse ::
  -- | 'carrsResponseStatus'
  Int ->
  -- | 'carrsApplicationSummary'
...
createApplicationResponse
  ...
  pApplicationSummary_ =
    CreateApplicationResponse'
      { _carrsResponseStatus =
          pResponseStatus_,
        _carrsApplicationSummary = pApplicationSummary_
      }
...
carrsApplicationSummary :: Lens' CreateApplicationResponse ApplicationSummary
carrsApplicationSummary = lens _carrsApplicationSummary (\s a -> s {_carrsApplicationSummary = a})
