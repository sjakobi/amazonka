  ...
  pApplicationVersionId_ =
    ApplicationDetail'
      { _adApplicationCode = Nothing,
        ...
        _adApplicationVersionId =
          _Nat # pApplicationVersionId_
      }
