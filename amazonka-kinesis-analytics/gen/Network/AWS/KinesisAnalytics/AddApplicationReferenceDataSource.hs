...
instance AWSRequest AddApplicationReferenceDataSource where
  type
...
instance ToHeaders AddApplicationReferenceDataSource where
  toHeaders =
    const
      ( mconcat
          [ "X-Amz-Target"
...
instance ToJSON AddApplicationReferenceDataSource where
...
instance ToPath AddApplicationReferenceDataSource where
  toPath = const "/"

instance ToQuery AddApplicationReferenceDataSource where
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'aardsrrsResponseStatus' - -- | The response status code.
addApplicationReferenceDataSourceResponse ::
  -- | 'aardsrrsResponseStatus'
  Int ->
  AddApplicationReferenceDataSourceResponse
...
aardsrrsResponseStatus :: Lens' AddApplicationReferenceDataSourceResponse Int
aardsrrsResponseStatus = lens _aardsrrsResponseStatus (\s a -> s {_aardsrrsResponseStatus = a})
