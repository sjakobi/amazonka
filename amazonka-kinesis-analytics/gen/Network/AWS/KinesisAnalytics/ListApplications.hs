...
data ListApplicationsResponse = ListApplicationsResponse'
  { _larrsResponseStatus ::
      !Int,
    _larrsApplicationSummaries ::
      ![ApplicationSummary],
    _larrsHasMoreApplications ::
      !Bool
  }
  deriving
    ( Eq,
...
--
-- * 'larrsApplicationSummaries' - List of @ApplicationSummary@ objects.
--
-- * 'larrsHasMoreApplications' - Returns true if there are more applications to retrieve.
listApplicationsResponse ::
  -- | 'larrsResponseStatus'
  Int ->
  -- | 'larrsHasMoreApplications'
...
listApplicationsResponse
  ...
  pHasMoreApplications_ =
    ListApplicationsResponse'
      { _larrsResponseStatus =
          pResponseStatus_,
        _larrsApplicationSummaries = mempty,
        _larrsHasMoreApplications = pHasMoreApplications_
      }
...
larrsApplicationSummaries :: Lens' ListApplicationsResponse [ApplicationSummary]
larrsApplicationSummaries = lens _larrsApplicationSummaries (\s a -> s {_larrsApplicationSummaries = a}) . _Coerce

-- | Returns true if there are more applications to retrieve.
larrsHasMoreApplications :: Lens' ListApplicationsResponse Bool
larrsHasMoreApplications = lens _larrsHasMoreApplications (\s a -> s {_larrsHasMoreApplications = a})
