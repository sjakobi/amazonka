...
data GetDASHStreamingSessionURL = GetDASHStreamingSessionURL'
  { -- | Per the MPEG-DASH specification, the wall-clock time of fragments in the
    ...
    maxManifestFragmentResults :: Prelude.Maybe Prelude.Nat,
...
getDASHStreamingSessionURL_maxManifestFragmentResults = Lens.lens (\GetDASHStreamingSessionURL' {maxManifestFragmentResults} -> maxManifestFragmentResults) (\s@GetDASHStreamingSessionURL' {} a -> s {maxManifestFragmentResults = a} :: GetDASHStreamingSessionURL) Prelude.. Lens.mapping Prelude._Nat
...
getDASHStreamingSessionURL_expires = Lens.lens (\GetDASHStreamingSessionURL' {expires} -> expires) (\s@GetDASHStreamingSessionURL' {} a -> s {expires = a} :: GetDASHStreamingSessionURL) Prelude.. Lens.mapping Prelude._Nat
