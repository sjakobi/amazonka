...
data GetHLSStreamingSessionURL = GetHLSStreamingSessionURL'
  { -- | The maximum number of fragments that are returned in the HLS media
    ...
    maxMediaPlaylistFragmentResults :: Prelude.Maybe Prelude.Nat,
    ...
    expires :: Prelude.Maybe Prelude.Nat,
...
getHLSStreamingSessionURL_maxMediaPlaylistFragmentResults = Lens.lens (\GetHLSStreamingSessionURL' {maxMediaPlaylistFragmentResults} -> maxMediaPlaylistFragmentResults) (\s@GetHLSStreamingSessionURL' {} a -> s {maxMediaPlaylistFragmentResults = a} :: GetHLSStreamingSessionURL) Prelude.. Lens.mapping Prelude._Nat
...
getHLSStreamingSessionURL_expires = Lens.lens (\GetHLSStreamingSessionURL' {expires} -> expires) (\s@GetHLSStreamingSessionURL' {} a -> s {expires = a} :: GetHLSStreamingSessionURL) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.AWSRequest GetHLSStreamingSessionURL where
  type
  ...
  response =
    Response.receiveJSON
      ( \s h x ->
          GetHLSStreamingSessionURLResponse'
            Prelude.<$> (x Prelude..?> "HLSStreamingSessionURL")
...
instance Prelude.ToHeaders GetHLSStreamingSessionURL where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToJSON GetHLSStreamingSessionURL where
  toJSON GetHLSStreamingSessionURL' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("MaxMediaPlaylistFragmentResults" Prelude..=)
              Prelude.<$> maxMediaPlaylistFragmentResults,
            ("ContainerFormat" Prelude..=)
            ...
            ("DiscontinuityMode" Prelude..=)
              Prelude.<$> discontinuityMode,
            ("HLSFragmentSelector" Prelude..=)
              Prelude.<$> hLSFragmentSelector
          ]
      )

instance Prelude.ToPath GetHLSStreamingSessionURL where
  toPath = Prelude.const "/getHLSStreamingSessionURL"

instance Prelude.ToQuery GetHLSStreamingSessionURL where
