  ...
  pCaptionChannel_ =
    CaptionLanguageMapping'
      { languageCode =
        ...
        captionChannel =
          Prelude._Nat Lens.# pCaptionChannel_
      }
...
captionLanguageMapping_captionChannel = Lens.lens (\CaptionLanguageMapping' {captionChannel} -> captionChannel) (\s@CaptionLanguageMapping' {} a -> s {captionChannel = a} :: CaptionLanguageMapping) Prelude.. Prelude._Nat
