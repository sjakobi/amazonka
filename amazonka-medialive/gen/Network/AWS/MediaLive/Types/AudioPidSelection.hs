...
newAudioPidSelection pPid_ =
  AudioPidSelection' {pid = Prelude._Nat Lens.# pPid_}

-- | Selects a specific PID from within a source.
audioPidSelection_pid :: Lens.Lens' AudioPidSelection Prelude.Natural
audioPidSelection_pid = Lens.lens (\AudioPidSelection' {pid} -> pid) (\s@AudioPidSelection' {} a -> s {pid = a} :: AudioPidSelection) Prelude.. Prelude._Nat
