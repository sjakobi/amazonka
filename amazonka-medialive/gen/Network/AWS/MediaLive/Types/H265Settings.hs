...
data H265Settings = H265Settings'
  { -- | Sets the scan type of the output to progressive or top-field-first
    ...
    -- 23.976 fps.
    framerateNumerator :: Prelude.Nat,
    -- | Framerate denominator.
    framerateDenominator :: Prelude.Nat
  }
  ...
  pFramerateDenominator_ =
    H265Settings'
      { scanType = Prelude.Nothing,
        ...
        framerateNumerator =
          Prelude._Nat Lens.# pFramerateNumerator_,
        framerateDenominator =
          Prelude._Nat Lens.# pFramerateDenominator_
      }
...
h265Settings_bufSize = Lens.lens (\H265Settings' {bufSize} -> bufSize) (\s@H265Settings' {} a -> s {bufSize = a} :: H265Settings) Prelude.. Lens.mapping Prelude._Nat
...
h265Settings_qvbrQualityLevel = Lens.lens (\H265Settings' {qvbrQualityLevel} -> qvbrQualityLevel) (\s@H265Settings' {} a -> s {qvbrQualityLevel = a} :: H265Settings) Prelude.. Lens.mapping Prelude._Nat
...
h265Settings_framerateNumerator = Lens.lens (\H265Settings' {framerateNumerator} -> framerateNumerator) (\s@H265Settings' {} a -> s {framerateNumerator = a} :: H265Settings) Prelude.. Prelude._Nat

-- | Framerate denominator.
h265Settings_framerateDenominator :: Lens.Lens' H265Settings Prelude.Natural
h265Settings_framerateDenominator = Lens.lens (\H265Settings' {framerateDenominator} -> framerateDenominator) (\s@H265Settings' {} a -> s {framerateDenominator = a} :: H265Settings) Prelude.. Prelude._Nat
