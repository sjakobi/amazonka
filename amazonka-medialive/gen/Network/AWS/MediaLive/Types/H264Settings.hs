...
data H264Settings = H264Settings'
  { -- | Sets the scan type of the output to progressive or top-field-first
    ...
    bufSize :: Prelude.Maybe Prelude.Nat,
    ...
    gopNumBFrames :: Prelude.Maybe Prelude.Nat,
    ...
    -- model).
    bufFillPct :: Prelude.Maybe Prelude.Nat,
    ...
    numRefFrames :: Prelude.Maybe Prelude.Nat,
    -- | H.264 Level.
...
h264Settings_bufSize = Lens.lens (\H264Settings' {bufSize} -> bufSize) (\s@H264Settings' {} a -> s {bufSize = a} :: H264Settings) Prelude.. Lens.mapping Prelude._Nat
...
h264Settings_gopNumBFrames = Lens.lens (\H264Settings' {gopNumBFrames} -> gopNumBFrames) (\s@H264Settings' {} a -> s {gopNumBFrames = a} :: H264Settings) Prelude.. Lens.mapping Prelude._Nat
...
h264Settings_qvbrQualityLevel = Lens.lens (\H264Settings' {qvbrQualityLevel} -> qvbrQualityLevel) (\s@H264Settings' {} a -> s {qvbrQualityLevel = a} :: H264Settings) Prelude.. Lens.mapping Prelude._Nat
...
h264Settings_bufFillPct = Lens.lens (\H264Settings' {bufFillPct} -> bufFillPct) (\s@H264Settings' {} a -> s {bufFillPct = a} :: H264Settings) Prelude.. Lens.mapping Prelude._Nat
...
h264Settings_numRefFrames = Lens.lens (\H264Settings' {numRefFrames} -> numRefFrames) (\s@H264Settings' {} a -> s {numRefFrames = a} :: H264Settings) Prelude.. Lens.mapping Prelude._Nat
