...
--
-- * 'stTimecode' - The timecode for the frame where you want to start the clip. Optional; if not specified, the clip starts at first frame in the file. Enter the timecode as HH:MM:SS:FF or HH:MM:SS;FF.
startTimecode ::
  StartTimecode
startTimecode = StartTimecode' {_stTimecode = Nothing}

-- | The timecode for the frame where you want to start the clip. Optional; if not specified, the clip starts at first frame in the file. Enter the timecode as HH:MM:SS:FF or HH:MM:SS;FF.
stTimecode :: Lens' StartTimecode (Maybe Text)
...
instance ToJSON StartTimecode where
  toJSON StartTimecode' {..} =
    object
      (catMaybes [("timecode" .=) <$> _stTimecode])
