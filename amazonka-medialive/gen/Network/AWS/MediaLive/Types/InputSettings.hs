...
data InputSettings = InputSettings'
  { -- | Enable or disable the denoise filter when filtering.
    ...
    filterStrength :: Prelude.Maybe Prelude.Nat,
...
inputSettings_filterStrength = Lens.lens (\InputSettings' {filterStrength} -> filterStrength) (\s@InputSettings' {} a -> s {filterStrength = a} :: InputSettings) Prelude.. Lens.mapping Prelude._Nat
