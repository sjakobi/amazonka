...
scte35ReturnToNetworkScheduleActionSettings_spliceEventId = Lens.lens (\Scte35ReturnToNetworkScheduleActionSettings' {spliceEventId} -> spliceEventId) (\s@Scte35ReturnToNetworkScheduleActionSettings' {} a -> s {spliceEventId = a} :: Scte35ReturnToNetworkScheduleActionSettings) Prelude.. Prelude._Nat
