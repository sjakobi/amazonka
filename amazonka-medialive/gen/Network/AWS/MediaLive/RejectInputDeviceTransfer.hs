...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ridtrrsResponseStatus' - -- | The response status code.
rejectInputDeviceTransferResponse ::
  -- | 'ridtrrsResponseStatus'
  Int ->
  RejectInputDeviceTransferResponse
...
ridtrrsResponseStatus :: Lens' RejectInputDeviceTransferResponse Int
ridtrrsResponseStatus = lens _ridtrrsResponseStatus (\s a -> s {_ridtrrsResponseStatus = a})
