...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'usrrsARN' - The ARN of the secret that was updated.
--
-- * 'usrrsVersionId' - If a new version of the secret was created by this operation, then @VersionId@ contains the unique identifier of the new version.
--
-- * 'usrrsName' - The friendly name of the secret that was updated.
--
...
updateSecretResponse pResponseStatus_ =
  UpdateSecretResponse'
    { _usrrsARN = Nothing,
      _usrrsVersionId = Nothing,
      _usrrsName = Nothing,
      _usrrsResponseStatus = pResponseStatus_
    }

-- | The ARN of the secret that was updated.
usrrsARN :: Lens' UpdateSecretResponse (Maybe Text)
usrrsARN = lens _usrrsARN (\s a -> s {_usrrsARN = a})
...
usrrsVersionId :: Lens' UpdateSecretResponse (Maybe Text)
usrrsVersionId = lens _usrrsVersionId (\s a -> s {_usrrsVersionId = a})

-- | The friendly name of the secret that was updated.
usrrsName :: Lens' UpdateSecretResponse (Maybe Text)
usrrsName = lens _usrrsName (\s a -> s {_usrrsName = a})

-- | -- | The response status code.
usrrsResponseStatus :: Lens' UpdateSecretResponse Int
