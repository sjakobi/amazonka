...
--
-- * 'fValues' - Filters your list of secrets by a specific value. You can prefix your search value with an exclamation mark (@!@ ) in order to perform negation filters.
filter' ::
  Filter
filter' =
  Filter' {_fKey = Nothing, _fValues = Nothing}
