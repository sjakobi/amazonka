  ...
  pMailboxQuota_ =
    UpdateMailboxQuota'
      { organizationId =
          pOrganizationId_,
        userId = pUserId_,
        mailboxQuota = Prelude._Nat Lens.# pMailboxQuota_
      }
...
updateMailboxQuota_mailboxQuota = Lens.lens (\UpdateMailboxQuota' {mailboxQuota} -> mailboxQuota) (\s@UpdateMailboxQuota' {} a -> s {mailboxQuota = a} :: UpdateMailboxQuota) Prelude.. Prelude._Nat
