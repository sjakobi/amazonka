...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'usgrrsSubnetGroup' - The subnet group that has been modified.
--
...
updateSubnetGroupResponse pResponseStatus_ =
  UpdateSubnetGroupResponse'
    { _usgrrsSubnetGroup =
        Nothing,
      _usgrrsResponseStatus = pResponseStatus_
    }

-- | The subnet group that has been modified.
usgrrsSubnetGroup :: Lens' UpdateSubnetGroupResponse (Maybe SubnetGroup)
usgrrsSubnetGroup = lens _usgrrsSubnetGroup (\s a -> s {_usgrrsSubnetGroup = a})

-- | -- | The response status code.
usgrrsResponseStatus :: Lens' UpdateSubnetGroupResponse Int
