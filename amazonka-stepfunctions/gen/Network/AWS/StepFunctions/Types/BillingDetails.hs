...
data BillingDetails = BillingDetails'
  { -- | Billed memory consumption of your workflow, in MB.
    billedMemoryUsedInMB :: Prelude.Maybe Prelude.Nat,
    -- | Billed duration of your workflow, in milliseconds.
    billedDurationInMilliseconds :: Prelude.Maybe Prelude.Nat
  }
...
billingDetails_billedMemoryUsedInMB = Lens.lens (\BillingDetails' {billedMemoryUsedInMB} -> billedMemoryUsedInMB) (\s@BillingDetails' {} a -> s {billedMemoryUsedInMB = a} :: BillingDetails) Prelude.. Lens.mapping Prelude._Nat

-- | Billed duration of your workflow, in milliseconds.
billingDetails_billedDurationInMilliseconds :: Lens.Lens' BillingDetails (Prelude.Maybe Prelude.Natural)
billingDetails_billedDurationInMilliseconds = Lens.lens (\BillingDetails' {billedDurationInMilliseconds} -> billedDurationInMilliseconds) (\s@BillingDetails' {} a -> s {billedDurationInMilliseconds = a} :: BillingDetails) Prelude.. Lens.mapping Prelude._Nat
