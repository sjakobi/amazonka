...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'upsrrsPipeline' - A section of the response body that provides information about the pipeline.
--
...
upsrrsPipeline :: Lens' UpdatePipelineStatusResponse (Maybe Pipeline)
upsrrsPipeline = lens _upsrrsPipeline (\s a -> s {_upsrrsPipeline = a})

-- | -- | The response status code.
upsrrsResponseStatus :: Lens' UpdatePipelineStatusResponse Int
