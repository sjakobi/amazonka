...
uprrsWarnings :: Lens' UpdatePipelineResponse [Warning]
uprrsWarnings = lens _uprrsWarnings (\s a -> s {_uprrsWarnings = a}) . _Default . _Coerce

-- | The pipeline updated by this @UpdatePipelineResponse@ call.
uprrsPipeline :: Lens' UpdatePipelineResponse (Maybe Pipeline)
