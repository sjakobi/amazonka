...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'upnrrsPipeline' - A section of the response body that provides information about the pipeline associated with this notification.
--
-- * 'upnrrsResponseStatus' - -- | The response status code.
updatePipelineNotificationsResponse ::
  -- | 'upnrrsResponseStatus'
  Int ->
  UpdatePipelineNotificationsResponse
...
upnrrsPipeline :: Lens' UpdatePipelineNotificationsResponse (Maybe Pipeline)
upnrrsPipeline = lens _upnrrsPipeline (\s a -> s {_upnrrsPipeline = a})

-- | -- | The response status code.
upnrrsResponseStatus :: Lens' UpdatePipelineNotificationsResponse Int
upnrrsResponseStatus = lens _upnrrsResponseStatus (\s a -> s {_upnrrsResponseStatus = a})
