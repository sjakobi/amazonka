...
createPipelineResponse pResponseStatus_ =
  CreatePipelineResponse'
    { _crersWarnings = Nothing,
      _crersPipeline = Nothing,
...
crersWarnings :: Lens' CreatePipelineResponse [Warning]
crersWarnings = lens _crersWarnings (\s a -> s {_crersWarnings = a}) . _Default . _Coerce

-- | A section of the response body that provides information about the pipeline that is created.
crersPipeline :: Lens' CreatePipelineResponse (Maybe Pipeline)
crersPipeline = lens _crersPipeline (\s a -> s {_crersPipeline = a})

-- | -- | The response status code.
crersResponseStatus :: Lens' CreatePipelineResponse Int
