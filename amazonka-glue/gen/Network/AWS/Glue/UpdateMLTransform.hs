...
updateMLTransform_timeout = Lens.lens (\UpdateMLTransform' {timeout} -> timeout) (\s@UpdateMLTransform' {} a -> s {timeout = a} :: UpdateMLTransform) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.AWSRequest UpdateMLTransform where
...
instance Prelude.ToHeaders UpdateMLTransform where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ("AWSGlue.UpdateMLTransform" :: Prelude.ByteString),
            "Content-Type"
...
instance Prelude.ToJSON UpdateMLTransform where
...
instance Prelude.ToPath UpdateMLTransform where
  toPath = Prelude.const "/"

instance Prelude.ToQuery UpdateMLTransform where
