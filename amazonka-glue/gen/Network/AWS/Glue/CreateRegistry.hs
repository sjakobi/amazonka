...
createRegistry_tags = Lens.lens (\CreateRegistry' {tags} -> tags) (\s@CreateRegistry' {} a -> s {tags = a} :: CreateRegistry) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.AWSRequest CreateRegistry where
...
instance Prelude.ToHeaders CreateRegistry where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ("AWSGlue.CreateRegistry" :: Prelude.ByteString),
            "Content-Type"
...
instance Prelude.ToJSON CreateRegistry where
    ...
    Prelude.object
      ( Prelude.catMaybes
          [ ("Tags" Prelude..=) Prelude.<$> tags,
            ...
            Prelude.Just
              ("RegistryName" Prelude..= registryName)
          ]
      )

instance Prelude.ToPath CreateRegistry where
  toPath = Prelude.const "/"

instance Prelude.ToQuery CreateRegistry where
...
createRegistryResponse_tags = Lens.lens (\CreateRegistryResponse' {tags} -> tags) (\s@CreateRegistryResponse' {} a -> s {tags = a} :: CreateRegistryResponse) Prelude.. Lens.mapping Prelude._Map
