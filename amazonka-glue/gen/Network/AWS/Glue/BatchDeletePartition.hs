...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'bdprrsErrors' - The errors encountered when trying to delete the requested partitions.
--
-- * 'bdprrsResponseStatus' - -- | The response status code.
batchDeletePartitionResponse ::
  -- | 'bdprrsResponseStatus'
  Int ->
  BatchDeletePartitionResponse
batchDeletePartitionResponse pResponseStatus_ =
  BatchDeletePartitionResponse'
    { _bdprrsErrors =
        Nothing,
      _bdprrsResponseStatus = pResponseStatus_
    }

-- | The errors encountered when trying to delete the requested partitions.
bdprrsErrors :: Lens' BatchDeletePartitionResponse [PartitionError]
bdprrsErrors = lens _bdprrsErrors (\s a -> s {_bdprrsErrors = a}) . _Default . _Coerce

-- | -- | The response status code.
bdprrsResponseStatus :: Lens' BatchDeletePartitionResponse Int
bdprrsResponseStatus = lens _bdprrsResponseStatus (\s a -> s {_bdprrsResponseStatus = a})
