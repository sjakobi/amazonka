...
createCrawler_classifiers = Lens.lens (\CreateCrawler' {classifiers} -> classifiers) (\s@CreateCrawler' {} a -> s {classifiers = a} :: CreateCrawler) Prelude.. Lens.mapping Prelude._Coerce
...
createCrawler_tags = Lens.lens (\CreateCrawler' {tags} -> tags) (\s@CreateCrawler' {} a -> s {tags = a} :: CreateCrawler) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.AWSRequest CreateCrawler where
...
instance Prelude.ToHeaders CreateCrawler where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ("AWSGlue.CreateCrawler" :: Prelude.ByteString),
            "Content-Type"
...
instance Prelude.ToJSON CreateCrawler where
...
instance Prelude.ToPath CreateCrawler where
  toPath = Prelude.const "/"

instance Prelude.ToQuery CreateCrawler where
