...
--
-- * 'fmmColumnImportances' - A list of @ColumnImportance@ structures containing column importance metrics, sorted in order of descending importance.
--
...
fmmColumnImportances :: Lens' FindMatchesMetrics [ColumnImportance]
fmmColumnImportances = lens _fmmColumnImportances (\s a -> s {_fmmColumnImportances = a}) . _Default . _Coerce
