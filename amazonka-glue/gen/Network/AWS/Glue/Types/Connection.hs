...
data Connection = Connection'
  { -- | These key-value pairs define parameters for the connection:
    ...
    connectionProperties :: Prelude.Maybe (Prelude.Map ConnectionPropertyKey Prelude.Text),
...
connection_connectionProperties = Lens.lens (\Connection' {connectionProperties} -> connectionProperties) (\s@Connection' {} a -> s {connectionProperties = a} :: Connection) Prelude.. Lens.mapping Prelude._Map
