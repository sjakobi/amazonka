...
data SkewedInfo = SkewedInfo'
  { -- | A list of names of columns that contain skewed values.
    ...
    skewedColumnValueLocationMaps :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text)
  }
...
skewedInfo_skewedColumnValueLocationMaps = Lens.lens (\SkewedInfo' {skewedColumnValueLocationMaps} -> skewedColumnValueLocationMaps) (\s@SkewedInfo' {} a -> s {skewedColumnValueLocationMaps = a} :: SkewedInfo) Prelude.. Lens.mapping Prelude._Map
