...
--
-- * 'drType' - The resource type in which you want to log data events. You can specify @AWS::S3::Object@ or @AWS::Lambda::Function@ resources. The @AWS::S3Outposts::Object@ resource type is not valid in basic event selectors. To log data events on this resource type, use advanced event selectors.
dataResource ::
  DataResource
dataResource =
  DataResource'
