...
data StartBuild = StartBuild'
  { -- | A buildspec file declaration that overrides, for this build only, the
    ...
    -- the build project.
    timeoutInMinutesOverride :: Prelude.Maybe Prelude.Nat,
...
startBuild_queuedTimeoutInMinutesOverride = Lens.lens (\StartBuild' {queuedTimeoutInMinutesOverride} -> queuedTimeoutInMinutesOverride) (\s@StartBuild' {} a -> s {queuedTimeoutInMinutesOverride = a} :: StartBuild) Prelude.. Lens.mapping Prelude._Nat
...
startBuild_gitCloneDepthOverride = Lens.lens (\StartBuild' {gitCloneDepthOverride} -> gitCloneDepthOverride) (\s@StartBuild' {} a -> s {gitCloneDepthOverride = a} :: StartBuild) Prelude.. Lens.mapping Prelude._Nat
...
startBuild_timeoutInMinutesOverride = Lens.lens (\StartBuild' {timeoutInMinutesOverride} -> timeoutInMinutesOverride) (\s@StartBuild' {} a -> s {timeoutInMinutesOverride = a} :: StartBuild) Prelude.. Lens.mapping Prelude._Nat
