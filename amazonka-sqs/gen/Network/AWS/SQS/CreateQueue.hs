...
data CreateQueue = CreateQueue'
  { -- | A map of attributes with their corresponding values.
    ...
    -- in the /Amazon Simple Queue Service Developer Guide/.
    attributes :: Prelude.Maybe (Prelude.Map QueueAttributeName Prelude.Text),
...
createQueue_attributes = Lens.lens (\CreateQueue' {attributes} -> attributes) (\s@CreateQueue' {} a -> s {attributes = a} :: CreateQueue) Prelude.. Lens.mapping Prelude._Map
