...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cqrrsQueueURL' - The URL of the created Amazon SQS queue.
--
...
createQueueResponse pResponseStatus_ =
  CreateQueueResponse'
    { _cqrrsQueueURL = Nothing,
      _cqrrsResponseStatus = pResponseStatus_
    }

-- | The URL of the created Amazon SQS queue.
cqrrsQueueURL :: Lens' CreateQueueResponse (Maybe Text)
cqrrsQueueURL = lens _cqrrsQueueURL (\s a -> s {_cqrrsQueueURL = a})
