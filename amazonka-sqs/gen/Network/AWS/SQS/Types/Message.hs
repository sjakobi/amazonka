...
data Message = Message'
  { -- | The message\'s contents (not URL-encoded).
    ...
    attributes :: Prelude.Maybe (Prelude.Map MessageAttribute Prelude.Text),
...
message_attributes = Lens.lens (\Message' {attributes} -> attributes) (\s@Message' {} a -> s {attributes = a} :: Message) Prelude.. Lens.mapping Prelude._Map
...
message_messageAttributes = Lens.lens (\Message' {messageAttributes} -> messageAttributes) (\s@Message' {} a -> s {messageAttributes = a} :: Message) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.FromXML Message where
  parseXML x =
    Message'
      Prelude.<$> (x Prelude..@? "Body")
      Prelude.<*> (x Prelude..@? "MD5OfBody")
      Prelude.<*> ( Prelude.may
      ...
      Prelude.<*> (x Prelude..@? "ReceiptHandle")
