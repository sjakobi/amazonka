...
data SendMessageBatchRequestEntry = SendMessageBatchRequestEntry'
  { -- | This parameter applies only to FIFO (first-in-first-out) queues.
    ...
    -- in the /Amazon Simple Queue Service Developer Guide/.
    messageAttributes :: Prelude.Maybe (Prelude.Map Prelude.Text MessageAttributeValue),
    ...
    messageSystemAttributes :: Prelude.Maybe (Prelude.Map MessageSystemAttributeNameForSends MessageSystemAttributeValue),
    -- | This parameter applies only to FIFO (first-in-first-out) queues.
    --
...
sendMessageBatchRequestEntry_messageAttributes = Lens.lens (\SendMessageBatchRequestEntry' {messageAttributes} -> messageAttributes) (\s@SendMessageBatchRequestEntry' {} a -> s {messageAttributes = a} :: SendMessageBatchRequestEntry) Prelude.. Lens.mapping Prelude._Map
...
sendMessageBatchRequestEntry_messageSystemAttributes = Lens.lens (\SendMessageBatchRequestEntry' {messageSystemAttributes} -> messageSystemAttributes) (\s@SendMessageBatchRequestEntry' {} a -> s {messageSystemAttributes = a} :: SendMessageBatchRequestEntry) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.ToQuery SendMessageBatchRequestEntry where
