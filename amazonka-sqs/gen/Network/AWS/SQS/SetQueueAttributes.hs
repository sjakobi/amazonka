...
data SetQueueAttributes = SetQueueAttributes'
  { -- | The URL of the Amazon SQS queue whose attributes are set.
    ...
    -- in the /Amazon Simple Queue Service Developer Guide/.
    attributes :: Prelude.Map QueueAttributeName Prelude.Text
  }
...
setQueueAttributes_attributes = Lens.lens (\SetQueueAttributes' {attributes} -> attributes) (\s@SetQueueAttributes' {} a -> s {attributes = a} :: SetQueueAttributes) Prelude.. Prelude._Map
