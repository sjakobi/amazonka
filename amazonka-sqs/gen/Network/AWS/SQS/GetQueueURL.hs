...
data GetQueueURLResponse = GetQueueURLResponse'
  { _gqurrsResponseStatus ::
      !Int,
    _gqurrsQueueURL :: !Text
  }
  deriving (Eq, Read, Show, Data, Typeable, Generic)
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gqurrsResponseStatus' - -- | The response status code.
--
-- * 'gqurrsQueueURL' - The URL of the queue.
getQueueURLResponse ::
  -- | 'gqurrsResponseStatus'
  Int ->
  -- | 'gqurrsQueueURL'
...
getQueueURLResponse pResponseStatus_ pQueueURL_ =
  GetQueueURLResponse'
    { _gqurrsResponseStatus =
        pResponseStatus_,
      _gqurrsQueueURL = pQueueURL_
    }

-- | -- | The response status code.
gqurrsResponseStatus :: Lens' GetQueueURLResponse Int
gqurrsResponseStatus = lens _gqurrsResponseStatus (\s a -> s {_gqurrsResponseStatus = a})

-- | The URL of the queue.
gqurrsQueueURL :: Lens' GetQueueURLResponse Text
gqurrsQueueURL = lens _gqurrsQueueURL (\s a -> s {_gqurrsQueueURL = a})
