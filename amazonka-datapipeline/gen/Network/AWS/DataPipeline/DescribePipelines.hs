...
--
-- * 'dprrsPipelineDescriptionList' - An array of descriptions for the specified pipelines.
describePipelinesResponse ::
  -- | 'dprrsResponseStatus'
  Int ->
  DescribePipelinesResponse
describePipelinesResponse pResponseStatus_ =
  DescribePipelinesResponse'
    { _dprrsResponseStatus =
        pResponseStatus_,
      _dprrsPipelineDescriptionList = mempty
    }

-- | -- | The response status code.
dprrsResponseStatus :: Lens' DescribePipelinesResponse Int
dprrsResponseStatus = lens _dprrsResponseStatus (\s a -> s {_dprrsResponseStatus = a})

-- | An array of descriptions for the specified pipelines.
dprrsPipelineDescriptionList :: Lens' DescribePipelinesResponse [PipelineDescription]
dprrsPipelineDescriptionList = lens _dprrsPipelineDescriptionList (\s a -> s {_dprrsPipelineDescriptionList = a}) . _Coerce
