...
data MedicalTranscriptionSetting = MedicalTranscriptionSetting'
  { -- | Determines whether alternative transcripts are generated along with the
    ...
    maxAlternatives :: Prelude.Maybe Prelude.Nat,
    ...
    maxSpeakerLabels :: Prelude.Maybe Prelude.Nat
  }
...
medicalTranscriptionSetting_maxAlternatives = Lens.lens (\MedicalTranscriptionSetting' {maxAlternatives} -> maxAlternatives) (\s@MedicalTranscriptionSetting' {} a -> s {maxAlternatives = a} :: MedicalTranscriptionSetting) Prelude.. Lens.mapping Prelude._Nat
...
medicalTranscriptionSetting_maxSpeakerLabels = Lens.lens (\MedicalTranscriptionSetting' {maxSpeakerLabels} -> maxSpeakerLabels) (\s@MedicalTranscriptionSetting' {} a -> s {maxSpeakerLabels = a} :: MedicalTranscriptionSetting) Prelude.. Lens.mapping Prelude._Nat

instance Prelude.FromJSON MedicalTranscriptionSetting where
  parseJSON =
    Prelude.withObject
      "MedicalTranscriptionSetting"
      ( \x ->
          MedicalTranscriptionSetting'
            Prelude.<$> (x Prelude..:? "ShowAlternatives")
            Prelude.<*> (x Prelude..:? "ChannelIdentification")
            Prelude.<*> (x Prelude..:? "MaxAlternatives")
            Prelude.<*> (x Prelude..:? "ShowSpeakerLabels")
            Prelude.<*> (x Prelude..:? "VocabularyName")
            Prelude.<*> (x Prelude..:? "MaxSpeakerLabels")
      )
...
instance Prelude.ToJSON MedicalTranscriptionSetting where
  toJSON MedicalTranscriptionSetting' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("ShowAlternatives" Prelude..=)
              Prelude.<$> showAlternatives,
            ("ChannelIdentification" Prelude..=)
              Prelude.<$> channelIdentification,
            ("MaxAlternatives" Prelude..=)
              Prelude.<$> maxAlternatives,
            ("ShowSpeakerLabels" Prelude..=)
              Prelude.<$> showSpeakerLabels,
            ("VocabularyName" Prelude..=)
              Prelude.<$> vocabularyName,
            ("MaxSpeakerLabels" Prelude..=)
