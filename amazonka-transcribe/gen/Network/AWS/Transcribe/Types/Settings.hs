...
settings_maxAlternatives = Lens.lens (\Settings' {maxAlternatives} -> maxAlternatives) (\s@Settings' {} a -> s {maxAlternatives = a} :: Settings) Prelude.. Lens.mapping Prelude._Nat
...
settings_maxSpeakerLabels = Lens.lens (\Settings' {maxSpeakerLabels} -> maxSpeakerLabels) (\s@Settings' {} a -> s {maxSpeakerLabels = a} :: Settings) Prelude.. Lens.mapping Prelude._Nat

instance Prelude.FromJSON Settings where
  parseJSON =
    Prelude.withObject
      "Settings"
      ( \x ->
          Settings'
            Prelude.<$> (x Prelude..:? "VocabularyFilterMethod")
...
instance Prelude.ToJSON Settings where
  toJSON Settings' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("VocabularyFilterMethod" Prelude..=)
              Prelude.<$> vocabularyFilterMethod,
            ("VocabularyFilterName" Prelude..=)
