...
data StartTranscriptionJob = StartTranscriptionJob'
  { -- | The language code for the language used in the input media file.
    ...
    languageOptions :: Prelude.Maybe (Prelude.List1 LanguageCode),
...
startTranscriptionJob_mediaSampleRateHertz = Lens.lens (\StartTranscriptionJob' {mediaSampleRateHertz} -> mediaSampleRateHertz) (\s@StartTranscriptionJob' {} a -> s {mediaSampleRateHertz = a} :: StartTranscriptionJob) Prelude.. Lens.mapping Prelude._Nat
...
startTranscriptionJob_languageOptions = Lens.lens (\StartTranscriptionJob' {languageOptions} -> languageOptions) (\s@StartTranscriptionJob' {} a -> s {languageOptions = a} :: StartTranscriptionJob) Prelude.. Lens.mapping Prelude._List1
