...
data CreateVocabularyFilter = CreateVocabularyFilter'
  { -- | The Amazon S3 location of a text file used as input to create the
    ...
    words :: Prelude.Maybe (Prelude.List1 Prelude.Text),
...
createVocabularyFilter_words = Lens.lens (\CreateVocabularyFilter' {words} -> words) (\s@CreateVocabularyFilter' {} a -> s {words = a} :: CreateVocabularyFilter) Prelude.. Lens.mapping Prelude._List1
