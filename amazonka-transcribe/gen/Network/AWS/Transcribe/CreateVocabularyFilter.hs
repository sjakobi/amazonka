    ...
    object
      ( catMaybes
          [ ("VocabularyFilterFileUri" .=)
            ...
            ("Words" .=) <$> _cvfWords,
            Just
              ("VocabularyFilterName" .= _cvfVocabularyFilterName),
...
data CreateVocabularyFilterResponse = CreateVocabularyFilterResponse'
  { _cvfrrsLanguageCode ::
    ...
    _cvfrrsVocabularyFilterName ::
      !( Maybe
           Text
       ),
    _cvfrrsLastModifiedTime ::
      !( Maybe
           POSIX
       ),
    _cvfrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cvfrrsLanguageCode' - The language code of the words in the collection.
--
-- * 'cvfrrsVocabularyFilterName' - The name of the vocabulary filter.
--
-- * 'cvfrrsLastModifiedTime' - The date and time that the vocabulary filter was modified.
--
-- * 'cvfrrsResponseStatus' - -- | The response status code.
createVocabularyFilterResponse ::
  -- | 'cvfrrsResponseStatus'
  Int ->
  CreateVocabularyFilterResponse
createVocabularyFilterResponse pResponseStatus_ =
  CreateVocabularyFilterResponse'
    { _cvfrrsLanguageCode =
        Nothing,
      _cvfrrsVocabularyFilterName = Nothing,
      _cvfrrsLastModifiedTime = Nothing,
      _cvfrrsResponseStatus = pResponseStatus_
    }

-- | The language code of the words in the collection.
cvfrrsLanguageCode :: Lens' CreateVocabularyFilterResponse (Maybe LanguageCode)
cvfrrsLanguageCode = lens _cvfrrsLanguageCode (\s a -> s {_cvfrrsLanguageCode = a})

-- | The name of the vocabulary filter.
cvfrrsVocabularyFilterName :: Lens' CreateVocabularyFilterResponse (Maybe Text)
cvfrrsVocabularyFilterName = lens _cvfrrsVocabularyFilterName (\s a -> s {_cvfrrsVocabularyFilterName = a})

-- | The date and time that the vocabulary filter was modified.
cvfrrsLastModifiedTime :: Lens' CreateVocabularyFilterResponse (Maybe UTCTime)
cvfrrsLastModifiedTime = lens _cvfrrsLastModifiedTime (\s a -> s {_cvfrrsLastModifiedTime = a}) . mapping _Time

-- | -- | The response status code.
cvfrrsResponseStatus :: Lens' CreateVocabularyFilterResponse Int
cvfrrsResponseStatus = lens _cvfrrsResponseStatus (\s a -> s {_cvfrrsResponseStatus = a})
