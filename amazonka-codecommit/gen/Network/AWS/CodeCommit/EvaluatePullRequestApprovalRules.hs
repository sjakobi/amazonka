...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'eprarrrsResponseStatus' - -- | The response status code.
--
-- * 'eprarrrsEvaluation' - The result of the evaluation, including the names of the rules whose conditions have been met (if any), the names of the rules whose conditions have not been met (if any), whether the pull request is in the approved state, and whether the pull request approval rule has been set aside by an override.
evaluatePullRequestApprovalRulesResponse ::
  -- | 'eprarrrsResponseStatus'
  Int ->
  -- | 'eprarrrsEvaluation'
...
eprarrrsResponseStatus :: Lens' EvaluatePullRequestApprovalRulesResponse Int
eprarrrsResponseStatus = lens _eprarrrsResponseStatus (\s a -> s {_eprarrrsResponseStatus = a})

-- | The result of the evaluation, including the names of the rules whose conditions have been met (if any), the names of the rules whose conditions have not been met (if any), whether the pull request is in the approved state, and whether the pull request approval rule has been set aside by an override.
eprarrrsEvaluation :: Lens' EvaluatePullRequestApprovalRulesResponse Evaluation
eprarrrsEvaluation = lens _eprarrrsEvaluation (\s a -> s {_eprarrrsEvaluation = a})
