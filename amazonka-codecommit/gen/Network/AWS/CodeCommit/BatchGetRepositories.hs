...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'bgrrrsRepositoriesNotFound' - Returns a list of repository names for which information could not be found.
--
-- * 'bgrrrsRepositories' - A list of repositories returned by the batch get repositories operation.
--
...
batchGetRepositoriesResponse pResponseStatus_ =
  BatchGetRepositoriesResponse'
    { _bgrrrsRepositoriesNotFound =
        Nothing,
      _bgrrrsRepositories = Nothing,
      _bgrrrsResponseStatus = pResponseStatus_
    }

-- | Returns a list of repository names for which information could not be found.
bgrrrsRepositoriesNotFound :: Lens' BatchGetRepositoriesResponse [Text]
bgrrrsRepositoriesNotFound = lens _bgrrrsRepositoriesNotFound (\s a -> s {_bgrrrsRepositoriesNotFound = a}) . _Default . _Coerce

-- | A list of repositories returned by the batch get repositories operation.
bgrrrsRepositories :: Lens' BatchGetRepositoriesResponse [RepositoryMetadata]
bgrrrsRepositories = lens _bgrrrsRepositories (\s a -> s {_bgrrrsRepositories = a}) . _Default . _Coerce

-- | -- | The response status code.
bgrrrsResponseStatus :: Lens' BatchGetRepositoriesResponse Int
