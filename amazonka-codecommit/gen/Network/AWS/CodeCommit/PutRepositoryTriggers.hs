...
data PutRepositoryTriggersResponse = PutRepositoryTriggersResponse'
  { _prtrrsConfigurationId ::
      !( Maybe
           Text
       ),
    _prtrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'prtrrsConfigurationId' - The system-generated unique ID for the create or update operation.
--
-- * 'prtrrsResponseStatus' - -- | The response status code.
putRepositoryTriggersResponse ::
  -- | 'prtrrsResponseStatus'
  Int ->
  PutRepositoryTriggersResponse
putRepositoryTriggersResponse pResponseStatus_ =
  PutRepositoryTriggersResponse'
    { _prtrrsConfigurationId =
        Nothing,
      _prtrrsResponseStatus = pResponseStatus_
    }

-- | The system-generated unique ID for the create or update operation.
prtrrsConfigurationId :: Lens' PutRepositoryTriggersResponse (Maybe Text)
prtrrsConfigurationId = lens _prtrrsConfigurationId (\s a -> s {_prtrrsConfigurationId = a})

-- | -- | The response status code.
prtrrsResponseStatus :: Lens' PutRepositoryTriggersResponse Int
prtrrsResponseStatus = lens _prtrrsResponseStatus (\s a -> s {_prtrrsResponseStatus = a})
