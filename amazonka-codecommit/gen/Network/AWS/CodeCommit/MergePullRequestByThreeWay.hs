...
instance Prelude.ToHeaders MergePullRequestByThreeWay where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "CodeCommit_20150413.MergePullRequestByThreeWay" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON MergePullRequestByThreeWay where
...
instance Prelude.ToPath MergePullRequestByThreeWay where
  toPath = Prelude.const "/"

instance Prelude.ToQuery MergePullRequestByThreeWay where
