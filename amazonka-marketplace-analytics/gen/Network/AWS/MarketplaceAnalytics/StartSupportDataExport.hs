...
data StartSupportDataExportResponse = StartSupportDataExportResponse'
  { _ssderrsDataSetRequestId ::
      !( Maybe
           Text
       ),
    _ssderrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ssderrsDataSetRequestId' - A unique identifier representing a specific request to the StartSupportDataExport operation. This identifier can be used to correlate a request with notifications from the SNS topic.
--
-- * 'ssderrsResponseStatus' - -- | The response status code.
startSupportDataExportResponse ::
  -- | 'ssderrsResponseStatus'
  Int ->
  StartSupportDataExportResponse
startSupportDataExportResponse pResponseStatus_ =
  StartSupportDataExportResponse'
    { _ssderrsDataSetRequestId =
        Nothing,
      _ssderrsResponseStatus = pResponseStatus_
    }
...
ssderrsDataSetRequestId :: Lens' StartSupportDataExportResponse (Maybe Text)
ssderrsDataSetRequestId = lens _ssderrsDataSetRequestId (\s a -> s {_ssderrsDataSetRequestId = a})

-- | -- | The response status code.
ssderrsResponseStatus :: Lens' StartSupportDataExportResponse Int
ssderrsResponseStatus = lens _ssderrsResponseStatus (\s a -> s {_ssderrsResponseStatus = a})
