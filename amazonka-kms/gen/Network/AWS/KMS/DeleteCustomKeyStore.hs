...
--
-- __Required permissions__ : <https://docs.aws.amazon.com/kms/latest/developerguide/kms-api-permissions-reference.html kms:DeleteCustomKeyStore> (IAM policy)
--
...
--
-- * 'dCustomKeyStoreId' - Enter the ID of the custom key store you want to delete. To find the ID of a custom key store, use the 'DescribeCustomKeyStores' operation.
deleteCustomKeyStore ::
  -- | 'dCustomKeyStoreId'
  Text ->
  DeleteCustomKeyStore
...
dCustomKeyStoreId :: Lens' DeleteCustomKeyStore Text
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dcksrrsResponseStatus' - -- | The response status code.
deleteCustomKeyStoreResponse ::
  -- | 'dcksrrsResponseStatus'
  Int ->
  DeleteCustomKeyStoreResponse
...
dcksrrsResponseStatus :: Lens' DeleteCustomKeyStoreResponse Int
dcksrrsResponseStatus = lens _dcksrrsResponseStatus (\s a -> s {_dcksrrsResponseStatus = a})
