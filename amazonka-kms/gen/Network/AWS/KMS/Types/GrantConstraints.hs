...
data GrantConstraints = GrantConstraints'
  { -- | A list of key-value pairs that must match the encryption context in the
    ...
    -- constraint.
    encryptionContextEquals :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text),
    ...
    encryptionContextSubset :: Prelude.Maybe (Prelude.Map Prelude.Text Prelude.Text)
  }
...
grantConstraints_encryptionContextEquals = Lens.lens (\GrantConstraints' {encryptionContextEquals} -> encryptionContextEquals) (\s@GrantConstraints' {} a -> s {encryptionContextEquals = a} :: GrantConstraints) Prelude.. Lens.mapping Prelude._Map
...
grantConstraints_encryptionContextSubset = Lens.lens (\GrantConstraints' {encryptionContextSubset} -> encryptionContextSubset) (\s@GrantConstraints' {} a -> s {encryptionContextSubset = a} :: GrantConstraints) Prelude.. Lens.mapping Prelude._Map

instance Prelude.FromJSON GrantConstraints where
  parseJSON =
    Prelude.withObject
      "GrantConstraints"
      ( \x ->
          GrantConstraints'
            Prelude.<$> ( x Prelude..:? "EncryptionContextEquals"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> ( x Prelude..:? "EncryptionContextSubset"
                            Prelude..!= Prelude.mempty
                        )
      )
...
instance Prelude.ToJSON GrantConstraints where
  toJSON GrantConstraints' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("EncryptionContextEquals" Prelude..=)
              Prelude.<$> encryptionContextEquals,
            ("EncryptionContextSubset" Prelude..=)
