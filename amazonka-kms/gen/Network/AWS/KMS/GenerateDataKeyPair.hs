...
--
-- __Required permissions__ : <https://docs.aws.amazon.com/kms/latest/developerguide/kms-api-permissions-reference.html kms:GenerateDataKeyPair> (key policy)
--
...
data GenerateDataKeyPairResponse = GenerateDataKeyPairResponse'
  { _gdkprrsPublicKey ::
    ...
    _gdkprrsPrivateKeyCiphertextBlob ::
      !(Maybe Base64),
    _gdkprrsPrivateKeyPlaintext ::
      !( Maybe
           ( Sensitive
               Base64
           )
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gdkprrsPublicKey' - The public key (in plaintext).-- /Note:/ This 'Lens' automatically encodes and decodes Base64 data. The underlying isomorphism will encode to Base64 representation during serialisation, and decode from Base64 representation during deserialisation. This 'Lens' accepts and returns only raw unencoded data.
--
-- * 'gdkprrsKeyPairSpec' - The type of data key pair that was generated.
--
...
--
-- * 'gdkprrsPrivateKeyPlaintext' - The plaintext copy of the private key. When you use the HTTP API or the AWS CLI, the value is Base64-encoded. Otherwise, it is not Base64-encoded.-- /Note:/ This 'Lens' automatically encodes and decodes Base64 data. The underlying isomorphism will encode to Base64 representation during serialisation, and decode from Base64 representation during deserialisation. This 'Lens' accepts and returns only raw unencoded data.
--
-- * 'gdkprrsKeyId' - The Amazon Resource Name (<https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN key ARN> ) of the CMK that encrypted the private key.
--
-- * 'gdkprrsResponseStatus' - -- | The response status code.
generateDataKeyPairResponse ::
  -- | 'gdkprrsResponseStatus'
  Int ->
  GenerateDataKeyPairResponse
generateDataKeyPairResponse pResponseStatus_ =
  GenerateDataKeyPairResponse'
    { _gdkprrsPublicKey =
        Nothing,
      _gdkprrsKeyPairSpec = Nothing,
      _gdkprrsPrivateKeyCiphertextBlob = Nothing,
      _gdkprrsPrivateKeyPlaintext = Nothing,
      _gdkprrsKeyId = Nothing,
      _gdkprrsResponseStatus = pResponseStatus_
    }
...
gdkprrsPublicKey :: Lens' GenerateDataKeyPairResponse (Maybe ByteString)
gdkprrsPublicKey = lens _gdkprrsPublicKey (\s a -> s {_gdkprrsPublicKey = a}) . mapping _Base64

-- | The type of data key pair that was generated.
gdkprrsKeyPairSpec :: Lens' GenerateDataKeyPairResponse (Maybe DataKeyPairSpec)
gdkprrsKeyPairSpec = lens _gdkprrsKeyPairSpec (\s a -> s {_gdkprrsKeyPairSpec = a})

-- | The encrypted copy of the private key. When you use the HTTP API or the AWS CLI, the value is Base64-encoded. Otherwise, it is not Base64-encoded.-- /Note:/ This 'Lens' automatically encodes and decodes Base64 data. The underlying isomorphism will encode to Base64 representation during serialisation, and decode from Base64 representation during deserialisation. This 'Lens' accepts and returns only raw unencoded data.
gdkprrsPrivateKeyCiphertextBlob :: Lens' GenerateDataKeyPairResponse (Maybe ByteString)
gdkprrsPrivateKeyCiphertextBlob = lens _gdkprrsPrivateKeyCiphertextBlob (\s a -> s {_gdkprrsPrivateKeyCiphertextBlob = a}) . mapping _Base64

-- | The plaintext copy of the private key. When you use the HTTP API or the AWS CLI, the value is Base64-encoded. Otherwise, it is not Base64-encoded.-- /Note:/ This 'Lens' automatically encodes and decodes Base64 data. The underlying isomorphism will encode to Base64 representation during serialisation, and decode from Base64 representation during deserialisation. This 'Lens' accepts and returns only raw unencoded data.
gdkprrsPrivateKeyPlaintext :: Lens' GenerateDataKeyPairResponse (Maybe ByteString)
gdkprrsPrivateKeyPlaintext = lens _gdkprrsPrivateKeyPlaintext (\s a -> s {_gdkprrsPrivateKeyPlaintext = a}) . mapping (_Sensitive . _Base64)
...
gdkprrsKeyId :: Lens' GenerateDataKeyPairResponse (Maybe Text)
gdkprrsKeyId = lens _gdkprrsKeyId (\s a -> s {_gdkprrsKeyId = a})

-- | -- | The response status code.
gdkprrsResponseStatus :: Lens' GenerateDataKeyPairResponse Int
gdkprrsResponseStatus = lens _gdkprrsResponseStatus (\s a -> s {_gdkprrsResponseStatus = a})
