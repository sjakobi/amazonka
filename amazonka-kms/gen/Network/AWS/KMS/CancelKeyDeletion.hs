...
--
-- __Required permissions__ : <https://docs.aws.amazon.com/kms/latest/developerguide/kms-api-permissions-reference.html kms:CancelKeyDeletion> (key policy)
--
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ckdrrsKeyId' - The Amazon Resource Name (<https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN key ARN> ) of the CMK whose deletion is canceled.
--
-- * 'ckdrrsResponseStatus' - -- | The response status code.
cancelKeyDeletionResponse ::
  -- | 'ckdrrsResponseStatus'
  Int ->
  CancelKeyDeletionResponse
cancelKeyDeletionResponse pResponseStatus_ =
  CancelKeyDeletionResponse'
    { _ckdrrsKeyId = Nothing,
      _ckdrrsResponseStatus = pResponseStatus_
    }
...
ckdrrsKeyId :: Lens' CancelKeyDeletionResponse (Maybe Text)
ckdrrsKeyId = lens _ckdrrsKeyId (\s a -> s {_ckdrrsKeyId = a})

-- | -- | The response status code.
ckdrrsResponseStatus :: Lens' CancelKeyDeletionResponse Int
ckdrrsResponseStatus = lens _ckdrrsResponseStatus (\s a -> s {_ckdrrsResponseStatus = a})
