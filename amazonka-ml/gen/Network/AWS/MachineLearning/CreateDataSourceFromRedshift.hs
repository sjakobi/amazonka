...
data CreateDataSourceFromRedshift = CreateDataSourceFromRedshift'
  { _cdsfrComputeStatistics ::
      !(Maybe Bool),
    _cdsfrDataSourceName ::
      !(Maybe Text),
    _cdsfrDataSourceId ::
      !Text,
    _cdsfrDataSpec ::
...
data CreateDataSourceFromRedshiftResponse = CreateDataSourceFromRedshiftResponse'
  { _cdsfrrrsDataSourceId ::
      !( Maybe
           Text
       ),
    _cdsfrrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cdsfrrrsDataSourceId' - A user-supplied ID that uniquely identifies the datasource. This value should be identical to the value of the @DataSourceID@ in the request.
--
-- * 'cdsfrrrsResponseStatus' - -- | The response status code.
createDataSourceFromRedshiftResponse ::
  -- | 'cdsfrrrsResponseStatus'
  Int ->
  CreateDataSourceFromRedshiftResponse
...
cdsfrrrsDataSourceId :: Lens' CreateDataSourceFromRedshiftResponse (Maybe Text)
cdsfrrrsDataSourceId = lens _cdsfrrrsDataSourceId (\s a -> s {_cdsfrrrsDataSourceId = a})

-- | -- | The response status code.
cdsfrrrsResponseStatus :: Lens' CreateDataSourceFromRedshiftResponse Int
cdsfrrrsResponseStatus = lens _cdsfrrrsResponseStatus (\s a -> s {_cdsfrrrsResponseStatus = a})
