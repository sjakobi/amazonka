...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cmlmrrsMLModelId' - A user-supplied ID that uniquely identifies the @MLModel@ . This value should be identical to the value of the @MLModelId@ in the request.
--
-- * 'cmlmrrsResponseStatus' - -- | The response status code.
createMLModelResponse ::
  -- | 'cmlmrrsResponseStatus'
  Int ->
  CreateMLModelResponse
createMLModelResponse pResponseStatus_ =
  CreateMLModelResponse'
    { _cmlmrrsMLModelId = Nothing,
      _cmlmrrsResponseStatus = pResponseStatus_
    }

-- | A user-supplied ID that uniquely identifies the @MLModel@ . This value should be identical to the value of the @MLModelId@ in the request.
cmlmrrsMLModelId :: Lens' CreateMLModelResponse (Maybe Text)
cmlmrrsMLModelId = lens _cmlmrrsMLModelId (\s a -> s {_cmlmrrsMLModelId = a})

-- | -- | The response status code.
cmlmrrsResponseStatus :: Lens' CreateMLModelResponse Int
cmlmrrsResponseStatus = lens _cmlmrrsResponseStatus (\s a -> s {_cmlmrrsResponseStatus = a})
