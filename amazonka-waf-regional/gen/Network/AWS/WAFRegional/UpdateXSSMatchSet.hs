...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uxmsrrsChangeToken' - The @ChangeToken@ that you used to submit the @UpdateXssMatchSet@ request. You can also use this value to query the status of the request. For more information, see 'GetChangeTokenStatus' .
--
-- * 'uxmsrrsResponseStatus' - -- | The response status code.
updateXSSMatchSetResponse ::
  -- | 'uxmsrrsResponseStatus'
  Int ->
  UpdateXSSMatchSetResponse
updateXSSMatchSetResponse pResponseStatus_ =
  UpdateXSSMatchSetResponse'
    { _uxmsrrsChangeToken =
        Nothing,
      _uxmsrrsResponseStatus = pResponseStatus_
    }

-- | The @ChangeToken@ that you used to submit the @UpdateXssMatchSet@ request. You can also use this value to query the status of the request. For more information, see 'GetChangeTokenStatus' .
uxmsrrsChangeToken :: Lens' UpdateXSSMatchSetResponse (Maybe Text)
uxmsrrsChangeToken = lens _uxmsrrsChangeToken (\s a -> s {_uxmsrrsChangeToken = a})

-- | -- | The response status code.
uxmsrrsResponseStatus :: Lens' UpdateXSSMatchSetResponse Int
uxmsrrsResponseStatus = lens _uxmsrrsResponseStatus (\s a -> s {_uxmsrrsResponseStatus = a})
