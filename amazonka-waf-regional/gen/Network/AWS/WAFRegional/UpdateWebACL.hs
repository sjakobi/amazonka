...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uwarrsChangeToken' - The @ChangeToken@ that you used to submit the @UpdateWebACL@ request. You can also use this value to query the status of the request. For more information, see 'GetChangeTokenStatus' .
--
-- * 'uwarrsResponseStatus' - -- | The response status code.
updateWebACLResponse ::
  -- | 'uwarrsResponseStatus'
  Int ->
  UpdateWebACLResponse
updateWebACLResponse pResponseStatus_ =
  UpdateWebACLResponse'
    { _uwarrsChangeToken = Nothing,
      _uwarrsResponseStatus = pResponseStatus_
    }

-- | The @ChangeToken@ that you used to submit the @UpdateWebACL@ request. You can also use this value to query the status of the request. For more information, see 'GetChangeTokenStatus' .
uwarrsChangeToken :: Lens' UpdateWebACLResponse (Maybe Text)
uwarrsChangeToken = lens _uwarrsChangeToken (\s a -> s {_uwarrsChangeToken = a})

-- | -- | The response status code.
uwarrsResponseStatus :: Lens' UpdateWebACLResponse Int
uwarrsResponseStatus = lens _uwarrsResponseStatus (\s a -> s {_uwarrsResponseStatus = a})
