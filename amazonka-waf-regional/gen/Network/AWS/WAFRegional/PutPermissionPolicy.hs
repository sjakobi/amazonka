...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ppprrsResponseStatus' - -- | The response status code.
putPermissionPolicyResponse ::
  -- | 'ppprrsResponseStatus'
  Int ->
  PutPermissionPolicyResponse
...
ppprrsResponseStatus :: Lens' PutPermissionPolicyResponse Int
ppprrsResponseStatus = lens _ppprrsResponseStatus (\s a -> s {_ppprrsResponseStatus = a})
