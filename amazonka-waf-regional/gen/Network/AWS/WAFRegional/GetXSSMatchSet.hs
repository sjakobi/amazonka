...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gxmsrrsXSSMatchSet' - Information about the 'XssMatchSet' that you specified in the @GetXssMatchSet@ request. For more information, see the following topics:     * 'XssMatchSet' : Contains @Name@ , @XssMatchSetId@ , and an array of @XssMatchTuple@ objects     * 'XssMatchTuple' : Each @XssMatchTuple@ object contains @FieldToMatch@ and @TextTransformation@      * 'FieldToMatch' : Contains @Data@ and @Type@
--
-- * 'gxmsrrsResponseStatus' - -- | The response status code.
getXSSMatchSetResponse ::
  -- | 'gxmsrrsResponseStatus'
  Int ->
  GetXSSMatchSetResponse
getXSSMatchSetResponse pResponseStatus_ =
  GetXSSMatchSetResponse'
    { _gxmsrrsXSSMatchSet =
        Nothing,
      _gxmsrrsResponseStatus = pResponseStatus_
    }
...
gxmsrrsXSSMatchSet :: Lens' GetXSSMatchSetResponse (Maybe XSSMatchSet)
gxmsrrsXSSMatchSet = lens _gxmsrrsXSSMatchSet (\s a -> s {_gxmsrrsXSSMatchSet = a})

-- | -- | The response status code.
gxmsrrsResponseStatus :: Lens' GetXSSMatchSetResponse Int
gxmsrrsResponseStatus = lens _gxmsrrsResponseStatus (\s a -> s {_gxmsrrsResponseStatus = a})
