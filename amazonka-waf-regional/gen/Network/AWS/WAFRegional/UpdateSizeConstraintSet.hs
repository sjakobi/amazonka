...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uscsrrsChangeToken' - The @ChangeToken@ that you used to submit the @UpdateSizeConstraintSet@ request. You can also use this value to query the status of the request. For more information, see 'GetChangeTokenStatus' .
--
-- * 'uscsrrsResponseStatus' - -- | The response status code.
updateSizeConstraintSetResponse ::
  -- | 'uscsrrsResponseStatus'
  Int ->
  UpdateSizeConstraintSetResponse
updateSizeConstraintSetResponse pResponseStatus_ =
  UpdateSizeConstraintSetResponse'
    { _uscsrrsChangeToken =
        Nothing,
      _uscsrrsResponseStatus = pResponseStatus_
    }

-- | The @ChangeToken@ that you used to submit the @UpdateSizeConstraintSet@ request. You can also use this value to query the status of the request. For more information, see 'GetChangeTokenStatus' .
uscsrrsChangeToken :: Lens' UpdateSizeConstraintSetResponse (Maybe Text)
uscsrrsChangeToken = lens _uscsrrsChangeToken (\s a -> s {_uscsrrsChangeToken = a})

-- | -- | The response status code.
uscsrrsResponseStatus :: Lens' UpdateSizeConstraintSetResponse Int
uscsrrsResponseStatus = lens _uscsrrsResponseStatus (\s a -> s {_uscsrrsResponseStatus = a})
