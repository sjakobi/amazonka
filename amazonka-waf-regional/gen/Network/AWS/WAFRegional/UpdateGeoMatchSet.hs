...
instance Hashable UpdateGeoMatchSet

instance NFData UpdateGeoMatchSet
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ugmsrrsChangeToken' - The @ChangeToken@ that you used to submit the @UpdateGeoMatchSet@ request. You can also use this value to query the status of the request. For more information, see 'GetChangeTokenStatus' .
--
-- * 'ugmsrrsResponseStatus' - -- | The response status code.
updateGeoMatchSetResponse ::
  -- | 'ugmsrrsResponseStatus'
  Int ->
  UpdateGeoMatchSetResponse
updateGeoMatchSetResponse pResponseStatus_ =
  UpdateGeoMatchSetResponse'
    { _ugmsrrsChangeToken =
        Nothing,
      _ugmsrrsResponseStatus = pResponseStatus_
    }
...
ugmsrrsChangeToken :: Lens' UpdateGeoMatchSetResponse (Maybe Text)
ugmsrrsChangeToken = lens _ugmsrrsChangeToken (\s a -> s {_ugmsrrsChangeToken = a})

-- | -- | The response status code.
ugmsrrsResponseStatus :: Lens' UpdateGeoMatchSetResponse Int
ugmsrrsResponseStatus = lens _ugmsrrsResponseStatus (\s a -> s {_ugmsrrsResponseStatus = a})

instance NFData UpdateGeoMatchSetResponse
