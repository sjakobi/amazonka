...
module Network.AWS.WAFRegional.Types.SizeConstraint where
...
sizeConstraint_size = Lens.lens (\SizeConstraint' {size} -> size) (\s@SizeConstraint' {} a -> s {size = a} :: SizeConstraint) Prelude.. Prelude._Nat

instance Prelude.FromJSON SizeConstraint where
  parseJSON =
    Prelude.withObject
      "SizeConstraint"
      ( \x ->
...
instance Prelude.ToJSON SizeConstraint where
