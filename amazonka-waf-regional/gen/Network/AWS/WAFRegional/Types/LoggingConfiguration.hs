...
data LoggingConfiguration = LoggingConfiguration'
  { -- | The parts of the request that you want redacted from the logs. For
    ...
    logDestinationConfigs :: Prelude.List1 Prelude.Text
  }
  ...
  pLogDestinationConfigs_ =
    LoggingConfiguration'
      { redactedFields =
        ...
        logDestinationConfigs =
          Prelude._List1 Lens.# pLogDestinationConfigs_
      }
...
loggingConfiguration_logDestinationConfigs = Lens.lens (\LoggingConfiguration' {logDestinationConfigs} -> logDestinationConfigs) (\s@LoggingConfiguration' {} a -> s {logDestinationConfigs = a} :: LoggingConfiguration) Prelude.. Prelude._List1
