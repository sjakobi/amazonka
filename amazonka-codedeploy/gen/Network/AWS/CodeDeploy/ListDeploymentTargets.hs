...
data ListDeploymentTargets = ListDeploymentTargets'
  { -- | The unique ID of a deployment.
    ...
    --     @Blue@ or @Green@.
    targetFilters :: Prelude.Maybe (Prelude.Map TargetFilterName [Prelude.Text])
  }
...
listDeploymentTargets_targetFilters = Lens.lens (\ListDeploymentTargets' {targetFilters} -> targetFilters) (\s@ListDeploymentTargets' {} a -> s {targetFilters = a} :: ListDeploymentTargets) Prelude.. Lens.mapping Prelude._Map
