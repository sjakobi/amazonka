...
data StreamDescriptionSummary = StreamDescriptionSummary'
  { -- | The encryption type used. This value is one of the following:
    ...
    consumerCount :: Prelude.Maybe Prelude.Nat,
...
streamDescriptionSummary_consumerCount = Lens.lens (\StreamDescriptionSummary' {consumerCount} -> consumerCount) (\s@StreamDescriptionSummary' {} a -> s {consumerCount = a} :: StreamDescriptionSummary) Prelude.. Lens.mapping Prelude._Nat
...
streamDescriptionSummary_openShardCount = Lens.lens (\StreamDescriptionSummary' {openShardCount} -> openShardCount) (\s@StreamDescriptionSummary' {} a -> s {openShardCount = a} :: StreamDescriptionSummary) Prelude.. Prelude._Nat
