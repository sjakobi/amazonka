...
data SubscribeToShardEvent = SubscribeToShardEvent'
  { childShards :: Prelude.Maybe [ChildShard],
    ...
    millisBehindLatest :: Prelude.Nat
  }
    ...
    SubscribeToShardEvent'
      { childShards =
        ...
        continuationSequenceNumber =
          pContinuationSequenceNumber_,
        millisBehindLatest =
          Prelude._Nat Lens.# pMillisBehindLatest_
      }
...
subscribeToShardEvent_millisBehindLatest = Lens.lens (\SubscribeToShardEvent' {millisBehindLatest} -> millisBehindLatest) (\s@SubscribeToShardEvent' {} a -> s {millisBehindLatest = a} :: SubscribeToShardEvent) Prelude.. Prelude._Nat
