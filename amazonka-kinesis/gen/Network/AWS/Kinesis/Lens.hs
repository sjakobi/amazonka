...
module Network.AWS.Kinesis.Lens
  ( -- * Operations
    ...
    subscribeToShardEventStream_kMSThrottlingException,
    subscribeToShardEventStream_kMSInvalidStateException,
    subscribeToShardEventStream_kMSNotFoundException,
    subscribeToShardEventStream_kMSOptInRequired,
    subscribeToShardEventStream_resourceInUseException,
    subscribeToShardEventStream_kMSAccessDeniedException,
    subscribeToShardEventStream_resourceNotFoundException,
    subscribeToShardEventStream_internalFailureException,
    subscribeToShardEventStream_kMSDisabledException,
    subscribeToShardEventStream_subscribeToShardEvent,
