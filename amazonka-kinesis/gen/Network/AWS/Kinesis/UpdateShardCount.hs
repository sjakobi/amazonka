  ...
  pScalingType_ =
    UpdateShardCount'
      { streamName = pStreamName_,
        targetShardCount =
          Prelude._Nat Lens.# pTargetShardCount_,
...
updateShardCount_targetShardCount = Lens.lens (\UpdateShardCount' {targetShardCount} -> targetShardCount) (\s@UpdateShardCount' {} a -> s {targetShardCount = a} :: UpdateShardCount) Prelude.. Prelude._Nat
...
data UpdateShardCountResponse = UpdateShardCountResponse'
  { -- | The updated number of shards.
    targetShardCount :: Prelude.Maybe Prelude.Nat,
    -- | The current number of shards.
    currentShardCount :: Prelude.Maybe Prelude.Nat,
    -- | The name of the stream.
...
updateShardCountResponse_targetShardCount = Lens.lens (\UpdateShardCountResponse' {targetShardCount} -> targetShardCount) (\s@UpdateShardCountResponse' {} a -> s {targetShardCount = a} :: UpdateShardCountResponse) Prelude.. Lens.mapping Prelude._Nat

-- | The current number of shards.
updateShardCountResponse_currentShardCount :: Lens.Lens' UpdateShardCountResponse (Prelude.Maybe Prelude.Natural)
updateShardCountResponse_currentShardCount = Lens.lens (\UpdateShardCountResponse' {currentShardCount} -> currentShardCount) (\s@UpdateShardCountResponse' {} a -> s {currentShardCount = a} :: UpdateShardCountResponse) Prelude.. Lens.mapping Prelude._Nat
