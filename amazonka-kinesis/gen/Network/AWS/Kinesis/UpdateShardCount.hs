...
data UpdateShardCountResponse = UpdateShardCountResponse'
  { _uscrrsTargetShardCount ::
      !(Maybe Nat),
    _uscrrsCurrentShardCount ::
      !(Maybe Nat),
    _uscrrsStreamName ::
      !(Maybe Text),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'uscrrsTargetShardCount' - The updated number of shards.
--
-- * 'uscrrsCurrentShardCount' - The current number of shards.
--
-- * 'uscrrsStreamName' - The name of the stream.
--
...
updateShardCountResponse pResponseStatus_ =
  UpdateShardCountResponse'
    { _uscrrsTargetShardCount =
        Nothing,
      _uscrrsCurrentShardCount = Nothing,
      _uscrrsStreamName = Nothing,
      _uscrrsResponseStatus = pResponseStatus_
    }

-- | The updated number of shards.
uscrrsTargetShardCount :: Lens' UpdateShardCountResponse (Maybe Natural)
uscrrsTargetShardCount = lens _uscrrsTargetShardCount (\s a -> s {_uscrrsTargetShardCount = a}) . mapping _Nat

-- | The current number of shards.
uscrrsCurrentShardCount :: Lens' UpdateShardCountResponse (Maybe Natural)
uscrrsCurrentShardCount = lens _uscrrsCurrentShardCount (\s a -> s {_uscrrsCurrentShardCount = a}) . mapping _Nat

-- | The name of the stream.
uscrrsStreamName :: Lens' UpdateShardCountResponse (Maybe Text)
uscrrsStreamName = lens _uscrrsStreamName (\s a -> s {_uscrrsStreamName = a})

-- | -- | The response status code.
uscrrsResponseStatus :: Lens' UpdateShardCountResponse Int
