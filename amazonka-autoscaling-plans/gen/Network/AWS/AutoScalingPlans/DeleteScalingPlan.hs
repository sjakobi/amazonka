...
--
-- * 'dspScalingPlanVersion' - The version number of the scaling plan. Currently, the only valid value is @1@ .
deleteScalingPlan ::
  -- | 'dspScalingPlanName'
  Text ->
  -- | 'dspScalingPlanVersion'
...
dsprrsResponseStatus :: Lens' DeleteScalingPlanResponse Int
