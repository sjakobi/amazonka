...
data GetLoadBalancerTLSCertificatesResponse = GetLoadBalancerTLSCertificatesResponse'
  { _glbtcrrsTlsCertificates ::
      !( Maybe
           [LoadBalancerTLSCertificate]
       ),
    _glbtcrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'glbtcrrsTlsCertificates' - An array of LoadBalancerTlsCertificate objects describing your SSL/TLS certificates.
--
-- * 'glbtcrrsResponseStatus' - -- | The response status code.
getLoadBalancerTLSCertificatesResponse ::
  -- | 'glbtcrrsResponseStatus'
  Int ->
  GetLoadBalancerTLSCertificatesResponse
...
glbtcrrsTlsCertificates :: Lens' GetLoadBalancerTLSCertificatesResponse [LoadBalancerTLSCertificate]
glbtcrrsTlsCertificates = lens _glbtcrrsTlsCertificates (\s a -> s {_glbtcrrsTlsCertificates = a}) . _Default . _Coerce

-- | -- | The response status code.
glbtcrrsResponseStatus :: Lens' GetLoadBalancerTLSCertificatesResponse Int
glbtcrrsResponseStatus = lens _glbtcrrsResponseStatus (\s a -> s {_glbtcrrsResponseStatus = a})
