...
--
-- * 'ivprrsIsPeered' - Returns @true@ if the Lightsail VPC is peered; otherwise, @false@ .
--
-- * 'ivprrsResponseStatus' - -- | The response status code.
isVPCPeeredResponse ::
  -- | 'ivprrsResponseStatus'
  Int ->
  IsVPCPeeredResponse
isVPCPeeredResponse pResponseStatus_ =
  IsVPCPeeredResponse'
    { _ivprrsIsPeered = Nothing,
      _ivprrsResponseStatus = pResponseStatus_
    }

-- | Returns @true@ if the Lightsail VPC is peered; otherwise, @false@ .
ivprrsIsPeered :: Lens' IsVPCPeeredResponse (Maybe Bool)
ivprrsIsPeered = lens _ivprrsIsPeered (\s a -> s {_ivprrsIsPeered = a})

-- | -- | The response status code.
ivprrsResponseStatus :: Lens' IsVPCPeeredResponse Int
ivprrsResponseStatus = lens _ivprrsResponseStatus (\s a -> s {_ivprrsResponseStatus = a})
