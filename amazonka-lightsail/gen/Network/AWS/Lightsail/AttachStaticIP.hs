...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'asiprrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the timestamp of the request, and the resources affected by the request.
--
-- * 'asiprrsResponseStatus' - -- | The response status code.
attachStaticIPResponse ::
  -- | 'asiprrsResponseStatus'
  Int ->
  AttachStaticIPResponse
attachStaticIPResponse pResponseStatus_ =
  AttachStaticIPResponse'
    { _asiprrsOperations =
        Nothing,
      _asiprrsResponseStatus = pResponseStatus_
    }

-- | An array of objects that describe the result of the action, such as the status of the request, the timestamp of the request, and the resources affected by the request.
asiprrsOperations :: Lens' AttachStaticIPResponse [Operation]
asiprrsOperations = lens _asiprrsOperations (\s a -> s {_asiprrsOperations = a}) . _Default . _Coerce

-- | -- | The response status code.
asiprrsResponseStatus :: Lens' AttachStaticIPResponse Int
asiprrsResponseStatus = lens _asiprrsResponseStatus (\s a -> s {_asiprrsResponseStatus = a})
