...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cderrsOperation' - An array of objects that describe the result of the action, such as the status of the request, the timestamp of the request, and the resources affected by the request.
--
...
cderrsOperation :: Lens' CreateDomainEntryResponse (Maybe Operation)
cderrsOperation = lens _cderrsOperation (\s a -> s {_cderrsOperation = a})

-- | -- | The response status code.
cderrsResponseStatus :: Lens' CreateDomainEntryResponse Int
