...
instance Prelude.AWSRequest CreateDomainEntry where
...
instance Prelude.ToHeaders CreateDomainEntry where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "Lightsail_20161128.CreateDomainEntry" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON CreateDomainEntry where
...
instance Prelude.ToPath CreateDomainEntry where
  toPath = Prelude.const "/"

instance Prelude.ToQuery CreateDomainEntry where
