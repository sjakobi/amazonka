...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dlbtcrrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the timestamp of the request, and the resources affected by the request.
--
-- * 'dlbtcrrsResponseStatus' - -- | The response status code.
deleteLoadBalancerTLSCertificateResponse ::
  -- | 'dlbtcrrsResponseStatus'
  Int ->
  DeleteLoadBalancerTLSCertificateResponse
...
dlbtcrrsOperations :: Lens' DeleteLoadBalancerTLSCertificateResponse [Operation]
dlbtcrrsOperations = lens _dlbtcrrsOperations (\s a -> s {_dlbtcrrsOperations = a}) . _Default . _Coerce

-- | -- | The response status code.
dlbtcrrsResponseStatus :: Lens' DeleteLoadBalancerTLSCertificateResponse Int
dlbtcrrsResponseStatus = lens _dlbtcrrsResponseStatus (\s a -> s {_dlbtcrrsResponseStatus = a})
