...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dsirrsOperations' - An array of objects that describe the result of the action, such as the status of the request, the timestamp of the request, and the resources affected by the request.
--
...
dsirrsOperations :: Lens' DetachStaticIPResponse [Operation]
dsirrsOperations = lens _dsirrsOperations (\s a -> s {_dsirrsOperations = a}) . _Default . _Coerce

-- | -- | The response status code.
dsirrsResponseStatus :: Lens' DetachStaticIPResponse Int
