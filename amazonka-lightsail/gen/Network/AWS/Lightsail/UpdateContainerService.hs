...
data UpdateContainerService = UpdateContainerService'
  { -- | The power for the container service.
    ...
    scale :: Prelude.Maybe Prelude.Nat,
    ...
    publicDomainNames :: Prelude.Maybe (Prelude.Map Prelude.Text [Prelude.Text]),
...
updateContainerService_scale = Lens.lens (\UpdateContainerService' {scale} -> scale) (\s@UpdateContainerService' {} a -> s {scale = a} :: UpdateContainerService) Prelude.. Lens.mapping Prelude._Nat
...
updateContainerService_publicDomainNames = Lens.lens (\UpdateContainerService' {publicDomainNames} -> publicDomainNames) (\s@UpdateContainerService' {} a -> s {publicDomainNames = a} :: UpdateContainerService) Prelude.. Lens.mapping Prelude._Map
