...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'grdmdrrsMetricName' - The name of the metric returned.
--
-- * 'grdmdrrsMetricData' - An array of objects that describe the metric data returned.
--
-- * 'grdmdrrsResponseStatus' - -- | The response status code.
getRelationalDatabaseMetricDataResponse ::
  -- | 'grdmdrrsResponseStatus'
  Int ->
  GetRelationalDatabaseMetricDataResponse
getRelationalDatabaseMetricDataResponse
  pResponseStatus_ =
    GetRelationalDatabaseMetricDataResponse'
      { _grdmdrrsMetricName =
          Nothing,
        _grdmdrrsMetricData = Nothing,
        _grdmdrrsResponseStatus =
          pResponseStatus_
      }

-- | The name of the metric returned.
grdmdrrsMetricName :: Lens' GetRelationalDatabaseMetricDataResponse (Maybe RelationalDatabaseMetricName)
grdmdrrsMetricName = lens _grdmdrrsMetricName (\s a -> s {_grdmdrrsMetricName = a})

-- | An array of objects that describe the metric data returned.
grdmdrrsMetricData :: Lens' GetRelationalDatabaseMetricDataResponse [MetricDatapoint]
grdmdrrsMetricData = lens _grdmdrrsMetricData (\s a -> s {_grdmdrrsMetricData = a}) . _Default . _Coerce

-- | -- | The response status code.
grdmdrrsResponseStatus :: Lens' GetRelationalDatabaseMetricDataResponse Int
grdmdrrsResponseStatus = lens _grdmdrrsResponseStatus (\s a -> s {_grdmdrrsResponseStatus = a})
