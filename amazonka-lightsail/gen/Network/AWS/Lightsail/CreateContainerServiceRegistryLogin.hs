...
data CreateContainerServiceRegistryLoginResponse = CreateContainerServiceRegistryLoginResponse'
  { _ccsrlrrsRegistryLogin ::
      !( Maybe
           ContainerServiceRegistryLogin
       ),
    _ccsrlrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
--
-- * 'ccsrlrrsRegistryLogin' - An object that describes the log in information for the container service registry of your Lightsail account.
--
-- * 'ccsrlrrsResponseStatus' - -- | The response status code.
createContainerServiceRegistryLoginResponse ::
  -- | 'ccsrlrrsResponseStatus'
  Int ->
  CreateContainerServiceRegistryLoginResponse
...
ccsrlrrsRegistryLogin :: Lens' CreateContainerServiceRegistryLoginResponse (Maybe ContainerServiceRegistryLogin)
ccsrlrrsRegistryLogin = lens _ccsrlrrsRegistryLogin (\s a -> s {_ccsrlrrsRegistryLogin = a})

-- | -- | The response status code.
ccsrlrrsResponseStatus :: Lens' CreateContainerServiceRegistryLoginResponse Int
ccsrlrrsResponseStatus = lens _ccsrlrrsResponseStatus (\s a -> s {_ccsrlrrsResponseStatus = a})
