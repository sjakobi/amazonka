...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gdmdrrsMetricName' - The name of the metric returned.
--
-- * 'gdmdrrsMetricData' - An array of objects that describe the metric data returned.
--
-- * 'gdmdrrsResponseStatus' - -- | The response status code.
getDistributionMetricDataResponse ::
  -- | 'gdmdrrsResponseStatus'
  Int ->
  GetDistributionMetricDataResponse
getDistributionMetricDataResponse pResponseStatus_ =
  GetDistributionMetricDataResponse'
    { _gdmdrrsMetricName =
        Nothing,
      _gdmdrrsMetricData = Nothing,
      _gdmdrrsResponseStatus =
        pResponseStatus_
    }

-- | The name of the metric returned.
gdmdrrsMetricName :: Lens' GetDistributionMetricDataResponse (Maybe DistributionMetricName)
gdmdrrsMetricName = lens _gdmdrrsMetricName (\s a -> s {_gdmdrrsMetricName = a})

-- | An array of objects that describe the metric data returned.
gdmdrrsMetricData :: Lens' GetDistributionMetricDataResponse [MetricDatapoint]
gdmdrrsMetricData = lens _gdmdrrsMetricData (\s a -> s {_gdmdrrsMetricData = a}) . _Default . _Coerce

-- | -- | The response status code.
gdmdrrsResponseStatus :: Lens' GetDistributionMetricDataResponse Int
gdmdrrsResponseStatus = lens _gdmdrrsResponseStatus (\s a -> s {_gdmdrrsResponseStatus = a})
