...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gimdrrsMetricName' - The name of the metric returned.
--
-- * 'gimdrrsMetricData' - An array of objects that describe the metric data returned.
--
-- * 'gimdrrsResponseStatus' - -- | The response status code.
getInstanceMetricDataResponse ::
  -- | 'gimdrrsResponseStatus'
  Int ->
  GetInstanceMetricDataResponse
getInstanceMetricDataResponse pResponseStatus_ =
  GetInstanceMetricDataResponse'
    { _gimdrrsMetricName =
        Nothing,
      _gimdrrsMetricData = Nothing,
      _gimdrrsResponseStatus = pResponseStatus_
    }

-- | The name of the metric returned.
gimdrrsMetricName :: Lens' GetInstanceMetricDataResponse (Maybe InstanceMetricName)
gimdrrsMetricName = lens _gimdrrsMetricName (\s a -> s {_gimdrrsMetricName = a})

-- | An array of objects that describe the metric data returned.
gimdrrsMetricData :: Lens' GetInstanceMetricDataResponse [MetricDatapoint]
gimdrrsMetricData = lens _gimdrrsMetricData (\s a -> s {_gimdrrsMetricData = a}) . _Default . _Coerce

-- | -- | The response status code.
gimdrrsResponseStatus :: Lens' GetInstanceMetricDataResponse Int
gimdrrsResponseStatus = lens _gimdrrsResponseStatus (\s a -> s {_gimdrrsResponseStatus = a})
