  ...
  pScale_ =
    CreateContainerService'
      { deployment =
        ...
        power = pPower_,
        scale = Prelude._Nat Lens.# pScale_
      }
...
createContainerService_publicDomainNames = Lens.lens (\CreateContainerService' {publicDomainNames} -> publicDomainNames) (\s@CreateContainerService' {} a -> s {publicDomainNames = a} :: CreateContainerService) Prelude.. Lens.mapping Prelude._Map
...
createContainerService_scale = Lens.lens (\CreateContainerService' {scale} -> scale) (\s@CreateContainerService' {} a -> s {scale = a} :: CreateContainerService) Prelude.. Prelude._Nat
