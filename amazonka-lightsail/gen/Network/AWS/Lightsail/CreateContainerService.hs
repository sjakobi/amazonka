...
--
--
-- A Lightsail container service is a compute resource to which you can deploy containers. For more information, see <https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-container-services Container services in Amazon Lightsail> in the /Lightsail Dev Guide/ .
module Network.AWS.Lightsail.CreateContainerService
  ( -- * Creating a Request
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ccsrrsContainerService' - An object that describes a container service.
--
...
ccsrrsContainerService :: Lens' CreateContainerServiceResponse (Maybe ContainerService)
ccsrrsContainerService = lens _ccsrrsContainerService (\s a -> s {_ccsrrsContainerService = a})

-- | -- | The response status code.
ccsrrsResponseStatus :: Lens' CreateContainerServiceResponse Int
