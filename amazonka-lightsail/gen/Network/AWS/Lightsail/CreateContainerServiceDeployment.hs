...
data CreateContainerServiceDeploymentResponse = CreateContainerServiceDeploymentResponse'
  { _ccsdrrsContainerService ::
      !( Maybe
           ContainerService
       ),
    _ccsdrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ccsdrrsContainerService' - An object that describes a container service.
--
-- * 'ccsdrrsResponseStatus' - -- | The response status code.
createContainerServiceDeploymentResponse ::
  -- | 'ccsdrrsResponseStatus'
  Int ->
  CreateContainerServiceDeploymentResponse
...
ccsdrrsContainerService :: Lens' CreateContainerServiceDeploymentResponse (Maybe ContainerService)
ccsdrrsContainerService = lens _ccsdrrsContainerService (\s a -> s {_ccsdrrsContainerService = a})

-- | -- | The response status code.
ccsdrrsResponseStatus :: Lens' CreateContainerServiceDeploymentResponse Int
ccsdrrsResponseStatus = lens _ccsdrrsResponseStatus (\s a -> s {_ccsdrrsResponseStatus = a})
