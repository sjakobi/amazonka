...
-- |
-- Module      : Network.AWS.Lightsail.Types.IpAddressType
...
instance Prelude.ToJSON IpAddressType where
  toJSON = Prelude.toJSONText

instance Prelude.FromJSON IpAddressType where
  parseJSON = Prelude.parseJSONText "IpAddressType"
