...
instance Prelude.FromText RegionName where
  parser = RegionName' Prelude.<$> Prelude.takeText

instance Prelude.ToText RegionName where
  toText (RegionName' x) = x

instance Prelude.Hashable RegionName

instance Prelude.NFData RegionName

instance Prelude.ToByteString RegionName

instance Prelude.ToQuery RegionName

instance Prelude.ToHeader RegionName

instance Prelude.ToJSON RegionName where
  toJSON = Prelude.toJSONText

instance Prelude.FromJSON RegionName where
  parseJSON = Prelude.parseJSONText "RegionName"
