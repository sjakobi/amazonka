...
data DeleteFleetsResponse = DeleteFleetsResponse'
  { _dfrrsUnsuccessfulFleetDeletions ::
      !( Maybe
           [DeleteFleetErrorItem]
       ),
    _dfrrsSuccessfulFleetDeletions ::
      !( Maybe
           [DeleteFleetSuccessItem]
       ),
    _dfrrsResponseStatus :: !Int
  }
  deriving (Eq, Read, Show, Data, Typeable, Generic)
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dfrrsUnsuccessfulFleetDeletions' - Information about the EC2 Fleets that are not successfully deleted.
--
-- * 'dfrrsSuccessfulFleetDeletions' - Information about the EC2 Fleets that are successfully deleted.
--
...
deleteFleetsResponse pResponseStatus_ =
  DeleteFleetsResponse'
    { _dfrrsUnsuccessfulFleetDeletions =
        Nothing,
      _dfrrsSuccessfulFleetDeletions = Nothing,
      _dfrrsResponseStatus = pResponseStatus_
    }

-- | Information about the EC2 Fleets that are not successfully deleted.
dfrrsUnsuccessfulFleetDeletions :: Lens' DeleteFleetsResponse [DeleteFleetErrorItem]
dfrrsUnsuccessfulFleetDeletions = lens _dfrrsUnsuccessfulFleetDeletions (\s a -> s {_dfrrsUnsuccessfulFleetDeletions = a}) . _Default . _Coerce

-- | Information about the EC2 Fleets that are successfully deleted.
dfrrsSuccessfulFleetDeletions :: Lens' DeleteFleetsResponse [DeleteFleetSuccessItem]
dfrrsSuccessfulFleetDeletions = lens _dfrrsSuccessfulFleetDeletions (\s a -> s {_dfrrsSuccessfulFleetDeletions = a}) . _Default . _Coerce

-- | -- | The response status code.
dfrrsResponseStatus :: Lens' DeleteFleetsResponse Int
