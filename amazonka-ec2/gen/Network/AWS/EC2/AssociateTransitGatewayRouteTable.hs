...
instance AWSRequest AssociateTransitGatewayRouteTable where
  type
...
instance ToHeaders AssociateTransitGatewayRouteTable where
  toHeaders = const mempty

instance ToPath AssociateTransitGatewayRouteTable where
  toPath = const "/"

instance ToQuery AssociateTransitGatewayRouteTable where
...
data AssociateTransitGatewayRouteTableResponse = AssociateTransitGatewayRouteTableResponse'
  { _atgrtrrsAssociation ::
      !( Maybe
           TransitGatewayAssociation
       ),
    _atgrtrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'atgrtrrsAssociation' - The ID of the association.
--
-- * 'atgrtrrsResponseStatus' - -- | The response status code.
associateTransitGatewayRouteTableResponse ::
  -- | 'atgrtrrsResponseStatus'
  Int ->
  AssociateTransitGatewayRouteTableResponse
...
atgrtrrsAssociation :: Lens' AssociateTransitGatewayRouteTableResponse (Maybe TransitGatewayAssociation)
atgrtrrsAssociation = lens _atgrtrrsAssociation (\s a -> s {_atgrtrrsAssociation = a})

-- | -- | The response status code.
atgrtrrsResponseStatus :: Lens' AssociateTransitGatewayRouteTableResponse Int
atgrtrrsResponseStatus = lens _atgrtrrsResponseStatus (\s a -> s {_atgrtrrsResponseStatus = a})
