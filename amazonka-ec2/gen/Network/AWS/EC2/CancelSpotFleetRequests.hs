...
data CancelSpotFleetRequestsResponse = CancelSpotFleetRequestsResponse'
  { _csfrrrsUnsuccessfulFleetRequests ::
      !( Maybe
           [CancelSpotFleetRequestsErrorItem]
       ),
    _csfrrrsSuccessfulFleetRequests ::
      !( Maybe
           [CancelSpotFleetRequestsSuccessItem]
       ),
    _csfrrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'csfrrrsUnsuccessfulFleetRequests' - Information about the Spot Fleet requests that are not successfully canceled.
--
-- * 'csfrrrsSuccessfulFleetRequests' - Information about the Spot Fleet requests that are successfully canceled.
--
-- * 'csfrrrsResponseStatus' - -- | The response status code.
cancelSpotFleetRequestsResponse ::
  -- | 'csfrrrsResponseStatus'
  Int ->
  CancelSpotFleetRequestsResponse
cancelSpotFleetRequestsResponse pResponseStatus_ =
  CancelSpotFleetRequestsResponse'
    { _csfrrrsUnsuccessfulFleetRequests =
        Nothing,
      _csfrrrsSuccessfulFleetRequests = Nothing,
      _csfrrrsResponseStatus = pResponseStatus_
    }

-- | Information about the Spot Fleet requests that are not successfully canceled.
csfrrrsUnsuccessfulFleetRequests :: Lens' CancelSpotFleetRequestsResponse [CancelSpotFleetRequestsErrorItem]
csfrrrsUnsuccessfulFleetRequests = lens _csfrrrsUnsuccessfulFleetRequests (\s a -> s {_csfrrrsUnsuccessfulFleetRequests = a}) . _Default . _Coerce

-- | Information about the Spot Fleet requests that are successfully canceled.
csfrrrsSuccessfulFleetRequests :: Lens' CancelSpotFleetRequestsResponse [CancelSpotFleetRequestsSuccessItem]
csfrrrsSuccessfulFleetRequests = lens _csfrrrsSuccessfulFleetRequests (\s a -> s {_csfrrrsSuccessfulFleetRequests = a}) . _Default . _Coerce

-- | -- | The response status code.
csfrrrsResponseStatus :: Lens' CancelSpotFleetRequestsResponse Int
csfrrrsResponseStatus = lens _csfrrrsResponseStatus (\s a -> s {_csfrrrsResponseStatus = a})
