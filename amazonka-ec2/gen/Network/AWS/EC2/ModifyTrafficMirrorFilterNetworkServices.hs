...
data ModifyTrafficMirrorFilterNetworkServicesResponse = ModifyTrafficMirrorFilterNetworkServicesResponse'
  { _mtmfnsrrsTrafficMirrorFilter ::
      !( Maybe
           TrafficMirrorFilter
       ),
    _mtmfnsrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mtmfnsrrsTrafficMirrorFilter' - The Traffic Mirror filter that the network service is associated with.
--
-- * 'mtmfnsrrsResponseStatus' - -- | The response status code.
modifyTrafficMirrorFilterNetworkServicesResponse ::
  -- | 'mtmfnsrrsResponseStatus'
  Int ->
  ModifyTrafficMirrorFilterNetworkServicesResponse
...
mtmfnsrrsTrafficMirrorFilter :: Lens' ModifyTrafficMirrorFilterNetworkServicesResponse (Maybe TrafficMirrorFilter)
mtmfnsrrsTrafficMirrorFilter = lens _mtmfnsrrsTrafficMirrorFilter (\s a -> s {_mtmfnsrrsTrafficMirrorFilter = a})

-- | -- | The response status code.
mtmfnsrrsResponseStatus :: Lens' ModifyTrafficMirrorFilterNetworkServicesResponse Int
mtmfnsrrsResponseStatus = lens _mtmfnsrrsResponseStatus (\s a -> s {_mtmfnsrrsResponseStatus = a})
