...
instance AWSPager GetManagedPrefixListAssociations where
  page rq rs
    | stop (rs ^. gmplarrsNextToken) = Nothing
    | stop (rs ^. gmplarrsPrefixListAssociations) =
      Nothing
    | otherwise =
      Just $ rq & gmplaNextToken .~ rs ^. gmplarrsNextToken
...
data GetManagedPrefixListAssociationsResponse = GetManagedPrefixListAssociationsResponse'
  { _gmplarrsNextToken ::
    ...
    _gmplarrsPrefixListAssociations ::
      !( Maybe
           [PrefixListAssociation]
       ),
    _gmplarrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gmplarrsNextToken' - The token to use to retrieve the next page of results. This value is @null@ when there are no more results to return.
--
-- * 'gmplarrsPrefixListAssociations' - Information about the associations.
--
-- * 'gmplarrsResponseStatus' - -- | The response status code.
getManagedPrefixListAssociationsResponse ::
  -- | 'gmplarrsResponseStatus'
  Int ->
  GetManagedPrefixListAssociationsResponse
...
gmplarrsNextToken :: Lens' GetManagedPrefixListAssociationsResponse (Maybe Text)
gmplarrsNextToken = lens _gmplarrsNextToken (\s a -> s {_gmplarrsNextToken = a})

-- | Information about the associations.
gmplarrsPrefixListAssociations :: Lens' GetManagedPrefixListAssociationsResponse [PrefixListAssociation]
gmplarrsPrefixListAssociations = lens _gmplarrsPrefixListAssociations (\s a -> s {_gmplarrsPrefixListAssociations = a}) . _Default . _Coerce

-- | -- | The response status code.
gmplarrsResponseStatus :: Lens' GetManagedPrefixListAssociationsResponse Int
gmplarrsResponseStatus = lens _gmplarrsResponseStatus (\s a -> s {_gmplarrsResponseStatus = a})
