...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'icvccrlrrsReturn' - Returns @true@ if the request succeeds; otherwise, it returns an error.
--
-- * 'icvccrlrrsResponseStatus' - -- | The response status code.
importClientVPNClientCertificateRevocationListResponse ::
  -- | 'icvccrlrrsResponseStatus'
  Int ->
  ImportClientVPNClientCertificateRevocationListResponse
...
icvccrlrrsReturn :: Lens' ImportClientVPNClientCertificateRevocationListResponse (Maybe Bool)
icvccrlrrsReturn = lens _icvccrlrrsReturn (\s a -> s {_icvccrlrrsReturn = a})

-- | -- | The response status code.
icvccrlrrsResponseStatus :: Lens' ImportClientVPNClientCertificateRevocationListResponse Int
icvccrlrrsResponseStatus = lens _icvccrlrrsResponseStatus (\s a -> s {_icvccrlrrsResponseStatus = a})
