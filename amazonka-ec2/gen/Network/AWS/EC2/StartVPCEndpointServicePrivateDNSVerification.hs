...
data StartVPCEndpointServicePrivateDNSVerificationResponse = StartVPCEndpointServicePrivateDNSVerificationResponse'
  { _svespdvrrsReturnValue ::
      !( Maybe
           Bool
       ),
    _svespdvrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'svespdvrrsReturnValue' - Returns @true@ if the request succeeds; otherwise, it returns an error.
--
-- * 'svespdvrrsResponseStatus' - -- | The response status code.
startVPCEndpointServicePrivateDNSVerificationResponse ::
  -- | 'svespdvrrsResponseStatus'
  Int ->
  StartVPCEndpointServicePrivateDNSVerificationResponse
...
svespdvrrsReturnValue :: Lens' StartVPCEndpointServicePrivateDNSVerificationResponse (Maybe Bool)
svespdvrrsReturnValue = lens _svespdvrrsReturnValue (\s a -> s {_svespdvrrsReturnValue = a})

-- | -- | The response status code.
svespdvrrsResponseStatus :: Lens' StartVPCEndpointServicePrivateDNSVerificationResponse Int
svespdvrrsResponseStatus = lens _svespdvrrsResponseStatus (\s a -> s {_svespdvrrsResponseStatus = a})
