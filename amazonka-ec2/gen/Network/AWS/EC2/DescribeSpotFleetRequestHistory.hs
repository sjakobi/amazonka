...
data DescribeSpotFleetRequestHistoryResponse = DescribeSpotFleetRequestHistoryResponse'
  { _dsfrhrrsNextToken ::
    ...
    _dsfrhrrsHistoryRecords ::
      !( Maybe
           [HistoryRecord]
       ),
    _dsfrhrrsLastEvaluatedTime ::
      !( Maybe
           ISO8601
       ),
    _dsfrhrrsSpotFleetRequestId ::
      !( Maybe
           Text
       ),
    _dsfrhrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dsfrhrrsNextToken' - The token required to retrieve the next set of results. This value is @null@ when there are no more results to return.
--
-- * 'dsfrhrrsStartTime' - The starting date and time for the events, in UTC format (for example, /YYYY/ -/MM/ -/DD/ T/HH/ :/MM/ :/SS/ Z).
--
-- * 'dsfrhrrsHistoryRecords' - Information about the events in the history of the Spot Fleet request.
--
-- * 'dsfrhrrsLastEvaluatedTime' - The last date and time for the events, in UTC format (for example, /YYYY/ -/MM/ -/DD/ T/HH/ :/MM/ :/SS/ Z). All records up to this time were retrieved. If @nextToken@ indicates that there are more results, this value is not present.
--
-- * 'dsfrhrrsSpotFleetRequestId' - The ID of the Spot Fleet request.
--
-- * 'dsfrhrrsResponseStatus' - -- | The response status code.
describeSpotFleetRequestHistoryResponse ::
  -- | 'dsfrhrrsResponseStatus'
  Int ->
  DescribeSpotFleetRequestHistoryResponse
describeSpotFleetRequestHistoryResponse
  pResponseStatus_ =
    DescribeSpotFleetRequestHistoryResponse'
      { _dsfrhrrsNextToken =
          Nothing,
        _dsfrhrrsStartTime = Nothing,
        _dsfrhrrsHistoryRecords = Nothing,
        _dsfrhrrsLastEvaluatedTime =
          Nothing,
        _dsfrhrrsSpotFleetRequestId =
          Nothing,
...
dsfrhrrsNextToken :: Lens' DescribeSpotFleetRequestHistoryResponse (Maybe Text)
dsfrhrrsNextToken = lens _dsfrhrrsNextToken (\s a -> s {_dsfrhrrsNextToken = a})

-- | The starting date and time for the events, in UTC format (for example, /YYYY/ -/MM/ -/DD/ T/HH/ :/MM/ :/SS/ Z).
dsfrhrrsStartTime :: Lens' DescribeSpotFleetRequestHistoryResponse (Maybe UTCTime)
dsfrhrrsStartTime = lens _dsfrhrrsStartTime (\s a -> s {_dsfrhrrsStartTime = a}) . mapping _Time

-- | Information about the events in the history of the Spot Fleet request.
dsfrhrrsHistoryRecords :: Lens' DescribeSpotFleetRequestHistoryResponse [HistoryRecord]
dsfrhrrsHistoryRecords = lens _dsfrhrrsHistoryRecords (\s a -> s {_dsfrhrrsHistoryRecords = a}) . _Default . _Coerce
...
dsfrhrrsLastEvaluatedTime :: Lens' DescribeSpotFleetRequestHistoryResponse (Maybe UTCTime)
dsfrhrrsLastEvaluatedTime = lens _dsfrhrrsLastEvaluatedTime (\s a -> s {_dsfrhrrsLastEvaluatedTime = a}) . mapping _Time

-- | The ID of the Spot Fleet request.
dsfrhrrsSpotFleetRequestId :: Lens' DescribeSpotFleetRequestHistoryResponse (Maybe Text)
dsfrhrrsSpotFleetRequestId = lens _dsfrhrrsSpotFleetRequestId (\s a -> s {_dsfrhrrsSpotFleetRequestId = a})

-- | -- | The response status code.
dsfrhrrsResponseStatus :: Lens' DescribeSpotFleetRequestHistoryResponse Int
dsfrhrrsResponseStatus = lens _dsfrhrrsResponseStatus (\s a -> s {_dsfrhrrsResponseStatus = a})
