...
data DeleteLocalGatewayRouteTableVPCAssociationResponse = DeleteLocalGatewayRouteTableVPCAssociationResponse'
  { _dlgrtvarrsLocalGatewayRouteTableVPCAssociation ::
      !( Maybe
           LocalGatewayRouteTableVPCAssociation
       ),
    _dlgrtvarrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dlgrtvarrsLocalGatewayRouteTableVPCAssociation' - Information about the association.
--
-- * 'dlgrtvarrsResponseStatus' - -- | The response status code.
deleteLocalGatewayRouteTableVPCAssociationResponse ::
  -- | 'dlgrtvarrsResponseStatus'
  Int ->
  DeleteLocalGatewayRouteTableVPCAssociationResponse
...
dlgrtvarrsLocalGatewayRouteTableVPCAssociation :: Lens' DeleteLocalGatewayRouteTableVPCAssociationResponse (Maybe LocalGatewayRouteTableVPCAssociation)
dlgrtvarrsLocalGatewayRouteTableVPCAssociation = lens _dlgrtvarrsLocalGatewayRouteTableVPCAssociation (\s a -> s {_dlgrtvarrsLocalGatewayRouteTableVPCAssociation = a})

-- | -- | The response status code.
dlgrtvarrsResponseStatus :: Lens' DeleteLocalGatewayRouteTableVPCAssociationResponse Int
dlgrtvarrsResponseStatus = lens _dlgrtvarrsResponseStatus (\s a -> s {_dlgrtvarrsResponseStatus = a})
