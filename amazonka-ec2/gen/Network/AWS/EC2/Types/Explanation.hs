...
data Explanation = Explanation'
  { -- | The target groups.
    ...
    loadBalancerListenerPort :: Prelude.Maybe Prelude.Nat,
    -- | The component VPC.
    vpc :: Prelude.Maybe AnalysisComponent,
    -- | The target port.
    loadBalancerTargetPort :: Prelude.Maybe Prelude.Nat
  }
...
explanation_port = Lens.lens (\Explanation' {port} -> port) (\s@Explanation' {} a -> s {port = a} :: Explanation) Prelude.. Lens.mapping Prelude._Nat
...
explanation_loadBalancerListenerPort = Lens.lens (\Explanation' {loadBalancerListenerPort} -> loadBalancerListenerPort) (\s@Explanation' {} a -> s {loadBalancerListenerPort = a} :: Explanation) Prelude.. Lens.mapping Prelude._Nat
...
explanation_loadBalancerTargetPort = Lens.lens (\Explanation' {loadBalancerTargetPort} -> loadBalancerTargetPort) (\s@Explanation' {} a -> s {loadBalancerTargetPort = a} :: Explanation) Prelude.. Lens.mapping Prelude._Nat
