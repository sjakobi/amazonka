...
--
-- * 'crsCapacityReservationPreference' - Indicates the instance's Capacity Reservation preferences. Possible preferences include:     * @open@ - The instance can run in any @open@ Capacity Reservation that has matching attributes (instance type, platform, Availability Zone).     * @none@ - The instance avoids running in a Capacity Reservation even if one is available. The instance runs as an On-Demand Instance.
--
-- * 'crsCapacityReservationTarget' - Information about the target Capacity Reservation or Capacity Reservation group.
...
crsCapacityReservationPreference :: Lens' CapacityReservationSpecification (Maybe CapacityReservationPreference)
...
crsCapacityReservationTarget :: Lens' CapacityReservationSpecification (Maybe CapacityReservationTarget)
