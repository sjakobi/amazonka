...
--
-- * 'iLicenseConfigurationARN' - The ARN of a license configuration.
...
iLicenseConfigurationARN :: Lens' ImportImageLicenseConfigurationResponse (Maybe Text)
iLicenseConfigurationARN = lens _iLicenseConfigurationARN (\s a -> s {_iLicenseConfigurationARN = a})
