...
instance Hashable ModifyVPCTenancy

instance NFData ModifyVPCTenancy
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mvtrrsReturnValue' - Returns @true@ if the request succeeds; otherwise, returns an error.
--
-- * 'mvtrrsResponseStatus' - -- | The response status code.
modifyVPCTenancyResponse ::
  -- | 'mvtrrsResponseStatus'
  Int ->
  ModifyVPCTenancyResponse
modifyVPCTenancyResponse pResponseStatus_ =
  ModifyVPCTenancyResponse'
    { _mvtrrsReturnValue =
        Nothing,
      _mvtrrsResponseStatus = pResponseStatus_
    }

-- | Returns @true@ if the request succeeds; otherwise, returns an error.
mvtrrsReturnValue :: Lens' ModifyVPCTenancyResponse (Maybe Bool)
mvtrrsReturnValue = lens _mvtrrsReturnValue (\s a -> s {_mvtrrsReturnValue = a})

-- | -- | The response status code.
mvtrrsResponseStatus :: Lens' ModifyVPCTenancyResponse Int
mvtrrsResponseStatus = lens _mvtrrsResponseStatus (\s a -> s {_mvtrrsResponseStatus = a})

instance NFData ModifyVPCTenancyResponse
