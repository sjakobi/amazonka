...
data ReplaceNetworkACLAssociationResponse = ReplaceNetworkACLAssociationResponse'
  { _rnaarrsNewAssociationId ::
      !( Maybe
           Text
       ),
    _rnaarrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rnaarrsNewAssociationId' - The ID of the new association.
--
-- * 'rnaarrsResponseStatus' - -- | The response status code.
replaceNetworkACLAssociationResponse ::
  -- | 'rnaarrsResponseStatus'
  Int ->
  ReplaceNetworkACLAssociationResponse
...
rnaarrsNewAssociationId :: Lens' ReplaceNetworkACLAssociationResponse (Maybe Text)
rnaarrsNewAssociationId = lens _rnaarrsNewAssociationId (\s a -> s {_rnaarrsNewAssociationId = a})

-- | -- | The response status code.
rnaarrsResponseStatus :: Lens' ReplaceNetworkACLAssociationResponse Int
rnaarrsResponseStatus = lens _rnaarrsResponseStatus (\s a -> s {_rnaarrsResponseStatus = a})
