...
data AttachVPNGatewayResponse = AttachVPNGatewayResponse'
  { _avgrrsVPCAttachment ::
      !( Maybe
           VPCAttachment
       ),
    _avgrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'avgrrsVPCAttachment' - Information about the attachment.
--
-- * 'avgrrsResponseStatus' - -- | The response status code.
attachVPNGatewayResponse ::
  -- | 'avgrrsResponseStatus'
  Int ->
  AttachVPNGatewayResponse
attachVPNGatewayResponse pResponseStatus_ =
  AttachVPNGatewayResponse'
    { _avgrrsVPCAttachment =
        Nothing,
      _avgrrsResponseStatus = pResponseStatus_
    }

-- | Information about the attachment.
avgrrsVPCAttachment :: Lens' AttachVPNGatewayResponse (Maybe VPCAttachment)
avgrrsVPCAttachment = lens _avgrrsVPCAttachment (\s a -> s {_avgrrsVPCAttachment = a})

-- | -- | The response status code.
avgrrsResponseStatus :: Lens' AttachVPNGatewayResponse Int
avgrrsResponseStatus = lens _avgrrsResponseStatus (\s a -> s {_avgrrsResponseStatus = a})
