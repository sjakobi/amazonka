...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cdorrsDHCPOptions' - A set of DHCP options.
--
-- * 'cdorrsResponseStatus' - -- | The response status code.
createDHCPOptionsResponse ::
  -- | 'cdorrsResponseStatus'
  Int ->
  CreateDHCPOptionsResponse
createDHCPOptionsResponse pResponseStatus_ =
  CreateDHCPOptionsResponse'
    { _cdorrsDHCPOptions =
        Nothing,
      _cdorrsResponseStatus = pResponseStatus_
    }

-- | A set of DHCP options.
cdorrsDHCPOptions :: Lens' CreateDHCPOptionsResponse (Maybe DHCPOptions)
cdorrsDHCPOptions = lens _cdorrsDHCPOptions (\s a -> s {_cdorrsDHCPOptions = a})

-- | -- | The response status code.
cdorrsResponseStatus :: Lens' CreateDHCPOptionsResponse Int
cdorrsResponseStatus = lens _cdorrsResponseStatus (\s a -> s {_cdorrsResponseStatus = a})
