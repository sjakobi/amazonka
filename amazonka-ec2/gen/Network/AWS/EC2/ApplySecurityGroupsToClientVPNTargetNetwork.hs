...
data ApplySecurityGroupsToClientVPNTargetNetworkResponse = ApplySecurityGroupsToClientVPNTargetNetworkResponse'
  { _asgtcvtnrrsSecurityGroupIds ::
      !( Maybe
           [Text]
       ),
    _asgtcvtnrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'asgtcvtnrrsSecurityGroupIds' - The IDs of the applied security groups.
--
-- * 'asgtcvtnrrsResponseStatus' - -- | The response status code.
applySecurityGroupsToClientVPNTargetNetworkResponse ::
  -- | 'asgtcvtnrrsResponseStatus'
  Int ->
  ApplySecurityGroupsToClientVPNTargetNetworkResponse
...
asgtcvtnrrsSecurityGroupIds :: Lens' ApplySecurityGroupsToClientVPNTargetNetworkResponse [Text]
asgtcvtnrrsSecurityGroupIds = lens _asgtcvtnrrsSecurityGroupIds (\s a -> s {_asgtcvtnrrsSecurityGroupIds = a}) . _Default . _Coerce

-- | -- | The response status code.
asgtcvtnrrsResponseStatus :: Lens' ApplySecurityGroupsToClientVPNTargetNetworkResponse Int
asgtcvtnrrsResponseStatus = lens _asgtcvtnrrsResponseStatus (\s a -> s {_asgtcvtnrrsResponseStatus = a})
