...
--
--
-- For more information about Reserved Instances, see <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/concepts-on-demand-reserved-instances.html Reserved Instances> in the /Amazon EC2 User Guide/ .
module Network.AWS.EC2.DescribeReservedInstances
  ( -- * Creating a Request
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'drirrsReservedInstances' - A list of Reserved Instances.
--
...
drirrsReservedInstances :: Lens' DescribeReservedInstancesResponse [ReservedInstances]
drirrsReservedInstances = lens _drirrsReservedInstances (\s a -> s {_drirrsReservedInstances = a}) . _Default . _Coerce

-- | -- | The response status code.
drirrsResponseStatus :: Lens' DescribeReservedInstancesResponse Int
