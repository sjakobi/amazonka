...
--
-- * 'daAssociationId' - [EC2-VPC] The association ID. Required for EC2-VPC.
--
-- * 'daPublicIP' - [EC2-Classic] The Elastic IP address. Required for EC2-Classic.
disassociateAddress ::
  DisassociateAddress
disassociateAddress =
  DisassociateAddress'
...
daDryRun :: Lens' DisassociateAddress (Maybe Bool)
daDryRun = lens _daDryRun (\s a -> s {_daDryRun = a})

-- | [EC2-VPC] The association ID. Required for EC2-VPC.
daAssociationId :: Lens' DisassociateAddress (Maybe Text)
daAssociationId = lens _daAssociationId (\s a -> s {_daAssociationId = a})

-- | [EC2-Classic] The Elastic IP address. Required for EC2-Classic.
daPublicIP :: Lens' DisassociateAddress (Maybe Text)
