...
--
-- * 'ditInstanceTypes' - The instance types. For more information, see <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html Instance types> in the /Amazon EC2 User Guide/ .
describeInstanceTypes ::
  DescribeInstanceTypes
describeInstanceTypes =
  DescribeInstanceTypes'
...
-- | The instance types. For more information, see <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html Instance types> in the /Amazon EC2 User Guide/ .
...
instance AWSPager DescribeInstanceTypes where
  page rq rs
    | stop (rs ^. ditrrsNextToken) = Nothing
    | stop (rs ^. ditrrsInstanceTypes) = Nothing
    | otherwise =
      Just $ rq & ditNextToken .~ rs ^. ditrrsNextToken
  ...
  toQuery DescribeInstanceTypes' {..} =
    mconcat
      [ "Action" =: ("DescribeInstanceTypes" :: ByteString),
        ...
        toQuery
          (toQueryList "InstanceType" <$> _ditInstanceTypes)
      ]
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ditrrsNextToken' - The token to use to retrieve the next page of results. This value is @null@ when there are no more results to return.
--
-- * 'ditrrsInstanceTypes' - The instance type. For more information, see <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html Instance types> in the /Amazon EC2 User Guide/ .
--
...
describeInstanceTypesResponse pResponseStatus_ =
  DescribeInstanceTypesResponse'
    { _ditrrsNextToken =
        Nothing,
      _ditrrsInstanceTypes = Nothing,
      _ditrrsResponseStatus = pResponseStatus_
    }

-- | The token to use to retrieve the next page of results. This value is @null@ when there are no more results to return.
ditrrsNextToken :: Lens' DescribeInstanceTypesResponse (Maybe Text)
...
ditrrsInstanceTypes :: Lens' DescribeInstanceTypesResponse [InstanceTypeInfo]
ditrrsInstanceTypes = lens _ditrrsInstanceTypes (\s a -> s {_ditrrsInstanceTypes = a}) . _Default . _Coerce

-- | -- | The response status code.
ditrrsResponseStatus :: Lens' DescribeInstanceTypesResponse Int
