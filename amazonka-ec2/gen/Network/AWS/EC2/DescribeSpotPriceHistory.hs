...
instance AWSPager DescribeSpotPriceHistory where
  page rq rs
    | stop (rs ^. dsphrrsNextToken) = Nothing
    | stop (rs ^. dsphrrsSpotPriceHistory) = Nothing
    | otherwise =
      Just $ rq & dsphNextToken .~ rs ^. dsphrrsNextToken
...
data DescribeSpotPriceHistoryResponse = DescribeSpotPriceHistoryResponse'
  { _dsphrrsNextToken ::
    ...
    _dsphrrsSpotPriceHistory ::
      !( Maybe
           [SpotPrice]
       ),
    _dsphrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dsphrrsNextToken' - The token required to retrieve the next set of results. This value is null or an empty string when there are no more results to return.
--
-- * 'dsphrrsSpotPriceHistory' - The historical Spot prices.
--
-- * 'dsphrrsResponseStatus' - -- | The response status code.
describeSpotPriceHistoryResponse ::
  -- | 'dsphrrsResponseStatus'
  Int ->
  DescribeSpotPriceHistoryResponse
describeSpotPriceHistoryResponse pResponseStatus_ =
  DescribeSpotPriceHistoryResponse'
    { _dsphrrsNextToken =
        Nothing,
      _dsphrrsSpotPriceHistory = Nothing,
      _dsphrrsResponseStatus = pResponseStatus_
    }

-- | The token required to retrieve the next set of results. This value is null or an empty string when there are no more results to return.
dsphrrsNextToken :: Lens' DescribeSpotPriceHistoryResponse (Maybe Text)
dsphrrsNextToken = lens _dsphrrsNextToken (\s a -> s {_dsphrrsNextToken = a})

-- | The historical Spot prices.
dsphrrsSpotPriceHistory :: Lens' DescribeSpotPriceHistoryResponse [SpotPrice]
dsphrrsSpotPriceHistory = lens _dsphrrsSpotPriceHistory (\s a -> s {_dsphrrsSpotPriceHistory = a}) . _Default . _Coerce

-- | -- | The response status code.
dsphrrsResponseStatus :: Lens' DescribeSpotPriceHistoryResponse Int
dsphrrsResponseStatus = lens _dsphrrsResponseStatus (\s a -> s {_dsphrrsResponseStatus = a})
