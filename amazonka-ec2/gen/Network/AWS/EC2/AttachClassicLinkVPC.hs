...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'aclvrrsReturn' - Returns @true@ if the request succeeds; otherwise, it returns an error.
--
-- * 'aclvrrsResponseStatus' - -- | The response status code.
attachClassicLinkVPCResponse ::
  -- | 'aclvrrsResponseStatus'
  Int ->
  AttachClassicLinkVPCResponse
attachClassicLinkVPCResponse pResponseStatus_ =
  AttachClassicLinkVPCResponse'
    { _aclvrrsReturn =
        Nothing,
      _aclvrrsResponseStatus = pResponseStatus_
    }

-- | Returns @true@ if the request succeeds; otherwise, it returns an error.
aclvrrsReturn :: Lens' AttachClassicLinkVPCResponse (Maybe Bool)
aclvrrsReturn = lens _aclvrrsReturn (\s a -> s {_aclvrrsReturn = a})

-- | -- | The response status code.
aclvrrsResponseStatus :: Lens' AttachClassicLinkVPCResponse Int
aclvrrsResponseStatus = lens _aclvrrsResponseStatus (\s a -> s {_aclvrrsResponseStatus = a})
