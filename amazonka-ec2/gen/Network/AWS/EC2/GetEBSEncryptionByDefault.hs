...
instance ToQuery GetEBSEncryptionByDefault where
  toQuery GetEBSEncryptionByDefault' {..} =
    mconcat
      [ "Action"
          =: ("GetEbsEncryptionByDefault" :: ByteString),
...
data GetEBSEncryptionByDefaultResponse = GetEBSEncryptionByDefaultResponse'
  { _geebdrrsEBSEncryptionByDefault ::
      !( Maybe
           Bool
       ),
    _geebdrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'geebdrrsEBSEncryptionByDefault' - Indicates whether encryption by default is enabled.
--
-- * 'geebdrrsResponseStatus' - -- | The response status code.
getEBSEncryptionByDefaultResponse ::
  -- | 'geebdrrsResponseStatus'
  Int ->
  GetEBSEncryptionByDefaultResponse
...
geebdrrsEBSEncryptionByDefault :: Lens' GetEBSEncryptionByDefaultResponse (Maybe Bool)
geebdrrsEBSEncryptionByDefault = lens _geebdrrsEBSEncryptionByDefault (\s a -> s {_geebdrrsEBSEncryptionByDefault = a})

-- | -- | The response status code.
geebdrrsResponseStatus :: Lens' GetEBSEncryptionByDefaultResponse Int
geebdrrsResponseStatus = lens _geebdrrsResponseStatus (\s a -> s {_geebdrrsResponseStatus = a})
