...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rvpcrrsReturn' - Returns @true@ if the request succeeds; otherwise, it returns an error.
--
-- * 'rvpcrrsResponseStatus' - -- | The response status code.
rejectVPCPeeringConnectionResponse ::
  -- | 'rvpcrrsResponseStatus'
  Int ->
  RejectVPCPeeringConnectionResponse
...
rvpcrrsReturn :: Lens' RejectVPCPeeringConnectionResponse (Maybe Bool)
rvpcrrsReturn = lens _rvpcrrsReturn (\s a -> s {_rvpcrrsReturn = a})

-- | -- | The response status code.
rvpcrrsResponseStatus :: Lens' RejectVPCPeeringConnectionResponse Int
rvpcrrsResponseStatus = lens _rvpcrrsResponseStatus (\s a -> s {_rvpcrrsResponseStatus = a})
