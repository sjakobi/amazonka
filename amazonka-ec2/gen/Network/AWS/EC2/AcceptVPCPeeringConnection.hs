...
data AcceptVPCPeeringConnectionResponse = AcceptVPCPeeringConnectionResponse'
  { _avpcrrsVPCPeeringConnection ::
      !( Maybe
           VPCPeeringConnection
       ),
    _avpcrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'avpcrrsVPCPeeringConnection' - Information about the VPC peering connection.
--
-- * 'avpcrrsResponseStatus' - -- | The response status code.
acceptVPCPeeringConnectionResponse ::
  -- | 'avpcrrsResponseStatus'
  Int ->
  AcceptVPCPeeringConnectionResponse
...
avpcrrsVPCPeeringConnection :: Lens' AcceptVPCPeeringConnectionResponse (Maybe VPCPeeringConnection)
avpcrrsVPCPeeringConnection = lens _avpcrrsVPCPeeringConnection (\s a -> s {_avpcrrsVPCPeeringConnection = a})

-- | -- | The response status code.
avpcrrsResponseStatus :: Lens' AcceptVPCPeeringConnectionResponse Int
avpcrrsResponseStatus = lens _avpcrrsResponseStatus (\s a -> s {_avpcrrsResponseStatus = a})
