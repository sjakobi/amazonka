...
getAssociatedIpv6PoolCidrs_maxResults = Lens.lens (\GetAssociatedIpv6PoolCidrs' {maxResults} -> maxResults) (\s@GetAssociatedIpv6PoolCidrs' {} a -> s {maxResults = a} :: GetAssociatedIpv6PoolCidrs) Prelude.. Lens.mapping Prelude._Nat
...
instance
  ...
  response =
    Response.receiveXML
      ( \s h x ->
          GetAssociatedIpv6PoolCidrsResponse'
            Prelude.<$> ( x Prelude..@? "ipv6CidrAssociationSet"
...
instance Prelude.ToHeaders GetAssociatedIpv6PoolCidrs where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath GetAssociatedIpv6PoolCidrs where
  toPath = Prelude.const "/"

instance Prelude.ToQuery GetAssociatedIpv6PoolCidrs where
  toQuery GetAssociatedIpv6PoolCidrs' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("GetAssociatedIpv6PoolCidrs" :: Prelude.ByteString),
        "Version"
...
getAssociatedIpv6PoolCidrsResponse_ipv6CidrAssociations = Lens.lens (\GetAssociatedIpv6PoolCidrsResponse' {ipv6CidrAssociations} -> ipv6CidrAssociations) (\s@GetAssociatedIpv6PoolCidrsResponse' {} a -> s {ipv6CidrAssociations = a} :: GetAssociatedIpv6PoolCidrsResponse) Prelude.. Lens.mapping Prelude._Coerce
