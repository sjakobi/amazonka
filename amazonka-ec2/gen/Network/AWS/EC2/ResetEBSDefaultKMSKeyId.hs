...
instance ToQuery ResetEBSDefaultKMSKeyId where
  toQuery ResetEBSDefaultKMSKeyId' {..} =
    mconcat
      [ "Action"
          =: ("ResetEbsDefaultKmsKeyId" :: ByteString),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'redkkirrsKMSKeyId' - The Amazon Resource Name (ARN) of the default CMK for EBS encryption by default.
--
-- * 'redkkirrsResponseStatus' - -- | The response status code.
resetEBSDefaultKMSKeyIdResponse ::
  -- | 'redkkirrsResponseStatus'
  Int ->
  ResetEBSDefaultKMSKeyIdResponse
...
redkkirrsKMSKeyId :: Lens' ResetEBSDefaultKMSKeyIdResponse (Maybe Text)
redkkirrsKMSKeyId = lens _redkkirrsKMSKeyId (\s a -> s {_redkkirrsKMSKeyId = a})

-- | -- | The response status code.
redkkirrsResponseStatus :: Lens' ResetEBSDefaultKMSKeyIdResponse Int
redkkirrsResponseStatus = lens _redkkirrsResponseStatus (\s a -> s {_redkkirrsResponseStatus = a})
