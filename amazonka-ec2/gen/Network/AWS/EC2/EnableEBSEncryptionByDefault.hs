...
instance ToQuery EnableEBSEncryptionByDefault where
  toQuery EnableEBSEncryptionByDefault' {..} =
    mconcat
      [ "Action"
          =: ("EnableEbsEncryptionByDefault" :: ByteString),
...
data EnableEBSEncryptionByDefaultResponse = EnableEBSEncryptionByDefaultResponse'
  { _eeebdrrsEBSEncryptionByDefault ::
      !( Maybe
           Bool
       ),
    _eeebdrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'eeebdrrsEBSEncryptionByDefault' - The updated status of encryption by default.
--
-- * 'eeebdrrsResponseStatus' - -- | The response status code.
enableEBSEncryptionByDefaultResponse ::
  -- | 'eeebdrrsResponseStatus'
  Int ->
  EnableEBSEncryptionByDefaultResponse
...
eeebdrrsEBSEncryptionByDefault :: Lens' EnableEBSEncryptionByDefaultResponse (Maybe Bool)
eeebdrrsEBSEncryptionByDefault = lens _eeebdrrsEBSEncryptionByDefault (\s a -> s {_eeebdrrsEBSEncryptionByDefault = a})

-- | -- | The response status code.
eeebdrrsResponseStatus :: Lens' EnableEBSEncryptionByDefaultResponse Int
eeebdrrsResponseStatus = lens _eeebdrrsResponseStatus (\s a -> s {_eeebdrrsResponseStatus = a})
