...
createClientVpnEndpoint_securityGroupIds = Lens.lens (\CreateClientVpnEndpoint' {securityGroupIds} -> securityGroupIds) (\s@CreateClientVpnEndpoint' {} a -> s {securityGroupIds = a} :: CreateClientVpnEndpoint) Prelude.. Lens.mapping Prelude._Coerce

-- | The tags to apply to the Client VPN endpoint during creation.
createClientVpnEndpoint_tagSpecifications :: Lens.Lens' CreateClientVpnEndpoint (Prelude.Maybe [TagSpecification])
createClientVpnEndpoint_tagSpecifications = Lens.lens (\CreateClientVpnEndpoint' {tagSpecifications} -> tagSpecifications) (\s@CreateClientVpnEndpoint' {} a -> s {tagSpecifications = a} :: CreateClientVpnEndpoint) Prelude.. Lens.mapping Prelude._Coerce
...
createClientVpnEndpoint_dnsServers = Lens.lens (\CreateClientVpnEndpoint' {dnsServers} -> dnsServers) (\s@CreateClientVpnEndpoint' {} a -> s {dnsServers = a} :: CreateClientVpnEndpoint) Prelude.. Lens.mapping Prelude._Coerce
...
createClientVpnEndpoint_authenticationOptions = Lens.lens (\CreateClientVpnEndpoint' {authenticationOptions} -> authenticationOptions) (\s@CreateClientVpnEndpoint' {} a -> s {authenticationOptions = a} :: CreateClientVpnEndpoint) Prelude.. Prelude._Coerce
...
instance Prelude.AWSRequest CreateClientVpnEndpoint where
  type
...
instance Prelude.ToHeaders CreateClientVpnEndpoint where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath CreateClientVpnEndpoint where
  toPath = Prelude.const "/"

instance Prelude.ToQuery CreateClientVpnEndpoint where
  toQuery CreateClientVpnEndpoint' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("CreateClientVpnEndpoint" :: Prelude.ByteString),
        "Version"
        ...
        "TransportProtocol" Prelude.=: transportProtocol,
        "ClientConnectOptions"
          Prelude.=: clientConnectOptions,
        Prelude.toQuery
          ( Prelude.toQueryList "DnsServers"
              Prelude.<$> dnsServers
          ),
        ...
        "ClientCidrBlock" Prelude.=: clientCidrBlock,
        "ServerCertificateArn"
