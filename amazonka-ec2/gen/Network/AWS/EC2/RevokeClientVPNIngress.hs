...
instance Hashable RevokeClientVPNIngress

instance NFData RevokeClientVPNIngress
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rcvirrsStatus' - The current state of the authorization rule.
--
-- * 'rcvirrsResponseStatus' - -- | The response status code.
revokeClientVPNIngressResponse ::
  -- | 'rcvirrsResponseStatus'
  Int ->
  RevokeClientVPNIngressResponse
revokeClientVPNIngressResponse pResponseStatus_ =
  RevokeClientVPNIngressResponse'
    { _rcvirrsStatus =
        Nothing,
      _rcvirrsResponseStatus = pResponseStatus_
    }

-- | The current state of the authorization rule.
rcvirrsStatus :: Lens' RevokeClientVPNIngressResponse (Maybe ClientVPNAuthorizationRuleStatus)
rcvirrsStatus = lens _rcvirrsStatus (\s a -> s {_rcvirrsStatus = a})

-- | -- | The response status code.
rcvirrsResponseStatus :: Lens' RevokeClientVPNIngressResponse Int
rcvirrsResponseStatus = lens _rcvirrsResponseStatus (\s a -> s {_rcvirrsResponseStatus = a})

instance NFData RevokeClientVPNIngressResponse
