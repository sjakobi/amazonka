...
describeNetworkAcls_maxResults = Lens.lens (\DescribeNetworkAcls' {maxResults} -> maxResults) (\s@DescribeNetworkAcls' {} a -> s {maxResults = a} :: DescribeNetworkAcls) Prelude.. Lens.mapping Prelude._Nat

-- | One or more network ACL IDs.
--
-- Default: Describes all your network ACLs.
describeNetworkAcls_networkAclIds :: Lens.Lens' DescribeNetworkAcls (Prelude.Maybe [Prelude.Text])
describeNetworkAcls_networkAclIds = Lens.lens (\DescribeNetworkAcls' {networkAclIds} -> networkAclIds) (\s@DescribeNetworkAcls' {} a -> s {networkAclIds = a} :: DescribeNetworkAcls) Prelude.. Lens.mapping Prelude._Coerce
...
describeNetworkAcls_filters = Lens.lens (\DescribeNetworkAcls' {filters} -> filters) (\s@DescribeNetworkAcls' {} a -> s {filters = a} :: DescribeNetworkAcls) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.AWSRequest DescribeNetworkAcls where
  type
    Rs DescribeNetworkAcls =
      DescribeNetworkAclsResponse
    ...
    Response.receiveXML
      ( \s h x ->
          DescribeNetworkAclsResponse'
            ...
            Prelude.<*> ( x Prelude..@? "networkAclSet"
...
instance Prelude.ToHeaders DescribeNetworkAcls where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath DescribeNetworkAcls where
  toPath = Prelude.const "/"

instance Prelude.ToQuery DescribeNetworkAcls where
  toQuery DescribeNetworkAcls' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("DescribeNetworkAcls" :: Prelude.ByteString),
        "Version"
        ...
        Prelude.toQuery
          ( Prelude.toQueryList "NetworkAclId"
...
describeNetworkAclsResponse_networkAcls = Lens.lens (\DescribeNetworkAclsResponse' {networkAcls} -> networkAcls) (\s@DescribeNetworkAclsResponse' {} a -> s {networkAcls = a} :: DescribeNetworkAclsResponse) Prelude.. Lens.mapping Prelude._Coerce
