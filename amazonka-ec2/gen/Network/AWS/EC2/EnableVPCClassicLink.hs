...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'evclrrsReturn' - Returns @true@ if the request succeeds; otherwise, it returns an error.
--
-- * 'evclrrsResponseStatus' - -- | The response status code.
enableVPCClassicLinkResponse ::
  -- | 'evclrrsResponseStatus'
  Int ->
  EnableVPCClassicLinkResponse
enableVPCClassicLinkResponse pResponseStatus_ =
  EnableVPCClassicLinkResponse'
    { _evclrrsReturn =
        Nothing,
      _evclrrsResponseStatus = pResponseStatus_
    }

-- | Returns @true@ if the request succeeds; otherwise, it returns an error.
evclrrsReturn :: Lens' EnableVPCClassicLinkResponse (Maybe Bool)
evclrrsReturn = lens _evclrrsReturn (\s a -> s {_evclrrsReturn = a})

-- | -- | The response status code.
evclrrsResponseStatus :: Lens' EnableVPCClassicLinkResponse Int
evclrrsResponseStatus = lens _evclrrsResponseStatus (\s a -> s {_evclrrsResponseStatus = a})
