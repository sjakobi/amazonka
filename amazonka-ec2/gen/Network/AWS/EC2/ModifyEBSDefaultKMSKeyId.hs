...
instance ToQuery ModifyEBSDefaultKMSKeyId where
  toQuery ModifyEBSDefaultKMSKeyId' {..} =
    mconcat
      [ "Action"
          =: ("ModifyEbsDefaultKmsKeyId" :: ByteString),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'medkkirrsKMSKeyId' - The Amazon Resource Name (ARN) of the default CMK for encryption by default.
--
-- * 'medkkirrsResponseStatus' - -- | The response status code.
modifyEBSDefaultKMSKeyIdResponse ::
  -- | 'medkkirrsResponseStatus'
  Int ->
  ModifyEBSDefaultKMSKeyIdResponse
...
medkkirrsKMSKeyId :: Lens' ModifyEBSDefaultKMSKeyIdResponse (Maybe Text)
medkkirrsKMSKeyId = lens _medkkirrsKMSKeyId (\s a -> s {_medkkirrsKMSKeyId = a})

-- | -- | The response status code.
medkkirrsResponseStatus :: Lens' ModifyEBSDefaultKMSKeyIdResponse Int
medkkirrsResponseStatus = lens _medkkirrsResponseStatus (\s a -> s {_medkkirrsResponseStatus = a})
