...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ivlrrsLockId' - The lock ID, which is used to complete the vault locking process.
--
-- * 'ivlrrsResponseStatus' - -- | The response status code.
initiateVaultLockResponse ::
  -- | 'ivlrrsResponseStatus'
  Int ->
  InitiateVaultLockResponse
initiateVaultLockResponse pResponseStatus_ =
  InitiateVaultLockResponse'
    { _ivlrrsLockId = Nothing,
      _ivlrrsResponseStatus = pResponseStatus_
    }

-- | The lock ID, which is used to complete the vault locking process.
ivlrrsLockId :: Lens' InitiateVaultLockResponse (Maybe Text)
ivlrrsLockId = lens _ivlrrsLockId (\s a -> s {_ivlrrsLockId = a})

-- | -- | The response status code.
ivlrrsResponseStatus :: Lens' InitiateVaultLockResponse Int
ivlrrsResponseStatus = lens _ivlrrsResponseStatus (\s a -> s {_ivlrrsResponseStatus = a})
