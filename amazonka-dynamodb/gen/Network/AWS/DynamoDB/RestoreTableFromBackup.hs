...
data RestoreTableFromBackupResponse = RestoreTableFromBackupResponse'
  { _rtfbrrsTableDescription ::
      !( Maybe
           TableDescription
       ),
    _rtfbrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'rtfbrrsTableDescription' - The description of the table created from an existing backup.
--
-- * 'rtfbrrsResponseStatus' - -- | The response status code.
restoreTableFromBackupResponse ::
  -- | 'rtfbrrsResponseStatus'
  Int ->
  RestoreTableFromBackupResponse
restoreTableFromBackupResponse pResponseStatus_ =
  RestoreTableFromBackupResponse'
    { _rtfbrrsTableDescription =
        Nothing,
      _rtfbrrsResponseStatus = pResponseStatus_
    }

-- | The description of the table created from an existing backup.
rtfbrrsTableDescription :: Lens' RestoreTableFromBackupResponse (Maybe TableDescription)
rtfbrrsTableDescription = lens _rtfbrrsTableDescription (\s a -> s {_rtfbrrsTableDescription = a})

-- | -- | The response status code.
rtfbrrsResponseStatus :: Lens' RestoreTableFromBackupResponse Int
rtfbrrsResponseStatus = lens _rtfbrrsResponseStatus (\s a -> s {_rtfbrrsResponseStatus = a})
