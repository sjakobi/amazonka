...
data Scan = Scan'
  { -- | This is a legacy parameter. Use @FilterExpression@ instead. For more
    ...
    -- in the /Amazon DynamoDB Developer Guide/.
    scanFilter :: Prelude.Maybe (Prelude.Map Prelude.Text Condition),
    ...
    exclusiveStartKey :: Prelude.Maybe (Prelude.Map Prelude.Text AttributeValue),
    ...
    segment :: Prelude.Maybe Prelude.Nat,
    ...
    -- in the /Amazon DynamoDB Developer Guide/.
    attributesToGet :: Prelude.Maybe (Prelude.List1 Prelude.Text),
    ...
    totalSegments :: Prelude.Maybe Prelude.Nat,
...
scan_scanFilter = Lens.lens (\Scan' {scanFilter} -> scanFilter) (\s@Scan' {} a -> s {scanFilter = a} :: Scan) Prelude.. Lens.mapping Prelude._Map
...
scan_exclusiveStartKey = Lens.lens (\Scan' {exclusiveStartKey} -> exclusiveStartKey) (\s@Scan' {} a -> s {exclusiveStartKey = a} :: Scan) Prelude.. Lens.mapping Prelude._Map
...
scan_expressionAttributeValues = Lens.lens (\Scan' {expressionAttributeValues} -> expressionAttributeValues) (\s@Scan' {} a -> s {expressionAttributeValues = a} :: Scan) Prelude.. Lens.mapping Prelude._Map
...
scan_segment = Lens.lens (\Scan' {segment} -> segment) (\s@Scan' {} a -> s {segment = a} :: Scan) Prelude.. Lens.mapping Prelude._Nat
...
scan_expressionAttributeNames = Lens.lens (\Scan' {expressionAttributeNames} -> expressionAttributeNames) (\s@Scan' {} a -> s {expressionAttributeNames = a} :: Scan) Prelude.. Lens.mapping Prelude._Map
...
scan_limit = Lens.lens (\Scan' {limit} -> limit) (\s@Scan' {} a -> s {limit = a} :: Scan) Prelude.. Lens.mapping Prelude._Nat
...
scan_attributesToGet = Lens.lens (\Scan' {attributesToGet} -> attributesToGet) (\s@Scan' {} a -> s {attributesToGet = a} :: Scan) Prelude.. Lens.mapping Prelude._List1
...
scan_totalSegments = Lens.lens (\Scan' {totalSegments} -> totalSegments) (\s@Scan' {} a -> s {totalSegments = a} :: Scan) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.AWSRequest Scan where
...
instance Prelude.ToHeaders Scan where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ("DynamoDB_20120810.Scan" :: Prelude.ByteString),
            "Content-Type"
...
instance Prelude.ToJSON Scan where
  toJSON Scan' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("ScanFilter" Prelude..=) Prelude.<$> scanFilter,
            ...
            ("TotalSegments" Prelude..=)
              Prelude.<$> totalSegments,
            Prelude.Just ("TableName" Prelude..= tableName)
          ]
      )

instance Prelude.ToPath Scan where
  toPath = Prelude.const "/"

instance Prelude.ToQuery Scan where
...
data ScanResponse = ScanResponse'
  { -- | An array of item attributes that match the scan criteria. Each element
    ...
    lastEvaluatedKey :: Prelude.Maybe (Prelude.Map Prelude.Text AttributeValue),
...
scanResponse_items = Lens.lens (\ScanResponse' {items} -> items) (\s@ScanResponse' {} a -> s {items = a} :: ScanResponse) Prelude.. Lens.mapping Prelude._Coerce
...
scanResponse_lastEvaluatedKey = Lens.lens (\ScanResponse' {lastEvaluatedKey} -> lastEvaluatedKey) (\s@ScanResponse' {} a -> s {lastEvaluatedKey = a} :: ScanResponse) Prelude.. Lens.mapping Prelude._Map
