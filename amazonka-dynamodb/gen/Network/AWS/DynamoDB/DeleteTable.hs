...
deleteTable pTableName_ =
  DeleteTable' {_dtTableName = pTableName_}
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dtrrsTableDescription' - Represents the properties of a table.
--
...
dtrrsTableDescription :: Lens' DeleteTableResponse (Maybe TableDescription)
dtrrsTableDescription = lens _dtrrsTableDescription (\s a -> s {_dtrrsTableDescription = a})

-- | -- | The response status code.
dtrrsResponseStatus :: Lens' DeleteTableResponse Int
