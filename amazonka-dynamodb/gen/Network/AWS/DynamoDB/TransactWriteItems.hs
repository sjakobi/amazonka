...
data TransactWriteItems = TransactWriteItems'
  { _twiReturnItemCollectionMetrics ::
    ...
    _twiClientRequestToken ::
      !(Maybe Text),
    _twiTransactItems ::
      !(List1 TransactWriteItem)
  }
...
data TransactWriteItemsResponse = TransactWriteItemsResponse'
  { _twirrsItemCollectionMetrics ::
    ...
    _twirrsConsumedCapacity ::
      !( Maybe
           [ConsumedCapacity]
       ),
    _twirrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'twirrsItemCollectionMetrics' - A list of tables that were processed by @TransactWriteItems@ and, for each table, information about any item collections that were affected by individual @UpdateItem@ , @PutItem@ , or @DeleteItem@ operations.
--
-- * 'twirrsConsumedCapacity' - The capacity units consumed by the entire @TransactWriteItems@ operation. The values of the list are ordered according to the ordering of the @TransactItems@ request parameter.
--
-- * 'twirrsResponseStatus' - -- | The response status code.
transactWriteItemsResponse ::
  -- | 'twirrsResponseStatus'
  Int ->
  TransactWriteItemsResponse
transactWriteItemsResponse pResponseStatus_ =
  TransactWriteItemsResponse'
    { _twirrsItemCollectionMetrics =
        Nothing,
      _twirrsConsumedCapacity = Nothing,
      _twirrsResponseStatus = pResponseStatus_
    }

-- | A list of tables that were processed by @TransactWriteItems@ and, for each table, information about any item collections that were affected by individual @UpdateItem@ , @PutItem@ , or @DeleteItem@ operations.
twirrsItemCollectionMetrics :: Lens' TransactWriteItemsResponse (HashMap Text [ItemCollectionMetrics])
twirrsItemCollectionMetrics = lens _twirrsItemCollectionMetrics (\s a -> s {_twirrsItemCollectionMetrics = a}) . _Default . _Map

-- | The capacity units consumed by the entire @TransactWriteItems@ operation. The values of the list are ordered according to the ordering of the @TransactItems@ request parameter.
twirrsConsumedCapacity :: Lens' TransactWriteItemsResponse [ConsumedCapacity]
twirrsConsumedCapacity = lens _twirrsConsumedCapacity (\s a -> s {_twirrsConsumedCapacity = a}) . _Default . _Coerce

-- | -- | The response status code.
twirrsResponseStatus :: Lens' TransactWriteItemsResponse Int
twirrsResponseStatus = lens _twirrsResponseStatus (\s a -> s {_twirrsResponseStatus = a})
