...
data BatchGetItem = BatchGetItem'
  { returnConsumedCapacity :: Prelude.Maybe ReturnConsumedCapacity,
    ...
    --     in the /Amazon DynamoDB Developer Guide/.
    requestItems :: Prelude.Map Prelude.Text KeysAndAttributes
  }
...
batchGetItem_requestItems = Lens.lens (\BatchGetItem' {requestItems} -> requestItems) (\s@BatchGetItem' {} a -> s {requestItems = a} :: BatchGetItem) Prelude.. Prelude._Map
...
data BatchGetItemResponse = BatchGetItemResponse'
  { -- | A map of tables and their respective keys that were not processed with
    ...
    unprocessedKeys :: Prelude.Maybe (Prelude.Map Prelude.Text KeysAndAttributes),
    ...
    responses :: Prelude.Maybe (Prelude.Map Prelude.Text [Prelude.Map Prelude.Text AttributeValue]),
...
batchGetItemResponse_unprocessedKeys = Lens.lens (\BatchGetItemResponse' {unprocessedKeys} -> unprocessedKeys) (\s@BatchGetItemResponse' {} a -> s {unprocessedKeys = a} :: BatchGetItemResponse) Prelude.. Lens.mapping Prelude._Map
...
batchGetItemResponse_responses = Lens.lens (\BatchGetItemResponse' {responses} -> responses) (\s@BatchGetItemResponse' {} a -> s {responses = a} :: BatchGetItemResponse) Prelude.. Lens.mapping Prelude._Map
