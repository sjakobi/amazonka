...
putItem_expected = Lens.lens (\PutItem' {expected} -> expected) (\s@PutItem' {} a -> s {expected = a} :: PutItem) Prelude.. Lens.mapping Prelude._Map
...
putItem_expressionAttributeValues = Lens.lens (\PutItem' {expressionAttributeValues} -> expressionAttributeValues) (\s@PutItem' {} a -> s {expressionAttributeValues = a} :: PutItem) Prelude.. Lens.mapping Prelude._Map
...
putItem_expressionAttributeNames = Lens.lens (\PutItem' {expressionAttributeNames} -> expressionAttributeNames) (\s@PutItem' {} a -> s {expressionAttributeNames = a} :: PutItem) Prelude.. Lens.mapping Prelude._Map
...
putItem_item = Lens.lens (\PutItem' {item} -> item) (\s@PutItem' {} a -> s {item = a} :: PutItem) Prelude.. Prelude._Map

instance Prelude.AWSRequest PutItem where
...
instance Prelude.ToHeaders PutItem where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ("DynamoDB_20120810.PutItem" :: Prelude.ByteString),
            "Content-Type"
...
instance Prelude.ToJSON PutItem where
  toJSON PutItem' {..} =
    Prelude.object
      ( Prelude.catMaybes
...
instance Prelude.ToPath PutItem where
  toPath = Prelude.const "/"

instance Prelude.ToQuery PutItem where
...
putItemResponse_attributes = Lens.lens (\PutItemResponse' {attributes} -> attributes) (\s@PutItemResponse' {} a -> s {attributes = a} :: PutItemResponse) Prelude.. Lens.mapping Prelude._Map
