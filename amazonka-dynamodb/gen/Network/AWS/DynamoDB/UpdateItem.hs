...
data UpdateItem = UpdateItem'
  { _uiExpected ::
    ...
    _uiAttributeUpdates ::
      !(Maybe (Map Text AttributeValueUpdate)),
...
--
-- * 'uiExpected' - This is a legacy parameter. Use @ConditionExpression@ instead. For more information, see <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.Expected.html Expected> in the /Amazon DynamoDB Developer Guide/ .
--
...
--
-- * 'uiConditionExpression' - A condition that must be satisfied in order for a conditional update to succeed. An expression can contain any of the following:     * Functions: @attribute_exists | attribute_not_exists | attribute_type | contains | begins_with | size@  These function names are case-sensitive.     * Comparison operators: @= | <> | < | > | <= | >= | BETWEEN | IN @      * Logical operators: @AND | OR | NOT@  For more information about condition expressions, see <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.SpecifyingConditions.html Specifying Conditions> in the /Amazon DynamoDB Developer Guide/ .
--
-- * 'uiAttributeUpdates' - This is a legacy parameter. Use @UpdateExpression@ instead. For more information, see <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.AttributeUpdates.html AttributeUpdates> in the /Amazon DynamoDB Developer Guide/ .
--
-- * 'uiReturnConsumedCapacity' - Undocumented member.
--
-- * 'uiConditionalOperator' - This is a legacy parameter. Use @ConditionExpression@ instead. For more information, see <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.ConditionalOperator.html ConditionalOperator> in the /Amazon DynamoDB Developer Guide/ .
--
...
updateItemResponse pResponseStatus_ =
  UpdateItemResponse'
    { _uirrsItemCollectionMetrics =
        Nothing,
      _uirrsAttributes = Nothing,
      _uirrsConsumedCapacity = Nothing,
      _uirrsResponseStatus = pResponseStatus_
    }

-- | Information about item collections, if any, that were affected by the @UpdateItem@ operation. @ItemCollectionMetrics@ is only returned if the @ReturnItemCollectionMetrics@ parameter was specified. If the table does not have any local secondary indexes, this information is not returned in the response. Each @ItemCollectionMetrics@ element consists of:     * @ItemCollectionKey@ - The partition key value of the item collection. This is the same as the partition key value of the item itself.     * @SizeEstimateRangeGB@ - An estimate of item collection size, in gigabytes. This value is a two-element array containing a lower bound and an upper bound for the estimate. The estimate includes the size of all the items in the table, plus the size of all attributes projected into all of the local secondary indexes on that table. Use this estimate to measure whether a local secondary index is approaching its size limit. The estimate is subject to change over time; therefore, do not rely on the precision or accuracy of the estimate.
uirrsItemCollectionMetrics :: Lens' UpdateItemResponse (Maybe ItemCollectionMetrics)
uirrsItemCollectionMetrics = lens _uirrsItemCollectionMetrics (\s a -> s {_uirrsItemCollectionMetrics = a})
...
uirrsAttributes :: Lens' UpdateItemResponse (HashMap Text AttributeValue)
uirrsAttributes = lens _uirrsAttributes (\s a -> s {_uirrsAttributes = a}) . _Default . _Map

-- | The capacity units consumed by the @UpdateItem@ operation. The data returned includes the total provisioned throughput consumed, along with statistics for the table and any indexes involved in the operation. @ConsumedCapacity@ is only returned if the @ReturnConsumedCapacity@ parameter was specified. For more information, see <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ProvisionedThroughputIntro.html Provisioned Throughput> in the /Amazon DynamoDB Developer Guide/ .
uirrsConsumedCapacity :: Lens' UpdateItemResponse (Maybe ConsumedCapacity)
uirrsConsumedCapacity = lens _uirrsConsumedCapacity (\s a -> s {_uirrsConsumedCapacity = a})

-- | -- | The response status code.
uirrsResponseStatus :: Lens' UpdateItemResponse Int
