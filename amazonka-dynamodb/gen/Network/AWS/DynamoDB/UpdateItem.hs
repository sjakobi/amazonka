...
data UpdateItem = UpdateItem'
  { -- | This is a legacy parameter. Use @ConditionExpression@ instead. For more
    ...
    expected :: Prelude.Maybe (Prelude.Map Prelude.Text ExpectedAttributeValue),
    ...
    -- in the /Amazon DynamoDB Developer Guide/.
    attributeUpdates :: Prelude.Maybe (Prelude.Map Prelude.Text AttributeValueUpdate),
...
updateItem_expected = Lens.lens (\UpdateItem' {expected} -> expected) (\s@UpdateItem' {} a -> s {expected = a} :: UpdateItem) Prelude.. Lens.mapping Prelude._Map
...
updateItem_expressionAttributeValues = Lens.lens (\UpdateItem' {expressionAttributeValues} -> expressionAttributeValues) (\s@UpdateItem' {} a -> s {expressionAttributeValues = a} :: UpdateItem) Prelude.. Lens.mapping Prelude._Map
...
updateItem_expressionAttributeNames = Lens.lens (\UpdateItem' {expressionAttributeNames} -> expressionAttributeNames) (\s@UpdateItem' {} a -> s {expressionAttributeNames = a} :: UpdateItem) Prelude.. Lens.mapping Prelude._Map
...
updateItem_attributeUpdates = Lens.lens (\UpdateItem' {attributeUpdates} -> attributeUpdates) (\s@UpdateItem' {} a -> s {attributeUpdates = a} :: UpdateItem) Prelude.. Lens.mapping Prelude._Map
...
updateItem_key = Lens.lens (\UpdateItem' {key} -> key) (\s@UpdateItem' {} a -> s {key = a} :: UpdateItem) Prelude.. Prelude._Map

instance Prelude.AWSRequest UpdateItem where
...
instance Prelude.ToHeaders UpdateItem where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "DynamoDB_20120810.UpdateItem" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON UpdateItem where
  toJSON UpdateItem' {..} =
    Prelude.object
      ( Prelude.catMaybes
...
instance Prelude.ToPath UpdateItem where
  toPath = Prelude.const "/"

instance Prelude.ToQuery UpdateItem where
...
data UpdateItemResponse = UpdateItemResponse'
  { -- | Information about item collections, if any, that were affected by the
    ...
    -- attribute.
    attributes :: Prelude.Maybe (Prelude.Map Prelude.Text AttributeValue),
...
updateItemResponse_attributes = Lens.lens (\UpdateItemResponse' {attributes} -> attributes) (\s@UpdateItemResponse' {} a -> s {attributes = a} :: UpdateItemResponse) Prelude.. Lens.mapping Prelude._Map
