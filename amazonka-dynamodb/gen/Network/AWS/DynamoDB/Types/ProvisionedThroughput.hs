...
data ProvisionedThroughput = ProvisionedThroughput'
  { -- | The maximum number of strongly consistent reads consumed per second
    ...
    --
    -- If read\/write capacity mode is @PAY_PER_REQUEST@ the value is set to 0.
    writeCapacityUnits :: Prelude.Nat
  }
...
newProvisionedThroughput
  ...
  pWriteCapacityUnits_ =
    ProvisionedThroughput'
      { readCapacityUnits =
          Prelude._Nat Lens.# pReadCapacityUnits_,
        writeCapacityUnits =
          Prelude._Nat Lens.# pWriteCapacityUnits_
      }
...
provisionedThroughput_readCapacityUnits = Lens.lens (\ProvisionedThroughput' {readCapacityUnits} -> readCapacityUnits) (\s@ProvisionedThroughput' {} a -> s {readCapacityUnits = a} :: ProvisionedThroughput) Prelude.. Prelude._Nat
...
provisionedThroughput_writeCapacityUnits = Lens.lens (\ProvisionedThroughput' {writeCapacityUnits} -> writeCapacityUnits) (\s@ProvisionedThroughput' {} a -> s {writeCapacityUnits = a} :: ProvisionedThroughput) Prelude.. Prelude._Nat
