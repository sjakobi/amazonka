...
data KeysAndAttributes = KeysAndAttributes'
  { -- | A string that identifies one or more attributes to retrieve from the
    ...
    keys :: Prelude.List1 (Prelude.Map Prelude.Text AttributeValue)
  }
...
keysAndAttributes_expressionAttributeNames = Lens.lens (\KeysAndAttributes' {expressionAttributeNames} -> expressionAttributeNames) (\s@KeysAndAttributes' {} a -> s {expressionAttributeNames = a} :: KeysAndAttributes) Prelude.. Lens.mapping Prelude._Map
...
keysAndAttributes_attributesToGet = Lens.lens (\KeysAndAttributes' {attributesToGet} -> attributesToGet) (\s@KeysAndAttributes' {} a -> s {attributesToGet = a} :: KeysAndAttributes) Prelude.. Lens.mapping Prelude._List1

-- | The primary key attribute values that define the items and the
-- attributes associated with the items.
keysAndAttributes_keys :: Lens.Lens' KeysAndAttributes (Prelude.NonEmpty (Prelude.HashMap Prelude.Text AttributeValue))
keysAndAttributes_keys = Lens.lens (\KeysAndAttributes' {keys} -> keys) (\s@KeysAndAttributes' {} a -> s {keys = a} :: KeysAndAttributes) Prelude.. Prelude._List1

instance Prelude.FromJSON KeysAndAttributes where
  parseJSON =
    Prelude.withObject
      "KeysAndAttributes"
      ( \x ->
          KeysAndAttributes'
            Prelude.<$> (x Prelude..:? "ProjectionExpression")
            Prelude.<*> (x Prelude..:? "ConsistentRead")
            Prelude.<*> ( x Prelude..:? "ExpressionAttributeNames"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "AttributesToGet")
...
instance Prelude.ToJSON KeysAndAttributes where
