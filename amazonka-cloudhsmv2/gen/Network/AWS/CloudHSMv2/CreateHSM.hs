...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'chrrsHSM' - Information about the HSM that was created.
--
...
chrrsHSM :: Lens' CreateHSMResponse (Maybe HSM)
chrrsHSM = lens _chrrsHSM (\s a -> s {_chrrsHSM = a})

-- | -- | The response status code.
chrrsResponseStatus :: Lens' CreateHSMResponse Int
