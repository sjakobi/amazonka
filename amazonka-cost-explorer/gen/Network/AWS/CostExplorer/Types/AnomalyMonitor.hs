...
data AnomalyMonitor = AnomalyMonitor'
  { -- | The date when the monitor last evaluated for anomalies.
    ...
    dimensionalValueCount :: Prelude.Maybe Prelude.Nat,
...
anomalyMonitor_dimensionalValueCount = Lens.lens (\AnomalyMonitor' {dimensionalValueCount} -> dimensionalValueCount) (\s@AnomalyMonitor' {} a -> s {dimensionalValueCount = a} :: AnomalyMonitor) Prelude.. Lens.mapping Prelude._Nat
