...
instance Prelude.FromText VoiceId where
  parser = VoiceId' Prelude.<$> Prelude.takeText

instance Prelude.ToText VoiceId where
  toText (VoiceId' x) = x

instance Prelude.Hashable VoiceId

instance Prelude.NFData VoiceId

instance Prelude.ToByteString VoiceId

instance Prelude.ToQuery VoiceId

instance Prelude.ToHeader VoiceId

instance Prelude.ToJSON VoiceId where
  toJSON = Prelude.toJSONText

instance Prelude.FromJSON VoiceId where
  parseJSON = Prelude.parseJSONText "VoiceId"
