...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'bdidrrsErrors' - Error messages returned for each import task that you deleted as a response for this command.
--
-- * 'bdidrrsResponseStatus' - -- | The response status code.
batchDeleteImportDataResponse ::
  -- | 'bdidrrsResponseStatus'
  Int ->
  BatchDeleteImportDataResponse
batchDeleteImportDataResponse pResponseStatus_ =
  BatchDeleteImportDataResponse'
    { _bdidrrsErrors =
        Nothing,
      _bdidrrsResponseStatus = pResponseStatus_
    }

-- | Error messages returned for each import task that you deleted as a response for this command.
bdidrrsErrors :: Lens' BatchDeleteImportDataResponse [BatchDeleteImportDataError]
bdidrrsErrors = lens _bdidrrsErrors (\s a -> s {_bdidrrsErrors = a}) . _Default . _Coerce

-- | -- | The response status code.
bdidrrsResponseStatus :: Lens' BatchDeleteImportDataResponse Int
bdidrrsResponseStatus = lens _bdidrrsResponseStatus (\s a -> s {_bdidrrsResponseStatus = a})
