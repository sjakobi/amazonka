...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'acitarrsResponseStatus' - -- | The response status code.
associateConfigurationItemsToApplicationResponse ::
  -- | 'acitarrsResponseStatus'
  Int ->
  AssociateConfigurationItemsToApplicationResponse
...
acitarrsResponseStatus :: Lens' AssociateConfigurationItemsToApplicationResponse Int
acitarrsResponseStatus = lens _acitarrsResponseStatus (\s a -> s {_acitarrsResponseStatus = a})
