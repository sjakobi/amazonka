...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ugsrrsGameSession' - The updated game session metadata.
--
-- * 'ugsrrsResponseStatus' - -- | The response status code.
updateGameSessionResponse ::
  -- | 'ugsrrsResponseStatus'
  Int ->
  UpdateGameSessionResponse
updateGameSessionResponse pResponseStatus_ =
  UpdateGameSessionResponse'
    { _ugsrrsGameSession =
        Nothing,
      _ugsrrsResponseStatus = pResponseStatus_
    }

-- | The updated game session metadata.
ugsrrsGameSession :: Lens' UpdateGameSessionResponse (Maybe GameSession)
ugsrrsGameSession = lens _ugsrrsGameSession (\s a -> s {_ugsrrsGameSession = a})

-- | -- | The response status code.
ugsrrsResponseStatus :: Lens' UpdateGameSessionResponse Int
ugsrrsResponseStatus = lens _ugsrrsResponseStatus (\s a -> s {_ugsrrsResponseStatus = a})
