...
data CreateVPCPeeringAuthorizationResponse = CreateVPCPeeringAuthorizationResponse'
  { _cvparrsVPCPeeringAuthorization ::
      !( Maybe
           VPCPeeringAuthorization
       ),
    _cvparrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cvparrsVPCPeeringAuthorization' - Details on the requested VPC peering authorization, including expiration.
--
-- * 'cvparrsResponseStatus' - -- | The response status code.
createVPCPeeringAuthorizationResponse ::
  -- | 'cvparrsResponseStatus'
  Int ->
  CreateVPCPeeringAuthorizationResponse
...
cvparrsVPCPeeringAuthorization :: Lens' CreateVPCPeeringAuthorizationResponse (Maybe VPCPeeringAuthorization)
cvparrsVPCPeeringAuthorization = lens _cvparrsVPCPeeringAuthorization (\s a -> s {_cvparrsVPCPeeringAuthorization = a})

-- | -- | The response status code.
cvparrsResponseStatus :: Lens' CreateVPCPeeringAuthorizationResponse Int
cvparrsResponseStatus = lens _cvparrsResponseStatus (\s a -> s {_cvparrsResponseStatus = a})
