...
data CreateMatchmakingConfigurationResponse = CreateMatchmakingConfigurationResponse'
  { _cmcrrsConfiguration ::
      !( Maybe
           MatchmakingConfiguration
       ),
    _cmcrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cmcrrsConfiguration' - Object that describes the newly created matchmaking configuration.
--
-- * 'cmcrrsResponseStatus' - -- | The response status code.
createMatchmakingConfigurationResponse ::
  -- | 'cmcrrsResponseStatus'
  Int ->
  CreateMatchmakingConfigurationResponse
...
cmcrrsConfiguration :: Lens' CreateMatchmakingConfigurationResponse (Maybe MatchmakingConfiguration)
cmcrrsConfiguration = lens _cmcrrsConfiguration (\s a -> s {_cmcrrsConfiguration = a})

-- | -- | The response status code.
cmcrrsResponseStatus :: Lens' CreateMatchmakingConfigurationResponse Int
cmcrrsResponseStatus = lens _cmcrrsResponseStatus (\s a -> s {_cmcrrsResponseStatus = a})
