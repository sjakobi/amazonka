...
module Network.AWS.GameLift.DescribeVPCPeeringAuthorizations
  ( -- * Creating a Request
    ...
    -- * Response Lenses
    dvpcparrsVPCPeeringAuthorizations,
    dvpcparrsResponseStatus,
  )
where
...
data DescribeVPCPeeringAuthorizationsResponse = DescribeVPCPeeringAuthorizationsResponse'
  { _dvpcparrsVPCPeeringAuthorizations ::
      !( Maybe
           [VPCPeeringAuthorization]
       ),
    _dvpcparrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
--
-- * 'dvpcparrsVPCPeeringAuthorizations' - A collection of objects that describe all valid VPC peering operations for the current AWS account.
--
-- * 'dvpcparrsResponseStatus' - -- | The response status code.
describeVPCPeeringAuthorizationsResponse ::
  -- | 'dvpcparrsResponseStatus'
  Int ->
  DescribeVPCPeeringAuthorizationsResponse
...
dvpcparrsVPCPeeringAuthorizations :: Lens' DescribeVPCPeeringAuthorizationsResponse [VPCPeeringAuthorization]
dvpcparrsVPCPeeringAuthorizations = lens _dvpcparrsVPCPeeringAuthorizations (\s a -> s {_dvpcparrsVPCPeeringAuthorizations = a}) . _Default . _Coerce

-- | -- | The response status code.
dvpcparrsResponseStatus :: Lens' DescribeVPCPeeringAuthorizationsResponse Int
dvpcparrsResponseStatus = lens _dvpcparrsResponseStatus (\s a -> s {_dvpcparrsResponseStatus = a})
