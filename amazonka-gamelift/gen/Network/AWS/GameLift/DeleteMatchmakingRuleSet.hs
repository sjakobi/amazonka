...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dmrsrmrsResponseStatus' - -- | The response status code.
deleteMatchmakingRuleSetResponse ::
  -- | 'dmrsrmrsResponseStatus'
  Int ->
  DeleteMatchmakingRuleSetResponse
...
dmrsrmrsResponseStatus :: Lens' DeleteMatchmakingRuleSetResponse Int
dmrsrmrsResponseStatus = lens _dmrsrmrsResponseStatus (\s a -> s {_dmrsrmrsResponseStatus = a})
