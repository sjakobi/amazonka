...
instance Prelude.AWSRequest ClaimGameServer where
...
instance Prelude.ToHeaders ClaimGameServer where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ("GameLift.ClaimGameServer" :: Prelude.ByteString),
            "Content-Type"
...
instance Prelude.ToJSON ClaimGameServer where
  toJSON ClaimGameServer' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("GameServerData" Prelude..=)
              Prelude.<$> gameServerData,
            ("GameServerId" Prelude..=) Prelude.<$> gameServerId,
            Prelude.Just
              ( "GameServerGroupName"
...
instance Prelude.ToPath ClaimGameServer where
  toPath = Prelude.const "/"

instance Prelude.ToQuery ClaimGameServer where
