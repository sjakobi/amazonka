...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cgsrrsGameServer' - Object that describes the newly claimed game server.
--
-- * 'cgsrrsResponseStatus' - -- | The response status code.
claimGameServerResponse ::
  -- | 'cgsrrsResponseStatus'
  Int ->
  ClaimGameServerResponse
claimGameServerResponse pResponseStatus_ =
  ClaimGameServerResponse'
    { _cgsrrsGameServer =
        Nothing,
      _cgsrrsResponseStatus = pResponseStatus_
    }

-- | Object that describes the newly claimed game server.
cgsrrsGameServer :: Lens' ClaimGameServerResponse (Maybe GameServer)
cgsrrsGameServer = lens _cgsrrsGameServer (\s a -> s {_cgsrrsGameServer = a})

-- | -- | The response status code.
cgsrrsResponseStatus :: Lens' ClaimGameServerResponse Int
cgsrrsResponseStatus = lens _cgsrrsResponseStatus (\s a -> s {_cgsrrsResponseStatus = a})
