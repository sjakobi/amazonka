...
data StartGameSessionPlacement = StartGameSessionPlacement'
  { -- | Set of custom properties for a game session, formatted as key:value
    ...
    -- the game session.
    maximumPlayerSessionCount :: Prelude.Nat
  }
  ...
  pMaximumPlayerSessionCount_ =
    StartGameSessionPlacement'
      { gameProperties =
        ...
        maximumPlayerSessionCount =
          Prelude._Nat
            Lens.# pMaximumPlayerSessionCount_
      }
...
startGameSessionPlacement_maximumPlayerSessionCount = Lens.lens (\StartGameSessionPlacement' {maximumPlayerSessionCount} -> maximumPlayerSessionCount) (\s@StartGameSessionPlacement' {} a -> s {maximumPlayerSessionCount = a} :: StartGameSessionPlacement) Prelude.. Prelude._Nat
