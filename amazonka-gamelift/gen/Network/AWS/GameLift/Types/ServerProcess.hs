...
data ServerProcess = ServerProcess'
  { -- | An optional list of parameters to pass to the server executable or
    ...
    concurrentExecutions :: Prelude.Nat
  }
...
newServerProcess pLaunchPath_ pConcurrentExecutions_ =
  ServerProcess'
    { parameters = Prelude.Nothing,
      ...
      concurrentExecutions =
        Prelude._Nat Lens.# pConcurrentExecutions_
    }
...
serverProcess_concurrentExecutions = Lens.lens (\ServerProcess' {concurrentExecutions} -> concurrentExecutions) (\s@ServerProcess' {} a -> s {concurrentExecutions = a} :: ServerProcess) Prelude.. Prelude._Nat
