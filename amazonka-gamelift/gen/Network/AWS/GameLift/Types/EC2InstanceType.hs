...
instance Prelude.FromText EC2InstanceType where
  parser = EC2InstanceType' Prelude.<$> Prelude.takeText

instance Prelude.ToText EC2InstanceType where
  toText (EC2InstanceType' x) = x

instance Prelude.Hashable EC2InstanceType

instance Prelude.NFData EC2InstanceType

instance Prelude.ToByteString EC2InstanceType

instance Prelude.ToQuery EC2InstanceType

instance Prelude.ToHeader EC2InstanceType

instance Prelude.ToJSON EC2InstanceType where
  toJSON = Prelude.toJSONText

instance Prelude.FromJSON EC2InstanceType where
  parseJSON = Prelude.parseJSONText "EC2InstanceType"
