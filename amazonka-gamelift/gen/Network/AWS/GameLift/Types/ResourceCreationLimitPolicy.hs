...
data ResourceCreationLimitPolicy = ResourceCreationLimitPolicy'
  { -- | The time span used in evaluating the resource creation limit policy.
    policyPeriodInMinutes :: Prelude.Maybe Prelude.Nat,
    -- | The maximum number of game sessions that an individual can create during
    -- the policy period.
    newGameSessionsPerCreator' :: Prelude.Maybe Prelude.Nat
  }
...
resourceCreationLimitPolicy_policyPeriodInMinutes = Lens.lens (\ResourceCreationLimitPolicy' {policyPeriodInMinutes} -> policyPeriodInMinutes) (\s@ResourceCreationLimitPolicy' {} a -> s {policyPeriodInMinutes = a} :: ResourceCreationLimitPolicy) Prelude.. Lens.mapping Prelude._Nat
...
resourceCreationLimitPolicy_newGameSessionsPerCreator = Lens.lens (\ResourceCreationLimitPolicy' {newGameSessionsPerCreator'} -> newGameSessionsPerCreator') (\s@ResourceCreationLimitPolicy' {} a -> s {newGameSessionsPerCreator' = a} :: ResourceCreationLimitPolicy) Prelude.. Lens.mapping Prelude._Nat
