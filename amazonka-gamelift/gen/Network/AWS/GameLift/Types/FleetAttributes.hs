...
data FleetAttributes = FleetAttributes'
  { -- | Current status of the fleet.
    ...
    stoppedActions :: Prelude.Maybe (Prelude.List1 FleetAction),
...
fleetAttributes_creationTime = Lens.lens (\FleetAttributes' {creationTime} -> creationTime) (\s@FleetAttributes' {} a -> s {creationTime = a} :: FleetAttributes) Prelude.. Lens.mapping Prelude._Time
...
fleetAttributes_logPaths = Lens.lens (\FleetAttributes' {logPaths} -> logPaths) (\s@FleetAttributes' {} a -> s {logPaths = a} :: FleetAttributes) Prelude.. Lens.mapping Prelude._Coerce
...
fleetAttributes_stoppedActions = Lens.lens (\FleetAttributes' {stoppedActions} -> stoppedActions) (\s@FleetAttributes' {} a -> s {stoppedActions = a} :: FleetAttributes) Prelude.. Lens.mapping Prelude._List1

-- | Time stamp indicating when this data object was terminated. Format is a
-- number expressed in Unix time as milliseconds (for example
-- \"1469498468.057\").
fleetAttributes_terminationTime :: Lens.Lens' FleetAttributes (Prelude.Maybe Prelude.UTCTime)
fleetAttributes_terminationTime = Lens.lens (\FleetAttributes' {terminationTime} -> terminationTime) (\s@FleetAttributes' {} a -> s {terminationTime = a} :: FleetAttributes) Prelude.. Lens.mapping Prelude._Time
...
fleetAttributes_metricGroups = Lens.lens (\FleetAttributes' {metricGroups} -> metricGroups) (\s@FleetAttributes' {} a -> s {metricGroups = a} :: FleetAttributes) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.FromJSON FleetAttributes where
  parseJSON =
    Prelude.withObject
      "FleetAttributes"
      ( \x ->
          FleetAttributes'
            ...
            Prelude.<*> (x Prelude..:? "InstanceRoleArn")
            Prelude.<*> (x Prelude..:? "CertificateConfiguration")
            Prelude.<*> (x Prelude..:? "ServerLaunchPath")
            Prelude.<*> (x Prelude..:? "ScriptArn")
            Prelude.<*> (x Prelude..:? "ServerLaunchParameters")
            Prelude.<*> (x Prelude..:? "LogPaths" Prelude..!= Prelude.mempty)
            Prelude.<*> (x Prelude..:? "NewGameSessionProtectionPolicy")
            Prelude.<*> (x Prelude..:? "Name")
            Prelude.<*> (x Prelude..:? "StoppedActions")
            Prelude.<*> (x Prelude..:? "TerminationTime")
            Prelude.<*> (x Prelude..:? "Description")
            Prelude.<*> (x Prelude..:? "ResourceCreationLimitPolicy")
            Prelude.<*> (x Prelude..:? "BuildArn")
            Prelude.<*> (x Prelude..:? "BuildId")
            Prelude.<*> (x Prelude..:? "OperatingSystem")
            Prelude.<*> ( x Prelude..:? "MetricGroups"
