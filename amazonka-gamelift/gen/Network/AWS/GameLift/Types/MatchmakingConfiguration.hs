...
data MatchmakingConfiguration = MatchmakingConfiguration'
  { -- | Information to attach to all events related to the matchmaking
    ...
    additionalPlayerCount :: Prelude.Maybe Prelude.Nat,
    ...
    acceptanceTimeoutSeconds :: Prelude.Maybe Prelude.Nat,
    ...
    requestTimeoutSeconds :: Prelude.Maybe Prelude.Nat,
...
matchmakingConfiguration_gameProperties = Lens.lens (\MatchmakingConfiguration' {gameProperties} -> gameProperties) (\s@MatchmakingConfiguration' {} a -> s {gameProperties = a} :: MatchmakingConfiguration) Prelude.. Lens.mapping Prelude._Coerce
...
matchmakingConfiguration_creationTime = Lens.lens (\MatchmakingConfiguration' {creationTime} -> creationTime) (\s@MatchmakingConfiguration' {} a -> s {creationTime = a} :: MatchmakingConfiguration) Prelude.. Lens.mapping Prelude._Time
...
matchmakingConfiguration_additionalPlayerCount = Lens.lens (\MatchmakingConfiguration' {additionalPlayerCount} -> additionalPlayerCount) (\s@MatchmakingConfiguration' {} a -> s {additionalPlayerCount = a} :: MatchmakingConfiguration) Prelude.. Lens.mapping Prelude._Nat
...
matchmakingConfiguration_acceptanceTimeoutSeconds = Lens.lens (\MatchmakingConfiguration' {acceptanceTimeoutSeconds} -> acceptanceTimeoutSeconds) (\s@MatchmakingConfiguration' {} a -> s {acceptanceTimeoutSeconds = a} :: MatchmakingConfiguration) Prelude.. Lens.mapping Prelude._Nat
...
matchmakingConfiguration_gameSessionQueueArns = Lens.lens (\MatchmakingConfiguration' {gameSessionQueueArns} -> gameSessionQueueArns) (\s@MatchmakingConfiguration' {} a -> s {gameSessionQueueArns = a} :: MatchmakingConfiguration) Prelude.. Lens.mapping Prelude._Coerce
...
matchmakingConfiguration_requestTimeoutSeconds = Lens.lens (\MatchmakingConfiguration' {requestTimeoutSeconds} -> requestTimeoutSeconds) (\s@MatchmakingConfiguration' {} a -> s {requestTimeoutSeconds = a} :: MatchmakingConfiguration) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.FromJSON MatchmakingConfiguration where
  parseJSON =
    Prelude.withObject
      "MatchmakingConfiguration"
      ( \x ->
          MatchmakingConfiguration'
            Prelude.<$> (x Prelude..:? "CustomEventData")
            Prelude.<*> ( x Prelude..:? "GameProperties"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "FlexMatchMode")
            Prelude.<*> (x Prelude..:? "BackfillMode")
            Prelude.<*> (x Prelude..:? "CreationTime")
            Prelude.<*> (x Prelude..:? "AdditionalPlayerCount")
            Prelude.<*> (x Prelude..:? "AcceptanceTimeoutSeconds")
            Prelude.<*> (x Prelude..:? "GameSessionData")
            Prelude.<*> (x Prelude..:? "ConfigurationArn")
            Prelude.<*> ( x Prelude..:? "GameSessionQueueArns"
                            Prelude..!= Prelude.mempty
                        )
            Prelude.<*> (x Prelude..:? "Name")
            Prelude.<*> (x Prelude..:? "NotificationTarget")
            Prelude.<*> (x Prelude..:? "RequestTimeoutSeconds")
