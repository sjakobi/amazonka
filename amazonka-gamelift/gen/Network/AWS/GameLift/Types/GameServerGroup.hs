...
data GameServerGroup = GameServerGroup'
  { -- | The current status of the game server group. Possible statuses include:
    ...
    -- Scaling group.
    instanceDefinitions :: Prelude.Maybe (Prelude.List1 InstanceDefinition),
    ...
    suspendedActions :: Prelude.Maybe (Prelude.List1 GameServerGroupAction),
...
gameServerGroup_creationTime = Lens.lens (\GameServerGroup' {creationTime} -> creationTime) (\s@GameServerGroup' {} a -> s {creationTime = a} :: GameServerGroup) Prelude.. Lens.mapping Prelude._Time
...
gameServerGroup_instanceDefinitions = Lens.lens (\GameServerGroup' {instanceDefinitions} -> instanceDefinitions) (\s@GameServerGroup' {} a -> s {instanceDefinitions = a} :: GameServerGroup) Prelude.. Lens.mapping Prelude._List1
...
gameServerGroup_suspendedActions = Lens.lens (\GameServerGroup' {suspendedActions} -> suspendedActions) (\s@GameServerGroup' {} a -> s {suspendedActions = a} :: GameServerGroup) Prelude.. Lens.mapping Prelude._List1
...
gameServerGroup_lastUpdatedTime = Lens.lens (\GameServerGroup' {lastUpdatedTime} -> lastUpdatedTime) (\s@GameServerGroup' {} a -> s {lastUpdatedTime = a} :: GameServerGroup) Prelude.. Lens.mapping Prelude._Time

instance Prelude.FromJSON GameServerGroup where
  parseJSON =
    Prelude.withObject
      "GameServerGroup"
      ( \x ->
          GameServerGroup'
            ...
            Prelude.<*> (x Prelude..:? "InstanceDefinitions")
            Prelude.<*> (x Prelude..:? "GameServerGroupArn")
            Prelude.<*> (x Prelude..:? "SuspendedActions")
            Prelude.<*> (x Prelude..:? "GameServerGroupName")
            Prelude.<*> (x Prelude..:? "BalancingStrategy")
            Prelude.<*> (x Prelude..:? "GameServerProtectionPolicy")
