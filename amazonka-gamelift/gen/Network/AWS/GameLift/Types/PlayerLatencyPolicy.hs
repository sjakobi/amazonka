...
data PlayerLatencyPolicy = PlayerLatencyPolicy'
  { -- | The length of time, in seconds, that the policy is enforced while
    ...
    policyDurationSeconds :: Prelude.Maybe Prelude.Nat,
    ...
    maximumIndividualPlayerLatencyMilliseconds :: Prelude.Maybe Prelude.Nat
  }
...
playerLatencyPolicy_policyDurationSeconds = Lens.lens (\PlayerLatencyPolicy' {policyDurationSeconds} -> policyDurationSeconds) (\s@PlayerLatencyPolicy' {} a -> s {policyDurationSeconds = a} :: PlayerLatencyPolicy) Prelude.. Lens.mapping Prelude._Nat
...
playerLatencyPolicy_maximumIndividualPlayerLatencyMilliseconds = Lens.lens (\PlayerLatencyPolicy' {maximumIndividualPlayerLatencyMilliseconds} -> maximumIndividualPlayerLatencyMilliseconds) (\s@PlayerLatencyPolicy' {} a -> s {maximumIndividualPlayerLatencyMilliseconds = a} :: PlayerLatencyPolicy) Prelude.. Lens.mapping Prelude._Nat
