...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dvparrsResponseStatus' - -- | The response status code.
deleteVPCPeeringAuthorizationResponse ::
  -- | 'dvparrsResponseStatus'
  Int ->
  DeleteVPCPeeringAuthorizationResponse
...
dvparrsResponseStatus :: Lens' DeleteVPCPeeringAuthorizationResponse Int
dvparrsResponseStatus = lens _dvparrsResponseStatus (\s a -> s {_dvparrsResponseStatus = a})
