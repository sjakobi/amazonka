...
instance Prelude.FromText H264TemporalAdaptiveQuantization where
  parser = H264TemporalAdaptiveQuantization' Prelude.<$> Prelude.takeText

instance Prelude.ToText H264TemporalAdaptiveQuantization where
  toText (H264TemporalAdaptiveQuantization' x) = x

instance Prelude.Hashable H264TemporalAdaptiveQuantization

instance Prelude.NFData H264TemporalAdaptiveQuantization

instance Prelude.ToByteString H264TemporalAdaptiveQuantization

instance Prelude.ToQuery H264TemporalAdaptiveQuantization

instance Prelude.ToHeader H264TemporalAdaptiveQuantization

instance Prelude.ToJSON H264TemporalAdaptiveQuantization where
  toJSON = Prelude.toJSONText

instance Prelude.FromJSON H264TemporalAdaptiveQuantization where
  parseJSON = Prelude.parseJSONText "H264TemporalAdaptiveQuantization"
