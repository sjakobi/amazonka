...
pattern HSAQDisabled :: H264SpatialAdaptiveQuantization
pattern HSAQDisabled = H264SpatialAdaptiveQuantization' "DISABLED"

pattern HSAQEnabled :: H264SpatialAdaptiveQuantization
pattern HSAQEnabled = H264SpatialAdaptiveQuantization' "ENABLED"
