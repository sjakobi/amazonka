...
--
-- * 'psCodecProfile' - Use Profile (ProResCodecProfile) to specify the type of Apple ProRes codec to use for this output.
--
...
proresSettings =
  ProresSettings'
    { _psInterlaceMode = Nothing,
      ...
      _psScanTypeConversionMode = Nothing,
...
psScanTypeConversionMode :: Lens' ProresSettings (Maybe ProresScanTypeConversionMode)
psScanTypeConversionMode = lens _psScanTypeConversionMode (\s a -> s {_psScanTypeConversionMode = a})
