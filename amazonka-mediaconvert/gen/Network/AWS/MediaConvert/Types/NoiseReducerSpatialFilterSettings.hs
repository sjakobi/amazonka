...
data NoiseReducerSpatialFilterSettings = NoiseReducerSpatialFilterSettings'
  { -- | The speed of the filter, from -2 (lower speed) to 3 (higher speed), with
    ...
    postFilterSharpenStrength :: Prelude.Maybe Prelude.Nat,
...
noiseReducerSpatialFilterSettings_postFilterSharpenStrength = Lens.lens (\NoiseReducerSpatialFilterSettings' {postFilterSharpenStrength} -> postFilterSharpenStrength) (\s@NoiseReducerSpatialFilterSettings' {} a -> s {postFilterSharpenStrength = a} :: NoiseReducerSpatialFilterSettings) Prelude.. Lens.mapping Prelude._Nat

-- | Relative strength of noise reducing filter. Higher values produce
-- stronger filtering.
noiseReducerSpatialFilterSettings_strength :: Lens.Lens' NoiseReducerSpatialFilterSettings (Prelude.Maybe Prelude.Natural)
noiseReducerSpatialFilterSettings_strength = Lens.lens (\NoiseReducerSpatialFilterSettings' {strength} -> strength) (\s@NoiseReducerSpatialFilterSettings' {} a -> s {strength = a} :: NoiseReducerSpatialFilterSettings) Prelude.. Lens.mapping Prelude._Nat
    ...
    Prelude.withObject
      ...
      ( \x ->
          NoiseReducerSpatialFilterSettings'
            ...
            Prelude.<*> (x Prelude..:? "postFilterSharpenStrength")
    ...
    Prelude.object
      ( Prelude.catMaybes
          [ ("speed" Prelude..=) Prelude.<$> speed,
            ("postFilterSharpenStrength" Prelude..=)
