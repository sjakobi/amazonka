...
data DashIsoGroupSettings = DashIsoGroupSettings'
  { -- | Length of mpd segments to create (in seconds). Note that segments will
    ...
    -- playout.
    minBufferTime :: Prelude.Maybe Prelude.Nat,
...
dashIsoGroupSettings_segmentLength = Lens.lens (\DashIsoGroupSettings' {segmentLength} -> segmentLength) (\s@DashIsoGroupSettings' {} a -> s {segmentLength = a} :: DashIsoGroupSettings) Prelude.. Lens.mapping Prelude._Nat
...
dashIsoGroupSettings_fragmentLength = Lens.lens (\DashIsoGroupSettings' {fragmentLength} -> fragmentLength) (\s@DashIsoGroupSettings' {} a -> s {fragmentLength = a} :: DashIsoGroupSettings) Prelude.. Lens.mapping Prelude._Nat
...
dashIsoGroupSettings_minBufferTime = Lens.lens (\DashIsoGroupSettings' {minBufferTime} -> minBufferTime) (\s@DashIsoGroupSettings' {} a -> s {minBufferTime = a} :: DashIsoGroupSettings) Prelude.. Lens.mapping Prelude._Nat
