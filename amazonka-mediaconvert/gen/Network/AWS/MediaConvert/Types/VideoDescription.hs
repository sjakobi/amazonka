...
data VideoDescription = VideoDescription'
  { -- | Use the Height (Height) setting to define the video resolution height
    ...
    fixedAfd :: Prelude.Maybe Prelude.Nat,
...
videoDescription_height = Lens.lens (\VideoDescription' {height} -> height) (\s@VideoDescription' {} a -> s {height = a} :: VideoDescription) Prelude.. Lens.mapping Prelude._Nat
...
videoDescription_width = Lens.lens (\VideoDescription' {width} -> width) (\s@VideoDescription' {} a -> s {width = a} :: VideoDescription) Prelude.. Lens.mapping Prelude._Nat
...
videoDescription_fixedAfd = Lens.lens (\VideoDescription' {fixedAfd} -> fixedAfd) (\s@VideoDescription' {} a -> s {fixedAfd = a} :: VideoDescription) Prelude.. Lens.mapping Prelude._Nat
