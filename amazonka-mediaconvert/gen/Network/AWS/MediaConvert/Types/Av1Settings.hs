...
av1Settings_framerateNumerator = Lens.lens (\Av1Settings' {framerateNumerator} -> framerateNumerator) (\s@Av1Settings' {} a -> s {framerateNumerator = a} :: Av1Settings) Prelude.. Lens.mapping Prelude._Nat
...
av1Settings_slices = Lens.lens (\Av1Settings' {slices} -> slices) (\s@Av1Settings' {} a -> s {slices = a} :: Av1Settings) Prelude.. Lens.mapping Prelude._Nat
...
av1Settings_framerateDenominator = Lens.lens (\Av1Settings' {framerateDenominator} -> framerateDenominator) (\s@Av1Settings' {} a -> s {framerateDenominator = a} :: Av1Settings) Prelude.. Lens.mapping Prelude._Nat

-- | Maximum bitrate in bits\/second. For example, enter five megabits per
-- second as 5000000. Required when Rate control mode is QVBR.
av1Settings_maxBitrate :: Lens.Lens' Av1Settings (Prelude.Maybe Prelude.Natural)
av1Settings_maxBitrate = Lens.lens (\Av1Settings' {maxBitrate} -> maxBitrate) (\s@Av1Settings' {} a -> s {maxBitrate = a} :: Av1Settings) Prelude.. Lens.mapping Prelude._Nat
...
av1Settings_numberBFramesBetweenReferenceFrames = Lens.lens (\Av1Settings' {numberBFramesBetweenReferenceFrames} -> numberBFramesBetweenReferenceFrames) (\s@Av1Settings' {} a -> s {numberBFramesBetweenReferenceFrames = a} :: Av1Settings) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.FromJSON Av1Settings where
  parseJSON =
    Prelude.withObject
      "Av1Settings"
      ( \x ->
...
instance Prelude.ToJSON Av1Settings where
  toJSON Av1Settings' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("spatialAdaptiveQuantization" Prelude..=)
            ...
            ("qvbrSettings" Prelude..=)
              Prelude.<$> qvbrSettings
          ]
      )
