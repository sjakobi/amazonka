...
dvbSubDestinationSettings_fontSize = Lens.lens (\DvbSubDestinationSettings' {fontSize} -> fontSize) (\s@DvbSubDestinationSettings' {} a -> s {fontSize = a} :: DvbSubDestinationSettings) Prelude.. Lens.mapping Prelude._Nat
    ...
    Prelude.withObject
      ...
      ( \x ->
          DvbSubDestinationSettings'
            ...
            Prelude.<*> (x Prelude..:? "subtitlingType")
