...
pattern HSAQSDisabled :: H265SpatialAdaptiveQuantization
pattern HSAQSDisabled = H265SpatialAdaptiveQuantization' "DISABLED"

pattern HSAQSEnabled :: H265SpatialAdaptiveQuantization
pattern HSAQSEnabled = H265SpatialAdaptiveQuantization' "ENABLED"
