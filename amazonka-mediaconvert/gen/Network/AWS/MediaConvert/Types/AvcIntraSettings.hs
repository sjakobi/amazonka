...
avcIntraSettings_framerateNumerator = Lens.lens (\AvcIntraSettings' {framerateNumerator} -> framerateNumerator) (\s@AvcIntraSettings' {} a -> s {framerateNumerator = a} :: AvcIntraSettings) Prelude.. Lens.mapping Prelude._Nat
...
avcIntraSettings_framerateDenominator = Lens.lens (\AvcIntraSettings' {framerateDenominator} -> framerateDenominator) (\s@AvcIntraSettings' {} a -> s {framerateDenominator = a} :: AvcIntraSettings) Prelude.. Lens.mapping Prelude._Nat
...
instance Prelude.FromJSON AvcIntraSettings where
  parseJSON =
    Prelude.withObject
      "AvcIntraSettings"
      ( \x ->
...
instance Prelude.ToJSON AvcIntraSettings where
