...
data AvcIntraSettings = AvcIntraSettings'
  { _aisInterlaceMode ::
    ...
    _aisFramerateNumerator ::
      !(Maybe Nat),
    _aisFramerateDenominator ::
      !(Maybe Nat),
    _aisAvcIntraClass ::
      !(Maybe AvcIntraClass),
    _aisScanTypeConversionMode ::
      !( Maybe
           AvcIntraScanTypeConversionMode
       ),
    _aisFramerateControl ::
      !(Maybe AvcIntraFramerateControl),
    _aisAvcIntraUhdSettings ::
...
--
-- * 'aisAvcIntraUhdSettings' - Optional when you set AVC-Intra class (avcIntraClass) to Class 4K/2K (CLASS_4K_2K). When you set AVC-Intra class to a different value, this object isn't allowed.
--
...
avcIntraSettings =
  AvcIntraSettings'
    { _aisInterlaceMode = Nothing,
      ...
      _aisScanTypeConversionMode = Nothing,
      _aisFramerateControl = Nothing,
      _aisAvcIntraUhdSettings = Nothing,
...
aisScanTypeConversionMode :: Lens' AvcIntraSettings (Maybe AvcIntraScanTypeConversionMode)
aisScanTypeConversionMode = lens _aisScanTypeConversionMode (\s a -> s {_aisScanTypeConversionMode = a})
...
aisAvcIntraUhdSettings :: Lens' AvcIntraSettings (Maybe AvcIntraUhdSettings)
aisAvcIntraUhdSettings = lens _aisAvcIntraUhdSettings (\s a -> s {_aisAvcIntraUhdSettings = a})
