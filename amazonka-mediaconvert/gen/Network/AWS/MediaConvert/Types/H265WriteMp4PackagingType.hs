...
instance Prelude.FromText H265WriteMp4PackagingType where
  parser = H265WriteMp4PackagingType' Prelude.<$> Prelude.takeText

instance Prelude.ToText H265WriteMp4PackagingType where
  toText (H265WriteMp4PackagingType' x) = x

instance Prelude.Hashable H265WriteMp4PackagingType

instance Prelude.NFData H265WriteMp4PackagingType

instance Prelude.ToByteString H265WriteMp4PackagingType

instance Prelude.ToQuery H265WriteMp4PackagingType

instance Prelude.ToHeader H265WriteMp4PackagingType

instance Prelude.ToJSON H265WriteMp4PackagingType where
  toJSON = Prelude.toJSONText

instance Prelude.FromJSON H265WriteMp4PackagingType where
  parseJSON = Prelude.parseJSONText "H265WriteMp4PackagingType"
