...
av1QvbrSettings_qvbrQualityLevel = Lens.lens (\Av1QvbrSettings' {qvbrQualityLevel} -> qvbrQualityLevel) (\s@Av1QvbrSettings' {} a -> s {qvbrQualityLevel = a} :: Av1QvbrSettings) Prelude.. Lens.mapping Prelude._Nat

instance Prelude.FromJSON Av1QvbrSettings where
  parseJSON =
    Prelude.withObject
      "Av1QvbrSettings"
      ( \x ->
...
instance Prelude.ToJSON Av1QvbrSettings where
