...
data AudioSelector = AudioSelector'
  { -- | Selects a specific language code from within an audio source.
    ...
    -- track.
    programSelection :: Prelude.Maybe Prelude.Nat,
    ...
    tracks :: Prelude.Maybe [Prelude.Nat],
    ...
    -- 0x101).
    pids :: Prelude.Maybe [Prelude.Nat],
...
audioSelector_programSelection = Lens.lens (\AudioSelector' {programSelection} -> programSelection) (\s@AudioSelector' {} a -> s {programSelection = a} :: AudioSelector) Prelude.. Lens.mapping Prelude._Nat
...
audioSelector_tracks = Lens.lens (\AudioSelector' {tracks} -> tracks) (\s@AudioSelector' {} a -> s {tracks = a} :: AudioSelector) Prelude.. Lens.mapping Prelude._Coerce
...
audioSelector_pids = Lens.lens (\AudioSelector' {pids} -> pids) (\s@AudioSelector' {} a -> s {pids = a} :: AudioSelector) Prelude.. Lens.mapping Prelude._Coerce
    ...
    Prelude.withObject
      ...
      ( \x ->
          AudioSelector'
            ...
            Prelude.<*> (x Prelude..:? "programSelection")
            Prelude.<*> (x Prelude..:? "customLanguageCode")
            Prelude.<*> (x Prelude..:? "tracks" Prelude..!= Prelude.mempty)
            Prelude.<*> (x Prelude..:? "defaultSelection")
            Prelude.<*> (x Prelude..:? "selectorType")
            Prelude.<*> (x Prelude..:? "remixSettings")
            Prelude.<*> (x Prelude..:? "pids" Prelude..!= Prelude.mempty)
            Prelude.<*> (x Prelude..:? "externalAudioFileInput")
    ...
    Prelude.object
      ( Prelude.catMaybes
          [ ("languageCode" Prelude..=)
            ...
            ("programSelection" Prelude..=)
              Prelude.<$> programSelection,
            ("customLanguageCode" Prelude..=)
              Prelude.<$> customLanguageCode,
            ("tracks" Prelude..=) Prelude.<$> tracks,
            ("defaultSelection" Prelude..=)
              Prelude.<$> defaultSelection,
            ("selectorType" Prelude..=) Prelude.<$> selectorType,
            ("remixSettings" Prelude..=)
              Prelude.<$> remixSettings,
            ("pids" Prelude..=) Prelude.<$> pids,
            ("externalAudioFileInput" Prelude..=)
