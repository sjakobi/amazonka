...
data Mp4Settings = Mp4Settings'
  { -- | When enabled, file composition times will start at zero, composition
    ...
    cttsVersion :: Prelude.Maybe Prelude.Nat
  }
...
mp4Settings_cttsVersion = Lens.lens (\Mp4Settings' {cttsVersion} -> cttsVersion) (\s@Mp4Settings' {} a -> s {cttsVersion = a} :: Mp4Settings) Prelude.. Lens.mapping Prelude._Nat
