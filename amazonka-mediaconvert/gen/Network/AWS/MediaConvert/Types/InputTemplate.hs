...
data InputTemplate = InputTemplate'
  { -- | Enable the image inserter feature to include a graphic overlay on your
    ...
    audioSelectors :: Prelude.Maybe (Prelude.Map Prelude.Text AudioSelector),
    ...
    audioSelectorGroups :: Prelude.Maybe (Prelude.Map Prelude.Text AudioSelectorGroup),
    -- | Selector for video.
    ...
    -- input.
    captionSelectors :: Prelude.Maybe (Prelude.Map Prelude.Text CaptionSelector),
...
inputTemplate_audioSelectors = Lens.lens (\InputTemplate' {audioSelectors} -> audioSelectors) (\s@InputTemplate' {} a -> s {audioSelectors = a} :: InputTemplate) Prelude.. Lens.mapping Prelude._Map
...
inputTemplate_programNumber = Lens.lens (\InputTemplate' {programNumber} -> programNumber) (\s@InputTemplate' {} a -> s {programNumber = a} :: InputTemplate) Prelude.. Lens.mapping Prelude._Nat

-- | Specifies set of audio selectors within an input to combine. An input
-- may have multiple audio selector groups. See \"Audio Selector
-- Group\":#inputs-audio_selector_group for more information.
inputTemplate_audioSelectorGroups :: Lens.Lens' InputTemplate (Prelude.Maybe (Prelude.HashMap Prelude.Text AudioSelectorGroup))
inputTemplate_audioSelectorGroups = Lens.lens (\InputTemplate' {audioSelectorGroups} -> audioSelectorGroups) (\s@InputTemplate' {} a -> s {audioSelectorGroups = a} :: InputTemplate) Prelude.. Lens.mapping Prelude._Map
...
inputTemplate_captionSelectors = Lens.lens (\InputTemplate' {captionSelectors} -> captionSelectors) (\s@InputTemplate' {} a -> s {captionSelectors = a} :: InputTemplate) Prelude.. Lens.mapping Prelude._Map
