...
vp8Settings_framerateNumerator = Lens.lens (\Vp8Settings' {framerateNumerator} -> framerateNumerator) (\s@Vp8Settings' {} a -> s {framerateNumerator = a} :: Vp8Settings) Prelude.. Lens.mapping Prelude._Nat
...
vp8Settings_framerateDenominator = Lens.lens (\Vp8Settings' {framerateDenominator} -> framerateDenominator) (\s@Vp8Settings' {} a -> s {framerateDenominator = a} :: Vp8Settings) Prelude.. Lens.mapping Prelude._Nat
...
vp8Settings_parNumerator = Lens.lens (\Vp8Settings' {parNumerator} -> parNumerator) (\s@Vp8Settings' {} a -> s {parNumerator = a} :: Vp8Settings) Prelude.. Lens.mapping Prelude._Nat
...
vp8Settings_parDenominator = Lens.lens (\Vp8Settings' {parDenominator} -> parDenominator) (\s@Vp8Settings' {} a -> s {parDenominator = a} :: Vp8Settings) Prelude.. Lens.mapping Prelude._Nat
...
vp8Settings_maxBitrate = Lens.lens (\Vp8Settings' {maxBitrate} -> maxBitrate) (\s@Vp8Settings' {} a -> s {maxBitrate = a} :: Vp8Settings) Prelude.. Lens.mapping Prelude._Nat

-- | Optional. Size of buffer (HRD buffer model) in bits. For example, enter
-- five megabits as 5000000.
vp8Settings_hrdBufferSize :: Lens.Lens' Vp8Settings (Prelude.Maybe Prelude.Natural)
vp8Settings_hrdBufferSize = Lens.lens (\Vp8Settings' {hrdBufferSize} -> hrdBufferSize) (\s@Vp8Settings' {} a -> s {hrdBufferSize = a} :: Vp8Settings) Prelude.. Lens.mapping Prelude._Nat
...
vp8Settings_bitrate = Lens.lens (\Vp8Settings' {bitrate} -> bitrate) (\s@Vp8Settings' {} a -> s {bitrate = a} :: Vp8Settings) Prelude.. Lens.mapping Prelude._Nat

instance Prelude.FromJSON Vp8Settings where
  parseJSON =
    Prelude.withObject
      "Vp8Settings"
      ( \x ->
...
instance Prelude.ToJSON Vp8Settings where
  toJSON Vp8Settings' {..} =
    Prelude.object
      ( Prelude.catMaybes
