...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'djtrrsResponseStatus' - -- | The response status code.
deleteJobTemplateResponse ::
  -- | 'djtrrsResponseStatus'
  Int ->
  DeleteJobTemplateResponse
...
djtrrsResponseStatus :: Lens' DeleteJobTemplateResponse Int
djtrrsResponseStatus = lens _djtrrsResponseStatus (\s a -> s {_djtrrsResponseStatus = a})
