  ...
  toQuery PutMetricAlarm' {..} =
    mconcat
      [ "Action" =: ("PutMetricAlarm" :: ByteString),
        ...
        "Tags"
          =: toQuery (toQueryList "member" <$> _pmaTags),
        "OKActions"
