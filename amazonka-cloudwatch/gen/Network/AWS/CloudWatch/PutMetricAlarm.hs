  ...
  pComparisonOperator_ =
    PutMetricAlarm'
      { threshold = Prelude.Nothing,
        ...
        evaluationPeriods =
          Prelude._Nat Lens.# pEvaluationPeriods_,
...
putMetricAlarm_datapointsToAlarm = Lens.lens (\PutMetricAlarm' {datapointsToAlarm} -> datapointsToAlarm) (\s@PutMetricAlarm' {} a -> s {datapointsToAlarm = a} :: PutMetricAlarm) Prelude.. Lens.mapping Prelude._Nat
...
putMetricAlarm_alarmActions = Lens.lens (\PutMetricAlarm' {alarmActions} -> alarmActions) (\s@PutMetricAlarm' {} a -> s {alarmActions = a} :: PutMetricAlarm) Prelude.. Lens.mapping Prelude._Coerce
...
putMetricAlarm_insufficientDataActions = Lens.lens (\PutMetricAlarm' {insufficientDataActions} -> insufficientDataActions) (\s@PutMetricAlarm' {} a -> s {insufficientDataActions = a} :: PutMetricAlarm) Prelude.. Lens.mapping Prelude._Coerce
...
putMetricAlarm_metrics = Lens.lens (\PutMetricAlarm' {metrics} -> metrics) (\s@PutMetricAlarm' {} a -> s {metrics = a} :: PutMetricAlarm) Prelude.. Lens.mapping Prelude._Coerce
...
putMetricAlarm_tags = Lens.lens (\PutMetricAlarm' {tags} -> tags) (\s@PutMetricAlarm' {} a -> s {tags = a} :: PutMetricAlarm) Prelude.. Lens.mapping Prelude._Coerce
...
putMetricAlarm_oKActions = Lens.lens (\PutMetricAlarm' {oKActions} -> oKActions) (\s@PutMetricAlarm' {} a -> s {oKActions = a} :: PutMetricAlarm) Prelude.. Lens.mapping Prelude._Coerce
...
putMetricAlarm_dimensions = Lens.lens (\PutMetricAlarm' {dimensions} -> dimensions) (\s@PutMetricAlarm' {} a -> s {dimensions = a} :: PutMetricAlarm) Prelude.. Lens.mapping Prelude._Coerce
...
putMetricAlarm_period = Lens.lens (\PutMetricAlarm' {period} -> period) (\s@PutMetricAlarm' {} a -> s {period = a} :: PutMetricAlarm) Prelude.. Lens.mapping Prelude._Nat
...
putMetricAlarm_evaluationPeriods = Lens.lens (\PutMetricAlarm' {evaluationPeriods} -> evaluationPeriods) (\s@PutMetricAlarm' {} a -> s {evaluationPeriods = a} :: PutMetricAlarm) Prelude.. Prelude._Nat
...
instance Prelude.AWSRequest PutMetricAlarm where
...
instance Prelude.ToHeaders PutMetricAlarm where
  toHeaders = Prelude.const Prelude.mempty

instance Prelude.ToPath PutMetricAlarm where
  toPath = Prelude.const "/"

instance Prelude.ToQuery PutMetricAlarm where
  toQuery PutMetricAlarm' {..} =
    Prelude.mconcat
      [ "Action"
          Prelude.=: ("PutMetricAlarm" :: Prelude.ByteString),
        "Version"
          Prelude.=: ("2010-08-01" :: Prelude.ByteString),
        "Threshold" Prelude.=: threshold,
        "DatapointsToAlarm" Prelude.=: datapointsToAlarm,
        "EvaluateLowSampleCountPercentile"
          Prelude.=: evaluateLowSampleCountPercentile,
        "ExtendedStatistic" Prelude.=: extendedStatistic,
        "AlarmActions"
        ...
        "Unit" Prelude.=: unit,
        "ThresholdMetricId" Prelude.=: thresholdMetricId,
        ...
        "TreatMissingData" Prelude.=: treatMissingData,
        "Metrics"
          Prelude.=: Prelude.toQuery
