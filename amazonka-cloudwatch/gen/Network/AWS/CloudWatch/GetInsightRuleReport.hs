...
data GetInsightRuleReportResponse = GetInsightRuleReportResponse'
  { _girrrrsApproximateUniqueCount ::
      !( Maybe
           Integer
       ),
    _girrrrsMetricDatapoints ::
      !( Maybe
           [InsightRuleMetricDatapoint]
       ),
    _girrrrsContributors ::
      !( Maybe
           [InsightRuleContributor]
       ),
    _girrrrsAggregateValue ::
      !( Maybe
           Double
       ),
    _girrrrsKeyLabels ::
    ...
    _girrrrsAggregationStatistic ::
      !(Maybe Text),
    _girrrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'girrrrsApproximateUniqueCount' - An approximate count of the unique contributors found by this rule in this time period.
--
-- * 'girrrrsMetricDatapoints' - A time series of metric data points that matches the time period in the rule request.
--
-- * 'girrrrsContributors' - An array of the unique contributors found by this rule in this time period. If the rule contains multiple keys, each combination of values for the keys counts as a unique contributor.
--
-- * 'girrrrsAggregateValue' - The sum of the values from all individual contributors that match the rule.
--
-- * 'girrrrsKeyLabels' - An array of the strings used as the keys for this rule. The keys are the dimensions used to classify contributors. If the rule contains more than one key, then each unique combination of values for the keys is counted as a unique contributor.
--
-- * 'girrrrsAggregationStatistic' - Specifies whether this rule aggregates contributor data by COUNT or SUM.
--
-- * 'girrrrsResponseStatus' - -- | The response status code.
getInsightRuleReportResponse ::
  -- | 'girrrrsResponseStatus'
  Int ->
  GetInsightRuleReportResponse
getInsightRuleReportResponse pResponseStatus_ =
  GetInsightRuleReportResponse'
    { _girrrrsApproximateUniqueCount =
        Nothing,
      _girrrrsMetricDatapoints = Nothing,
      _girrrrsContributors = Nothing,
      _girrrrsAggregateValue = Nothing,
      _girrrrsKeyLabels = Nothing,
      _girrrrsAggregationStatistic = Nothing,
      _girrrrsResponseStatus = pResponseStatus_
    }

-- | An approximate count of the unique contributors found by this rule in this time period.
girrrrsApproximateUniqueCount :: Lens' GetInsightRuleReportResponse (Maybe Integer)
girrrrsApproximateUniqueCount = lens _girrrrsApproximateUniqueCount (\s a -> s {_girrrrsApproximateUniqueCount = a})

-- | A time series of metric data points that matches the time period in the rule request.
girrrrsMetricDatapoints :: Lens' GetInsightRuleReportResponse [InsightRuleMetricDatapoint]
girrrrsMetricDatapoints = lens _girrrrsMetricDatapoints (\s a -> s {_girrrrsMetricDatapoints = a}) . _Default . _Coerce

-- | An array of the unique contributors found by this rule in this time period. If the rule contains multiple keys, each combination of values for the keys counts as a unique contributor.
girrrrsContributors :: Lens' GetInsightRuleReportResponse [InsightRuleContributor]
girrrrsContributors = lens _girrrrsContributors (\s a -> s {_girrrrsContributors = a}) . _Default . _Coerce

-- | The sum of the values from all individual contributors that match the rule.
girrrrsAggregateValue :: Lens' GetInsightRuleReportResponse (Maybe Double)
girrrrsAggregateValue = lens _girrrrsAggregateValue (\s a -> s {_girrrrsAggregateValue = a})

-- | An array of the strings used as the keys for this rule. The keys are the dimensions used to classify contributors. If the rule contains more than one key, then each unique combination of values for the keys is counted as a unique contributor.
girrrrsKeyLabels :: Lens' GetInsightRuleReportResponse [Text]
girrrrsKeyLabels = lens _girrrrsKeyLabels (\s a -> s {_girrrrsKeyLabels = a}) . _Default . _Coerce

-- | Specifies whether this rule aggregates contributor data by COUNT or SUM.
girrrrsAggregationStatistic :: Lens' GetInsightRuleReportResponse (Maybe Text)
girrrrsAggregationStatistic = lens _girrrrsAggregationStatistic (\s a -> s {_girrrrsAggregationStatistic = a})

-- | -- | The response status code.
girrrrsResponseStatus :: Lens' GetInsightRuleReportResponse Int
girrrrsResponseStatus = lens _girrrrsResponseStatus (\s a -> s {_girrrrsResponseStatus = a})
