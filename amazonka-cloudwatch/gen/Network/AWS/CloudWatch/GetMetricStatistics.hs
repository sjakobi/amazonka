...
data GetMetricStatistics = GetMetricStatistics'
  { -- | The unit for a given metric. If you omit @Unit@, all data that was
    ...
    statistics :: Prelude.Maybe (Prelude.List1 Statistic),
    ...
    -- numbers.
    extendedStatistics :: Prelude.Maybe (Prelude.List1 Prelude.Text),
...
getMetricStatistics_statistics = Lens.lens (\GetMetricStatistics' {statistics} -> statistics) (\s@GetMetricStatistics' {} a -> s {statistics = a} :: GetMetricStatistics) Prelude.. Lens.mapping Prelude._List1
...
getMetricStatistics_extendedStatistics = Lens.lens (\GetMetricStatistics' {extendedStatistics} -> extendedStatistics) (\s@GetMetricStatistics' {} a -> s {extendedStatistics = a} :: GetMetricStatistics) Prelude.. Lens.mapping Prelude._List1
...
getMetricStatistics_period = Lens.lens (\GetMetricStatistics' {period} -> period) (\s@GetMetricStatistics' {} a -> s {period = a} :: GetMetricStatistics) Prelude.. Prelude._Nat
