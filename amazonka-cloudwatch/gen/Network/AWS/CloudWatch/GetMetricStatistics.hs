...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gmsrrsDatapoints' - The data points for the specified metric.
--
-- * 'gmsrrsLabel' - A label for the specified metric.
--
...
getMetricStatisticsResponse pResponseStatus_ =
  GetMetricStatisticsResponse'
    { _gmsrrsDatapoints =
        Nothing,
      _gmsrrsLabel = Nothing,
      _gmsrrsResponseStatus = pResponseStatus_
    }

-- | The data points for the specified metric.
gmsrrsDatapoints :: Lens' GetMetricStatisticsResponse [Datapoint]
gmsrrsDatapoints = lens _gmsrrsDatapoints (\s a -> s {_gmsrrsDatapoints = a}) . _Default . _Coerce

-- | A label for the specified metric.
gmsrrsLabel :: Lens' GetMetricStatisticsResponse (Maybe Text)
gmsrrsLabel = lens _gmsrrsLabel (\s a -> s {_gmsrrsLabel = a})

-- | -- | The response status code.
gmsrrsResponseStatus :: Lens' GetMetricStatisticsResponse Int
