...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'gslrrsSnapshotLimits' - A 'SnapshotLimits' object that contains the manual snapshot limits for the specified directory.
--
...
gslrrsSnapshotLimits :: Lens' GetSnapshotLimitsResponse (Maybe SnapshotLimits)
gslrrsSnapshotLimits = lens _gslrrsSnapshotLimits (\s a -> s {_gslrrsSnapshotLimits = a})

-- | -- | The response status code.
gslrrsResponseStatus :: Lens' GetSnapshotLimitsResponse Int
