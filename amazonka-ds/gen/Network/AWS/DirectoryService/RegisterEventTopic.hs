...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'retrrsResponseStatus' - -- | The response status code.
registerEventTopicResponse ::
  -- | 'retrrsResponseStatus'
  Int ->
  RegisterEventTopicResponse
...
retrrsResponseStatus :: Lens' RegisterEventTopicResponse Int
retrrsResponseStatus = lens _retrrsResponseStatus (\s a -> s {_retrrsResponseStatus = a})
