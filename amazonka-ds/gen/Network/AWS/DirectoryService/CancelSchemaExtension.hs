...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cserrsResponseStatus' - -- | The response status code.
cancelSchemaExtensionResponse ::
  -- | 'cserrsResponseStatus'
  Int ->
  CancelSchemaExtensionResponse
...
cserrsResponseStatus :: Lens' CancelSchemaExtensionResponse Int
cserrsResponseStatus = lens _cserrsResponseStatus (\s a -> s {_cserrsResponseStatus = a})
