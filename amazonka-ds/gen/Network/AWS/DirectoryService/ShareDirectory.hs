...
instance Hashable ShareDirectory

instance NFData ShareDirectory
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'sdrrsSharedDirectoryId' - Identifier of the directory that is stored in the directory consumer account that is shared from the specified directory (@DirectoryId@ ).
--
...
sdrrsSharedDirectoryId :: Lens' ShareDirectoryResponse (Maybe Text)
sdrrsSharedDirectoryId = lens _sdrrsSharedDirectoryId (\s a -> s {_sdrrsSharedDirectoryId = a})

-- | -- | The response status code.
sdrrsResponseStatus :: Lens' ShareDirectoryResponse Int
sdrrsResponseStatus = lens _sdrrsResponseStatus (\s a -> s {_sdrrsResponseStatus = a})

instance NFData ShareDirectoryResponse
