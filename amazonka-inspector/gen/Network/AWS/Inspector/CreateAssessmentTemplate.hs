...
createAssessmentTemplate_userAttributesForFindings = Lens.lens (\CreateAssessmentTemplate' {userAttributesForFindings} -> userAttributesForFindings) (\s@CreateAssessmentTemplate' {} a -> s {userAttributesForFindings = a} :: CreateAssessmentTemplate) Prelude.. Lens.mapping Prelude._Coerce
...
createAssessmentTemplate_durationInSeconds = Lens.lens (\CreateAssessmentTemplate' {durationInSeconds} -> durationInSeconds) (\s@CreateAssessmentTemplate' {} a -> s {durationInSeconds = a} :: CreateAssessmentTemplate) Prelude.. Prelude._Nat

-- | The ARNs that specify the rules packages that you want to attach to the
-- assessment template.
createAssessmentTemplate_rulesPackageArns :: Lens.Lens' CreateAssessmentTemplate [Prelude.Text]
createAssessmentTemplate_rulesPackageArns = Lens.lens (\CreateAssessmentTemplate' {rulesPackageArns} -> rulesPackageArns) (\s@CreateAssessmentTemplate' {} a -> s {rulesPackageArns = a} :: CreateAssessmentTemplate) Prelude.. Prelude._Coerce

instance Prelude.AWSRequest CreateAssessmentTemplate where
  type
    Rs CreateAssessmentTemplate =
      CreateAssessmentTemplateResponse
...
instance Prelude.ToHeaders CreateAssessmentTemplate where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "InspectorService.CreateAssessmentTemplate" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON CreateAssessmentTemplate where
  toJSON CreateAssessmentTemplate' {..} =
    Prelude.object
      ( Prelude.catMaybes
          [ ("userAttributesForFindings" Prelude..=)
            ...
            Prelude.Just
              ("durationInSeconds" Prelude..= durationInSeconds),
            Prelude.Just
              ("rulesPackageArns" Prelude..= rulesPackageArns)
          ]
      )

instance Prelude.ToPath CreateAssessmentTemplate where
  toPath = Prelude.const "/"

instance Prelude.ToQuery CreateAssessmentTemplate where
