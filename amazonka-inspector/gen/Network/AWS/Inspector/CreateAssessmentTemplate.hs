...
data CreateAssessmentTemplate = CreateAssessmentTemplate'
  { _catUserAttributesForFindings ::
      !(Maybe [Attribute]),
    _catAssessmentTargetARN ::
      !Text,
    _catAssessmentTemplateName ::
      !Text,
    _catDurationInSeconds ::
      !Nat,
    _catRulesPackageARNs ::
      ![Text]
  }
  deriving
    ( Eq,
...
--
-- * 'catrrsAssessmentTemplateARN' - The ARN that specifies the assessment template that is created.
createAssessmentTemplateResponse ::
  -- | 'catrrsResponseStatus'
  Int ->
  -- | 'catrrsAssessmentTemplateARN'
...
catrrsResponseStatus :: Lens' CreateAssessmentTemplateResponse Int
catrrsResponseStatus = lens _catrrsResponseStatus (\s a -> s {_catrrsResponseStatus = a})

-- | The ARN that specifies the assessment template that is created.
catrrsAssessmentTemplateARN :: Lens' CreateAssessmentTemplateResponse Text
catrrsAssessmentTemplateARN = lens _catrrsAssessmentTemplateARN (\s a -> s {_catrrsAssessmentTemplateARN = a})
