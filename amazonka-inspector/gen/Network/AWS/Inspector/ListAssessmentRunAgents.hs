...
instance Prelude.AWSRequest ListAssessmentRunAgents where
  type
    ...
    Response.receiveJSON
      ( \s h x ->
          ListAssessmentRunAgentsResponse'
            ...
            Prelude.<*> ( x Prelude..?> "assessmentRunAgents"
...
instance Prelude.ToHeaders ListAssessmentRunAgents where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "InspectorService.ListAssessmentRunAgents" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON ListAssessmentRunAgents where
...
instance Prelude.ToPath ListAssessmentRunAgents where
  toPath = Prelude.const "/"

instance Prelude.ToQuery ListAssessmentRunAgents where
...
listAssessmentRunAgentsResponse_assessmentRunAgents = Lens.lens (\ListAssessmentRunAgentsResponse' {assessmentRunAgents} -> assessmentRunAgents) (\s@ListAssessmentRunAgentsResponse' {} a -> s {assessmentRunAgents = a} :: ListAssessmentRunAgentsResponse) Prelude.. Prelude._Coerce
