...
--
-- * 'crsAssessmentTargetARN' - The ARN that specifies the assessment target that is created.
createAssessmentTargetResponse ::
  -- | 'crsResponseStatus'
  Int ->
  -- | 'crsAssessmentTargetARN'
...
crsResponseStatus :: Lens' CreateAssessmentTargetResponse Int
crsResponseStatus = lens _crsResponseStatus (\s a -> s {_crsResponseStatus = a})

-- | The ARN that specifies the assessment target that is created.
crsAssessmentTargetARN :: Lens' CreateAssessmentTargetResponse Text
crsAssessmentTargetARN = lens _crsAssessmentTargetARN (\s a -> s {_crsAssessmentTargetARN = a})
