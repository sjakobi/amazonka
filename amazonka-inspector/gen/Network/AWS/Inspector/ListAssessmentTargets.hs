...
--
-- * 'latNextToken' - You can use this parameter when paginating results. Set the value of this parameter to null on your first call to the __ListAssessmentTargets__ action. Subsequent calls to the action fill __nextToken__ in the request with the value of __NextToken__ from the previous response to continue listing data.
--
...
instance AWSPager ListAssessmentTargets where
  page rq rs
    ...
    | otherwise =
      Just $ rq & latNextToken .~ rs ^. lrsNextToken
