...
newAssetAttributes pSchemaVersion_ =
  AssetAttributes'
    { hostname = Prelude.Nothing,
      ...
      schemaVersion = Prelude._Nat Lens.# pSchemaVersion_
    }
...
assetAttributes_schemaVersion = Lens.lens (\AssetAttributes' {schemaVersion} -> schemaVersion) (\s@AssetAttributes' {} a -> s {schemaVersion = a} :: AssetAttributes) Prelude.. Prelude._Nat
