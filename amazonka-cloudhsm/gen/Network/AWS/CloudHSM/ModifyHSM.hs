...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'mhrrsHSMARN' - The ARN of the HSM.
--
...
modifyHSMResponse pResponseStatus_ =
  ModifyHSMResponse'
    { _mhrrsHSMARN = Nothing,
      _mhrrsResponseStatus = pResponseStatus_
    }

-- | The ARN of the HSM.
mhrrsHSMARN :: Lens' ModifyHSMResponse (Maybe Text)
mhrrsHSMARN = lens _mhrrsHSMARN (\s a -> s {_mhrrsHSMARN = a})

-- | -- | The response status code.
mhrrsResponseStatus :: Lens' ModifyHSMResponse Int
