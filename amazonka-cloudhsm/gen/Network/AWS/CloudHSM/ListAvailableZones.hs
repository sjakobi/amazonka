...
--
-- * 'lazrrsAZList' - The list of Availability Zones that have available AWS CloudHSM capacity.
--
-- * 'lazrrsResponseStatus' - -- | The response status code.
listAvailableZonesResponse ::
  -- | 'lazrrsResponseStatus'
  Int ->
  ListAvailableZonesResponse
listAvailableZonesResponse pResponseStatus_ =
  ListAvailableZonesResponse'
    { _lazrrsAZList =
        Nothing,
      _lazrrsResponseStatus = pResponseStatus_
    }

-- | The list of Availability Zones that have available AWS CloudHSM capacity.
lazrrsAZList :: Lens' ListAvailableZonesResponse [Text]
lazrrsAZList = lens _lazrrsAZList (\s a -> s {_lazrrsAZList = a}) . _Default . _Coerce

-- | -- | The response status code.
lazrrsResponseStatus :: Lens' ListAvailableZonesResponse Int
lazrrsResponseStatus = lens _lazrrsResponseStatus (\s a -> s {_lazrrsResponseStatus = a})
