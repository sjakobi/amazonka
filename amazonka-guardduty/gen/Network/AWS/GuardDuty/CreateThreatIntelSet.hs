...
createThreatIntelSet_tags = Lens.lens (\CreateThreatIntelSet' {tags} -> tags) (\s@CreateThreatIntelSet' {} a -> s {tags = a} :: CreateThreatIntelSet) Prelude.. Lens.mapping Prelude._Map
...
instance Prelude.AWSRequest CreateThreatIntelSet where
  type
    ...
    Response.receiveJSON
      ( \s h x ->
          CreateThreatIntelSetResponse'
            ...
            Prelude.<*> (x Prelude..:> "threatIntelSetId")
      )
...
instance Prelude.ToHeaders CreateThreatIntelSet where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "Content-Type"
...
instance Prelude.ToJSON CreateThreatIntelSet where
...
instance Prelude.ToPath CreateThreatIntelSet where
...
instance Prelude.ToQuery CreateThreatIntelSet where
