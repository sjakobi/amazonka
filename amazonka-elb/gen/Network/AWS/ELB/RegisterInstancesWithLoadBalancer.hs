...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'riwlbrrsInstances' - The updated list of instances for the load balancer.
--
-- * 'riwlbrrsResponseStatus' - -- | The response status code.
registerInstancesWithLoadBalancerResponse ::
  -- | 'riwlbrrsResponseStatus'
  Int ->
  RegisterInstancesWithLoadBalancerResponse
...
riwlbrrsInstances :: Lens' RegisterInstancesWithLoadBalancerResponse [Instance]
riwlbrrsInstances = lens _riwlbrrsInstances (\s a -> s {_riwlbrrsInstances = a}) . _Default . _Coerce

-- | -- | The response status code.
riwlbrrsResponseStatus :: Lens' RegisterInstancesWithLoadBalancerResponse Int
riwlbrrsResponseStatus = lens _riwlbrrsResponseStatus (\s a -> s {_riwlbrrsResponseStatus = a})
