...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'diflbrrsInstances' - The remaining instances registered with the load balancer.
--
...
diflbrrsInstances :: Lens' DeregisterInstancesFromLoadBalancerResponse [Instance]
diflbrrsInstances = lens _diflbrrsInstances (\s a -> s {_diflbrrsInstances = a}) . _Default . _Coerce

-- | -- | The response status code.
diflbrrsResponseStatus :: Lens' DeregisterInstancesFromLoadBalancerResponse Int
