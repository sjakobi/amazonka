  ...
  pInstancePort_ =
    Listener'
      { instanceProtocol = Prelude.Nothing,
        ...
        instancePort = Prelude._Nat Lens.# pInstancePort_
      }
...
listener_instancePort = Lens.lens (\Listener' {instancePort} -> instancePort) (\s@Listener' {} a -> s {instancePort = a} :: Listener) Prelude.. Prelude._Nat
