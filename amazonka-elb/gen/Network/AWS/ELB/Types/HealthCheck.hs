...
data HealthCheck = HealthCheck'
  { -- | The instance being checked. The protocol is either TCP, HTTP, HTTPS, or
    ...
    unhealthyThreshold :: Prelude.Nat,
    -- | The number of consecutive health checks successes required before moving
    -- the instance to the @Healthy@ state.
    healthyThreshold :: Prelude.Nat
  }
...
newHealthCheck
  ...
  pHealthyThreshold_ =
    HealthCheck'
      { target = pTarget_,
        interval = Prelude._Nat Lens.# pInterval_,
        timeout = Prelude._Nat Lens.# pTimeout_,
        unhealthyThreshold =
          Prelude._Nat Lens.# pUnhealthyThreshold_,
        healthyThreshold =
          Prelude._Nat Lens.# pHealthyThreshold_
      }
...
healthCheck_interval = Lens.lens (\HealthCheck' {interval} -> interval) (\s@HealthCheck' {} a -> s {interval = a} :: HealthCheck) Prelude.. Prelude._Nat
...
healthCheck_timeout = Lens.lens (\HealthCheck' {timeout} -> timeout) (\s@HealthCheck' {} a -> s {timeout = a} :: HealthCheck) Prelude.. Prelude._Nat

-- | The number of consecutive health check failures required before moving
-- the instance to the @Unhealthy@ state.
healthCheck_unhealthyThreshold :: Lens.Lens' HealthCheck Prelude.Natural
healthCheck_unhealthyThreshold = Lens.lens (\HealthCheck' {unhealthyThreshold} -> unhealthyThreshold) (\s@HealthCheck' {} a -> s {unhealthyThreshold = a} :: HealthCheck) Prelude.. Prelude._Nat

-- | The number of consecutive health checks successes required before moving
-- the instance to the @Healthy@ state.
healthCheck_healthyThreshold :: Lens.Lens' HealthCheck Prelude.Natural
healthCheck_healthyThreshold = Lens.lens (\HealthCheck' {healthyThreshold} -> healthyThreshold) (\s@HealthCheck' {} a -> s {healthyThreshold = a} :: HealthCheck) Prelude.. Prelude._Nat
...
instance Prelude.ToQuery HealthCheck where
  toQuery HealthCheck' {..} =
    Prelude.mconcat
      [ "Target" Prelude.=: target,
        "Interval" Prelude.=: interval,
        "Timeout" Prelude.=: timeout,
        "UnhealthyThreshold" Prelude.=: unhealthyThreshold,
        "HealthyThreshold" Prelude.=: healthyThreshold
      ]
