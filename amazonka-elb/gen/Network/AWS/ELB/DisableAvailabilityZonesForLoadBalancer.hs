...
data DisableAvailabilityZonesForLoadBalancerResponse = DisableAvailabilityZonesForLoadBalancerResponse'
  { _dazflbrrsAvailabilityZones ::
      !( Maybe
           [Text]
       ),
    _dazflbrrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dazflbrrsAvailabilityZones' - The remaining Availability Zones for the load balancer.
--
-- * 'dazflbrrsResponseStatus' - -- | The response status code.
disableAvailabilityZonesForLoadBalancerResponse ::
  -- | 'dazflbrrsResponseStatus'
  Int ->
  DisableAvailabilityZonesForLoadBalancerResponse
...
dazflbrrsAvailabilityZones :: Lens' DisableAvailabilityZonesForLoadBalancerResponse [Text]
dazflbrrsAvailabilityZones = lens _dazflbrrsAvailabilityZones (\s a -> s {_dazflbrrsAvailabilityZones = a}) . _Default . _Coerce

-- | -- | The response status code.
dazflbrrsResponseStatus :: Lens' DisableAvailabilityZonesForLoadBalancerResponse Int
dazflbrrsResponseStatus = lens _dazflbrrsResponseStatus (\s a -> s {_dazflbrrsResponseStatus = a})
