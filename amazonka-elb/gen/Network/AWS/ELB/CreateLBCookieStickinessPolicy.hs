...
instance ToHeaders CreateLBCookieStickinessPolicy where
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'clbcsprrsResponseStatus' - -- | The response status code.
createLBCookieStickinessPolicyResponse ::
  -- | 'clbcsprrsResponseStatus'
  Int ->
  CreateLBCookieStickinessPolicyResponse
...
clbcsprrsResponseStatus :: Lens' CreateLBCookieStickinessPolicyResponse Int
clbcsprrsResponseStatus = lens _clbcsprrsResponseStatus (\s a -> s {_clbcsprrsResponseStatus = a})
