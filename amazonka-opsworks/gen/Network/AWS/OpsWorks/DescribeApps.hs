...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'darrsApps' - An array of @App@ objects that describe the specified apps.
--
...
darrsApps :: Lens' DescribeAppsResponse [App]
darrsApps = lens _darrsApps (\s a -> s {_darrsApps = a}) . _Default . _Coerce

-- | -- | The response status code.
darrsResponseStatus :: Lens' DescribeAppsResponse Int
