...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'drdirrsRDSDBInstances' - An a array of @RdsDbInstance@ objects that describe the instances.
--
...
describeRDSDBInstancesResponse pResponseStatus_ =
  DescribeRDSDBInstancesResponse'
    { _drdirrsRDSDBInstances =
        Nothing,
      _drdirrsResponseStatus = pResponseStatus_
    }

-- | An a array of @RdsDbInstance@ objects that describe the instances.
drdirrsRDSDBInstances :: Lens' DescribeRDSDBInstancesResponse [RDSDBInstance]
drdirrsRDSDBInstances = lens _drdirrsRDSDBInstances (\s a -> s {_drdirrsRDSDBInstances = a}) . _Default . _Coerce

-- | -- | The response status code.
drdirrsResponseStatus :: Lens' DescribeRDSDBInstancesResponse Int
