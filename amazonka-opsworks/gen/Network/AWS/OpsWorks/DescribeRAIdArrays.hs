...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'draiarrsRAIdArrays' - A @RaidArrays@ object that describes the specified RAID arrays.
--
-- * 'draiarrsResponseStatus' - -- | The response status code.
describeRAIdArraysResponse ::
  -- | 'draiarrsResponseStatus'
  Int ->
  DescribeRAIdArraysResponse
describeRAIdArraysResponse pResponseStatus_ =
  DescribeRAIdArraysResponse'
    { _draiarrsRAIdArrays =
        Nothing,
      _draiarrsResponseStatus = pResponseStatus_
    }

-- | A @RaidArrays@ object that describes the specified RAID arrays.
draiarrsRAIdArrays :: Lens' DescribeRAIdArraysResponse [RAIdArray]
draiarrsRAIdArrays = lens _draiarrsRAIdArrays (\s a -> s {_draiarrsRAIdArrays = a}) . _Default . _Coerce

-- | -- | The response status code.
draiarrsResponseStatus :: Lens' DescribeRAIdArraysResponse Int
draiarrsResponseStatus = lens _draiarrsResponseStatus (\s a -> s {_draiarrsResponseStatus = a})
