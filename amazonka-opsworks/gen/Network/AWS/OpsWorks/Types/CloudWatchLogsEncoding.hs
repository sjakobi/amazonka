...
instance Prelude.FromText CloudWatchLogsEncoding where
  parser = CloudWatchLogsEncoding' Prelude.<$> Prelude.takeText

instance Prelude.ToText CloudWatchLogsEncoding where
  toText (CloudWatchLogsEncoding' x) = x

instance Prelude.Hashable CloudWatchLogsEncoding

instance Prelude.NFData CloudWatchLogsEncoding

instance Prelude.ToByteString CloudWatchLogsEncoding

instance Prelude.ToQuery CloudWatchLogsEncoding

instance Prelude.ToHeader CloudWatchLogsEncoding

instance Prelude.ToJSON CloudWatchLogsEncoding where
  toJSON = Prelude.toJSONText

instance Prelude.FromJSON CloudWatchLogsEncoding where
  parseJSON = Prelude.parseJSONText "CloudWatchLogsEncoding"
