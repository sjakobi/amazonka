...
data DeploymentCommand = DeploymentCommand'
  { -- | The arguments of those commands that take arguments. It should be set to
    ...
    args :: Prelude.Maybe (Prelude.Map Prelude.Text [Prelude.Text]),
...
deploymentCommand_args = Lens.lens (\DeploymentCommand' {args} -> args) (\s@DeploymentCommand' {} a -> s {args = a} :: DeploymentCommand) Prelude.. Lens.mapping Prelude._Map
