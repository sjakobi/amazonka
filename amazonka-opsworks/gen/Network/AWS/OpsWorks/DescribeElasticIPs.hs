...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'deirrsElasticIPs' - An @ElasticIps@ object that describes the specified Elastic IP addresses.
--
-- * 'deirrsResponseStatus' - -- | The response status code.
describeElasticIPsResponse ::
  -- | 'deirrsResponseStatus'
  Int ->
  DescribeElasticIPsResponse
describeElasticIPsResponse pResponseStatus_ =
  DescribeElasticIPsResponse'
    { _deirrsElasticIPs =
        Nothing,
      _deirrsResponseStatus = pResponseStatus_
    }

-- | An @ElasticIps@ object that describes the specified Elastic IP addresses.
deirrsElasticIPs :: Lens' DescribeElasticIPsResponse [ElasticIP]
deirrsElasticIPs = lens _deirrsElasticIPs (\s a -> s {_deirrsElasticIPs = a}) . _Default . _Coerce

-- | -- | The response status code.
deirrsResponseStatus :: Lens' DescribeElasticIPsResponse Int
deirrsResponseStatus = lens _deirrsResponseStatus (\s a -> s {_deirrsResponseStatus = a})
