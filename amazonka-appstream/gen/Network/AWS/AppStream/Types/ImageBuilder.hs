...
imageBuilder_accessEndpoints = Lens.lens (\ImageBuilder' {accessEndpoints} -> accessEndpoints) (\s@ImageBuilder' {} a -> s {accessEndpoints = a} :: ImageBuilder) Prelude.. Lens.mapping Prelude._List1
...
imageBuilder_createdTime = Lens.lens (\ImageBuilder' {createdTime} -> createdTime) (\s@ImageBuilder' {} a -> s {createdTime = a} :: ImageBuilder) Prelude.. Lens.mapping Prelude._Time
...
imageBuilder_imageBuilderErrors = Lens.lens (\ImageBuilder' {imageBuilderErrors} -> imageBuilderErrors) (\s@ImageBuilder' {} a -> s {imageBuilderErrors = a} :: ImageBuilder) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.FromJSON ImageBuilder where
  parseJSON =
    Prelude.withObject
      "ImageBuilder"
      ( \x ->
          ImageBuilder'
            ...
            Prelude.<*> ( x Prelude..:? "ImageBuilderErrors"
