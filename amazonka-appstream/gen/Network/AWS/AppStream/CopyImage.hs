...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cirrsDestinationImageName' - The name of the destination image.
--
...
cirrsDestinationImageName :: Lens' CopyImageResponse (Maybe Text)
cirrsDestinationImageName = lens _cirrsDestinationImageName (\s a -> s {_cirrsDestinationImageName = a})
