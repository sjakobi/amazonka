...
updateProvisionedProduct_tags = Lens.lens (\UpdateProvisionedProduct' {tags} -> tags) (\s@UpdateProvisionedProduct' {} a -> s {tags = a} :: UpdateProvisionedProduct) Prelude.. Lens.mapping Prelude._Coerce
...
updateProvisionedProduct_provisioningParameters = Lens.lens (\UpdateProvisionedProduct' {provisioningParameters} -> provisioningParameters) (\s@UpdateProvisionedProduct' {} a -> s {provisioningParameters = a} :: UpdateProvisionedProduct) Prelude.. Lens.mapping Prelude._Coerce
...
instance Prelude.AWSRequest UpdateProvisionedProduct where
  type
...
instance Prelude.ToHeaders UpdateProvisionedProduct where
  toHeaders =
    Prelude.const
      ( Prelude.mconcat
          [ "X-Amz-Target"
              Prelude.=# ( "AWS242ServiceCatalogService.UpdateProvisionedProduct" ::
                             Prelude.ByteString
                         ),
            "Content-Type"
...
instance Prelude.ToJSON UpdateProvisionedProduct where
    ...
    Prelude.object
      ( Prelude.catMaybes
          [ ("ProvisionedProductName" Prelude..=)
            ...
            Prelude.Just ("UpdateToken" Prelude..= updateToken)
          ]
      )

instance Prelude.ToPath UpdateProvisionedProduct where
  toPath = Prelude.const "/"

instance Prelude.ToQuery UpdateProvisionedProduct where
