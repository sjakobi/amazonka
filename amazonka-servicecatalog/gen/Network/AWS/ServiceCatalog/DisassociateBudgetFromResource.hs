...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'dbfrrrsResponseStatus' - -- | The response status code.
disassociateBudgetFromResourceResponse ::
  -- | 'dbfrrrsResponseStatus'
  Int ->
  DisassociateBudgetFromResourceResponse
...
dbfrrrsResponseStatus :: Lens' DisassociateBudgetFromResourceResponse Int
dbfrrrsResponseStatus = lens _dbfrrrsResponseStatus (\s a -> s {_dbfrrrsResponseStatus = a})
