...
data ExecuteProvisionedProductServiceActionResponse = ExecuteProvisionedProductServiceActionResponse'
  { _eppsarrsRecordDetail ::
      !( Maybe
           RecordDetail
       ),
    _eppsarrsResponseStatus ::
      !Int
  }
  deriving
    ( Eq,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'eppsarrsRecordDetail' - An object containing detailed information about the result of provisioning the product.
--
-- * 'eppsarrsResponseStatus' - -- | The response status code.
executeProvisionedProductServiceActionResponse ::
  -- | 'eppsarrsResponseStatus'
  Int ->
  ExecuteProvisionedProductServiceActionResponse
...
eppsarrsRecordDetail :: Lens' ExecuteProvisionedProductServiceActionResponse (Maybe RecordDetail)
eppsarrsRecordDetail = lens _eppsarrsRecordDetail (\s a -> s {_eppsarrsRecordDetail = a})

-- | -- | The response status code.
eppsarrsResponseStatus :: Lens' ExecuteProvisionedProductServiceActionResponse Int
eppsarrsResponseStatus = lens _eppsarrsResponseStatus (\s a -> s {_eppsarrsResponseStatus = a})
