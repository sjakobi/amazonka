...
data CreateConstraintResponse = CreateConstraintResponse'
  { _ccrrsConstraintParameters ::
      !(Maybe Text),
    _ccrrsStatus ::
      !( Maybe
           RequestStatus
       ),
    _ccrrsConstraintDetail ::
      !( Maybe
           ConstraintDetail
       ),
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ccrrsConstraintParameters' - The constraint parameters.
--
-- * 'ccrrsStatus' - The status of the current request.
--
-- * 'ccrrsConstraintDetail' - Information about the constraint.
--
...
createConstraintResponse pResponseStatus_ =
  CreateConstraintResponse'
    { _ccrrsConstraintParameters =
        Nothing,
      _ccrrsStatus = Nothing,
      _ccrrsConstraintDetail = Nothing,
      _ccrrsResponseStatus = pResponseStatus_
    }

-- | The constraint parameters.
ccrrsConstraintParameters :: Lens' CreateConstraintResponse (Maybe Text)
ccrrsConstraintParameters = lens _ccrrsConstraintParameters (\s a -> s {_ccrrsConstraintParameters = a})

-- | The status of the current request.
ccrrsStatus :: Lens' CreateConstraintResponse (Maybe RequestStatus)
ccrrsStatus = lens _ccrrsStatus (\s a -> s {_ccrrsStatus = a})

-- | Information about the constraint.
ccrrsConstraintDetail :: Lens' CreateConstraintResponse (Maybe ConstraintDetail)
ccrrsConstraintDetail = lens _ccrrsConstraintDetail (\s a -> s {_ccrrsConstraintDetail = a})

-- | -- | The response status code.
ccrrsResponseStatus :: Lens' CreateConstraintResponse Int
