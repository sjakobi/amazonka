...
data SearchResponse = SearchResponse'
  { -- | The status information returned for the search request.
    ...
    stats :: Prelude.Maybe (Prelude.Map Prelude.Text FieldStats),
    -- | The requested facet information.
    facets :: Prelude.Maybe (Prelude.Map Prelude.Text BucketInfo),
...
searchResponse_stats = Lens.lens (\SearchResponse' {stats} -> stats) (\s@SearchResponse' {} a -> s {stats = a} :: SearchResponse) Prelude.. Lens.mapping Prelude._Map

-- | The requested facet information.
searchResponse_facets :: Lens.Lens' SearchResponse (Prelude.Maybe (Prelude.HashMap Prelude.Text BucketInfo))
searchResponse_facets = Lens.lens (\SearchResponse' {facets} -> facets) (\s@SearchResponse' {} a -> s {facets = a} :: SearchResponse) Prelude.. Lens.mapping Prelude._Map
